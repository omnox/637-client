...
final class Class98_Sub17_Sub1 extends Class98_Sub17 {
	...
	static final void method1157(int i) {
		try {
			if (i >= -115)
				method1160(14);
			Class217.method2799(2, 22050, (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub1_4043.method558((byte) 123) ^ 0xffffffff) == -2, (byte) 117);
	...
	final long method1154(boolean bool) {
		try {
			if (bool != true)
				return -39L;
			return ((Class98_Sub17_Sub1) this).aLong5777;
		} catch (RuntimeException runtimeexception) {
	...
	final int method1151(int i) {
		try {
			if (i < 34)
				return -100;
			return ((Class98_Sub17_Sub1) this).anInt5776;
		} catch (RuntimeException runtimeexception) {
	...
	final int method1156(int i) {
		try {
			if (i != -5)
				((Class98_Sub17_Sub1) this).aLong5777 = 50L;
			return ((Class98_Sub17_Sub1) this).anInt5779;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1158(int i) {
		try {
			if (i == -2) {
				...
				((OutgoingPacket) class98_sub11).packet.writeByte(Class146_Sub2.method2391((byte) 112));
				((OutgoingPacket) class98_sub11).packet.writeShort(Class39_Sub1.anInt3593);
				((OutgoingPacket) class98_sub11).packet.writeShort(Class98_Sub25.anInt4024);
				((OutgoingPacket) class98_sub11).packet.writeByte(((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub23_4055.method648((byte) 120));
	...
	final int method1155(int i) {
		try {
			int i_0_ = -3 % ((72 - i) / 49);
			return ((Class98_Sub17_Sub1) this).anInt5775;
		} catch (RuntimeException runtimeexception) {
	...
	final int method1152(int i) {
		try {
			if (i != 2)
				((Class98_Sub17_Sub1) this).aLong5777 = -28L;
			return ((Class98_Sub17_Sub1) this).anInt5774;
		} catch (RuntimeException runtimeexception) {
