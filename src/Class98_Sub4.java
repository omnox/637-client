...
final class Class98_Sub4 extends Node {
	...
	static final void method953(int i, int i_0_, boolean bool) {
		try {
			int i_1_ = (Class42_Sub1.aClass197_5354.method2674(TextResources.CHOOSE_OPTION.get_text(Class374.anInt3159), 99));
			int i_2_;
			...
			throw Class64_Sub27.method667(runtimeexception, ("bfa.A(" + i + ',' + i_0_ + ',' + bool + ')'));
		}
	}
