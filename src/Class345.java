...
final class Class345 {
	...
	static final void method3824(String string, int i) {
		try {
			if (i == 2 && !string.equals("")) {
				...
				((OutgoingPacket) class98_sub11).packet.writeByte(r_Sub2.method1650(string, (byte) 74));
	...
	protected final void finalize() throws Throwable {
		try {
			aHa_Sub1_2890.method1855(false, ((Class345) this).aLong2891);
			super.finalize();
		} catch (RuntimeException runtimeexception) {
