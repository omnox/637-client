...
final class Class301 {
	...
	static final void method3537(int i, byte i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		do {
			try {
				if (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub22_4066.method641((byte) 127) != 0 && i_2_ != 0 && (Class306.anInt2566 ^ 0xffffffff) > -51 && i_1_ != -1)
	...
	final Class141 method3538(int i_5_) {
		try {
			Class141 class141;
			synchronized (aClass79_2505) {
				class141 = (Class141) aClass79_2505.get((long) i_5_);
			}
			if (class141 != null)
				return class141;
			byte[] is;
			...
			((Class141) class141).anInt1097 = i_5_;
			((Class141) class141).aClass301_1133 = this;
			if (is != null)
				class141.method2297(new RSByteBuffer(is), true);
			class141.method2295((byte) 70);
			synchronized (aClass79_2505) {
				aClass79_2505.put((long) i_5_, class141);
			}
			return class141;
		} catch (RuntimeException runtimeexception) {
