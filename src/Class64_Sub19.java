...
final class Class64_Sub19 extends Class64 {
	...
	static final void method632(int i, int i_5_, byte i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		do {
			try {
				if ((Class76_Sub8.anInt3778 ^ 0xffffffff) >= (i_8_ ^ 0xffffffff) && Class3.anInt77 >= i_5_ && (i_9_ ^ 0xffffffff) <= (Class98_Sub10_Sub38.anInt5753 ^ 0xffffffff) && Class218.anInt1635 >= i_10_) {
	...
	final void method551(byte i) {
		try {
			...
			if (((Class64) this).anInt494 < 0 || (((Class64) this).anInt494 ^ 0xffffffff) < -5)
