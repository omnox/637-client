...
final class Class65 {
	...
	static char[] aCharArray497 = { '\u20ac', '\0', '\u201a', '\u0192', '\u201e', '\u2026', '\u2020', '\u2021', '\u02c6', '\u2030', '\u0160', '\u2039', '\u0152', '\0', '\u017d', '\0', '\0', '\u2018', '\u2019', '\u201c', '\u201d', '\u2022', '\u2013', '\u2014', '\u02dc', '\u2122', '\u0161', '\u203a', '\u0153', '\0', '\u017e', '\u0178' };
	static int anInt498;
	static GameInterfaceData[] aClass293Array500;
	...
	static final void method678(int i, boolean bool) {
		try {
			if (bool == false) {
				Class81.anInt624 = i;
			...
			throw Class64_Sub27.method667(runtimeexception, "ef.C(" + i + ',' + bool + ')');
		}
	}

	static final boolean method679(int i, int i_0_, byte i_1_, int i_2_) {
		try {
			if (i_1_ < 66)
				method678(-15, true);
			boolean bool = true;
			...
			interface19 = ((Interface19) Class97.method931(i_0_, i, i_2_, (aClass504 != null ? aClass504 : (aClass504 = method681("Interface19")))));
			if (interface19 != null)
				bool &= Class180.method2603((byte) 76, interface19);
			...
			throw Class64_Sub27.method667(runtimeexception, ("ef.B(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ')'));
		}
	}
	...
	public static void method680(byte i) {
		do {
			try {
				...
				aCharArray497 = null;
				IncomingOpcode.aClass58_499 = null;
				anIntArray501 = null;
				if (i == -108)
					break;
	...
	public final String toString() {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ef.toString(" + ')');
		}
	}

	/* synthetic */
	static Class method681(String string) {
		try {
