...
final class Class165 {
	...
	static final void method2523(int i, Mobile class246_sub3_sub4_sub2) {
		do {
			try {
				int i_0_ = (-Class215.anInt1614 + (((Mobile) class246_sub3_sub4_sub2).anInt6390));
				int i_1_ = ((((Mobile) class246_sub3_sub4_sub2).anInt6378) * 512 + 256 * class246_sub3_sub4_sub2.getSize());
				int i_2_ = ((((Mobile) class246_sub3_sub4_sub2).anInt6347) * 512 + 256 * class246_sub3_sub4_sub2.getSize());
				((AnimableEntity) class246_sub3_sub4_sub2).localYPos += (-((AnimableEntity) class246_sub3_sub4_sub2).localYPos + i_2_) / i_0_;
				((AnimableEntity) class246_sub3_sub4_sub2).localXPos += (-((AnimableEntity) class246_sub3_sub4_sub2).localXPos + i_1_) / i_0_;
				((Mobile) class246_sub3_sub4_sub2).anInt6433 = 0;
				if (((((Mobile) class246_sub3_sub4_sub2).anInt6407) ^ 0xffffffff) == -1)
				...
				if ((((Mobile) class246_sub3_sub4_sub2).anInt6407) != 3)
					break;
