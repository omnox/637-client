...
final class Class151_Sub4 extends Class151 {
	...
	Class151_Sub4(ha_Sub1 var_ha_Sub1, Class51 class51) {
		...
		do {
			try {
				...
				if (((Class51) aClass51_4984).aClass42_Sub4_421 == null || !(((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aBoolean4399) || !(((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aBoolean4447))
					break;
				...
				Class345 class345_0_ = (Class246_Sub3_Sub1_Sub1.method2996(35632, ((Class151) this).aHa_Sub1_1215, false, "varying vec3 wvVertex;\nvarying float waterDepth;\nuniform vec3 sunDir;\nuniform vec4 sunColour;\nuniform float sunExponent;\nuniform float breakWaterDepth;\nuniform float breakWaterOffset;\nuniform sampler3D normalSampler;\nuniform samplerCube envMapSampler;\nvoid main() {\nvec4 wnNormal = texture3D(normalSampler, gl_TexCoord[0].xyz).rbga;\nwnNormal.xyz = 2.0*wnNormal.xyz-1.0;\nvec3 wnVector = normalize(wvVertex);\nvec3 wnReflection = reflect(wnVector, wnNormal.xyz);\nvec3 envColour = textureCube(envMapSampler, wnReflection).rgb;\nvec4 specularColour = sunColour*pow(clamp(-dot(sunDir, wnReflection), 0.0, 1.0), sunExponent);\nfloat shoreFactor = clamp(waterDepth/breakWaterDepth-breakWaterOffset*wnNormal.w, 0.0, 1.0);\nfloat ndote = dot(wnVector, wnNormal.xyz);\nfloat fresnel = pow(1.0-abs(ndote), 2.0);\nvec4 surfaceColour = vec4(envColour, fresnel*shoreFactor)+specularColour*shoreFactor;\ngl_FragColor = vec4(mix(surfaceColour.rgb, gl_Fog.color.rgb, gl_FogFragCoord), surfaceColour.a);\n}\n"));
				aClass336_4986 = Class177.method2584(((Class151) this).aHa_Sub1_1215, new Class345[] { class345, class345_0_ }, true);
	...
	final void method2441(int i, int i_1_, int i_2_) {
		do {
			try {
				if (aBoolean4987) {
					int i_3_ = 1 << (i & 0x3);
					float f = (float) (1 << (i >> 496943907 & 0x7)) / 32.0F;
					int i_4_ = 0xffff & i_1_;
					float f_5_ = (float) ((i_1_ & 0x36757) >> 130557328) / 8.0F;
					long l = ((Class336) aClass336_4986).aLong2821;
					OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"), (float) ((((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4321) * i_3_ % 40000) / 40000.0F);
	...
	final void method2440(boolean bool, boolean bool_6_) {
		do {
			try {
				if (bool == false) {
					Class42_Sub2 class42_sub2 = ((Class151) this).aHa_Sub1_1215.method1827(-125);
					...
					((Class151) this).aHa_Sub1_1215.method1863(1, ((Class51) aClass51_4984).aClass42_Sub4_421);
					long l = ((Class336) aClass336_4986).aLong2821;
					...
					OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), (((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aFloat4433), (((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aFloat4420), (((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aFloat4458), 1.0F);
					OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"), Math.abs(((ha_Sub1) ((Class151) this).aHa_Sub1_1215).aFloatArray4438[1]) * 928.0F + 96.0F);
					aBoolean4987 = true;
				}
			} catch (RuntimeException runtimeexception) {
