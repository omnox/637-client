...
final class Class74 {
	...
	private final void method723(int i, Interface20 interface20, Object object, boolean bool) {
		try {
			...
			anInt550 -= i;
			while (anInt550 < 0) {
				Class98_Sub46_Sub20 class98_sub46_sub20 = ((Class98_Sub46_Sub20) aClass215_549.method2789(-16711936));
	...
	final void method724(byte i, int i_0_) {
		try {
			if (Class39_Sub1.aClass277_3590 != null) {
				for (Class98_Sub46_Sub20 class98_sub46_sub20 = (Class98_Sub46_Sub20) aClass215_549.method2792(-1); class98_sub46_sub20 != null; class98_sub46_sub20 = (Class98_Sub46_Sub20) aClass215_549.method2787(0)) {
			...
			throw Class64_Sub27.method667(runtimeexception, "ep.D(" + i + ',' + i_0_ + ')');
		}
	}
	...
	final void method725(int i) {
		do {
			try {
				for (Class98_Sub46_Sub20 class98_sub46_sub20 = (Class98_Sub46_Sub20) aClass215_549.method2792(-1); class98_sub46_sub20 != null; class98_sub46_sub20 = ((Class98_Sub46_Sub20) aClass215_549.method2787(i + -13937))) {
	...
	private final void method728(Class98_Sub46_Sub20 class98_sub46_sub20, byte i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ep.J(" + (class98_sub46_sub20 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}

	final void method729(Object object, Interface20 interface20, boolean bool) {
		try {
			method723(1, interface20, object, bool);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ep.E(" + (object != null ? "{...}" : "null") + ',' + (interface20 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	private final void method731(Interface20 interface20, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ep.C(" + (interface20 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	final Object method732(Interface20 interface20, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ep.G(" + (interface20 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	static final void method733(long l, int i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "ep.H(" + l + ',' + i + ')');
			}
			break;
		} while (false);
	}
