...
final class Class318 {
	...
	static final void method3656(int i, int i_0_, byte i_1_, int i_2_, int i_3_) {
		try {
			int i_4_ = 3 / ((-10 - i_1_) / 58);
			if (i_3_ >= Class98_Sub10_Sub38.anInt5753 && Class218.anInt1635 >= i_3_) {
				i_0_ = Class263.method3219(false, Class3.anInt77, Class76_Sub8.anInt3778, i_0_);
				i_2_ = Class263.method3219(false, Class3.anInt77, Class76_Sub8.anInt3778, i_2_);
				Class160.method2513((byte) -125, i, i_0_, i_2_, i_3_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("tk.C(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
		}
	}

	static final void method3657(byte i) {
		try {
