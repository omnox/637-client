...
final class Class119_Sub2 extends Class119 {
	...
	private static final void method2183(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			do {
				if (Class76_Sub8.anInt3778 <= i_2_ && i_0_ <= Class3.anInt77 && Class98_Sub10_Sub38.anInt5753 <= i_6_ && Class218.anInt1635 >= i_4_) {
	...
	final void method2178(int i, int i_7_, int i_8_) {
		try {
			int i_9_ = -52 / ((-3 - i) / 32);
			int i_10_ = anInt4724 * i_7_ >> 12;
			int i_11_ = anInt4722 * i_7_ >> 12;
			int i_12_ = i_8_ * anInt4725 >> 12;
			int i_13_ = i_8_ * anInt4723 >> 12;
			Class119.method2177(this.anInt988, i_13_, -80, i_11_, i_10_, i_12_);
		} catch (RuntimeException runtimeexception) {
	...
	final void method2179(byte i, int i_14_, int i_15_) {
		try {
			...
			int i_17_ = i_15_ * anInt4724 >> 12;
			int i_18_ = i_15_ * anInt4722 >> 12;
			int i_19_ = i_14_ * anInt4725 >> 12;
			int i_20_ = i_14_ * anInt4723 >> 12;
			Class64_Sub19.method632(this.anInt985, i_18_, (byte) -51, this.anInt987, i_17_, i_19_, i_20_);
		} catch (RuntimeException runtimeexception) {
	...
	final void method2174(int i, int i_21_, int i_22_) {
		try {
			int i_23_ = i * anInt4724 >> 12;
			if (i_22_ == -5515) {
				int i_24_ = anInt4722 * i >> 12;
				int i_25_ = i_21_ * anInt4725 >> 12;
				int i_26_ = i_21_ * anInt4723 >> 12;
				method2183(1701353708, i_24_, this.anInt988, i_23_, this.anInt985, i_26_, this.anInt987, i_25_);
			}
		} catch (RuntimeException runtimeexception) {
