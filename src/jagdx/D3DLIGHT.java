...
public class D3DLIGHT extends mfa {
	...
	public final native void SetAmbient(float f, float f_8_, float f_9_, float f_10_);
	...
	public final native void SetDiffuse(float f, float f_11_, float f_12_, float f_13_);
