...
public class PixelBuffer extends mfa implements Buffer {
	...
	public final void a(int[] is, int i, int i_4_, int i_5_) {
		try {
			if (((i_4_ ^ 0xffffffff) > -1 | (is == null | -1 < (i ^ 0xffffffff) | (is.length ^ 0xffffffff) > (i + i_5_ ^ 0xffffffff))) || (i_5_ * 4 + i_4_ ^ 0xffffffff) < (getSize() ^ 0xffffffff))
				throw new jc();
			puti(is, i, i_4_, i_5_);
		} catch (RuntimeException runtimeexception) {
			throw runtimeexception;
	...
	public final void a(byte[] is, int i, int i_6_, int i_7_) {
		try {
			if (((is.length ^ 0xffffffff) > (i + i_7_ ^ 0xffffffff) | (0 > i | is == null) | 0 > i_6_) || (getSize() ^ 0xffffffff) > (i_6_ - -i_7_ ^ 0xffffffff))
				throw new jc();
	...
	public final void b(int[] is, int i, int i_12_, int i_13_) {
		try {
			if ((is == null | 0 > i | (i + i_13_ ^ 0xffffffff) < (is.length ^ 0xffffffff) | -1 < (i_12_ ^ 0xffffffff)) || getSize() < 4 * i_13_ + i_12_)
				throw new jc();
