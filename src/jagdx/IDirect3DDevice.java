...
public final class IDirect3DDevice extends IUnknown {
	...
	public final native int SetViewport(int i, int i_0_, int i_1_, int i_2_, float f, float f_3_);

	public final native int _CreateTexture(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, IDirect3DTexture idirect3dtexture);

	public final native int _CreateCubeTexture(int i, int i_9_, int i_10_, int i_11_, int i_12_, IDirect3DCubeTexture idirect3dcubetexture);

	public final native int DrawIndexedPrimitive(int i, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_);
	...
	private final native int _CreateIndexBuffer(int i, int i_18_, int i_19_, int i_20_, IDirect3DIndexBuffer idirect3dindexbuffer);

	public final native int SetSamplerState(int i, int i_21_, int i_22_);

	public final native int EndScene();

	private final native int _CreateDepthStencilSurface(int i, int i_23_, int i_24_, int i_25_, int i_26_, boolean bool, IDirect3DSurface idirect3dsurface);
	...
	public final native int StretchRect(IDirect3DSurface idirect3dsurface, int i, int i_35_, int i_36_, int i_37_, IDirect3DSurface idirect3dsurface_38_, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_);

	private final native int _GetBackBuffer(int i, int i_44_, int i_45_, IDirect3DSurface idirect3dsurface);
	...
	public final IDirect3DEventQuery c() {
		...
		try {
			IDirect3DEventQuery idirect3deventquery_50_ = new IDirect3DEventQuery(b);
	...
	public final native int SetVertexShaderConstantF(int i, float[] fs, int i_51_);
	...
	private final native int _CreateRenderTarget(int i, int i_55_, int i_56_, int i_57_, int i_58_, boolean bool, IDirect3DSurface idirect3dsurface);
	...
	public final IDirect3DCubeTexture a(int i, int i_61_, int i_62_, int i_63_, int i_64_) {
		IDirect3DCubeTexture idirect3dcubetexture;
		try {
			IDirect3DCubeTexture idirect3dcubetexture_65_ = new IDirect3DCubeTexture(b);
			int i_66_ = _CreateCubeTexture(i, i_61_, i_62_, i_63_, i_64_, idirect3dcubetexture_65_);
			if (kg.b(-7175, i_66_))
	...
	public final IDirect3DVertexShader a(byte[] is) {
		...
		try {
			if (null == is)
				return null;
			IDirect3DVertexShader idirect3dvertexshader_68_ = new IDirect3DVertexShader(b);
	...
	private final native int _CreateOffscreenPlainSurface(int i, int i_69_, int i_70_, int i_71_, IDirect3DSurface idirect3dsurface);
	...
	public final IDirect3DVertexBuffer a(int i, int i_73_, int i_74_, int i_75_, IDirect3DVertexBuffer idirect3dvertexbuffer) {
		...
		try {
			...
			int i_77_ = _CreateVertexBuffer(i, i_73_, i_74_, i_75_, idirect3dvertexbuffer);
			if (kg.b(-7175, i_77_))
	...
	public final IDirect3DIndexBuffer a(int i, int i_78_, int i_79_, int i_80_, IDirect3DIndexBuffer idirect3dindexbuffer) {
		...
		try {
			...
			int i_82_ = _CreateIndexBuffer(i, i_78_, i_79_, i_80_, idirect3dindexbuffer);
			if (kg.b(-7175, i_82_))
	...
	public final IDirect3DSurface a(int i, int i_83_, int i_84_, int i_85_, int i_86_, boolean bool) {
		IDirect3DSurface idirect3dsurface;
		try {
			IDirect3DSurface idirect3dsurface_87_ = new IDirect3DSurface(b);
			int i_88_ = _CreateRenderTarget(i, i_83_, i_84_, i_85_, i_86_, bool, idirect3dsurface_87_);
			if (kg.b(-7175, i_88_))
	...
	public final IDirect3DVolumeTexture a(int i, int i_89_, int i_90_, int i_91_, int i_92_, int i_93_, int i_94_) {
		IDirect3DVolumeTexture idirect3dvolumetexture;
		try {
			IDirect3DVolumeTexture idirect3dvolumetexture_95_ = new IDirect3DVolumeTexture(b);
			int i_96_ = _CreateVolumeTexture(i, i_89_, i_90_, i_91_, i_92_, i_93_, i_94_, idirect3dvolumetexture_95_);
			if (kg.b(-7175, i_96_))
	...
	public final native int _CreateVolumeTexture(int i, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_, int i_102_, IDirect3DVolumeTexture idirect3dvolumetexture);

	public final native int SetPixelShader(IDirect3DPixelShader idirect3dpixelshader);

	public final native int SetScissorRect(int i, int i_103_, int i_104_, int i_105_);

	public final native boolean LightEnable(int i, boolean bool);

	public final native int SetStreamSource(int i, IDirect3DVertexBuffer idirect3dvertexbuffer, int i_106_, int i_107_);
	...
	public final IDirect3DTexture a(int i, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_) {
		IDirect3DTexture idirect3dtexture;
		try {
			IDirect3DTexture idirect3dtexture_114_ = new IDirect3DTexture(b);
			int i_115_ = _CreateTexture(i, i_109_, i_110_, i_111_, i_112_, i_113_, idirect3dtexture_114_);
			if (kg.b(-7175, i_115_))
	...
	private final native int _CreateVertexBuffer(int i, int i_116_, int i_117_, int i_118_, IDirect3DVertexBuffer idirect3dvertexbuffer);
	...
	public final IDirect3DPixelShader b(byte[] is) {
		...
		try {
			if (is == null)
				return null;
			IDirect3DPixelShader idirect3dpixelshader_119_ = new IDirect3DPixelShader(b);
	...
	public final IDirect3DSwapChain c(int i) {
		...
		try {
			IDirect3DSwapChain idirect3dswapchain_120_ = new IDirect3DSwapChain(b);
