...
final class Class37 {
	...
	final int method343() {
		...
		for (int i_2_ = 0; i_2_ < 10; i_2_++) {
			if (aClass344Array351[i_2_] != null && aClass344Array351[i_2_].anInt2867 / 20 < i)
	...
	private final byte[] method345() {
		...
		for (int i_4_ = 0; i_4_ < 10; i_4_++) {
			if (aClass344Array351[i_4_] != null && (aClass344Array351[i_4_].anInt2870 + aClass344Array351[i_4_].anInt2867) > i)
		...
		for (int i_6_ = 0; i_6_ < 10; i_6_++) {
			if (aClass344Array351[i_6_] != null) {
				int i_7_ = (aClass344Array351[i_6_].anInt2870 * 22050 / 1000);
				int i_8_ = (aClass344Array351[i_6_].anInt2867 * 22050 / 1000);
				int[] is_9_ = (aClass344Array351[i_6_].method3822(i_7_, aClass344Array351[i_6_].anInt2870));
