...
final class Class335 {
	...
	RuneScapeCache aClass207_2814;
	private RuneScapeCache aClass207_2815;
	...
	final Class9 method3766(int i, byte i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ui.B(" + i + ',' + i_0_ + ')');
		}
	}
	...
	public static void method3769(byte i) {
		do {
			try {
				IncomingOpcode.aClass58_2816 = null;
				aClass171_2812 = null;
				if (i >= 59)
					break;
				aBoolean2817 = true;
