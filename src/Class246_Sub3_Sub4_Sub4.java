...
final class Class246_Sub3_Sub4_Sub4 extends Class246_Sub3_Sub4 {
	...
	final void method2992(byte i) {
		try {
			if (i != -73)
				((Class246_Sub3_Sub4_Sub4) this).anInt6463 = -41;
	...
	final void method3074(int i, int i_1_, int i_2_, byte i_3_, int i_4_) {
		do {
			try {
				if (!aBoolean6481) {
					double d = (double) (-((AnimableEntity) this).localXPos + i);
					double d_5_ = (double) (i_4_ + -((AnimableEntity) this).localYPos);
					double d_6_ = Math.sqrt(d * d + d_5_ * d_5_);
					aDouble6462 = ((double) ((AnimableEntity) this).localYPos + (double) anInt6467 * d_5_ / d_6_);
					aDouble6472 = ((double) ((AnimableEntity) this).localXPos + d * (double) anInt6467 / d_6_);
					if (aBoolean6473)
						aDouble6490 = (double) ((Perspective.getTileHeight(((AnimableEntity) this).height_level, (int) aDouble6462, (int) aDouble6472)) - anInt6461);
					else
						aDouble6490 = (double) ((AnimableEntity) this).anInt5089;
				}
				double d = (double) (-i_2_ + 1 + ((Class246_Sub3_Sub4_Sub4) this).anInt6466);
			...
			try {
				...
				if (i == -10462) {
					...
					if (aClass97_6459 == null)
						break;
					anInt6477 += i_7_;
					while ((((Class97) aClass97_6459).anIntArray811[anInt6465] ^ 0xffffffff) > (anInt6477 ^ 0xffffffff)) {
						anInt6477 -= (((Class97) aClass97_6459).anIntArray811[anInt6465]);
						anInt6465++;
						if (anInt6465 >= (((Class97) aClass97_6459).anIntArray818).length) {
							anInt6465 -= ((Class97) aClass97_6459).anInt828;
							if (anInt6465 < 0 || anInt6465 >= (((Class97) aClass97_6459).anIntArray818).length)
								anInt6465 = 0;
						}
						anInt6469 = anInt6465 - -1;
						if (((Class97) aClass97_6459).anIntArray818.length <= anInt6469) {
							anInt6469 -= ((Class97) aClass97_6459).anInt828;
							if (anInt6469 < 0 || anInt6469 >= (((Class97) aClass97_6459).anIntArray818).length)
								anInt6469 = -1;
						}
					}
				}
	...
	private final void method3076(Class111 class111, ha var_ha, AbstractModel class146, byte i) {
		do {
			try {
				...
				if ((aClass246_Sub5_6489 == null || ((Class246_Sub5) aClass246_Sub5_6489).aBoolean5099) && (class87s != null || class35s != null))
					aClass246_Sub5_6489 = Class246_Sub5.method3117(Class215.anInt1614, true);
				if (aClass246_Sub5_6489 == null)
					break;
				aClass246_Sub5_6489.method3120(var_ha, (long) Class215.anInt1614, class87s, class35s, false);
				aClass246_Sub5_6489.method3123(((AnimableEntity) this).height_level, ((Class246_Sub3_Sub4) this).aShort6158, ((Class246_Sub3_Sub4) this).aShort6160, ((Class246_Sub3_Sub4) this).aShort6157, ((Class246_Sub3_Sub4) this).aShort6159);
			} catch (RuntimeException runtimeexception) {
	...
	Class246_Sub3_Sub4_Sub4(int i, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, boolean bool, int i_25_) {
		super(i_13_, i_14_, i_15_, -i_17_ + Perspective.getTileHeight(i_13_, i_16_, i_15_), i_16_, i_15_ >> 1293743369, i_15_ >> -108544983, i_16_ >> -860505271, i_16_ >> 1727487849, false, (byte) 0);
		anInt6460 = 0;
		anInt6469 = -1;
		aBoolean6481 = false;
		anInt6477 = 0;
		...
		try {
			...
			anInt6485 = i;
			aBoolean6481 = false;
			((Class246_Sub3_Sub4_Sub4) this).anInt6463 = i_24_;
			((Class246_Sub3_Sub4_Sub4) this).anInt6479 = i_18_;
			((Class246_Sub3_Sub4_Sub4) this).anInt6482 = i_23_;
			((Class246_Sub3_Sub4_Sub4) this).anInt6466 = i_19_;
			anInt6470 = i_22_;
			aBoolean6473 = bool;
			anInt6486 = i_25_;
			int i_26_ = (((Class107) Class196.aClass304_1509.method3564(2, anInt6485)).anInt910);
			if (i_26_ != -1)
			...
			try {
				if (!aBoolean6481) {
					...
					if (anInt6470 < 0) {
						...
						Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_30_, -1));
					...
					if (class246_sub3_sub4_sub2 == null)
						break;
					((AnimableEntity) this).localXPos = ((AnimableEntity) class246_sub3_sub4_sub2).localXPos;
					((AnimableEntity) this).localYPos = ((AnimableEntity) class246_sub3_sub4_sub2).localYPos;
					((AnimableEntity) this).anInt5089 = (Perspective.getTileHeight(((AnimableEntity) this).height_level, (((AnimableEntity) class246_sub3_sub4_sub2).localYPos), (((AnimableEntity) class246_sub3_sub4_sub2).localXPos))) - anInt6461;
					if (anInt6486 < 0)
						break;
					RenderAnimDefinitions class294 = class246_sub3_sub4_sub2.getRenderAnimation(1);
					int i_31_ = 0;
					int i_32_ = 0;
					if (((RenderAnimDefinitions) class294).anIntArrayArray2366 != null && (((RenderAnimDefinitions) class294).anIntArrayArray2366[anInt6486]) != null) {
						i_31_ += (((RenderAnimDefinitions) class294).anIntArrayArray2366[anInt6486][0]);
						i_32_ += (((RenderAnimDefinitions) class294).anIntArrayArray2366[anInt6486][2]);
					}
					if (((RenderAnimDefinitions) class294).anIntArrayArray2364 != null && (((RenderAnimDefinitions) class294).anIntArrayArray2364[anInt6486]) != null) {
						i_32_ += (((RenderAnimDefinitions) class294).anIntArrayArray2364[anInt6486][2]);
						i_31_ += (((RenderAnimDefinitions) class294).anIntArrayArray2364[anInt6486][0]);
					}
					if ((i_31_ ^ 0xffffffff) != -1 || i_32_ != 0) {
						int i_33_ = ((Mobile) class246_sub3_sub4_sub2).aClass325_6399.method3698((byte) 116);
						int i_34_ = i_33_;
						if (((Mobile) class246_sub3_sub4_sub2).anIntArray6370 != null && (((Mobile) class246_sub3_sub4_sub2).anIntArray6370[anInt6486]) != -1)
							i_34_ = (((Mobile) class246_sub3_sub4_sub2).anIntArray6370[anInt6486]);
						...
						i_31_ = i_38_;
						((AnimableEntity) this).localXPos += i_31_;
						((AnimableEntity) this).localYPos += i_32_;
					}
				}
			} catch (RuntimeException runtimeexception) {
