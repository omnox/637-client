...
final class Class51 {
	...
	static final void method487(int i, Class98_Sub46 class98_sub46, Class98_Sub46 class98_sub46_0_) {
		try {
			...
			if (i >= 32) {
				((Class98_Sub46) class98_sub46_0_).aClass98_Sub46_4262 = class98_sub46;
				((Class98_Sub46) class98_sub46_0_).aClass98_Sub46_4265 = ((Class98_Sub46) class98_sub46).aClass98_Sub46_4265;
	...
	Class51(ha_Sub1 var_ha_Sub1) {
		((Class51) this).aClass42_Sub4_421 = null;
		((Class51) this).aClass42_Sub4_425 = null;
		((Class51) this).aClass42_Sub4_422 = null;
		try {
			((Class51) this).aBoolean424 = ((ha_Sub1) var_ha_Sub1).aBoolean4434;
			Class64_Sub9.method590(true, var_ha_Sub1);
			if (((Class51) this).aBoolean424) {
				byte[] is = Class98_Sub28_Sub1.method1310(false, Class167.anObject1285, false);
				((Class51) this).aClass42_Sub4_422 = new Class42_Sub4(var_ha_Sub1, 6410, 128, 128, 16, is, 6410);
				is = Class98_Sub28_Sub1.method1310(false, Class130.anObject1030, false);
				((Class51) this).aClass42_Sub4_425 = new Class42_Sub4(var_ha_Sub1, 6410, 128, 128, 16, is, 6410);
				Class118 class118 = ((ha_Sub1) var_ha_Sub1).aClass118_4322;
				if (class118.method2171(true)) {
					is = Class98_Sub28_Sub1.method1310(false, (Class98_Sub41.anObject4203), false);
					((Class51) this).aClass42_Sub4_421 = new Class42_Sub4(var_ha_Sub1, 6408, 128, 128, 16);
					Class42_Sub4 class42_sub4 = new Class42_Sub4(var_ha_Sub1, 6409, 128, 128, 16, is, 6409);
					if (class118.method2172(0, class42_sub4, 2.0F, (((Class51) this).aClass42_Sub4_421)))
						((Class51) this).aClass42_Sub4_421.method371(35);
					else {
						((Class51) this).aClass42_Sub4_421.method375(true);
						((Class51) this).aClass42_Sub4_421 = null;
					}
					class42_sub4.method375(true);
				}
			} else {
				((Class51) this).aClass42_Sub1Array423 = new Class42_Sub1[16];
				for (int i = 0; (i ^ 0xffffffff) > -17; i++) {
					byte[] is = Class98_Sub10_Sub20.method1061(2, 32768, 128 * (128 * i) * 2, (Class167.anObject1285));
					((Class51) this).aClass42_Sub1Array423[i] = new Class42_Sub1(var_ha_Sub1, 3553, 6410, 128, 128, true, is, 6410, false);
				}
				((Class51) this).aClass42_Sub1Array420 = new Class42_Sub1[16];
				for (int i = 0; (i ^ 0xffffffff) > -17; i++) {
					byte[] is = Class98_Sub10_Sub20.method1061(2, 32768, 16384 * i * 2, (Class130.anObject1030));
					((Class51) this).aClass42_Sub1Array420[i] = new Class42_Sub1(var_ha_Sub1, 3553, 6410, 128, 128, true, is, 6410, false);
				}
			}
		} catch (RuntimeException runtimeexception) {
