...
final class Class315 implements Interface21 {
	...
	public static void method3645(boolean bool) {
		try {
			...
			aClient3529 = null;
			if (bool == false)
				IncomingOpcode.aClass58_3533 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3647(boolean bool, boolean bool_0_, String string, boolean bool_1_, Class88 class88) {
		try {
			if (bool_1_ == true) {
				if (bool) {
					if (Class88.aString699.startsWith("win") && class88.aBoolean682) {
						...
						if (string_2_ == null || !string_2_.equals("1")) {
							Class143 class143 = Class98_Sub10_Sub32.method1097(-18871, string, class88, 0);
					...
					if (Class88.aString699.startsWith("mac")) {
						...
						if (Class76_Sub11.anApplet3799 != null)
							string_3_ = Class76_Sub11.anApplet3799.getParameter("havefirefox");
			...
			throw Class64_Sub27.method667(runtimeexception, ("tga.B(" + bool + ',' + bool_0_ + ',' + (string != null ? "{...}" : "null") + ',' + bool_1_ + ',' + (class88 != null ? "{...}" : "null") + ')'));
		}
	}
