...
final class Class127 implements Runnable {
	...
	static RuneScapeCache aClass207_1019;
		...
		try {
			...
			synchronized (this) {
				...
				if (anInt1023 >= anInt1016 - -i_1_)
					...
					Class236.method2894(aByteArray1022, 0, is, i_4_ + i, i_1_ - i_4_);
				}
			...
			throw Class64_Sub27.method667(runtimeexception, ("ik.B(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_1_ + ',' + i_2_ + ')'));
		}
	}

	final boolean method2222(int i, byte i_5_) throws IOException {
		try {
			if (i_5_ > -120)
				aClass207_1019 = null;
			...
			throw Class64_Sub27.method667(runtimeexception, "ik.A(" + i + ',' + i_5_ + ')');
		}
	}

	Class127(InputStream inputstream, int i) {
		try {
			anInt1023 = i - -1;
			...
			throw Class64_Sub27.method667(runtimeexception, ("ik.<init>(" + (inputstream != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
}
