...
final class Class33 {
	...
	final void method320(boolean bool, int i, int i_0_, boolean[][] bools, byte i_1_, int i_2_) {
		try {
			if (i_1_ >= 8) {
				...
				float f = 1.0F / (float) (((ha_Sub1) aHa_Sub1_318).anInt4318 * 128);
				if (!bool) {
					for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > (anInt317 ^ 0xffffffff); i_3_++) {
						...
						for (int i_6_ = 0; (i_6_ ^ 0xffffffff) > (anInt323 ^ 0xffffffff); i_6_++) {
							...
							Class98_Sub22_Sub2 class98_sub22_sub2 = (((ha_Sub1) aHa_Sub1_318).aClass98_Sub22_Sub2_4446);
							...
							for (int i_10_ = i_4_; (i_5_ ^ 0xffffffff) < (i_10_ ^ 0xffffffff); i_10_++) {
								if (((i_10_ - i_2_ ^ 0xffffffff) <= (-i ^ 0xffffffff)) && i_10_ - i_2_ <= i) {
									int i_11_ = i_8_ + i_10_ * (((s) aS_Sub1_320).anInt2203);
									for (int i_12_ = i_8_; i_12_ < i_9_; i_12_++) {
										if (-i <= -i_0_ + i_12_ && ((-i_0_ + i_12_ ^ 0xffffffff) >= (i ^ 0xffffffff)) && (bools[i_12_ + (-i_0_ + i)][i + (-i_2_ + i_10_)])) {
											short[] is = (((s_Sub1) aS_Sub1_320).aShortArrayArray5196[i_11_]);
											if (is != null) {
												if (!((ha_Sub1) aHa_Sub1_318).aBoolean4397) {
							...
							if ((i_7_ ^ 0xffffffff) < -1) {
								...
								aClass46ArrayArray313[i_6_][i_3_].method438(i_7_, 0, 5123, (((RSByteBuffer) class98_sub22_sub2).data));
							}
						}
					}
				} else {
	...
	final void method322(int i, int i_25_, boolean bool, r var_r) {
		try {
			...
			i_25_ += 1 + ((r_Sub1) var_r_Sub1).anInt6324;
			i += 1 + ((r_Sub1) var_r_Sub1).anInt6320;
			int i_26_ = ((Class33) this).anInt314 * i + i_25_;
			int i_27_ = 0;
			int i_28_ = ((r_Sub1) var_r_Sub1).anInt6326;
			int i_29_ = ((r_Sub1) var_r_Sub1).anInt6323;
			int i_30_ = -i_29_ + ((Class33) this).anInt314;
			int i_31_ = 0;
			if (i <= 0) {
				int i_32_ = 1 + -i;
				i_28_ -= i_32_;
				i = 1;
				i_26_ += i_32_ * ((Class33) this).anInt314;
				i_27_ += i_29_ * i_32_;
			}
			if (anInt322 <= i_28_ + i) {
			...
			if ((i_25_ + i_29_ ^ 0xffffffff) <= (((Class33) this).anInt314 ^ 0xffffffff)) {
				int i_35_ = -((Class33) this).anInt314 + 1 + (i_25_ - -i_29_);
				i_29_ -= i_35_;
				i_30_ += i_35_;
				i_31_ += i_35_;
			}
			if ((i_29_ ^ 0xffffffff) < -1 && i_28_ > 0) {
				Class187.method2637(i_28_, i_26_, i_27_, ((r_Sub1) var_r_Sub1).aByteArray6325, ((Class33) this).aByteArray321, -18305, i_31_, i_30_, i_29_);
	...
	final void method324(byte i, int i_45_, int i_46_, r var_r) {
		try {
			if (i <= 87)
				aBoolean316 = true;
			r_Sub1 var_r_Sub1 = (r_Sub1) var_r;
			i_46_ += ((r_Sub1) var_r_Sub1).anInt6324 - -1;
			i_45_ += ((r_Sub1) var_r_Sub1).anInt6320 - -1;
			int i_47_ = i_46_ + ((Class33) this).anInt314 * i_45_;
			int i_48_ = 0;
			int i_49_ = ((r_Sub1) var_r_Sub1).anInt6326;
			int i_50_ = ((r_Sub1) var_r_Sub1).anInt6323;
			int i_51_ = ((Class33) this).anInt314 + -i_50_;
			int i_52_ = 0;
			if ((i_45_ ^ 0xffffffff) >= -1) {
				...
				i_45_ = 1;
				i_49_ -= i_53_;
				i_47_ += ((Class33) this).anInt314 * i_53_;
			}
			...
			if (((Class33) this).anInt314 <= i_46_ - -i_50_) {
				int i_56_ = i_50_ + (i_46_ - (-1 + ((Class33) this).anInt314));
				i_50_ -= i_56_;
				i_51_ += i_56_;
				i_52_ += i_56_;
			}
			if ((i_50_ ^ 0xffffffff) < -1 && i_49_ > 0) {
				Class76_Sub2.method751(i_52_, ((Class33) this).aByteArray321, i_49_, ((r_Sub1) var_r_Sub1).aByteArray6325, i_48_, i_51_, i_47_, i_50_, 0);
	...
	Class33(ha_Sub1 var_ha_Sub1, s_Sub1 var_s_Sub1) {
		try {
			...
			((Class33) this).anInt314 = (((s) aS_Sub1_320).anInt2206 * ((s) aS_Sub1_320).anInt2203 >> ((ha_Sub1) aHa_Sub1_318).anInt4319) + 2;
			anInt322 = 2 + ((((s) aS_Sub1_320).anInt2204 * ((s) aS_Sub1_320).anInt2206) >> ((ha_Sub1) aHa_Sub1_318).anInt4319);
			anInt319 = (((ha_Sub1) aHa_Sub1_318).anInt4319 + (7 + -((s) aS_Sub1_320).anInt2200));
			((Class33) this).aByteArray321 = new byte[((Class33) this).anInt314 * anInt322];
	...
	final boolean method325(r var_r, int i, int i_57_, int i_58_) {
		try {
			r_Sub1 var_r_Sub1 = (r_Sub1) var_r;
			i_57_ += 1 + ((r_Sub1) var_r_Sub1).anInt6324;
			i_58_ += ((r_Sub1) var_r_Sub1).anInt6320 - -1;
			int i_59_ = i_58_ * ((Class33) this).anInt314 + i_57_;
			int i_60_ = ((r_Sub1) var_r_Sub1).anInt6326;
			int i_61_ = ((r_Sub1) var_r_Sub1).anInt6323;
			int i_62_ = -i_61_ + ((Class33) this).anInt314;
			if (i_58_ <= 0) {
				int i_63_ = 1 - i_58_;
				i_58_ = 1;
				i_59_ += ((Class33) this).anInt314 * i_63_;
				i_60_ -= i_63_;
			}
			...
			if ((i_57_ - -i_61_ ^ 0xffffffff) <= (((Class33) this).anInt314 ^ 0xffffffff)) {
				int i_66_ = i_61_ + (i_57_ + 1 + -((Class33) this).anInt314);
				i_62_ += i_66_;
				i_61_ -= i_66_;
			}
			...
			if (i > -109)
				aS_Sub1_320 = null;
			i_62_ += ((Class33) this).anInt314 * (-1 + i_67_);
			return Class130.method2230(i_67_, i_59_, 1, i_62_, i_61_, ((Class33) this).aByteArray321, i_60_);
		} catch (RuntimeException runtimeexception) {
			...
			if (bool == false && aClass46ArrayArray313 != null) {
				...
				for (int i_75_ = i_71_; (i_72_ ^ 0xffffffff) <= (i_75_ ^ 0xffffffff); i_75_++) {
					...
					for (int i_76_ = i_73_; (i_76_ ^ 0xffffffff) >= (i_74_ ^ 0xffffffff); i_76_++)
						((Class46) class46s[i_76_]).aBoolean392 = true;
				}
			}
		} catch (RuntimeException runtimeexception) {
