...
final class Class17 {
	...
	static final void method239(int i, int i_0_) {
		try {
			...
			for (/**/; class98 != null; class98 = Class168.aClass377_1287.iterate_next(-1)) {
				if ((long) i_0_ == (class98.uid >> 48 & 0xffffL))
					class98.remove();
			}
		...
		try {
			...
			synchronized (aClass225_204) {
				try {
					...
					int i_1_ = ((0xff & Class159.aByteArray1255[2]) + ((Class159.aByteArray1255[1] & 0xff) << 8) + ((0xff & Class159.aByteArray1255[0]) << 16));
					int i_2_ = ((0xff & Class159.aByteArray1255[5]) + (((Class159.aByteArray1255[3] & 0xff) << 16) - -(0xff00 & (Class159.aByteArray1255[4] << 8))));
					if (i_1_ < 0 || i_1_ > anInt206)
						return null;
					if (i_2_ <= 0 || ((long) i_2_ > aClass225_204.method2847(!bool) / 520L))
						return null;
					...
					while (i_3_ < i_1_) {
						...
						int i_6_ = (((0xff & Class159.aByteArray1255[0]) << 8) - -(0xff & Class159.aByteArray1255[1]));
						int i_7_ = ((0xff00 & Class159.aByteArray1255[2] << 8) + (Class159.aByteArray1255[3] & 0xff));
						int i_8_ = (((Class159.aByteArray1255[5] & 0xff) << 8) + ((Class159.aByteArray1255[4] << 16 & 0xff0000) + (Class159.aByteArray1255[6] & 0xff)));
						int i_9_ = Class159.aByteArray1255[7] & 0xff;
						if (i_6_ != i || i_4_ != i_7_ || anInt200 != i_9_)
							return null;
						if (i_8_ < 0 || ((long) i_8_ > aClass225_204.method2847(true) / 520L))
							return null;
						i_4_++;
			...
			try {
				if (Class246_Sub3_Sub4_Sub2_Sub1.aClass332_6508 == null || Class300.aClass332_2500 == null) {
					if (!Class332_Sub2.aClass207_5423.method2742(-71, Class38.anInt360) || !Class332_Sub2.aClass207_5423.method2742(-48, Class222.anInt1672))
						var_ha.aa(i_14_, i_15_, i_11_, i, (-Class355.anInt3017 + 255 << 24 | Class260.anInt3261), 1);
					else {
				...
				var_ha.aa(i_14_, i + i_15_, i_11_, i_12_ + -i, (-Class355.anInt3017 + 255 << 24 | Class260.anInt3261), 1);
				if (i_13_ == 58)
					break;
				aClass198_205 = null;
			} catch (RuntimeException runtimeexception) {
			...
			synchronized (aClass225_204) {
				try {
					...
					if (!bool) {
						...
						if (aClass225_201.method2847(true) < (long) (6 * i_19_ - -6))
							return false;
						aClass225_201.method2846(6 * i_19_, 0);
						aClass225_201.method2849(0, Class159.aByteArray1255, -12913, 6);
						i_20_ = ((Class159.aByteArray1255[5] & 0xff) + ((0xff & Class159.aByteArray1255[4]) << 8) + (Class159.aByteArray1255[3] << 16 & 0xff0000));
						if (i_20_ <= 0 || ((long) i_20_ > aClass225_204.method2847(true) / 520L))
							return false;
					}
					Class159.aByteArray1255[2] = (byte) i;
					Class159.aByteArray1255[0] = (byte) (i >> 16);
					Class159.aByteArray1255[3] = (byte) (i_20_ >> 16);
					Class159.aByteArray1255[1] = (byte) (i >> 8);
					Class159.aByteArray1255[5] = (byte) i_20_;
					Class159.aByteArray1255[4] = (byte) (i_20_ >> 8);
					...
					for (/**/; i > i_21_; i_21_ += i_23_) {
						...
						if (bool) {
							...
							i_23_ = ((0xff & Class159.aByteArray1255[1]) + ((Class159.aByteArray1255[0] & 0xff) << 8));
							i_24_ = ((0xff & Class159.aByteArray1255[6]) + ((Class159.aByteArray1255[5] & 0xff) << 8) + (0xff0000 & (Class159.aByteArray1255[4] << 16)));
							int i_25_ = ((Class159.aByteArray1255[3] & 0xff) + (Class159.aByteArray1255[2] << 8 & 0xff00));
							int i_26_ = Class159.aByteArray1255[7] & 0xff;
							if (i_23_ != i_19_ || i_25_ != i_22_ || anInt200 != i_26_)
								return false;
							if (i_24_ < 0 || ((long) i_24_ > aClass225_204.method2847(true) / 520L))
								return false;
						}
						if (i_24_ == 0) {
							bool = false;
						...
						Class159.aByteArray1255[0] = (byte) (i_19_ >> 8);
						if (i + -i_21_ <= 512)
							i_24_ = 0;
						Class159.aByteArray1255[2] = (byte) (i_22_ >> 8);
						Class159.aByteArray1255[3] = (byte) i_22_;
						Class159.aByteArray1255[1] = (byte) i_19_;
						Class159.aByteArray1255[7] = (byte) anInt200;
						Class159.aByteArray1255[5] = (byte) (i_24_ >> 8);
						Class159.aByteArray1255[4] = (byte) (i_24_ >> 16);
	...
	static final void method243(int i, int i_27_, int i_28_, int i_29_, Mobile class246_sub3_sub4_sub2, int i_30_, int i_31_) {
		try {
			Class168.method2533(i_27_, class246_sub3_sub4_sub2.localXPos, i_30_, 0, (byte) 111, class246_sub3_sub4_sub2.localYPos, i_31_, class246_sub3_sub4_sub2.height_level, i_29_, i);
