	...
	static final void method2696(int i, GameInterfaceData class293, ha var_ha, int i_0_, int i_1_) {
		do {
			try {
				...
				if (var_aa != null) {
					var_ha.KA(i_0_, i_1_, class293.anInt2311 + i_0_, i_1_ + class293.anInt2258);
					if (Class333.anInt3386 == 2 || Class333.anInt3386 == 5 || Class64_Sub9.aClass332_3663 == null)
						...
						if (Class98_Sub46_Sub20_Sub2.anInt6319 == 4) {
							...
							i_3_ = (Player.selfPlayer.localXPos);
							i_4_ = 0x3fff & (Class204.anInt1553 + (int) -(GameWorld.cameraGetHrot));
							i_5_ = (Player.selfPlayer.localYPos);
						}
						int i_6_ = (-(2 * (-104 + GameWorld.size_x)) + i_3_ / 128 + 48);
						int i_7_ = (-(i_5_ / 128) + 48 - (-(GameWorld.size_y * 4) - -(2 * GameWorld.size_y) - 208));
						Class64_Sub9.aClass332_3663.method3746((float) i_0_ + (float) (class293.anInt2311) / 2.0F, (float) i_1_ + (float) (class293.anInt2258) / 2.0F, (float) i_6_, (float) i_7_, i_2_, i_4_ << 2, var_aa, i_0_, i_1_);
						for (Class98_Sub34 class98_sub34 = (Class98_Sub34) Class64_Sub8.aClass148_3659.method2418(32); class98_sub34 != null; class98_sub34 = (Class98_Sub34) Class64_Sub8.aClass148_3659.method2417(i ^ 0x64)) {
							int i_8_ = class98_sub34.anInt4126;
							int i_9_ = ((0x3fff & (Class64_Sub23.aClass370_3707.anIntArray3133[i_8_]) >> 14) + -Class272.anInt2038);
							int i_10_ = (-aa_Sub2.anInt3562 + ((Class64_Sub23.aClass370_3707.anIntArray3133[i_8_]) & 0x3fff));
							int i_11_ = -(i_3_ / 128) + 2 + 4 * i_9_;
							int i_12_ = 2 + i_10_ * 4 - i_5_ / 128;
							Class164.method2522(i_11_, (Class64_Sub23.aClass370_3707.anIntArray3138[i_8_]), i_1_, var_aa, var_ha, i ^ ~0x7997ff75, class293, i_0_, i_12_);
						}
						for (int i_13_ = 0; (Class98_Sub10_Sub7.anInt5577 > i_13_); i_13_++) {
							...
							if (class352.anIntArray2928 != null) {
								...
								if (class352 == null || class352.anInt2958 == -1)
									continue;
							}
							Class164.method2522(i_14_, (class352.anInt2958), i_1_, var_aa, var_ha, -2040004466, class293, i_0_, i_15_);
						}
						for (Class98_Sub45 class98_sub45 = ((Class98_Sub45) AbstractModel.aClass377_1180.start_iteration(97)); class98_sub45 != null; class98_sub45 = ((Class98_Sub45) AbstractModel.aClass377_1180.iterate_next(-1))) {
							int i_16_ = (int) (0x3L & (class98_sub45.uid >> 28));
							if (Canvas_Sub1.anInt26 == i_16_) {
								int i_17_ = ((int) (0x3fffL & (class98_sub45.uid)) + -Class272.anInt2038);
								int i_18_ = ((int) (0x3fffL & (class98_sub45.uid) >> 14) + -aa_Sub2.anInt3562);
						...
						for (int i_21_ = 0; Class150.anInt1211 > i_21_; i_21_++) {
							Class98_Sub39 class98_sub39 = ((Class98_Sub39) (Class260.aClass377_3254.method3990(Class325.anIntArray2726[i_21_], i + -5)));
							if (class98_sub39 != null) {
								Class246_Sub3_Sub4_Sub2_Sub1 class246_sub3_sub4_sub2_sub1 = (class98_sub39.aClass246_Sub3_Sub4_Sub2_Sub1_4187);
								if (class246_sub3_sub4_sub2_sub1.method3052((byte) 106) && ((Player.selfPlayer.height_level) == (class246_sub3_sub4_sub2_sub1.height_level))) {
									Class141 class141 = (class246_sub3_sub4_sub2_sub1.aClass141_6504);
									if (class141 != null && (class141.anIntArray1109) != null)
										class141 = (class141.method2300(Class75.aClass140_584, (byte) 78));
									if (class141 != null && class141.aBoolean1140 && (class141.aBoolean1116)) {
										int i_22_ = ((class246_sub3_sub4_sub2_sub1.localXPos) / 128 - i_3_ / 128);
										int i_23_ = ((class246_sub3_sub4_sub2_sub1.localYPos) / 128 + -(i_5_ / 128));
										if (class141.anInt1118 == -1)
											Class4.method173(i_1_, i_23_, i_0_, class293, var_aa, i_22_, (byte) -24, (Class93.aClass332Array3512[1]));
										else
											Class164.method2522(i_22_, (class141.anInt1118), i_1_, var_aa, var_ha, -2040004466, class293, i_0_, i_23_);
									}
								}
							}
						}
						...
						for (int i_25_ = 0; i_24_ > i_25_; i_25_++) {
							...
							if (class246_sub3_sub4_sub2_sub2 != null && class246_sub3_sub4_sub2_sub2.method3055((byte) 106) && !class246_sub3_sub4_sub2_sub2.cursed_orb_id && (class246_sub3_sub4_sub2_sub2 != (Player.selfPlayer)) && ((class246_sub3_sub4_sub2_sub2.height_level) == (Player.selfPlayer.height_level))) {
								int i_26_ = (-(i_3_ / 128) + (class246_sub3_sub4_sub2_sub2.localXPos) / 128);
								int i_27_ = (-(i_5_ / 128) + (class246_sub3_sub4_sub2_sub2.localYPos) / 128);
								boolean bool = false;
								for (int i_28_ = 0; (i_28_ < Class314.anInt2692); i_28_++) {
									if ((class246_sub3_sub4_sub2_sub2.displayName.equals(Class98_Sub25.aStringArray4026[i_28_])) && Class98_Sub26.anIntArray4030[i_28_] != 0) {
										bool = true;
										break;
									}
								}
								...
								for (int i_30_ = 0; Class32.anInt308 > i_30_; i_30_++) {
									if (class246_sub3_sub4_sub2_sub2.displayName.equals(Class374.aClass147Array3157[i_30_].aString1186)) {
										bool_29_ = true;
										break;
									}
								}
								boolean bool_31_ = false;
								if ((Player.selfPlayer.team) != 0 && (class246_sub3_sub4_sub2_sub2.team) != 0 && ((class246_sub3_sub4_sub2_sub2.team) == (Player.selfPlayer.team)))
									bool_31_ = true;
						...
						for (int i_32_ = 0; (class36s.length > i_32_); i_32_++) {
							Class36 class36 = class36s[i_32_];
							if (class36 != null && class36.anInt346 != 0 && (Class215.anInt1614 % 20 < 10)) {
								if (class36.anInt346 == 1) {
									Class98_Sub39 class98_sub39 = ((Class98_Sub39) (Class260.aClass377_3254.method3990(class36.anInt345, -1)));
									if (class98_sub39 != null) {
										Class246_Sub3_Sub4_Sub2_Sub1 class246_sub3_sub4_sub2_sub1 = (class98_sub39.aClass246_Sub3_Sub4_Sub2_Sub1_4187);
										int i_33_ = ((class246_sub3_sub4_sub2_sub1.localXPos) / 128 - i_3_ / 128);
										int i_34_ = ((class246_sub3_sub4_sub2_sub1.localYPos) / 128 - i_5_ / 128);
										Class98_Sub10_Sub29.method1090(class36.anInt341, var_aa, i_34_, i_33_, class293, i_1_, 360000L, i_0_, 4);
									}
								}
								if (class36.anInt346 == 2) {
									int i_35_ = (-(i_3_ / 128) + (class36.anInt338 / 128));
									int i_36_ = (-(i_5_ / 128) + (class36.anInt347 / 128));
									long l = class36.anInt340 << 7;
									l *= l;
									Class98_Sub10_Sub29.method1090(class36.anInt341, var_aa, i_36_, i_35_, class293, i_1_, l, i_0_, 4);
								}
								if (class36.anInt346 == 10 && class36.anInt345 >= 0 && (class36.anInt345 < (Class151_Sub9.playerArray).length)) {
									...
									if (class246_sub3_sub4_sub2_sub2 != null) {
										int i_37_ = ((class246_sub3_sub4_sub2_sub2.localXPos) / 128 - i_3_ / 128);
										int i_38_ = (-(i_5_ / 128) + (class246_sub3_sub4_sub2_sub2.localYPos) / 128);
										Class98_Sub10_Sub29.method1090(class36.anInt341, var_aa, i_38_, i_37_, class293, i_1_, 360000L, i_0_, 4);
									}
								}
							}
						}
						if (Class98_Sub46_Sub20_Sub2.anInt6319 != 4) {
							if (Class269.anInt2024 != 0) {
							...
							if (!Player.selfPlayer.cursed_orb_id)
								var_ha.method1760(3, 3, (-1 + class293.anInt2258 / 2 + i_1_), -1, (byte) -66, i_0_ - (-(class293.anInt2311 / 2) - -1));
						}
					}
					if (i == 4)
						break;
