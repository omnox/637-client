...
final class Class364 {
	...
	final Class42_Sub1 method3931(int i, int i_0_) {
		try {
			Object object = aClass79_3106.get(i_0_);
			if (object != null)
			...
			if (class238.aBoolean1817 && aHa_Sub1_3105.method1768()) {
				float[] fs = aD3101.method10((byte) -126, false, i_0_, i_1_, 0.7F, i_1_);
				class42_sub1 = new Class42_Sub1(aHa_Sub1_3105, 3553, 34842, i_1_, i_1_, class238.aByte1832 != 0, fs, 6408);
			} else {
				int[] is;
				if (class238.anInt1818 == 2 || !Class98_Sub10_Sub7.method1023(1, class238.aByte1820))
			...
			aClass79_3106.put(i_0_, class42_sub1);
			return class42_sub1;
