...
abstract class Class246_Sub3_Sub1 extends AnimableEntity {
	...
	final boolean method2977(ha var_ha, byte i) {
		try {
			if (i != 77)
				return true;
			return Class76_Sub5.method758((byte) 62, this.aByte5081, (this.localYPos >> Class151_Sub8.anInt5015), (this.localXPos >> Class151_Sub8.anInt5015));
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2994(int i, int i_1_, byte i_2_, int i_3_) {
		try {
			i_1_ = (i_1_ * Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub22_4069.method641((byte) 126) >> 8);
			if (i_2_ != -83)
				method2995(-90, 54, -126, null, null);
			do {
				if (i == -1 && !Class151_Sub5.aBoolean4991) {
					Class337_Sub1.method3777(31585);
					if (!client.aBoolean3553)
						break;
				}
				if (i != -1 && (i != Class144.anInt1169 || !Class8.method188(false)) && i_1_ != 0 && !Class151_Sub5.aBoolean4991) {
					Class64_Sub29.method674(i_1_, 0, i, Class98_Sub10_Sub1.aClass207_5544, i_3_, false, (byte) -86);
					Class233.method2883((byte) 111);
				}
			} while (false);
			if (i != Class144.anInt1169)
	...
	Class246_Sub3_Sub1(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			this.aShort6149 = (short) i_8_;
			this.localXPos = i;
			this.aByte5081 = (byte) i_7_;
			this.height_level = (byte) i_6_;
			this.anInt5089 = i_4_;
			this.localYPos = i_5_;
		} catch (RuntimeException runtimeexception) {
	...
	final boolean method2991(boolean bool) {
		try {
			if (bool != false)
				aClass171_6148 = null;
			return (Class74.aBooleanArrayArray551[(Class259.anInt1959 + (this.localXPos >> Class151_Sub8.anInt5015) - Class241.anInt1845)][(-Class64_Sub26.anInt3714 + (this.localYPos >> Class151_Sub8.anInt5015) + Class259.anInt1959)]);
		} catch (RuntimeException runtimeexception) {
		...
		if (class172 != null) {
			...
			if (class246_sub3_sub5.method2978(-124)) {
				if (class246_sub3_sub5.method2987(6540)) {
					class246_sub3_sub5.aClass246_Sub3_5090 = Class359.aClass246_Sub3Array3056[i_12_];
					Class359.aClass246_Sub3Array3056[i_12_] = class246_sub3_sub5;
				} else {
					class246_sub3_sub5.aClass246_Sub3_5090 = Class379.aClass246_Sub3Array3198[i_12_];
					Class379.aClass246_Sub3Array3198[i_12_] = class246_sub3_sub5;
					Class358.aBoolean3033 = true;
				}
			} else {
				class246_sub3_sub5.aClass246_Sub3_5090 = Class130.aClass246_Sub3Array1029[i_12_];
			...
			if (class246_sub3_sub5_11_ != null) {
				if (class246_sub3_sub5_11_.method2978(-7)) {
					if (class246_sub3_sub5_11_.method2987(6540)) {
						class246_sub3_sub5_11_.aClass246_Sub3_5090 = Class359.aClass246_Sub3Array3056[i_12_];
						Class359.aClass246_Sub3Array3056[i_12_] = class246_sub3_sub5_11_;
					} else {
						class246_sub3_sub5_11_.aClass246_Sub3_5090 = Class379.aClass246_Sub3Array3198[i_12_];
						Class379.aClass246_Sub3Array3198[i_12_] = class246_sub3_sub5_11_;
						Class358.aBoolean3033 = true;
					}
				} else {
					class246_sub3_sub5_11_.aClass246_Sub3_5090 = Class130.aClass246_Sub3Array1029[i_12_];
