...
final class Class102 {
	...
	static final AbstractModel method1703(Class97 class97, int i, int i_0_, int i_1_, AbstractModel class146, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, ha var_ha, int i_8_, int i_9_) {
		try {
			if (class146 == null)
				return null;
			int i_10_ = 2055;
			...
			long l = ((long) (i_0_ + (i_5_ << 16) - -(i_1_ << 24)) - -((long) i_8_ << 32) + ((long) i_6_ << 48));
			AbstractModel class146_11_;
			synchronized (RtMouseListener.aClass79_2493) {
				class146_11_ = (AbstractModel) RtMouseListener.aClass79_2493.get(l);
			}
			if (class146_11_ == null || (var_ha.c(class146_11_.ua(), i_10_) != 0)) {
				...
				int i_13_ = 3;
				int[] is = { 64, 96, 128 };
				ModelDefinitions class178 = new ModelDefinitions(i_13_ * i_12_ + 1, i_13_ * (i_12_ * 2) - i_12_, 0);
				...
				for (int i_16_ = 0; i_16_ < i_13_; i_16_++) {
					...
					for (int i_19_ = 0; i_12_ > i_19_; i_19_++) {
						...
						int i_21_ = (Class284_Sub2_Sub2.anIntArray6200[i_20_] * i_17_ >> 14);
						int i_22_ = (Class284_Sub2_Sub2.anIntArray6202[i_20_] * i_18_ >> 14);
				...
				for (int i_23_ = 0; i_23_ < i_13_; i_23_++) {
					...
					int i_25_ = -i_24_ + 256;
					byte i_26_ = (byte) (i_5_ * i_25_ + i_24_ * i_1_ >> 8);
					short i_27_ = (short) (((0x7f00 & (i_25_ * (0x7f & i_8_) + (0x7f & i_6_) * i_24_)) + ((0xfc0000 & (i_24_ * (0xfc00 & i_6_) + i_25_ * (0xfc00 & i_8_))) + (((i_8_ & 0x380) * i_25_ + (0x380 & i_6_) * i_24_) & 0x38000))) >> 8);
				...
				class146_11_ = var_ha.method1790(class178, i_10_, za_Sub1.anInt6076, 64, 768);
				synchronized (RtMouseListener.aClass79_2493) {
					RtMouseListener.aClass79_2493.put(l, class146_11_);
				}
			}
			...
			if (class97 != null) {
				...
				class98_sub46_sub16 = Class151_Sub7.aClass183_5001.method2624(2, i_7_ >> 16);
				i_7_ &= 0xffff;
			}
			if (class98_sub46_sub16 != null) {
				class146_11_ = class146_11_.method2341((byte) 3, i_10_, true);
				class146_11_.O(-i_29_ + i_30_ >> 1, 128, -i_31_ + i_32_ >> 1);
				class146_11_.H(i_30_ + i_29_ >> 1, 0, i_31_ - -i_32_ >> 1);
				class146_11_.method2340(class98_sub46_sub16, 0, i_7_);
			} else {
				class146_11_ = class146_11_.method2341((byte) 3, i_10_, true);
				class146_11_.O(-i_29_ + i_30_ >> 1, 128, -i_31_ + i_32_ >> 1);
				class146_11_.H(i_29_ + i_30_ >> 1, 0, i_31_ - -i_32_ >> 1);
			}
			if (i_2_ != 0)
			...
			throw Class64_Sub27.method667(runtimeexception, ("gh.G(" + (class97 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + (class146 != null ? "{...}" : "null") + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_8_ + ',' + i_9_ + ')'));
		}
	}

	static final Class102[] method1704(int i) {
		try {
			if (i != 4)
				return null;
			return (new Class102[] { aClass102_860, aClass102_862, aClass102_863, aClass102_864, aClass102_865, aClass102_866, aClass102_867, aClass102_868, aClass102_869, aClass102_870, aClass102_871, aClass102_872, aClass102_873, aClass102_874, aClass102_875, aClass102_876, aClass102_877, aClass102_878, aClass102_879, aClass102_880, aClass102_881, aClass102_882, aClass102_883, aClass102_884, aClass102_885, aClass102_886, aClass102_887 });
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "gh.B(" + i + ')');
		}
	}

	final int method1705(int i) {
		try {
			if (i < 59)
				aClass102_886 = null;
			return anInt858;
	...
	final void method1706(int i, int i_33_) {
		try {
			anInt858 = i;
			if (i_33_ <= 96)
				return;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "gh.F(" + i + ',' + i_33_ + ')');
		}
	}

	final void method1707(byte i, Interface14 interface14) {
		try {
			if (i != 1)
				method1709(-10);
			...
			throw Class64_Sub27.method667(runtimeexception, ("gh.A(" + i + ',' + (interface14 != null ? "{...}" : "null") + ')'));
		}
	}

	public static void method1708(byte i) {
		try {
			aClass102_879 = null;
			aClass102_860 = null;
			aClass102_865 = null;
	...
	final Interface14 method1709(int i) {
		try {
			int i_34_ = 117 % ((i - 40) / 40);
	...
	static final int method1710(int i) {
		try {
			if (i < 45)
				aClass102_881 = null;
			...
			if (Class266.aClass98_Sub46_Sub8_1994 == null)
				return 0;
			int i_35_ = (Class266.aClass98_Sub46_Sub8_1994.anInt5990);
	...
	public final String toString() {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "gh.toString(" + ')');
		}
	}

	private Class102(Class191 class191) {
		try {
			aClass191_861 = class191;
			anInt858 = 1;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "gh.<init>(" + (class191 != null ? "{...}" : "null") + ')');
		}
	}
}
