...
final class Class27 {
	static LinkedList aClass148_275 = new LinkedList();
	...
	static final void method294(boolean bool) {
		try {
			...
			ClientScript2Runtime.aClass79_1890.method806((byte) 28);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "c.C(" + bool + ')');
		}
	}

	public static void method295(byte i) {
		try {
			anIntArray278 = null;
			aClass268_276 = null;
			...
			if (i <= -121) {
				aClass148_275 = null;
				IncomingOpcode.closeInterfaceOpcode = null;
				aLongArray280 = null;
				IncomingOpcode.aClass58_274 = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method296(byte i) {
		do {
			try {
				...
				if (Class98_Sub10_Sub10.aString5593 == null)
					...
					RSByteBuffer class98_sub22 = new RSByteBuffer(Class167.method2531((Class378.method4006(Class98_Sub10_Sub10.aString5593, -1)), 12705));
					l = class98_sub22.method1246(i + -171);
					Class98_Sub10_Sub19.aLong5631 = class98_sub22.method1246(-105);
					Class342.method3814(true, Class98_Sub28.method1305(-111, l), 80, "");
					if (i == 55)
						break;
					anIntArray278 = null;
				}
	...
	static {
		...
		for (int i = 1; i <= 10; i++) {
			int i_7_ = -8 + i * 8;
			aLongArray280[i] = (Class284_Sub1_Sub1.method3367(Class35.method335(aLongArrayArray279[7][7 + i_7_], 255L), (Class284_Sub1_Sub1.method3367((Class284_Sub1_Sub1.method3367((Class284_Sub1_Sub1.method3367(Class35.method335(aLongArrayArray279[4][i_7_ + 4], 4278190080L), (Class284_Sub1_Sub1.method3367(Class35.method335(aLongArrayArray279[3][i_7_ + 3], 1095216660480L), (Class284_Sub1_Sub1.method3367((Class284_Sub1_Sub1.method3367(Class35.method335(71776119061217280L, (aLongArrayArray279[1][i_7_ + 1])), Class35.method335(aLongArrayArray279[0][i_7_], -72057594037927936L))), Class35.method335((aLongArrayArray279[2][i_7_ - -2]), 280375465082880L))))))), Class35.method335(aLongArrayArray279[5][i_7_ + 5], 16711680L))), Class35.method335(aLongArrayArray279[6][i_7_ - -6], 65280L)))));
		}
	}
}
