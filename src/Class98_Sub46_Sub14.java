...
final class Class98_Sub46_Sub14 extends Class98_Sub46 implements Interface3 {
	...
	static final void method1604(boolean bool, byte i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "is.E(" + bool + ',' + i + ')');
		}
	}
	...
	final void method1605(int i, int i_2_, int i_3_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("is.G(" + i + ',' + i_2_ + ',' + i_3_ + ')'));
			}
			break;
		} while (false);
	}
	...
	protected final void finalize() throws Throwable {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "is.finalize(" + ')');
		}
	}
	...
	Class98_Sub46_Sub14(ha_Sub1 var_ha_Sub1, int i, int i_6_, int i_7_, int i_8_) {
		try {
			aHa_Sub1_5373 = var_ha_Sub1;
			anInt5379 = i;
			this.anInt5376 = i_6_;
