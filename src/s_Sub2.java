...
final class s_Sub2 extends s {
	...
	private final void method3435(int i, int i_0_, int i_1_, boolean bool, boolean[][] bools, int i_2_, int i_3_, byte i_4_) {
		try {
			if (aClass98_Sub30Array5246 != null) {
				...
				i_5_ *= i_5_;
				if (i_5_ > Class98_Sub31_Sub2.anIntArray5832.length)
				...
				if (i_8_ < 0)
					i_8_ = 0;
				int i_10_ = i_0_ + i_2_;
				if (this.anInt2203 - 1 < i_10_)
					i_10_ = this.anInt2203 + -1;
				int i_11_ = i_1_ - -i_2_;
				Class337.anInt3539 = 0;
				if (-1 + this.anInt2204 < i_11_)
					i_11_ = this.anInt2204 + -1;
				for (int i_12_ = i_6_; i_10_ >= i_12_; i_12_++) {
					...
					for (int i_14_ = i_8_; i_11_ >= i_14_; i_14_++) {
						if (bools_13_[-i_9_ + i_14_])
							Class98_Sub31_Sub2.anIntArray5832[Class337.anInt3539++] = this.anInt2203 * i_14_ - -i_12_;
					}
				}
				if (i_3_ != -1) {
					this.aHa_Sub3_5225.method2056(117, (float) i_3_);
					this.aHa_Sub3_5225.method1937(4);
				} else
					this.aHa_Sub3_5225.method1976(-65);
				this.aHa_Sub3_5225.method1960(13951);
				this.aHa_Sub3_5225.method1979((0x7 & this.anInt5233) != 0, -126);
				this.aHa_Sub3_5225.method2039(false, 0, -1, false);
				this.aHa_Sub3_5225.method1971(0, true, anInterface2_Impl1_5249);
				...
				Class111_Sub3 class111_sub3 = this.aHa_Sub3_5225.method1978((byte) 121);
				class111_sub3.method2100(0, -1, 0);
				this.aHa_Sub3_5225.method1935(1);
				if (!aClass148_5231.method2420(-124)) {
					int i_16_ = this.aHa_Sub3_5225.anInt4636;
					int i_17_ = this.aHa_Sub3_5225.anInt4581;
					this.aHa_Sub3_5225.L(0, i_17_, this.aHa_Sub3_5225.anInt4601);
					...
					this.aHa_Sub3_5225.L(i_16_, i_17_, this.aHa_Sub3_5225.anInt4601);
				}
				if (aClass15_5235 != null) {
					this.aHa_Sub3_5225.method1971(0, true, anInterface2_Impl1_5249);
					this.aHa_Sub3_5225.method1971(1, true, anInterface2_Impl1_5245);
	...
	final void YA() {
		try {
			if (anInt5250 <= 0)
				...
				byte[][] is = (new byte[this.anInt2203 - -1][this.anInt2204 - -1]);
				for (int i = 1; this.anInt2203 > i; i++) {
					for (int i_18_ = 1; (i_18_ < this.anInt2204); i_18_++)
						is[i][i_18_] = (byte) ((aByteArrayArray5253[i + 1][i_18_] >> 3) + ((aByteArrayArray5253[i + -1][i_18_] >> 2) + (aByteArrayArray5253[i][i_18_ + -1] >> 2) + (aByteArrayArray5253[i][i_18_ - -1] >> 3) + (aByteArrayArray5253[i][i_18_] >> 1)));
				}
				...
				if (anIntArrayArrayArray5239 != null)
					i += 4;
				if ((0x7 & this.anInt5233) != 0)
					i += 12;
				jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer = this.aHa_Sub3_5225.aNativeHeap4522.a(anInt5250 * 4, false);
				jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer_19_ = this.aHa_Sub3_5225.aNativeHeap4522.a(anInt5250 * i, false);
				...
				for (int i_24_ = 0; this.anInt2203 > i_24_; i_24_++) {
					for (int i_25_ = 0; (this.anInt2204 > i_25_); i_25_++) {
						if ((this.anIntArrayArrayArray5241[i_24_][i_25_]) != null) {
							Class98_Sub30[] class98_sub30s_26_ = (aClass98_Sub30ArrayArrayArray5236[i_24_][i_25_]);
							int[] is_27_ = (this.anIntArrayArrayArray5226[i_24_][i_25_]);
							int[] is_28_ = (this.anIntArrayArrayArray5240[i_24_][i_25_]);
							int[] is_29_ = anIntArrayArrayArray5242[i_24_][i_25_];
							int[] is_30_ = (this.anIntArrayArrayArray5241[i_24_][i_25_]);
							...
							short[] is_51_ = (this.aShortArrayArray5230[i_24_ + this.anInt2203 * i_25_] = new short[is_30_.length]);
							for (int i_52_ = 0; (i_52_ < is_30_.length); i_52_++) {
								int i_53_ = ((i_24_ << this.anInt2200) - -is_27_[i_52_]);
								int i_54_ = ((i_25_ << this.anInt2200) + is_28_[i_52_]);
								...
								long l = ((long) i_58_ << 48 | (long) i_57_ << 32 | (long) (i_55_ << 16) | (long) i_56_);
								...
								if (i_60_ == 0 && i_61_ == 0) {
									...
									f_67_ = f_34_;
									f_65_ = f_33_;
								} else if (i_60_ != 0 || (i_61_ != this.anInt2206)) {
									if ((this.anInt2206 == i_60_) && (i_61_ == this.anInt2206)) {
										f_65_ = f_39_;
										f_66_ = f_38_;
										i_62_ -= i_46_;
										f_67_ = f_40_;
									} else if ((i_60_ == this.anInt2206) && i_61_ == 0) {
										f_65_ = f_42_;
										f_67_ = f_43_;
										i_62_ -= i_47_;
										f_66_ = f_41_;
									} else {
										float f_68_ = ((float) i_60_ / (float) this.anInt2206);
										float f_69_ = ((float) i_61_ / (float) this.anInt2206);
										...
										int i_76_ = (((i_47_ - i_44_) * i_60_ >> this.anInt2200) + i_44_);
										int i_77_ = (i_45_ + ((i_46_ + -i_45_) * i_60_ >> this.anInt2200));
										i_62_ -= (i_76_ + ((i_77_ - i_76_) * i_61_ >> this.anInt2200));
									}
								} else {
									i_62_ -= i_45_;
									f_65_ = f_36_;
								...
								if (i_57_ != -1) {
									int i_78_ = i_62_ * (0x7f & i_57_) >> 7;
									if (i_78_ < 2)
										i_78_ = 2;
									else if (i_78_ > 126)
										i_78_ = 126;
									if ((0x7 & this.anInt5233) == 0) {
										f_64_ = ((this.aHa_Sub3_5225.aFloatArray4596[0]) * f_66_ + (this.aHa_Sub3_5225.aFloatArray4596[1]) * f_65_ + f_67_ * (this.aHa_Sub3_5225.aFloatArray4596[2]));
										f_64_ = ((this.aHa_Sub3_5225.aFloat4576) + f_64_ * (!(f_64_ > 0.0F) ? (this.aHa_Sub3_5225.aFloat4594) : (this.aHa_Sub3_5225.aFloat4630)));
									}
									i_63_ = (Class208.anIntArray1579[i_78_ | 0xff80 & i_57_]);
								}
								Node class98 = null;
								if ((i_53_ & -1 + anInt5232) == 0 && ((-1 + anInt5232 & i_54_) == 0))
									class98 = class377.method3990(l, -1);
								int i_79_;
								if (class98 == null) {
									int i_80_;
									if (i_58_ != i_57_) {
										int i_81_ = ((i_58_ & 0x7f) * i_62_ >> 7);
										if (i_81_ < 2)
											i_81_ = 2;
										else if (i_81_ > 126)
											i_81_ = 126;
										...
										if ((0x7 & this.anInt5233) == 0) {
											float f_82_ = (((this.aHa_Sub3_5225.aFloatArray4596[1]) * f_65_) + (f_66_ * (this.aHa_Sub3_5225.aFloatArray4596[0])) + (f_67_ * (this.aHa_Sub3_5225.aFloatArray4596[2])));
											f_82_ = ((!(f_64_ > 0.0F) ? (this.aHa_Sub3_5225.aFloat4594) : (this.aHa_Sub3_5225.aFloat4630)) * f_64_ + (this.aHa_Sub3_5225.aFloat4576));
											int i_83_ = ((0xff85b1 & i_80_) >> 16);
											int i_84_ = ((i_80_ & 0xffeb) >> 8);
									...
									if (i_57_ != -1 && (class98_sub30s_26_[i_52_].uid < class98_sub30s_21_[i_79_].uid))
										class98_sub30s_21_[i_79_] = class98_sub30s_26_[i_52_];
								}
				...
				for (int i_88_ = 0; (this.anInt2203 > i_88_); i_88_++) {
					for (int i_89_ = 0; (this.anInt2204 > i_89_); i_89_++) {
						short[] is_90_ = (this.aShortArrayArray5230[i_89_ * this.anInt2203 - -i_88_]);
						if (is_90_ != null) {
							int i_91_ = 0;
							int i_92_ = 0;
							while (is_90_.length > i_92_) {
								...
								if (class98_sub30_96_ != null) {
									...
									if (class98_sub30_98_ == null || ((class98_sub30_96_.uid) < (class98_sub30_98_.uid)))
										class98_sub30_98_ = class98_sub30_96_;
								}
								if (class98_sub30_97_ != null) {
									class98_sub30_97_.method1315(i_91_, -20787, i_88_, i_89_);
									if (class98_sub30_98_ == null || ((class98_sub30_97_.uid) < (class98_sub30_98_.uid)))
				...
				stream.c();
				stream_20_.c();
				anInterface2_Impl1_5245 = this.aHa_Sub3_5225.method2060(false, 44);
				anInterface2_Impl1_5245.method73((byte) -123, anInt5237 * 4, 4, nativeheapbuffer);
				anInterface2_Impl1_5249 = this.aHa_Sub3_5225.method2060(false, 71);
			...
			this.anIntArrayArrayArray5226 = this.anIntArrayArrayArray5240 = null;
		} catch (RuntimeException runtimeexception) {
	...
	final r fa(int i, int i_104_, r var_r) {
		try {
			if ((0x1 & aByteArrayArray5234[i][i_104_]) == 0)
				return null;
			int i_105_ = (this.anInt2206 >> this.aHa_Sub3_5225.anInt4573);
			r_Sub2 var_r_Sub2 = (r_Sub2) var_r;
			r_Sub2 var_r_Sub2_106_;
			do {
				if (var_r_Sub2 == null || !var_r_Sub2.method1652(i_105_, i_105_, 22657)) {
					var_r_Sub2_106_ = new r_Sub2(this.aHa_Sub3_5225, i_105_, i_105_);
	...
	final void CA(r var_r, int i, int i_135_, int i_136_, int i_137_, boolean bool) {
		try {
			if (aClass15_5235 != null && var_r != null) {
				int i_138_ = (i - (i_135_ * (this.aHa_Sub3_5225.anInt4564) >> 8) >> this.aHa_Sub3_5225.anInt4573);
				int i_139_ = ((i_136_ - (i_135_ * (this.aHa_Sub3_5225.anInt4552) >> 8)) >> this.aHa_Sub3_5225.anInt4573);
	...
	final void method3422(int i, int i_140_, int i_141_, int i_142_, int i_143_, int i_144_, int i_145_, boolean[][] bools) {
		do {
			try {
				if (anInt5250 > 0) {
					Interface2_Impl2 interface2_impl2 = this.aHa_Sub3_5225.method1963(71, anInt5227);
					int i_146_ = 0;
					int i_147_ = 32767;
					int i_148_ = -32768;
					for (int i_149_ = 0; i_149_ < 4; i_149_++) {
						...
						if (buffer != null) {
							Stream stream = this.aHa_Sub3_5225.method2043(24022, buffer);
							if (Stream.a()) {
								for (int i_150_ = i_143_; i_150_ < i_145_; i_150_++) {
									int i_151_ = (i_142_ + this.anInt2203 * i_150_);
									for (int i_152_ = i_142_; (i_152_ < i_144_); i_152_++) {
										if (bools[i_152_ - i_142_][-i_143_ + i_150_]) {
											short[] is = (this.aShortArrayArray5230[i_151_]);
											if (is != null) {
								...
								for (int i_155_ = i_143_; i_155_ < i_145_; i_155_++) {
									int i_156_ = (i_155_ * this.anInt2203 + i_142_);
									for (int i_157_ = i_142_; i_144_ > i_157_; i_157_++) {
										if (bools[i_157_ + -i_142_][-i_143_ + i_155_]) {
											short[] is = (this.aShortArrayArray5230[i_156_]);
											if (is != null) {
					...
					Class111_Sub3 class111_sub3 = this.aHa_Sub3_5225.method1978((byte) -6);
					float[] fs = this.aHa_Sub3_5225.method2034(-113);
					fs[0] = ((float) i_141_ / ((float) this.aHa_Sub3_5225.anInt4527 * (128.0F * (float) this.anInt2206)));
					fs[5] = ((float) i_141_ / ((float) this.anInt2206 * 128.0F * (float) (this.aHa_Sub3_5225.anInt4531)));
					fs[9] = 0.0F;
					fs[6] = 0.0F;
					fs[10] = 1.0F / (aFloat5243 - aFloat5238);
					fs[14] = -aFloat5238 / (aFloat5243 - aFloat5238);
					fs[13] = 1.0F - (((float) (i_141_ * i_145_) / 128.0F + (float) (i_140_ * 2)) / (float) (this.aHa_Sub3_5225.anInt4531));
					fs[7] = 0.0F;
					fs[2] = 0.0F;
					fs[8] = 0.0F;
					fs[11] = 0.0F;
					...
					fs[4] = 0.0F;
					fs[3] = 0.0F;
					fs[12] = -1.0F - (((float) (i_142_ * i_141_) / 128.0F - (float) (2 * i)) / (float) (this.aHa_Sub3_5225.anInt4527));
					...
					this.aHa_Sub3_5225.method1973(Class336.aClass232_2822, -i_147_ + (i_148_ + 1), 0, 26810, interface2_impl2, i_147_, i_146_ / 3);
	...
	final void wa(r var_r, int i, int i_160_, int i_161_, int i_162_, boolean bool) {
		try {
			if (aClass15_5235 != null && var_r != null) {
				int i_163_ = (-((this.aHa_Sub3_5225.anInt4564 * i_160_) >> 8) + i >> this.aHa_Sub3_5225.anInt4573);
				int i_164_ = (i_161_ - ((this.aHa_Sub3_5225.anInt4552) * i_160_ >> 8) >> this.aHa_Sub3_5225.anInt4573);
	...
	final boolean method3418(r var_r, int i, int i_165_, int i_166_, int i_167_, boolean bool) {
		try {
			if (aClass15_5235 == null || var_r == null)
				return false;
			int i_168_ = (-((this.aHa_Sub3_5225.anInt4564 * i_165_) >> 8) + i >> this.aHa_Sub3_5225.anInt4573);
			int i_169_ = (i_166_ + -((this.aHa_Sub3_5225.anInt4552) * i_165_ >> 8) >> this.aHa_Sub3_5225.anInt4573);
	...
	private final void method3436(boolean bool, int i, int i_170_, r_Sub2 var_r_Sub2) {
		try {
			int[] is = this.anIntArrayArrayArray5226[i][i_170_];
			if (bool != true)
				method3421(null, null);
			int[] is_171_ = this.anIntArrayArrayArray5240[i][i_170_];
			...
			for (int i_173_ = 0; i_173_ < i_172_; i_173_++) {
				Class374.anIntArray3156[i_173_] = (is[i_173_] >> this.aHa_Sub3_5225.anInt4573);
				Class224_Sub1.anIntArray5033[i_173_] = (is_171_[i_173_] >> this.aHa_Sub3_5225.anInt4573);
			}
			int i_174_ = 0;
			while (i_174_ < i_172_) {
	...
	final void method3421(Class98_Sub5 class98_sub5, int[] is) {
		try {
			aClass148_5231.add_last(new Class98_Sub25((this.aHa_Sub3_5225), this, class98_sub5, is), -20911);
		} catch (RuntimeException runtimeexception) {
	...
	s_Sub2(ha_Sub3 var_ha_Sub3, int i, int i_181_, int i_182_, int i_183_, int[][] is, int[][] is_184_, int i_185_) {
		...
		do {
			try {
				this.aHa_Sub3_5225 = var_ha_Sub3;
				anInt5229 = -2 + this.anInt2200;
				aByteArrayArray5234 = new byte[i_182_][i_183_];
				anIntArrayArrayArray5242 = new int[i_182_][i_183_][];
				anInt5232 = 1 << anInt5229;
				this.anInt5233 = i_181_;
				this.anIntArrayArrayArray5240 = new int[i_182_][i_183_][];
				aClass98_Sub30ArrayArrayArray5236 = new Class98_Sub30[i_182_][i_183_][];
				this.aShortArrayArray5230 = new short[i_182_ * i_183_][];
				aFloatArrayArray5248 = (new float[this.anInt2203 - -1][this.anInt2204 + 1]);
				aFloatArrayArray5251 = (new float[this.anInt2203 + 1][1 + this.anInt2204]);
				anIntArrayArrayArray5228 = new int[i_182_][i_183_][];
				this.anIntArrayArrayArray5226 = new int[i_182_][i_183_][];
				aByteArrayArray5253 = new byte[1 + i_182_][i_183_ - -1];
				this.anIntArrayArrayArray5241 = new int[i_182_][i_183_][];
				aFloatArrayArray5254 = (new float[this.anInt2203 - -1][this.anInt2204 - -1]);
				for (int i_186_ = 0; (this.anInt2204 >= i_186_); i_186_++) {
					for (int i_187_ = 0; (this.anInt2203 >= i_187_); i_187_++) {
						int i_188_ = this.anIntArrayArray2201[i_187_][i_186_];
						if (aFloat5243 < (float) i_188_)
							aFloat5243 = (float) i_188_;
						if ((float) i_188_ < aFloat5238)
							aFloat5238 = (float) i_188_;
						if (i_187_ > 0 && i_186_ > 0 && i_187_ < this.anInt2203 && i_186_ < this.anInt2204) {
							int i_189_ = (is_184_[1 + i_187_][i_186_] - is_184_[i_187_ - 1][i_186_]);
							int i_190_ = (-is_184_[i_187_][-1 + i_186_] + is_184_[i_187_][i_186_ - -1]);
							float f = (float) (1.0 / (Math.sqrt(i_189_ * i_189_ + (i_185_ * 4 * i_185_ + (i_190_ * i_190_)))));
				...
				if ((0x10 & this.anInt5233) == 0)
					break;
				aClass15_5235 = new Class15(this.aHa_Sub3_5225, this);
			} catch (RuntimeException runtimeexception) {
	...
	final void U(int i, int i_195_, int[] is, int[] is_196_, int[] is_197_, int[] is_198_, int[] is_199_, int[] is_200_, int[] is_201_, int[] is_202_, int i_203_, int i_204_, int i_205_, boolean bool) {
		try {
			d var_d = this.aHa_Sub3_5225.aD938;
			if (is_198_ != null && anIntArrayArrayArray5239 == null)
				anIntArrayArrayArray5239 = new int[this.anInt2203][this.anInt2204][];
			if (is_196_ != null && anIntArrayArrayArray5228 == null)
				anIntArrayArrayArray5228 = new int[this.anInt2203][this.anInt2204][];
			this.anIntArrayArrayArray5226[i][i_195_] = is;
			this.anIntArrayArrayArray5240[i][i_195_] = is_197_;
			this.anIntArrayArrayArray5241[i][i_195_] = is_199_;
			...
			for (int i_206_ = 0; i_206_ < is_199_.length; i_206_++) {
				...
				if ((this.anInt5233 & 0x20) != 0 && i_207_ != -1 && (var_d.method11(i_207_, -28755).aBoolean1825)) {
					i_208_ = 128;
					i_207_ = -1;
				}
				long l = ((long) i_203_ << 28 | ((long) i_205_ << 48 | (long) i_204_ << 42) | (long) (i_208_ << 14) | (long) i_207_);
				Node class98;
				for (class98 = aClass377_5247.method3990(l, -1); class98 != null; class98 = aClass377_5247.method3993(-95)) {
					...
					if (i_207_ == class98_sub30.anInt4084 && ((float) i_208_ == class98_sub30.aFloat4092) && (class98_sub30.anInt4091 == i_203_) && class98_sub30.anInt4090 == i_204_ && i_205_ == class98_sub30.anInt4086)
						break;
				}
				if (class98 == null) {
