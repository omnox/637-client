...
final class Class35 {
	...
	static final void method333(Class246_Sub1 class246_sub1, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("cia.A(" + (class246_sub1 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	static final int method337(int i, String string) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("cia.G(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final int method338(int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, byte i_14_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("cia.F(" + i + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ',' + i_12_ + ',' + i_13_ + ',' + i_14_ + ')'));
		}
	}
