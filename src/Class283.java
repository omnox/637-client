...
final class Class283 {
	...
	private LinkedList aClass148_2137;
	...
	private final boolean method3339(int i) {
		try {
			if (aBoolean2151) {
				...
				if (aBoolean2152)
					...
					aClass98_Sub46_Sub14_2147 = new Class98_Sub46_Sub14(aHa_Sub1_2135, 6402, anInt2141, anInt2140);
				aBoolean2151 = false;
				aBoolean2148 = true;
				aBoolean2157 = true;
			}
			...
			if (aBoolean2148) {
				if (aClass288_2142 == null) {
					...
					aClass288_2136.method3395(0, aClass42_Sub1Array2154[0], 119);
					if (anInt2155 > 1)
						aClass288_2136.method3395(1, aClass42_Sub1Array2154[1], i + -20431);
					if (aBoolean2152)
						aClass288_2136.method3395(8, aClass42_Sub1_2149, i ^ 0x503b);
					else
						aClass288_2136.method3406((byte) 115, 8, aClass98_Sub46_Sub14_2147);
					...
					aClass288_2136.method3401(1, true);
					aClass288_2136.method3401(8, true);
					aClass288_2136.method3395(0, aClass42_Sub1Array2154[0], i ^ 0x5034);
					if (anInt2155 > 1)
						aClass288_2136.method3395(1, aClass42_Sub1Array2154[1], 127);
					if (aBoolean2152)
					...
					aClass288_2142.method3406((byte) 78, 0, aClass98_Sub46_Sub14_2156);
					aClass288_2142.method3406((byte) 66, 8, aClass98_Sub46_Sub14_2147);
	...
	private final void method3340(int i) {
		do {
			try {
				if (i != 6408)
					anInt2141 = 125;
				...
				int i_0_ = 0;
				int i_1_ = 0;
				for (Class98_Sub28 class98_sub28 = (Class98_Sub28) aClass148_2137.method2418(32); class98_sub28 != null; class98_sub28 = (Class98_Sub28) aClass148_2137.method2417(118)) {
					int i_2_ = class98_sub28.method1299(false);
	...
	final void method3341(Class98_Sub28 class98_sub28, int i) {
		try {
			...
			if (i != -17722)
				method3339(-66);
			class98_sub28.remove();
			method3340(i + 24130);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rm.G(" + (class98_sub28 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	final void method3342(int i) {
		try {
			if (aBoolean2144) {
				if (aClass288_2142 != null) {
					...
					if (aBoolean2152)
						i_6_ |= 0x100;
					OpenGL.glBlitFramebufferEXT(0, 0, anInt2141, anInt2140, 0, 0, anInt2141, anInt2140, i_6_, 9728);
					...
					for (Class98_Sub28 class98_sub28_9_ = (Class98_Sub28) aClass148_2137.method2418(32); class98_sub28_9_ != null; class98_sub28_9_ = class98_sub28) {
						...
						for (int i_11_ = 0; (i_11_ ^ 0xffffffff) > (i_10_ ^ 0xffffffff); i_11_++) {
							...
							if (class98_sub28 != null || i_10_ - 1 != i_11_) {
								...
								OpenGL.glBegin(7);
								OpenGL.glTexCoord2f(0.0F, (float) anInt2140);
								OpenGL.glMultiTexCoord2f(33985, 0.0F, 1.0F);
								OpenGL.glVertex2i(0, 0);
								OpenGL.glTexCoord2f(0.0F, 0.0F);
								OpenGL.glMultiTexCoord2f(33985, 0.0F, 0.0F);
								OpenGL.glVertex2i(0, anInt2140);
								OpenGL.glTexCoord2f((float) anInt2141, 0.0F);
								OpenGL.glMultiTexCoord2f(33985, 1.0F, 0.0F);
								OpenGL.glVertex2i(anInt2141, anInt2140);
								OpenGL.glTexCoord2f((float) anInt2141, (float) anInt2140);
								...
								OpenGL.glTexCoord2f(0.0F, 0.0F);
								OpenGL.glMultiTexCoord2f(33985, 0.0F, 0.0F);
								OpenGL.glVertex2i(anInt2138, anInt2140 + anInt2133);
								OpenGL.glTexCoord2f((float) anInt2141, 0.0F);
								OpenGL.glMultiTexCoord2f(33985, 1.0F, 0.0F);
								OpenGL.glVertex2i(anInt2141 + anInt2138, anInt2133 + anInt2140);
								OpenGL.glTexCoord2f((float) anInt2141, (float) anInt2140);
								OpenGL.glMultiTexCoord2f(33985, 1.0F, 1.0F);
								OpenGL.glVertex2i(anInt2138 + anInt2141, anInt2133);
								OpenGL.glEnd();
							}
	...
	static final void method3343(AnimableEntity[] class246_sub3s, int i, int i_12_) {
		if (i < i_12_) {
			int i_13_ = (i + i_12_) / 2;
			int i_14_ = i;
	...
	final boolean method3344(Class98_Sub28 class98_sub28, int i) {
		try {
			...
			int i_18_ = 79 % ((46 - i) / 52);
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rm.L(" + (class98_sub28 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	final boolean method3345(int i, int i_19_, int i_20_, int i_21_, int i_22_) {
		try {
			if (i_22_ != 0)
				return false;
			...
			throw Class64_Sub27.method667(runtimeexception, ("rm.A(" + i + ',' + i_19_ + ',' + i_20_ + ',' + i_21_ + ',' + i_22_ + ')'));
		}
	}

	final void method3346(byte i) {
		try {
			if (i >= -116)
				method3352(21);
	...
	static final void method3347(int i, Color color, Color color_23_, Color color_24_, String string, int i_25_) {
		try {
			try {
				...
				try {
					...
					Graphics graphics_26_ = Class3.anImage74.getGraphics();
					graphics_26_.setColor(Color.black);
					graphics_26_.fillRect(0, 0, Class39_Sub1.anInt3593, Class98_Sub25.anInt4024);
					int i_27_ = Class39_Sub1.anInt3593 / 2 + -152;
					int i_28_ = Class98_Sub25.anInt4024 / 2 - 18;
					...
					if (i_25_ == 90) {
						...
						graphics_26_.fillRect(2 + (i_27_ - -(i * 3)), i_28_ + 2, -(i * 3) + 300, 30);
						graphics_26_.setFont(Class98_Sub10_Sub7.aFont5576);
						graphics_26_.setColor(color_24_);
						graphics_26_.drawString(string, i_27_ - -((-(string.length() * 6) + 304) / 2), i_28_ - -22);
						if (Class265.aString1978 != null) {
							graphics_26_.setFont(Class98_Sub10_Sub7.aFont5576);
							graphics_26_.setColor(color_24_);
							graphics_26_.drawString(Class265.aString1978, (Class39_Sub1.anInt3593 / 2 - Class265.aString1978.length() * 6 / 2), Class98_Sub25.anInt4024 / 2 - 26);
						}
					...
					int i_29_ = Class39_Sub1.anInt3593 / 2 + -152;
					int i_30_ = Class98_Sub25.anInt4024 / 2 - 18;
					...
					graphics.fillRect(3 * i + i_29_ + 2, 2 + i_30_, 300 + -(i * 3), 30);
					...
					graphics.drawString(string, i_29_ - -((304 + -(string.length() * 6)) / 2), i_30_ - -22);
				}
			} catch (Exception exception) {
				Class42_Sub3.aCanvas5361.repaint();
			}
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rm.J(" + i + ',' + (color != null ? "{...}" : "null") + ',' + (color_23_ != null ? "{...}" : "null") + ',' + (color_24_ != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ',' + i_25_ + ')'));
		}
	}
	...
	static final int method3348(Class53_Sub1 class53_sub1, int i, boolean bool, Class53_Sub1 class53_sub1_31_, boolean bool_32_, int i_33_, int i_34_) {
		try {
			...
			int i_36_ = Class202.method2700(i_34_, class53_sub1, bool_32_, -1, class53_sub1_31_);
			if (!bool_32_)
				return i_36_;
			return -i_36_;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rm.N(" + (class53_sub1 != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + (class53_sub1_31_ != null ? "{...}" : "null") + ',' + bool_32_ + ',' + i_33_ + ',' + i_34_ + ')'));
		}
	}

	final boolean method3349(boolean bool) {
		try {
			if (bool != true)
				method3342(26);
			if (aClass288_2134 == null)
	...
	static final void method3350(int i, int i_37_, int i_38_, int i_39_, AbstractModel class146, Class228 class228) {
		try {
			if (i_38_ != 18)
				method3350(-82, 96, 36, 122, null, null);
			if (class146 != null)
				class228.method2860(i_37_, i_38_ + -7427, class146.RA(), class146.na(), class146.fa(), class146.V(), i_39_, class146.G(), class146.HA(), class146.EA(), i);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rm.D(" + i + ',' + i_37_ + ',' + i_38_ + ',' + i_39_ + ',' + (class146 != null ? "{...}" : "null") + ',' + (class228 != null ? "{...}" : "null") + ')'));
		}
	}

	static final void method3351(int i, int i_40_, boolean bool, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_) {
		while_166_: do {
			while_165_: do {
				try {
					if (bool != true)
					...
					if ((i_45_ ^ 0xffffffff) != -1) {
						do {
							...
							Interface19 interface19 = ((Interface19) Class101.method1701(i_43_, i_41_, i_42_));
							if (interface19 == null)
								break while_165_;
							if (!(interface19 instanceof Class246_Sub3_Sub5_Sub1)) {
								...
								if ((i ^ 0xffffffff) != -5 && (i ^ 0xffffffff) != -6) {
									if (i != 6) {
										...
										Canvas_Sub1.method119(i_46_, i_42_, i_45_, i_40_ - -4, i_43_, -2, i_41_, i_44_, 4);
								} else {
									Canvas_Sub1.method119(i_46_, i_42_, i_45_, i_40_, i_43_, -2, i_41_, i_44_, 4);
									break;
								}
								break;
							}
					...
					Interface19 interface19 = ((Interface19) Class21_Sub1.method268(i_43_, i_41_, i_42_));
					Interface19 interface19_47_ = ((Interface19) ItemDefinitionList.method2711(i_43_, i_41_, i_42_));
					do {
	...
	public static void method3352(int i) {
		try {
			IncomingOpcode.aClass58_2139 = null;
			aClass171_2146 = null;
			IncomingOpcode.aClass58_2143 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "rm.M(" + i + ')');
		}
	}

	Class283(ha_Sub1 var_ha_Sub1) {
		anInt2133 = 0;
		anInt2140 = 1;
		anInt2141 = 1;
		aClass148_2137 = new LinkedList();
		aBoolean2148 = true;
		anInt2150 = -1;
		aBoolean2153 = true;
		aBoolean2151 = true;
		...
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("rm.<init>(" + (var_ha_Sub1 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	/* synthetic */
	static Class method3353(String string) {
		try {
