...
final class Class222 {
	...
	static final int method2825(int i, int i_2_) {
		try {
			if (i >= -31)
				return -69;
			int i_3_ = i_2_ * (i_2_ * i_2_ >> 12) >> 12;
			int i_4_ = i_2_ * 6 - 61440;
			int i_5_ = (i_2_ * i_4_ >> 12) + 40960;
			return i_3_ * i_5_ >> 12;
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method2826(Class246_Sub3_Sub4 class246_sub3_sub4, boolean bool) {
		...
		for (int i_10_ = class246_sub3_sub4.aShort6158; i_10_ <= class246_sub3_sub4.aShort6160; i_10_++) {
			for (int i_11_ = class246_sub3_sub4.aShort6157; i_11_ <= class246_sub3_sub4.aShort6159; i_11_++) {
				Class172 class172 = Class100.method1693((class246_sub3_sub4.height_level), i_10_, i_11_);
				if (class172 != null) {
		...
		if (bool)
			...
			if (class246_sub3_sub4.method2978(-127)) {
				if (class246_sub3_sub4.method2987(6540)) {
					class246_sub3_sub4.aClass246_Sub3_5090 = Class359.aClass246_Sub3Array3056[i_15_];
					Class359.aClass246_Sub3Array3056[i_15_] = class246_sub3_sub4;
				} else {
					class246_sub3_sub4.aClass246_Sub3_5090 = Class379.aClass246_Sub3Array3198[i_15_];
					Class379.aClass246_Sub3Array3198[i_15_] = class246_sub3_sub4;
					Class358.aBoolean3033 = true;
				}
			} else {
				class246_sub3_sub4.aClass246_Sub3_5090 = Class130.aClass246_Sub3Array1029[i_15_];
