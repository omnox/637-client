...
final class Class98_Sub43_Sub3 extends Class98_Sub43 {
	...
	private final void method1495(int i, int i_0_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "sb.B(" + i + ',' + i_0_ + ')');
			}
			break;
		} while (false);
	}
	...
	final void method1482(OggPacket oggpacket, boolean bool) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("sb.J(" + (oggpacket != null ? "{...}" : "null") + ',' + bool + ')'));
			}
			break;
		} while (false);
	}
	...
	Class98_Sub43_Sub3(OggStreamState oggstreamstate) {
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sb.<init>(" + (oggstreamstate != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final boolean method1499(byte i, char c) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "sb.F(" + i + ',' + c + ')');
		}
	}
	...
	final Class332 method1501(ha var_ha, int i) {
		try {
			...
			if (i != 11242)
				return null;
			aClass332_5917 = var_ha.method1770(aFrame5911.pixels, 0, aFrame5911.a, aFrame5911.a, aFrame5911.b, false);
			aBoolean5912 = false;
			return aClass332_5917;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("sb.D(" + (var_ha != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
