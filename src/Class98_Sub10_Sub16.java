...
final class Class98_Sub10_Sub16 extends Class98_Sub10 {
	...
	static final AbstractModel method1052(int i, int i_0_, int i_1_, ha var_ha, int i_2_, int i_3_, int i_4_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ir.B(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ')'));
		}
	}
	...
	final int[] method990(int i, int i_6_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ir.G(" + i + ',' + i_6_ + ')');
		}
	}
}
