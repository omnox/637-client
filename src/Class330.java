...
final class Class330 {
	...
	private static final void method3717(Class331 class331) {
		...
		while (bool_37_) {
			...
			method3722(class331);
			int i_44_ = class331.anInt2805 + 2;
			...
			for (int i_57_ = 0; i_57_ < i_45_; i_57_++) {
				...
				method3715(class331.anIntArrayArray2806[i_57_], class331.anIntArrayArray2784[i_57_], class331.anIntArrayArray2790[i_57_], class331.aByteArrayArray2804[i_57_], i_58_, i_59_, i_44_);
				class331.anIntArray2791[i_57_] = i_58_;
			}
			int i_61_ = class331.anInt2805 + 1;
			int i_62_ = -1;
			int i_63_ = 0;
			...
			if (i_63_ == 0) {
				i_62_++;
				i_63_ = 50;
				byte i_69_ = class331.aByteArray2776[i_62_];
				...
				if (i_73_ == 0 || i_73_ == 1) {
					...
					do {
						...
						if (i_63_ == 0) {
							i_62_++;
							i_63_ = 50;
							byte i_76_ = class331.aByteArray2776[i_62_];
					...
					int i_77_ = i_73_ - 1;
					if (i_77_ < 16) {
						int i_78_ = class331.anIntArray2781[0];
						...
						for (/**/; i_77_ > 0; i_77_--)
							class331.aByteArray2796[i_78_ + i_77_] = (class331.aByteArray2796[i_78_ + i_77_ - 1]);
						...
						if (class331.anIntArray2781[0] == 0) {
							...
							for (int i_84_ = 15; i_84_ >= 0; i_84_--) {
								for (int i_85_ = 15; i_85_ >= 0; i_85_--) {
									class331.aByteArray2796[i_83_] = (class331.aByteArray2796[(class331.anIntArray2781[i_84_]) + i_85_]);
									i_83_--;
								}
					...
					if (i_63_ == 0) {
						i_62_++;
						i_63_ = 50;
						byte i_86_ = class331.aByteArray2776[i_62_];
	...
	private static final void method3719(Class331 class331) {
		...
		byte[] is_94_ = class331.aByteArray2775;
		int i_95_ = class331.anInt2808;
		int i_96_ = class331.anInt2785;
		int i_97_ = i_96_;
		int i_98_ = class331.anInt2797 + 1;
		while_224_: for (;;) {
			if (i_90_ > 0) {
				for (;;) {
					if (i_96_ == 0)
	...
	private static final int method3720(int i, Class331 class331) {
		for (;;) {
			if (class331.anInt2779 >= i) {
				int i_102_ = ((class331.anInt2777 >> class331.anInt2779 - i) & (1 << i) - 1);
