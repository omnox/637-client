...
final class Class213 {
	...
	static final void removePlayerAmbientSound(boolean bool, Player class246_sub3_sub4_sub2_sub2) {
		do {
			try {
				if (bool != true)
					anIntArray1610 = null;
				...
				throw Class64_Sub27.method667(runtimeexception, ("nq.C(" + bool + ',' + ((class246_sub3_sub4_sub2_sub2 != null) ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
	...
	static final Class98_Sub46_Sub4 method2779(byte i, int i_0_, int i_1_, Class105 class105) {
		try {
			...
			if (class98_sub46_sub4 != null)
				return class98_sub46_sub4;
			is = Class52.aClass207_3494.method2733(Class52.aClass207_3494.method2763(116, i_2_), 40);
			if (is != null) {
				if (is.length <= 1)
					return null;
				try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("nq.F(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (class105 != null ? "{...}" : "null") + ')'));
		}
	}

	final int method2780(int i, byte[] is, int i_4_, int i_5_, byte[] is_6_, int i_7_) {
		try {
			int i_8_ = 0;
			i += i_4_;
	...
	static final void method2781(int i) {
		do {
			try {
	...
	final int method2782(int i, byte[] is, int i_16_, int i_17_, byte[] is_18_, int i_19_) {
		try {
			if (i_17_ == 0)
				return 0;
			int i_20_ = 0;
			...
			throw Class64_Sub27.method667(runtimeexception, ("nq.D(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_16_ + ',' + i_17_ + ',' + (is_18_ != null ? "{...}" : "null") + ',' + i_19_ + ')'));
		}
	}
	...
	Class213(byte[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "nq.<init>(" + (is != null ? "{...}" : "null") + ')');
		}
	}

	public static void method2783(byte i) {
		try {
			if (i < -120) {
				IncomingOpcode.aClass58_1609 = null;
				aClass171_1604 = null;
