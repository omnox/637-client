...
final class Class155 {
	...
	Class155(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			this.aByte1242 = (byte) i;
			this.anIntArray1237 = new int[4];
			this.aByte1238 = (byte) i_3_;
			this.anIntArray1240 = new int[4];
			this.anIntArray1241 = new int[4];
			this.anIntArray1240[2] = i_6_;
			this.anIntArray1240[3] = i_7_;
			this.anIntArray1240[1] = i_5_;
			this.anIntArray1240[0] = i_4_;
			this.anIntArray1237[3] = i_11_;
			this.anIntArray1237[0] = i_8_;
			this.anIntArray1237[2] = i_10_;
			this.anIntArray1237[1] = i_9_;
			this.anIntArray1241[2] = i_14_;
			this.anIntArray1241[1] = i_13_;
			this.anIntArray1241[3] = i_15_;
			this.aShort1236 = (short) (i_4_ >> Class151_Sub8.anInt5015);
			this.anIntArray1241[0] = i_12_;
			this.aShort1243 = (short) (i_6_ >> Class151_Sub8.anInt5015);
			this.aShort1239 = (short) (i_12_ >> Class151_Sub8.anInt5015);
			this.aShort1245 = (short) (i_14_ >> Class151_Sub8.anInt5015);
