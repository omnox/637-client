...
final class Class98_Sub46_Sub13_Sub1 extends Class98_Sub46_Sub13 {
	...
	final int method1590(int i) {
		try {
			...
			if (this.aClass98_Sub22_6305 == null)
				return 0;
			return (this.aClass98_Sub22_6305.position * 100 / (-this.aByte6306 + (this.aClass98_Sub22_6305.data).length));
	...
	static final void method1593(byte i) {
		try {
			int i_0_ = 0;
			if (Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub10_4070.method592((byte) 127) == 1) {
				i_0_ |= 0x1;
				i_0_ |= 0x10;
				i_0_ |= 0x20;
				i_0_ |= 0x2;
	...
	final byte[] method1591(int i) {
		try {
			if (i < 5)
				return null;
			if (this.aBoolean6038 || (((this.aClass98_Sub22_6305.data).length - this.aByte6306) > this.aClass98_Sub22_6305.position))
				throw new RuntimeException();
			return (this.aClass98_Sub22_6305.data);
		} catch (RuntimeException runtimeexception) {
