...
final class Class64_Sub7 extends Class64 {
	...
	final int method556(int i, int i_5_) {
		try {
			if (i_5_ != 29053)
				aClass171_3657 = null;
			if (this.aClass98_Sub27_495.method1291((byte) 127))
				return 3;
			if (this.aClass98_Sub27_495.aClass64_Sub20_4056.method634((byte) 123) == 0)
				return 3;
			return 1;
		} catch (RuntimeException runtimeexception) {
			...
			for (Class98_Sub36 class98_sub36 = ((Class98_Sub36) Class156_Sub1.aClass377_3277.start_iteration(123)); class98_sub36 != null; class98_sub36 = (Class98_Sub36) Class156_Sub1.aClass377_3277.iterate_next(i + -16544)) {
				if (!class98_sub36.aClass237_Sub1_4157.method2902(true)) {
					...
					try {
						...
						Map.method3585(exception, -121, "TV: " + (class98_sub36.anInt4160));
	...
	final void method551(byte i) {
		try {
			...
			if (this.aClass98_Sub27_495.method1291((byte) 119))
				this.anInt494 = 0;
			if (this.aClass98_Sub27_495.aClass64_Sub20_4056.method634((byte) 120) == 0)
				this.anInt494 = 0;
