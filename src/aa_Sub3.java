...
final class aa_Sub3 extends aa {
	...
	static final int method157(int i, byte i_0_) {
		try {
			if (i_0_ != 64)
				method158(100);
	...
	public static void method158(int i) {
		try {
			...
			aClass348_3573 = null;
			anIntArray3571 = null;
			IncomingOpcode.aClass58_3566 = null;
			aCharArray3572 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method159(RuneScapeCache class207, int i, Class98_Sub31_Sub2 class98_sub31_sub2, Class268 class268, RuneScapeCache class207_2_, RuneScapeCache class207_3_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("nc.A(" + (class207 != null ? "{...}" : "null") + ',' + i + ',' + (class98_sub31_sub2 != null ? "{...}" : "null") + ',' + (class268 != null ? "{...}" : "null") + ',' + (class207_2_ != null ? "{...}" : "null") + ',' + (class207_3_ != null ? "{...}" : "null") + ')'));
		}
	}
