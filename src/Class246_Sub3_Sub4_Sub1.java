...
final class Class246_Sub3_Sub4_Sub1 extends Class246_Sub3_Sub4 implements Interface19 {
		...
		try {
			...
			do {
				if (Class239.aBoolean1839) {
					this.aClass146_6243.method2329(class111, (class246_sub1.aClass246_Sub6Array5067[0]), Class16.anInt197, 0);
					if (!client.aBoolean3553)
						break;
				}
				this.aClass146_6243.method2325(class111, (class246_sub1.aClass246_Sub6Array5067[0]), 0);
			} while (false);
	...
	static final void method3025(byte i) {
		do {
			try {
				if (Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub15_4058.method612((byte) 125) == 2) {
					...
					if (Class43.anInt377 != 3) {
						...
						int i_5_ = (Player.selfPlayer.localXPos);
						int i_6_ = (Player.selfPlayer.localYPos);
						if ((Class98_Sub46_Sub20_Sub2.anInt6319 == 1) || Class116.anInt967 != -1) {
							if (Class98_Sub46_Sub20_Sub2.anInt6319 != 1) {
								i_6_ = Class64_Sub26.anInt3712;
								i_5_ = Class116.anInt967;
							}
							if (((Class281.tileSettings[Class43.anInt377][i_5_ >> 9][i_6_ >> 9]) & 0x4) != 0)
								Class253.method3175(i_5_ >> 9, 0, (Class98_Sub46_Sub1.aClass172ArrayArrayArray5948), i_6_ >> 9, (byte) -76, false);
							if (GameWorld.cameraPitch < 2560) {
								int i_7_ = (Class98_Sub46_Sub10.renderX >> 9);
								int i_8_ = Class134.renderZ >> 9;
								int i_9_ = i_5_ >> 9;
								int i_10_ = i_6_ >> 9;
								int i_11_;
								if (i_7_ < i_9_)
								...
								if (i_10_ <= i_8_)
									...
									i_12_ = -i_8_ + i_10_;
								if (i_11_ == 0 && i_12_ == 0 || (-GameWorld.size_x >= i_11_) || (i_11_ >= GameWorld.size_x) || -GameWorld.size_y >= i_12_ || i_12_ >= GameWorld.size_y)
						...
						if (i_17_ + -Class79.renderY >= 3200 || ((0x4 & (Class281.tileSettings[Class43.anInt377][(Class98_Sub46_Sub10.renderX >> 9)][Class134.renderZ >> 9])) == 0))
							break;
						Class253.method3175((Class98_Sub46_Sub10.renderX >> 9), 1, (Class98_Sub46_Sub1.aClass172ArrayArrayArray5948), Class134.renderZ >> 9, (byte) -76, false);
					}
				}
			} catch (RuntimeException runtimeexception) {
	...
	final void method2992(byte i) {
		do {
			try {
				...
				if (this.aClass146_6243 == null)
					break;
				this.aClass146_6243.s(~0x10000 & this.aClass146_6243.ua());
			} catch (RuntimeException runtimeexception) {
	...
	private final AbstractModel method3026(int i, int i_19_, ha var_ha) {
		try {
			if (this.aClass146_6243 != null && var_ha.c(this.aClass146_6243.ua(), i_19_) == 0)
	...
	final Class228 method2974(byte i, ha var_ha) {
		try {
			...
			if (aClass228_6236 == null)
				aClass228_6236 = (Class48_Sub2_Sub1.method472(this.anInt5089, this.localXPos, method3026(-128, 0, var_ha), this.localYPos, i ^ ~0x30));
	...
	Class246_Sub3_Sub4_Sub1(ha var_ha, Class352 class352, int i, int i_20_, int i_21_, int i_22_, int i_23_, boolean bool, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_, boolean bool_30_) {
		...
		do {
			try {
				...
				aBoolean6234 = (class352.anInt2998 != 0 && !bool);
				this.aByte5081 = (byte) i_20_;
				aByte6232 = (byte) i_28_;
				aBoolean6239 = (var_ha.method1771() && class352.aBoolean2935 && !aBoolean6237 && Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub7_4073.method579((byte) 127) != 0);
				int i_31_ = 2048;
				if (aBoolean6235)
					i_31_ |= 0x10000;
				...
				this.aClass146_6243 = class298.aClass146_2477;
				if (!aBoolean6235)
					break;
				this.aClass146_6243 = this.aClass146_6243.method2341((byte) 0, i_31_, false);
			} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			if (!aBoolean6237) {
				if (this.aByte5081 >= 3)
					...
					var_s = (Class98_Sub46_Sub2_Sub2.aSArray6298[1 + this.aByte5081]);
				var_s_36_ = (Class98_Sub46_Sub2_Sub2.aSArray6298[this.aByte5081]);
			} else {
				var_s = Class98_Sub46_Sub2_Sub2.aSArray6298[0];
				var_s_36_ = Class81.aSArray618[this.aByte5081];
			}
			return class352.method3851(this.localYPos, false, var_s, (aByte6232 == 11 ? (aByte6233 + 4) : aByte6233), this.anInt5089, bool, this.localXPos, i, null, var_s_36_, var_ha, aByte6232 != 11 ? aByte6232 : 10);
		} catch (RuntimeException runtimeexception) {
		...
		try {
			do {
				if (class246_sub3 instanceof Class246_Sub3_Sub3_Sub2) {
					...
					if (this.aClass146_6243 == null || (class246_sub3_sub3_sub2.aClass146_6285) == null)
						break;
					this.aClass146_6243.method2332((class246_sub3_sub3_sub2.aClass146_6285), i_37_, i_38_, i_39_, bool);
					if (!client.aBoolean3553)
						break;
				}
				if (class246_sub3 instanceof Class246_Sub3_Sub4_Sub1) {
					...
					if (this.aClass146_6243 != null && (class246_sub3_sub4_sub1_40_.aClass146_6243 != null))
						this.aClass146_6243.method2332(class246_sub3_sub4_sub1_40_.aClass146_6243, i_37_, i_38_, i_39_, bool);
				}
			} while (false);
