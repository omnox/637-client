...
final class Class210 implements Interface10 {
	...
	public final int method25(int i) {
		try {
			if (i != -24591)
				return -30;
			return ((Class124) aClass124_3327).anInt1014;
	...
	public final boolean method28(int i, long l) {
		try {
			int i_2_ = -16 / ((-13 - i) / 50);
			if ((Class343.method3819(-47) ^ 0xffffffffffffffffL) > ((long) ((Class124) aClass124_3327).anInt1012 + l ^ 0xffffffffffffffffL))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	Class210(Class124 class124, Class362 class362) {
		try {
			...
			anInterface18Array3331 = new Interface18[(((Class124) aClass124_3327).anInterface21Array1013).length];
			for (int i = 0; ((anInterface18Array3331.length ^ 0xffffffff) < (i ^ 0xffffffff)); i++)
				anInterface18Array3331[i] = class362.method3927((byte) 62, (((Class124) aClass124_3327).anInterface21Array1013[i]));
		} catch (RuntimeException runtimeexception) {
