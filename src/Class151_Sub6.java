...
final class Class151_Sub6 extends Class151 {
		...
		do {
			try {
				if (!var_ha_Sub1.aBoolean4391)
					break;
				aBoolean5000 = var_ha_Sub1.anInt4410 < 3;
				...
				for (int i_3_ = 0; i_3_ < 64; i_3_++) {
					for (int i_4_ = 0; i_4_ < 64; i_4_++) {
						...
						for (int i_7_ = 0; i_7_ < 6; i_7_++) {
							...
							int i_11_;
							if (f_8_ > 0.0F) {
								i_9_ = (int) (Math.pow(f_8_, 96.0) * (double) i);
								i_10_ = (int) ((double) i * Math.pow(f_8_, 36.0));
								i_11_ = (int) ((double) i * Math.pow(f_8_, 12.0));
							} else
								i_9_ = i_10_ = i_11_ = 0;
		...
		do {
			try {
				if (aBoolean4996) {
					...
					this.aHa_Sub1_1215.method1863(1, aClass42_Sub2Array4995[i - 1]);
	...
	static final void method2463(GameInterfaceData class293, GameInterfaceData class293_15_, int i) {
		try {
			...
			class98_sub11.packet.writeInt(1571862888, class293_15_.anInt2248);
			if (i >= 18) {
				class98_sub11.packet.writeShortA(class293.anInt2302, (byte) 126);
				class98_sub11.packet.writeShort(class293_15_.anInt2302);
				class98_sub11.packet.writeLEInt(class293.anInt2248, 1046032984);
				class98_sub11.packet.writeLEShortA(class293_15_.anInt2300, 128);
				class98_sub11.packet.writeLEShort(class293.anInt2300, 17624);
	...
	private final void method2464(int i) {
		try {
			aClass91_4994 = new Class91(this.aHa_Sub1_1215, 2);
