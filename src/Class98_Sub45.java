...
final class Class98_Sub45 extends Node {
	...
	LinkedList aClass148_4254 = new LinkedList();
	...
	static final void method1519(GameInterfaceData class293, boolean bool) {
		try {
			GameInterfaceData class293_0_ = Class360.method3910(bool, class293);
			int i;
			int i_1_;
			do {
				if (class293_0_ == null) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tia.C(" + (class293 != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	static final void add_message(byte i, int i_3_, String string, int i_4_, String string_5_, String string_6_, String string_7_) {
		try {
			Class137.method2276(string_7_, i_3_, string_6_, string, -1, null, (byte) -99, i_4_, string_5_);
			int i_8_ = -101 / ((-33 - i) / 63);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("tia.B(" + i + ',' + i_3_ + ',' + (string != null ? "{...}" : "null") + ',' + i_4_ + ',' + (string_5_ != null ? "{...}" : "null") + ',' + (string_6_ != null ? "{...}" : "null") + ',' + (string_7_ != null ? "{...}" : "null") + ')'));
		}
	}

	static {
		aBigInteger4253 = (new BigInteger("87d2c867cb1ce29ac740deea9b15092fe92b9bb7daa489ad025ea95852070fac17ae66144119f134f0ae13236b003a8399f8ff59e9c857b81c4ef765ee48b7d7", 16));
