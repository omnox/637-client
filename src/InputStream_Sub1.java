...
final class InputStream_Sub1 extends InputStream {
	...
	static final boolean method121(AnimableEntity class246_sub3, boolean bool, byte[][][] is, int i, byte i_0_) {
		if (!Class302.aBoolean2526)
			return false;
		int i_1_ = (class246_sub3.localXPos >> Class151_Sub8.anInt5015);
		int i_2_ = i_1_;
		int i_3_ = (class246_sub3.localYPos >> Class151_Sub8.anInt5015);
		int i_4_ = i_3_;
		...
		for (int i_5_ = i_1_; i_5_ <= i_2_; i_5_++) {
			for (int i_6_ = i_3_; i_6_ <= i_4_; i_6_++) {
				if ((class246_sub3.aByte5081 < Class364.anInt3103) && i_5_ >= Class306.anInt2561 && i_5_ < Class21_Sub2.anInt5388 && i_6_ >= OutgoingOpcode.anInt1318 && i_6_ < Class32.anInt303) {
					if ((is != null && class246_sub3.height_level >= i && (is[class246_sub3.height_level][i_5_][i_6_]) == i_0_) || !class246_sub3.method2991(false) || class246_sub3.method2977((Class98_Sub10_Sub30.aHa5709), (byte) 77)) {
