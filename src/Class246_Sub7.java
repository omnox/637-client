...
final class Class246_Sub7 extends Class246 {
	...
	static final void method3131(int i, long l) {
		try {
			if (i != 0)
				aClass48_5119 = null;
			...
			throw Class64_Sub27.method667(runtimeexception, "mda.C(" + i + ',' + l + ')');
		}
	}

	static final int method3132(int i, byte i_0_, int i_1_) {
		try {
			if (i_0_ != 118)
				return 45;
			...
			throw Class64_Sub27.method667(runtimeexception, ("mda.A(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}
