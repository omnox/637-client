...
abstract class Class339 {
	...
	static final void method3783(ha var_ha, d var_d, int i) {
		try {
			if (Class278.aClass98_Sub46_Sub10_2056 != null && i >= 47) {
				...
				if (Class212.anInt1600 == 10) {
					Class278.anInt2078 = (Class278.aClass98_Sub46_Sub10_2056.anInt6009 >> 6 << 6);
					Class278.anInt2075 = (Class278.aClass98_Sub46_Sub10_2056.anInt6008 >> 6 << 6);
					Class278.anInt2084 = (-Class278.anInt2078 + ((Class278.aClass98_Sub46_Sub10_2056.anInt6023 >> 6 << 6) - -64));
					Class278.anInt2089 = 64 + (Class278.aClass98_Sub46_Sub10_2056.anInt6016 >> 6 << 6) - Class278.anInt2075;
					int[] is = new int[3];
					int i_0_ = -1;
					int i_1_ = -1;
					if (Class278.aClass98_Sub46_Sub10_2056.method1573(Player.selfPlayer.height_level, is, -90, (aa_Sub2.anInt3562 + ((Player.selfPlayer.localYPos) >> 9)), (Player.selfPlayer.localXPos >> 9) + Class272.anInt2038)) {
						i_1_ = -Class278.anInt2078 + is[2];
						i_0_ = is[1] + -Class278.anInt2075;
					}
					if (Class211.aBoolean1593 || i_0_ < 0 || i_0_ >= Class278.anInt2089 || i_1_ < 0 || (i_1_ >= Class278.anInt2084)) {
						if (RuntimeException_Sub1.anInt3205 != -1 && Node.anInt835 != -1) {
							...
							Class278.aClass98_Sub46_Sub10_2056.method1570((byte) 117, (Class278.aClass98_Sub46_Sub10_2056.anInt6006) & 0x3fff, is, ((Class278.aClass98_Sub46_Sub10_2056.anInt6006) & 0xfffc780) >> 14);
					...
					if (Class278.aClass98_Sub46_Sub10_2056.anInt6007 != 37) {
						if (Class278.aClass98_Sub46_Sub10_2056.anInt6007 != 50) {
							if (Class278.aClass98_Sub46_Sub10_2056.anInt6007 != 75) {
								if ((Class278.aClass98_Sub46_Sub10_2056.anInt6007) == 100)
					...
					Class278.anInt2069 = (int) Class278.aFloat2064 >> 1;
					...
					if (Class278.anInt2063 > 8)
						Class278.anInt2063 = 8;
					if (Class278.anInt2071 < -16)
						Class278.anInt2071 = -16;
					if (Class278.anInt2071 > 16)
						Class278.anInt2071 = 16;
					Class278.method3304(var_d, (Class278.anInt2063 >> 2 << 10), Class278.anInt2071 >> 1);
	...
	static final void method3788(int i, int i_3_, int i_4_, int i_5_, byte i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_) {
		try {
			if (i_5_ != i || i_11_ != i_10_ || i_8_ != i_7_ || i_4_ != i_9_) {
				int i_12_ = i;
				int i_13_ = i_10_;
				int i_14_ = i * 3;
				int i_15_ = i_10_ * 3;
				...
				for (int i_26_ = 128; i_26_ <= 4096; i_26_ += 128) {
					...
					int i_35_ = i - -(i_29_ - (-i_31_ - i_33_) >> 12);
					int i_36_ = (i_34_ + (i_30_ + i_32_) >> 12) + i_10_;
