...
final class Class98_Sub10_Sub33 extends Class98_Sub10 {
	...
	final int[][] method997(int i, int i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "sg.C(" + i + ',' + i_0_ + ')');
		}
	}

	static final void method1099(int i, int i_7_, byte i_8_) {
		try {
	...
	private final void method1100(int i, int i_9_) {
		do {
			try {
				while_172_: do {
					if (i_9_ != 0) {
				...
				throw Class64_Sub27.method667(runtimeexception, "sg.E(" + i + ',' + i_9_ + ')');
			}
			break;
		} while (false);
	}

	static final int method1101(int i, RuneScapeCache class207) {
		try {
			if (i != -11286)
				return -69;
			int i_11_ = 0;
			if (class207.method2742(i + 11209, aa.anInt51))
				i_11_++;
			if (class207.method2742(-35, VarpClass.anInt3243))
				i_11_++;
			...
			if (class207.method2742(-94, OutputStream_Sub1.anInt37))
				i_11_++;
			if (class207.method2742(-89, Collision.anInt1852))
				i_11_++;
			...
			throw Class64_Sub27.method667(runtimeexception, ("sg.B(" + i + ',' + (class207 != null ? "{...}" : "null") + ')'));
		}
	}

	final void method991(int i, RSByteBuffer class98_sub22, byte i_12_) {
		try {
			if (i_12_ >= -92)
				anIntArray5723 = null;
			if (i == 0) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sg.A(" + i + ',' + (class98_sub22 != null ? "{...}" : "null") + ',' + i_12_ + ')'));
		}
	}

	private final void method1102(int i) {
		do {
			try {
				...
				if (i == 3) {
					...
					for (int i_16_ = 0; i_16_ < 257; i_16_++) {
						...
						if (i_17_ < i_15_) {
							...
							int[] is = anIntArrayArray5724[-1 + i_15_];
							i_20_ = is[1];
							i_21_ = is[3];
							i_22_ = is[2];
						}
