...
final class IncomingMessages extends Class48_Sub1 {
	static Class98_Sub22_Sub1 packetStream;
	...
	final boolean method464(byte i, Class42_Sub2 class42_sub2, float f, Class42_Sub2 class42_sub2_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("cv.F(" + i + ',' + (class42_sub2 != null ? "{...}" : "null") + ',' + f + ',' + (class42_sub2_0_ != null ? "{...}" : "null") + ')'));
		}
	}
	...
	IncomingMessages(ha_Sub1 var_ha_Sub1, int i) {
		try {
			aHa_Sub1_5517 = var_ha_Sub1;
			aClass42_Sub2_5516 = new Class42_Sub2(var_ha_Sub1, 6408, i);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("cv.<init>(" + (var_ha_Sub1 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	public static void method467(int i) {
		try {
			...
			if (i == 1) {
				packetStream = null;
				IncomingOpcode.smallVarpOpcode = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method468(boolean bool, int i, int i_4_, String string) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("cv.I(" + bool + ',' + i + ',' + i_4_ + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}

	static {
		packetStream = new Class98_Sub22_Sub1(5000);
	}
}
