...
final class Class98_Sub26 extends Node {
	...
	static final int method1275(String string, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("kaa.E(" + (string != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	static final void method1277(int i, String string) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("kaa.B(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void method1278(int i) {
		try {
			int i_0_ = -45 % ((i - 10) / 55);
			anIntArray4030 = null;
			IncomingOpcode.aClass58_4029 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "kaa.D(" + i + ')');
		}
	}

	static final void method1279(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool) {
		try {
			int i_6_ = i_2_ + i;
			if (bool != true)
				method1276(-2);
			...
			for (int i_8_ = i; i_6_ > i_8_; i_8_++)
				Class333.method3761(i_3_, Class97.anIntArrayArray814[i_8_], i_5_, i_1_, (byte) 27);
			int i_9_ = i_1_ + -i_2_;
			...
			throw Class64_Sub27.method667(runtimeexception, ("kaa.A(" + i + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + bool + ')'));
		}
	}
