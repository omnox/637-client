...
class PacketParser extends Class373 {
	...
	final void method3965(int i, int i_0_, int i_1_, boolean bool) {
		try {
			...
			int i_3_ = i_1_ + (((Class93) ((Class373) this).aClass93_3478).anInt3514 + -aClass332_5465.method3737());
			int i_4_ = i_0_ + aClass332_5461.method3749();
			int i_5_ = i_0_ + (((Class93) ((Class373) this).aClass93_3478).anInt3504 + -aClass332_5464.method3749());
			int i_6_ = i_3_ + -i_2_;
			int i_7_ = -i_4_ + i_5_;
	...
	PacketParser(RuneScapeCache class207, RuneScapeCache class207_9_, Class93_Sub1 class93_sub1) {
		super(class207, class207_9_, (Class93) class93_sub1);
	}

	void method3966(int i, int i_10_, int i_11_, int i_12_, byte i_13_) {
		do {
			try {
				((PacketParser) this).aClass332_5462.method3738(i_12_, i_11_, i_10_, i);
				method3969(56, 14);
			} catch (RuntimeException runtimeexception) {
	...
	static final boolean method3967(int i) throws IOException {
		try {
			...
			if (IncomingOpcode.currentIncommingOpcode == null) {
				if (Class98_Sub43.aBoolean4243) {
					if (!aa_Sub1.aClass123_3561.method2203(-1949, 1))
						return false;
					aa_Sub1.aClass123_3561.method2208((((RSByteBuffer) IncomingMessages.packetStream).data), 0, 2047, 1);
				...
				if (IncomingMessages.packetStream.method1260((byte) 54)) {
					if (!aa_Sub1.aClass123_3561.method2203(-1949, 1))
						return false;
					aa_Sub1.aClass123_3561.method2208((((RSByteBuffer) IncomingMessages.packetStream).data), 1, 2047, 1);
					Class103.anInt892++;
					Class224_Sub1.anInt5031 = 0;
				}
				...
				if (i_14_ < 0 || i_14_ >= class58s.length)
					throw new IOException("invo:" + i_14_ + " ip:" + (((RSByteBuffer) (IncomingMessages.packetStream)).position));
				IncomingOpcode.currentIncommingOpcode = class58s[i_14_];
				Class65.anInt496 = ((IncomingOpcode) IncomingOpcode.currentIncommingOpcode).anInt460;
			}
			if ((Class65.anInt496 ^ 0xffffffff) == 0) {
				...
				aa_Sub1.aClass123_3561.method2208((((RSByteBuffer) IncomingMessages.packetStream).data), 0, 2047, 1);
				Class224_Sub1.anInt5031 = 0;
				Class65.anInt496 = (((RSByteBuffer) IncomingMessages.packetStream).data[0]) & 0xff;
				Class103.anInt892++;
			}
			if (Class65.anInt496 == -2) {
				if (!aa_Sub1.aClass123_3561.method2203(-1949, 2))
					return false;
				aa_Sub1.aClass123_3561.method2208((((RSByteBuffer) IncomingMessages.packetStream).data), 0, 2047, 2);
				((RSByteBuffer) IncomingMessages.packetStream).position = 0;
			...
			if ((Class65.anInt496 ^ 0xffffffff) < -1) {
				if (!aa_Sub1.aClass123_3561.method2203(-1949, Class65.anInt496))
					return false;
				((RSByteBuffer) IncomingMessages.packetStream).position = 0;
				aa_Sub1.aClass123_3561.method2208((((RSByteBuffer) IncomingMessages.packetStream).data), 0, i + -525198532, Class65.anInt496);
				Class224_Sub1.anInt5031 = 0;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_6057) {
				...
				Class353.method3868(((ItemDefinition) class297).anInt2465, i_25_, (byte) -104, ((ItemDefinition) class297).anInt2416, ((ItemDefinition) class297).anInt2476);
				Class323.method3675(i_25_, ((ItemDefinition) class297).anInt2437, true, ((ItemDefinition) class297).anInt2447, ((ItemDefinition) class297).anInt2441);
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.sendInterfaceOpcode) {
				...
				Class98_Sub25.method1274(-1);
				GameInterface class98_sub18 = ((GameInterface) Class116.aClass377_964.method3990((long) interfaceMask, i ^ ~0x1f4decc3));
				if (class98_sub18 != null)
					Class196.method2666(16398, false, class98_sub18, interfaceID != ((GameInterface) class98_sub18).interfaceID);
			...
			if (IncomingOpcode.aClass58_5793 == IncomingOpcode.currentIncommingOpcode) {
				...
				Class98_Sub25.method1274(-1);
				GameInterface class98_sub18 = ((GameInterface) Class116.aClass377_964.method3990((long) i_37_, -1));
				GameInterface class98_sub18_38_ = ((GameInterface) Class116.aClass377_964.method3990((long) i_36_, -1));
				if (class98_sub18_38_ != null)
					Class196.method2666(16398, false, class98_sub18_38_, (class98_sub18 == null || ((((GameInterface) class98_sub18).interfaceID) != (((GameInterface) class98_sub18_38_).interfaceID))));
				if (class98_sub18 != null) {
					class98_sub18.remove();
					Class116.aClass377_964.method3996(class98_sub18, (long) i_36_, i ^ ~0x1f4decc3);
				}
			...
			if (IncomingOpcode.aClass58_1743 == IncomingOpcode.currentIncommingOpcode) {
				while (((RSByteBuffer) IncomingMessages.packetStream).position < Class65.anInt496) {
					boolean bool = (IncomingMessages.packetStream.readUnsignedByte() == 1);
					String string = IncomingMessages.packetStream.readString();
							...
							if (string.equals(Class98_Sub25.aStringArray4026[i_44_])) {
								if (i_40_ != Class98_Sub26.anIntArray4030[i_44_]) {
									...
									for (Class246_Sub4_Sub1 class246_sub4_sub1 = ((Class246_Sub4_Sub1) Class119.aClass218_986.method2803((byte) 15)); class246_sub4_sub1 != null; class246_sub4_sub1 = ((Class246_Sub4_Sub1) Class119.aClass218_986.method2809(false))) {
										if (((Class246_Sub4_Sub1) class246_sub4_sub1).friendName.equals(string)) {
											if ((i_40_ ^ 0xffffffff) != -1 && ((((Class246_Sub4_Sub1) class246_sub4_sub1).aShort6167) ^ 0xffffffff) == -1) {
												bool_45_ = false;
												class246_sub4_sub1.method2965((byte) -72);
											} else if (i_40_ == 0 && ((((Class246_Sub4_Sub1) class246_sub4_sub1).aShort6167) ^ 0xffffffff) != -1) {
												bool_45_ = false;
					...
					if (string != null && (Class314.anInt2692 ^ 0xffffffff) > -201) {
				...
				while ((i_46_ ^ 0xffffffff) < -1) {
					...
					for (int i_47_ = 0; (i_46_ ^ 0xffffffff) < (i_47_ ^ 0xffffffff); i_47_++) {
						if (((Class98_Sub26.anIntArray4030[i_47_] != ((Class354) (Class98_Sub46_Sub10.aClass354_6011)).anInt3011) && ((Class98_Sub26.anIntArray4030[1 + i_47_] ^ 0xffffffff) == (((Class354) (Class98_Sub46_Sub10.aClass354_6011)).anInt3011 ^ 0xffffffff))) || (Class98_Sub26.anIntArray4030[i_47_] == 0 && (Class98_Sub26.anIntArray4030[1 + i_47_] != 0))) {
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_369) {
				((RSByteBuffer) IncomingMessages.packetStream).position += 28;
				if (IncomingMessages.packetStream.method1210(-114))
					Class76_Sub7.method762((((RSByteBuffer) (IncomingMessages.packetStream)).position) + -28, (IncomingMessages.packetStream), true);
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_3533) {
				...
				int i_65_ = (IncomingMessages.packetStream.readShort1((byte) 107) << -1408209406);
				Class98_Sub25.method1274(i + -525200580);
			...
			if (IncomingOpcode.aClass58_3398 == IncomingOpcode.currentIncommingOpcode) {
				...
				if (i_66_ >> -1165516802 != 0) {
					...
					int i_74_ = (((i_66_ & 0xfffdb84) >> -1260772882) - Class272.anInt2038);
					int i_75_ = -aa_Sub2.anInt3562 + (0x3fff & i_66_);
					if (i_74_ >= 0 && i_75_ >= 0 && GameWorld.size_x > i_74_ && ((GameWorld.size_y ^ 0xffffffff) < (i_75_ ^ 0xffffffff))) {
						int i_76_ = 512 * i_74_ + 256;
						int i_77_ = 256 + i_75_ * 512;
						int i_78_ = i_73_;
						if ((i_78_ ^ 0xffffffff) > -4 && Class1.method162(i_75_, (byte) -118, i_74_))
							i_78_++;
					...
					if ((i_66_ >> 1424175516 ^ 0xffffffff) != -1) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							int i_81_ = (bool ? ((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365 : ((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379);
							if (i_69_ != -1 && (i_81_ ^ 0xffffffff) != 0) {
								if ((i_69_ ^ 0xffffffff) != (i_81_ ^ 0xffffffff)) {
									...
									if ((((Class107) class107).anInt910 ^ 0xffffffff) != 0 && (((Class107) class107_82_).anInt910 != -1)) {
										Class97 class97 = (Class151_Sub7.aClass183_5001.method2623(((Class107) class107).anInt910, 16383));
										Class97 class97_83_ = (Class151_Sub7.aClass183_5001.method2623((((Class107) class107_82_).anInt910), 16383));
										if ((((Class97) class97).anInt829 ^ 0xffffffff) > (((Class97) class97_83_).anInt829 ^ 0xffffffff))
											bool_80_ = false;
									}
								} else {
									Class107 class107 = Class196.aClass304_1509.method3564(2, i_69_);
									if (((Class107) class107).aBoolean909 && (((Class107) class107).anInt910 ^ 0xffffffff) != 0) {
										Class97 class97 = (Class151_Sub7.aClass183_5001.method2623(((Class107) class107).anInt910, i + -525184196));
										int i_84_ = ((Class97) class97).anInt819;
							...
							if (bool_80_) {
								if (!bool) {
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6376 = 0;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6396 = 0;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6367 = 1;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6410 = i_72_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379 = i_69_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6382 = i_67_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6389 = i_71_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6391 = i_68_ + Class215.anInt1614;
									if (((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6391) ^ 0xffffffff) < (Class215.anInt1614 ^ 0xffffffff))
										((Mobile) class246_sub3_sub4_sub2_sub2).anInt6376 = -1;
									if (((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379) ^ 0xffffffff) == -65536)
										((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379 = -1;
									if ((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379) != -1 && (((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6391) ^ 0xffffffff) == (Class215.anInt1614 ^ 0xffffffff))) {
										int i_85_ = ((Class107) (Class196.aClass304_1509.method3564(i + -525200577, (((Mobile) class246_sub3_sub4_sub2_sub2).anInt6379)))).anInt910;
										if (i_85_ != -1) {
											Class97 class97 = (Class151_Sub7.aClass183_5001.method2623(i_85_, 16383));
											if (class97 != null && (((Class97) class97).anIntArray818) != null && !(((Mobile) class246_sub3_sub4_sub2_sub2).aBoolean6371))
												Class349.method3840((byte) -128, class246_sub3_sub4_sub2_sub2, 0, class97);
										}
									}
								} else {
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6427 = 0;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6426 = i_68_ + Class215.anInt1614;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6353 = i_72_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365 = i_69_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6360 = i_71_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6428 = 0;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6363 = i_67_;
									((Mobile) class246_sub3_sub4_sub2_sub2).anInt6421 = 1;
									if ((Class215.anInt1614 ^ 0xffffffff) > ((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6426) ^ 0xffffffff))
										((Mobile) class246_sub3_sub4_sub2_sub2).anInt6428 = -1;
									if (((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365) ^ 0xffffffff) == -65536)
										((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365 = -1;
									if ((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365) != -1 && ((((Mobile) class246_sub3_sub4_sub2_sub2).anInt6426) == Class215.anInt1614)) {
										int i_86_ = ((Class107) (Class196.aClass304_1509.method3564(2, (((Mobile) class246_sub3_sub4_sub2_sub2).anInt6365)))).anInt910;
										if (i_86_ != -1) {
					...
					Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_87_, -1));
					if (class98_sub39 != null) {
						...
						int i_89_ = (bool ? ((Mobile) class246_sub3_sub4_sub2_sub1).anInt6365 : ((Mobile) class246_sub3_sub4_sub2_sub1).anInt6379);
						if ((i_69_ ^ 0xffffffff) != 0 && (i_89_ ^ 0xffffffff) != 0) {
							if ((i_69_ ^ 0xffffffff) == (i_89_ ^ 0xffffffff)) {
								...
								if (((Class107) class107).aBoolean909 && (((Class107) class107).anInt910 ^ 0xffffffff) != 0) {
									Class97 class97 = (Class151_Sub7.aClass183_5001.method2623(((Class107) class107).anInt910, 16383));
									int i_90_ = ((Class97) class97).anInt819;
									if (i_90_ != 0 && i_90_ != 2) {
										if (i_90_ == 1)
											bool_88_ = true;
									} else
								...
								if ((((Class107) class107).anInt910 ^ 0xffffffff) != 0 && (((Class107) class107_91_).anInt910 ^ 0xffffffff) != 0) {
									Class97 class97 = (Class151_Sub7.aClass183_5001.method2623(((Class107) class107).anInt910, 16383));
									Class97 class97_92_ = (Class151_Sub7.aClass183_5001.method2623(((Class107) class107_91_).anInt910, 16383));
									if ((((Class97) class97_92_).anInt829 ^ 0xffffffff) < (((Class97) class97).anInt829 ^ 0xffffffff))
										bool_88_ = false;
								}
							}
						}
						if (bool_88_) {
							if (bool) {
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6426 = i_68_ + Class215.anInt1614;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6353 = i_72_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6427 = 0;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6360 = i_71_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6365 = i_69_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6428 = 0;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6421 = 1;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6363 = i_67_;
								if (Class215.anInt1614 < ((Mobile) class246_sub3_sub4_sub2_sub1).anInt6426)
									((Mobile) class246_sub3_sub4_sub2_sub1).anInt6428 = -1;
								if ((((Mobile) class246_sub3_sub4_sub2_sub1).anInt6365 != -1) && (Class215.anInt1614 == (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6426))) {
									int i_93_ = ((Class107) (Class196.aClass304_1509.method3564(2, (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6365)))).anInt910;
									if (i_93_ != -1) {
										Class97 class97 = Class151_Sub7.aClass183_5001.method2623(i_93_, 16383);
										if (class97 != null && (((Class97) class97).anIntArray818) != null && !(((Mobile) class246_sub3_sub4_sub2_sub1).aBoolean6371))
											Class349.method3840((byte) -128, class246_sub3_sub4_sub2_sub1, 0, class97);
									}
								}
							} else {
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6367 = 1;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6389 = i_71_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6376 = 0;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6396 = 0;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6379 = i_69_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6410 = i_72_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6391 = Class215.anInt1614 - -i_68_;
								((Mobile) class246_sub3_sub4_sub2_sub1).anInt6382 = i_67_;
								if (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6391 > Class215.anInt1614)
									((Mobile) class246_sub3_sub4_sub2_sub1).anInt6376 = -1;
								if ((((Mobile) class246_sub3_sub4_sub2_sub1).anInt6379 != -1) && (((((Mobile) class246_sub3_sub4_sub2_sub1).anInt6391) ^ 0xffffffff) == (Class215.anInt1614 ^ 0xffffffff))) {
									int i_94_ = ((Class107) (Class196.aClass304_1509.method3564(2, (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6379)))).anInt910;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_5615) {
				String string = IncomingMessages.packetStream.readString();
				boolean bool = ((IncomingMessages.packetStream.readUnsignedByte() ^ 0xffffffff) == -2);
				String string_100_;
				if (bool)
				...
				if (!bool_103_) {
					...
					((Class147) class147).aString1191 = string;
					((Class147) class147).aString1186 = string_100_;
					((Class147) class147).aString1185 = Class353.method3867(-1, (((Class147) class147).aString1186));
					((Class147) class147).aByte1187 = i_102_;
					((Class147) class147).anInt1188 = i_101_;
					((Class147) class147).aString1190 = string_104_;
					int i_105_;
					for (i_105_ = -1 + Class32.anInt308; (i_105_ ^ 0xffffffff) <= -1; i_105_--) {
						int i_106_ = (((Class147) Class374.aClass147Array3157[i_105_]).aString1185.compareTo(((Class147) class147).aString1185));
						if ((i_106_ ^ 0xffffffff) == -1) {
							((Class147) Class374.aClass147Array3157[i_105_]).anInt1188 = i_101_;
							((Class147) Class374.aClass147Array3157[i_105_]).aByte1187 = i_102_;
							((Class147) Class374.aClass147Array3157[i_105_]).aString1190 = string_104_;
							if (string_100_.equals(((Player) Player.selfPlayer).displayName))
					...
					for (i_109_ = 0; ((i_109_ ^ 0xffffffff) > (Class32.anInt308 ^ 0xffffffff)); i_109_++) {
						if (((Class147) Class374.aClass147Array3157[i_109_]).aString1186.equals(string_100_) && ((Class147) (Class374.aClass147Array3157[i_109_])).anInt1188 == i_101_)
							break;
					}
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_5482) {
				...
				boolean sendingQuickChat = (0x8000 & chatMask ^ 0xffffffff) != -1;
				if (((Player) class246_sub3_sub4_sub2_sub2).displayName != null && ((Player) class246_sub3_sub4_sub2_sub2).appearance != null) {
					boolean bool_122_ = false;
					if ((playerRank ^ 0xffffffff) >= -2) {
						if (!sendingQuickChat && ((Class109.aBoolean933 && !Class98_Sub10_Sub35.aBoolean5732) || ModelDefinitions.aBoolean1401))
							bool_122_ = true;
						else if (Class14.method225(((Player) class246_sub3_sub4_sub2_sub2).displayName, (byte) 117))
							bool_122_ = true;
					}
					if (!bool_122_ && Class22.anInt216 == 0) {
						...
						if (!sendingQuickChat)
							...
							i_123_ = ((Class300) class300).quickChatFileID;
							string = (((Class300) class300).aClass98_Sub46_Sub11_2498.getQuickChatMessage(15281, (IncomingMessages.packetStream)));
						}
						((Mobile) class246_sub3_sub4_sub2_sub2).aString6374 = string.trim();
						((Mobile) class246_sub3_sub4_sub2_sub2).anInt6398 = chatMask >> -1332042328;
						((Mobile) class246_sub3_sub4_sub2_sub2).anInt6402 = 0xff & chatMask;
						((Mobile) class246_sub3_sub4_sub2_sub2).anInt6384 = 150;
						int i_124_;
						if ((playerRank ^ 0xffffffff) == -2 || (playerRank ^ 0xffffffff) == -3)
							i_124_ = sendingQuickChat ? 17 : 1;
						else
							i_124_ = !sendingQuickChat ? 2 : 17;
						if ((playerRank ^ 0xffffffff) == -3)
							Class137.method2276(((Player) class246_sub3_sub4_sub2_sub2).name, i_124_, "<img=1>" + class246_sub3_sub4_sub2_sub2.method3063(0, true), string, i_123_, null, (byte) -107, 0, "<img=1>" + class246_sub3_sub4_sub2_sub2.method3059(-1, false));
						else if (playerRank == 1)
							Class137.method2276(((Player) class246_sub3_sub4_sub2_sub2).name, i_124_, "<img=0>" + class246_sub3_sub4_sub2_sub2.method3063(0, true), string, i_123_, null, (byte) -84, 0, "<img=0>" + class246_sub3_sub4_sub2_sub2.method3059(-1, false));
						else
							Class137.method2276(((Player) class246_sub3_sub4_sub2_sub2).name, i_124_, class246_sub3_sub4_sub2_sub2.method3063(i ^ 0x1f4decc3, true), string, i_123_, null, (byte) -81, 0, class246_sub3_sub4_sub2_sub2.method3059(-1, false));
					}
				}
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			...
			if (IncomingOpcode.aClass58_2844 == IncomingOpcode.currentIncommingOpcode) {//Quick chat? maybe
				...
				Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_133_, -1));
				if (class98_sub39 != null)
					Class98_Sub43.method1483(i_134_, (((Class98_Sub39) class98_sub39).aClass246_Sub3_Sub4_Sub2_Sub1_4187), i ^ 0x1f4decc2, is);
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			if (IncomingOpcode.aClass58_5086 == IncomingOpcode.currentIncommingOpcode) { //grand exchange
				...
				if ((IncomingMessages.packetStream.readUnsignedByte() ^ 0xffffffff) == -1)
					Class98_Sub10_Sub24.aClass101Array5666[i_135_] = new Class101();
				else {
					((RSByteBuffer) IncomingMessages.packetStream).position--;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_6457) {
				if (GameInterface.aFrame3950 != null)
					Class98_Sub16.method1150(((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub27_4052.method666((byte) 120), -1, 3, -1, false);
				...
				Class315.method3647(true, (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub8_4042.method583((byte) 127) ^ 0xffffffff) == -2, string, true, Class98_Sub43_Sub2.aClass88_5907);
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			if (IncomingOpcode.aClass58_5996 == IncomingOpcode.currentIncommingOpcode) {
				...
				long l = (long) IncomingMessages.packetStream.readShort();
				long l_148_ = (long) IncomingMessages.packetStream.readMedium(i ^ ~0x1f4decbf);
			...
			if (IncomingOpcode.aClass58_3134 == IncomingOpcode.currentIncommingOpcode) { //hinticon id 0
				...
				((Class36) class36).anInt346 = i_171_;
				((Class36) class36).anInt341 = IncomingMessages.packetStream.readUnsignedByte();
				if (((Class36) class36).anInt341 >= 0 && (((Class36) class36).anInt341 < Class306.aClass332Array2557.length)) {
					if ((((Class36) class36).anInt346 ^ 0xffffffff) != -2 && ((Class36) class36).anInt346 != 10) {
						if ((((Class36) class36).anInt346 ^ 0xffffffff) <= -3 && ((Class36) class36).anInt346 <= 6) {
							if (((Class36) class36).anInt346 == 2) {
								((Class36) class36).anInt338 = 256;
								((Class36) class36).anInt347 = 256;
							}
							if ((((Class36) class36).anInt346 ^ 0xffffffff) == -4) {
								((Class36) class36).anInt338 = 0;
								((Class36) class36).anInt347 = 256;
							}
							if ((((Class36) class36).anInt346 ^ 0xffffffff) == -5) {
								((Class36) class36).anInt338 = 512;
								((Class36) class36).anInt347 = 256;
							}
							if ((((Class36) class36).anInt346 ^ 0xffffffff) == -6) {
								((Class36) class36).anInt338 = 256;
								((Class36) class36).anInt347 = 0;
							}
							if ((((Class36) class36).anInt346 ^ 0xffffffff) == -7) {
								((Class36) class36).anInt347 = 512;
								((Class36) class36).anInt338 = 256;
							}
							((Class36) class36).anInt346 = 2;
							((Class36) class36).anInt342 = IncomingMessages.packetStream.readUnsignedByte();
							((Class36) class36).anInt338 += (IncomingMessages.packetStream.readShort() - Class272.anInt2038) << -1727288087;
							((Class36) class36).anInt347 += (IncomingMessages.packetStream.readShort() + -aa_Sub2.anInt3562) << 357961001;
							((Class36) class36).anInt343 = IncomingMessages.packetStream.readUnsignedByte() << -1401715486;
							((Class36) class36).anInt340 = IncomingMessages.packetStream.readShort();
						}
					} else {
						((Class36) class36).anInt345 = IncomingMessages.packetStream.readShort();
						((RSByteBuffer) IncomingMessages.packetStream).position += 6;
					}
					((Class36) class36).anInt339 = IncomingMessages.packetStream.readShort();
					if (((Class36) class36).anInt339 == 65535)
						((Class36) class36).anInt339 = -1;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_2507) {
				...
				int i_179_ = (IncomingMessages.packetStream.readShort1((byte) 57) << 12040226);
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_3554) {
				...
				if (Class159.gameInterfaces[i_193_] != null) {
					for (int i_196_ = i_194_; i_196_ < i_195_; i_196_++) {
						...
						if ((Class159.gameInterfaces[i_193_].length ^ 0xffffffff) < (i_196_ ^ 0xffffffff) && (Class159.gameInterfaces[i_193_][i_196_]) != null)
							((GameInterfaceData) (Class159.gameInterfaces[i_193_][i_196_])).anInt2259 = i_197_;
					}
				}
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_161) { //Changed their streams?
				...
				Class335.anInt2819 = IncomingMessages.packetStream.method1187((byte) -112) << -1201567837;
				Class53.anInt430 = IncomingMessages.packetStream.method1184(i + -2023493939) << -1233392637;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_3993) { //??
				Class53.anInt430 = IncomingMessages.packetStream.method1184(-1498293360) << -182592509;
				Class206.anInt1568 = IncomingMessages.packetStream.readByteC((byte) -106);
				Class335.anInt2819 = IncomingMessages.packetStream.method1184(i + -2023493939) << 1849187075;
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			if (IncomingOpcode.aClass58_4029 == IncomingOpcode.currentIncommingOpcode) {
				...
				while ((((RSByteBuffer) IncomingMessages.packetStream).position ^ 0xffffffff) > (Class65.anInt496 ^ 0xffffffff)) {
			...
			if (IncomingOpcode.ignoreOpcode == IncomingOpcode.currentIncommingOpcode) {
				...
				boolean bool = (i_221_ & 0x1 ^ 0xffffffff) == -2;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_4291) {
				Class218.aString1636 = ((Class65.anInt496 ^ 0xffffffff) < -3 ? IncomingMessages.packetStream.readString() : TextResources.WALK_HERE.get_text(Class374.anInt3159));
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.closeInterfaceOpcode) {
				...
				Class98_Sub25.method1274(-1);
				GameInterface class98_sub18 = ((GameInterface) Class116.aClass377_964.method3990((long) interfaceMask, -1));
				if (class98_sub18 != null)
			...
			if (IncomingOpcode.aClass58_2581 == IncomingOpcode.currentIncommingOpcode) {
				...
				Class98_Sub25.method1274(-1);
				Class98_Sub19.method1164(i_245_ << 725805072 | i_243_, i_246_, 7, 4, i_244_);
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			...
			if (IncomingOpcode.aClass58_2661 == IncomingOpcode.currentIncommingOpcode) {
				for (int i_248_ = 0; i_248_ < (Class151_Sub9.playerArray).length; i_248_++) {
					if ((Class151_Sub9.playerArray[i_248_]) != null) {
						((Mobile) (Class151_Sub9.playerArray[i_248_])).anIntArray6373 = null;
						((Mobile) (Class151_Sub9.playerArray[i_248_])).anInt6413 = -1;
					}
				}
				for (int i_249_ = 0; ((i_249_ ^ 0xffffffff) > (Class98_Sub10_Sub20.anInt5640 ^ 0xffffffff)); i_249_++) {
					((Mobile) (((Class98_Sub39) Class163.aClass98_Sub39Array3516[i_249_]).aClass246_Sub3_Sub4_Sub2_Sub1_4187)).anIntArray6373 = null;
					((Mobile) (((Class98_Sub39) Class163.aClass98_Sub39Array3516[i_249_]).aClass246_Sub3_Sub4_Sub2_Sub1_4187)).anInt6413 = -1;
				}
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
			}
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_112) {
				...
				long l_252_ = (long) IncomingMessages.packetStream.readShort();
				long l_253_ = (long) IncomingMessages.packetStream.readMedium(-124);
				int i_254_ = IncomingMessages.packetStream.readUnsignedByte();
				long l_255_ = (l_252_ << -172131936) + l_253_;
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_3677) {
				...
				if ((i_261_ ^ 0xffffffff) == -65536)
					i_261_ = -1;
				int i_262_ = IncomingMessages.packetStream.readIntReverse(true);
				Class98_Sub25.method1274(-1);
				for (int i_263_ = i_261_; (i_260_ ^ 0xffffffff) <= (i_263_ ^ 0xffffffff); i_263_++) {
					...
					if (class98_sub49 != null) {
						class98_sub49_264_ = new IComponentSettings(i_259_, ((IComponentSettings) class98_sub49).anInt4285);
						class98_sub49.remove();
					} else if ((i_263_ ^ 0xffffffff) == 0)
						class98_sub49_264_ = new IComponentSettings(i_259_, (((IComponentSettings) (((GameInterfaceData) Class159.method2509(i_262_, -9820)).aClass98_Sub49_2348)).anInt4285));
					else
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_344) {//shawn
				...
				for (int i_269_ = i_266_; (i_269_ ^ 0xffffffff) >= (i_268_ ^ 0xffffffff); i_269_++) {
					...
					if (class98_sub49 != null) {
						class98_sub49_270_ = new IComponentSettings(((IComponentSettings) class98_sub49).optionMask, i_267_);
						class98_sub49.remove();
					} else if ((i_269_ ^ 0xffffffff) == 0)
						class98_sub49_270_ = (new IComponentSettings(((IComponentSettings) (((GameInterfaceData) Class159.method2509(i_265_, i ^ ~0x1f4dca98)).aClass98_Sub49_2348)).optionMask, i_267_));
					else
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_6516) {
				...
				for (int i_276_ = 0; (i_276_ ^ 0xffffffff) > (Class32.anInt308 ^ 0xffffffff); i_276_++) {
					...
					((Class147) class147s[i_276_]).aString1191 = IncomingMessages.packetStream.readString();
					bool = IncomingMessages.packetStream.readUnsignedByte() == 1;
					if (bool)
						((Class147) class147s[i_276_]).aString1186 = IncomingMessages.packetStream.readString();
					else
						((Class147) class147s[i_276_]).aString1186 = ((Class147) class147s[i_276_]).aString1191;
					((Class147) class147s[i_276_]).aString1185 = Class353.method3867(i ^ ~0x1f4decc3, (((Class147) class147s[i_276_]).aString1186));
					((Class147) class147s[i_276_]).anInt1188 = IncomingMessages.packetStream.readShort();
					((Class147) class147s[i_276_]).aByte1187 = IncomingMessages.packetStream.readSignedByte();
					((Class147) class147s[i_276_]).aString1190 = IncomingMessages.packetStream.readString();
					if (((Class147) class147s[i_276_]).aString1186.equals(((Player) Player.selfPlayer).displayName))
						Class111.aByte947 = ((Class147) class147s[i_276_]).aByte1187;
				}
				...
				while (i_278_ > 0) {
					...
					for (int i_279_ = 0; i_278_ > i_279_; i_279_++) {
						if (((((Class147) class147s[i_279_]).aString1185.compareTo(((Class147) class147s[1 + i_279_]).aString1185)) ^ 0xffffffff) < -1) {
			...
			if (IncomingOpcode.aClass58_215 == IncomingOpcode.currentIncommingOpcode) {
				...
				long l_281_ = (long) IncomingMessages.packetStream.readShort();
				long l_282_ = (long) IncomingMessages.packetStream.readMedium(i ^ ~0x1f4decbe);
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.aClass58_3844) {
				...
				long l = (long) IncomingMessages.packetStream.readShort();
				long l_292_ = (long) IncomingMessages.packetStream.readMedium(-123);
			...
			if (IncomingOpcode.currentIncommingOpcode == IncomingOpcode.cs2Opcode) {
				...
				((ClientScript2Event) class98_sub21).cs2_params = objects;
			...
			if (IncomingOpcode.aClass58_3642 == IncomingOpcode.currentIncommingOpcode) { //rawr
				Class206.anInt1568 = IncomingMessages.packetStream.readUnsignedByte();
				Class335.anInt2819 = IncomingMessages.packetStream.method1234(128) << 212170051;
				Class53.anInt430 = IncomingMessages.packetStream.readSignedByte() << 773724419;
				for (Class98_Sub45 class98_sub45 = ((Class98_Sub45) AbstractModel.aClass377_1180.start_iteration(105)); class98_sub45 != null; class98_sub45 = (Class98_Sub45) AbstractModel.aClass377_1180.iterate_next(-1)) {
					int i_306_ = (int) (0x3L & (((Node) class98_sub45).uid >> 1200025692));
					int i_307_ = (int) (0x3fffL & ((Node) class98_sub45).uid);
					int i_308_ = i_307_ + -Class272.anInt2038;
					int i_309_ = (int) (0x3fffL & (((Node) class98_sub45).uid >> 1428694926));
					int i_310_ = -aa_Sub2.anInt3562 + i_309_;
					if (Class206.anInt1568 == i_306_ && i_308_ >= Class53.anInt430 && ((Class53.anInt430 - -8 ^ 0xffffffff) < (i_308_ ^ 0xffffffff)) && Class335.anInt2819 <= i_310_ && (i_310_ ^ 0xffffffff) > (Class335.anInt2819 - -8 ^ 0xffffffff)) {
						class98_sub45.remove();
						if ((i_308_ ^ 0xffffffff) <= -1 && (i_310_ ^ 0xffffffff) <= -1 && i_308_ < GameWorld.size_x && ((GameWorld.size_y ^ 0xffffffff) < (i_310_ ^ 0xffffffff)))
				...
				for (Class98_Sub33 class98_sub33 = ((Class98_Sub33) Class191.aClass148_1478.method2418(32)); class98_sub33 != null; class98_sub33 = (Class98_Sub33) Class191.aClass148_1478.method2417(96)) {
					if ((((Class98_Sub33) class98_sub33).anInt4112 ^ 0xffffffff) <= (Class53.anInt430 ^ 0xffffffff) && (((Class98_Sub33) class98_sub33).anInt4112 < 8 + Class53.anInt430) && (((Class98_Sub33) class98_sub33).anInt4113 ^ 0xffffffff) <= (Class335.anInt2819 ^ 0xffffffff) && ((8 + Class335.anInt2819 ^ 0xffffffff) < (((Class98_Sub33) class98_sub33).anInt4113 ^ 0xffffffff)) && (Class206.anInt1568 == ((Class98_Sub33) class98_sub33).anInt4116))
						((Class98_Sub33) class98_sub33).aBoolean4124 = true;
				}
				for (Class98_Sub33 class98_sub33 = ((Class98_Sub33) OutgoingPacket.aClass148_3866.method2418(32)); class98_sub33 != null; class98_sub33 = (Class98_Sub33) OutgoingPacket.aClass148_3866.method2417(i + -525200461)) {
					if (((Class53.anInt430 ^ 0xffffffff) >= (((Class98_Sub33) class98_sub33).anInt4112 ^ 0xffffffff)) && (((Class98_Sub33) class98_sub33).anInt4112 < 8 + Class53.anInt430) && (Class335.anInt2819 <= ((Class98_Sub33) class98_sub33).anInt4113) && ((8 + Class335.anInt2819 ^ 0xffffffff) < (((Class98_Sub33) class98_sub33).anInt4113 ^ 0xffffffff)) && ((Class206.anInt1568 ^ 0xffffffff) == (((Class98_Sub33) class98_sub33).anInt4116 ^ 0xffffffff)))
						((Class98_Sub33) class98_sub33).aBoolean4124 = true;
				}
				IncomingOpcode.currentIncommingOpcode = null;
				return true;
	...
	public final void method58(byte i) {
		try {
			super.method58(i);
			Class93_Sub1 class93_sub1 = (Class93_Sub1) ((Class373) this).aClass93_3478;
			((PacketParser) this).aClass332_5462 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5483), ((Class373) this).aClass207_3473, (byte) -89);
			aClass332_5467 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5480), ((Class373) this).aClass207_3473, (byte) -89);
			aClass332_5463 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5485), ((Class373) this).aClass207_3473, (byte) -89);
			aClass332_5465 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5481), ((Class373) this).aClass207_3473, (byte) -89);
			aClass332_5461 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5478), ((Class373) this).aClass207_3473, (byte) -89);
			aClass332_5464 = Class237_Sub1.method2915((((Class93_Sub1) class93_sub1).anInt5484), ((Class373) this).aClass207_3473, (byte) -89);
		} catch (RuntimeException runtimeexception) {
	...
	public final boolean method59(int i) {
		try {
			if (!super.method59(i))
				return false;
			Class93_Sub1 class93_sub1 = (Class93_Sub1) ((Class373) this).aClass93_3478;
			if (!((Class373) this).aClass207_3473.method2742(-22, ((Class93_Sub1) class93_sub1).anInt5483))
				return false;
			if (!((Class373) this).aClass207_3473.method2742(-81, ((Class93_Sub1) class93_sub1).anInt5480))
				return false;
			if (!((Class373) this).aClass207_3473.method2742(-87, ((Class93_Sub1) class93_sub1).anInt5485))
				return false;
			if (!((Class373) this).aClass207_3473.method2742(-58, ((Class93_Sub1) class93_sub1).anInt5481))
				return false;
			if (!((Class373) this).aClass207_3473.method2742(-61, ((Class93_Sub1) class93_sub1).anInt5478))
				return false;
			if (!((Class373) this).aClass207_3473.method2742(-61, ((Class93_Sub1) class93_sub1).anInt5484))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			if (i_312_ == -36) {
				if (bool) {
					int[] is = new int[4];
					Class265.aHa1974.K(is);
					Class265.aHa1974.KA(i_311_, i, i_311_ + (((Class93) (((Class373) this).aClass93_3478)).anInt3514), i - -(((Class93) ((Class373) this).aClass93_3478).anInt3504));
					...
					aClass332_5463.method3735(i_311_, (-i_314_ + (((Class93) (((Class373) this).aClass93_3478)).anInt3504)) / 2 + i);
					aClass332_5465.method3735(-i_315_ + (i_311_ - -((Class93) (((Class373) this).aClass93_3478)).anInt3514), (((Class93) ((Class373) this).aClass93_3478).anInt3504 + -i_316_) / 2 + i);
					Class265.aHa1974.KA(i_311_, i, (((Class93) (((Class373) this).aClass93_3478)).anInt3514 + i_311_), aClass332_5461.method3749() + i);
					aClass332_5461.method3738(i_311_ + i_313_, i, (-i_315_ + -i_313_ + (((Class93) (((Class373) this).aClass93_3478)).anInt3514)), (((Class93) (((Class373) this).aClass93_3478)).anInt3504));
					int i_317_ = aClass332_5464.method3749();
					Class265.aHa1974.KA(i_311_, i + (((Class93) ((Class373) this).aClass93_3478).anInt3504) - i_317_, (((Class93) ((Class373) this).aClass93_3478).anInt3514 + i_311_), i - -(((Class93) ((Class373) this).aClass93_3478).anInt3504));
					aClass332_5464.method3738(i_311_ + i_313_, (-i_317_ + (i - -(((Class93) ((Class373) this).aClass93_3478).anInt3504))), -i_315_ + (((Class93) ((Class373) this).aClass93_3478).anInt3514) + -i_313_, (((Class93) ((Class373) this).aClass93_3478).anInt3504));
