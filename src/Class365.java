...
final class Class365 {
	private RuneScapeCache aClass207_3107;
	...
	static final int method3937(int i, byte[] is, int i_0_, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("wba.C(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_0_ + ',' + bool + ')'));
		}
	}
	...
	static final GameInterfaceData method3939(int i, GameInterfaceData class293) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("wba.H(" + i + ',' + (class293 != null ? "{...}" : "null") + ')'));
		}
	}

	final ParamType list(byte i, int i_5_) {
		try {
			if (i != 31)
				return null;
			ParamType class149;
			...
			synchronized (aClass207_3107) {
				is = aClass207_3107.readArchive(i_5_, 11);
			}
			class149 = new ParamType();
			if (is != null)
			...
			throw Class64_Sub27.method667(runtimeexception, "wba.F(" + i + ',' + i_5_ + ')');
		}
	}

	static final void method3941(RuneScapeCache class207, Class88 class88, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("wba.G(" + (class207 != null ? "{...}" : "null") + ',' + (class88 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	final void method3943(int i, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "wba.D(" + i + ',' + bool + ')');
		}
	}
	...
	Class365(Class279 class279, int i, RuneScapeCache class207) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("wba.<init>(" + (class279 != null ? "{...}" : "null") + ',' + i + ',' + (class207 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
