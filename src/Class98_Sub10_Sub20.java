...
final class Class98_Sub10_Sub20 extends Class98_Sub10 {
			...
			try {
				...
				if (i_1_ == 0) {
					if (bool)
						...
						((Class376) class376).anInt3176 = (((aa_Sub2.anInt3562 + (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0])) >> 147138566) + ((((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]) + Class272.anInt2038 >> -1381338778 << 1313142894) + (((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level << 119645116));
						if (((Player) class246_sub3_sub4_sub2_sub2).anInt6512 != -1)
							((Class376) class376).anInt3172 = ((Player) class246_sub3_sub4_sub2_sub2).anInt6512;
						else
							((Class376) class376).anInt3172 = ((Mobile) class246_sub3_sub4_sub2_sub2).aClass325_6399.method3698((byte) 116);
						((Class376) class376).aBoolean3175 = ((Player) class246_sub3_sub4_sub2_sub2).aBoolean6534;
						((Class376) class376).anInt3177 = ((Mobile) class246_sub3_sub4_sub2_sub2).anInt6364;
						if ((((Player) class246_sub3_sub4_sub2_sub2).ambientSoundHearDistance ^ 0xffffffff) < -1)
					...
					int i_3_ = (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]);
					int i_4_ = (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]);
					if (i_2_ == 0) {
						i_3_--;
						i_4_--;
					...
					if (!bool)
						...
						((Player) class246_sub3_sub4_sub2_sub2).anInt6541 = i_4_;
						((Player) class246_sub3_sub4_sub2_sub2).aBoolean6532 = true;
						((Player) class246_sub3_sub4_sub2_sub2).anInt6521 = i_3_;
					}
				} else if (i_1_ == 2) {
					int dir = class98_sub22_sub1.readBits((byte) -85, 4);
					int dx = (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]);
					int dy = (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]);
					if (dir != 0) {
						if (dir == 1) {
							dx--;
							dy -= 2;
					...
					if (!bool)
						...
						((Player) class246_sub3_sub4_sub2_sub2).anInt6541 = dy;
						((Player) class246_sub3_sub4_sub2_sub2).aBoolean6532 = true;
						((Player) class246_sub3_sub4_sub2_sub2).anInt6521 = dx;
					}
				} else {
					int i_8_ = class98_sub22_sub1.readBits((byte) -53, 1);
					if (i_8_ == 0) {
						int i_9_ = class98_sub22_sub1.readBits((byte) -102, 12);
						int i_10_ = i_9_ >> -1711478582;
						...
						if (i_12_ > 15)
							i_12_ -= 32;
						int i_13_ = i_11_ + (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]);
						int i_14_ = (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0] - -i_12_);
						if (bool) {
							((Player) class246_sub3_sub4_sub2_sub2).anInt6521 = i_13_;
							((Player) class246_sub3_sub4_sub2_sub2).aBoolean6532 = true;
							((Player) class246_sub3_sub4_sub2_sub2).anInt6541 = i_14_;
						} else
							class246_sub3_sub4_sub2_sub2.method3057(i_13_, i_14_, Class98_Sub10_Sub21.aByteArray5642[i], -1);
						((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level = ((AnimableEntity) class246_sub3_sub4_sub2_sub2).aByte5081 = (byte) (0x3 & i_10_ + (((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level));
						if (Class1.method162(i_14_, (byte) -102, i_13_))
							((AnimableEntity) class246_sub3_sub4_sub2_sub2).aByte5081++;
						if (za_Sub2.anInt6080 == i) {
							if ((((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level) != Class43.anInt377)
								Class358.aBoolean3033 = true;
							Class43.anInt377 = ((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level;
						}
					} else {
						...
						if (bool) {
							((Player) class246_sub3_sub4_sub2_sub2).anInt6541 = i_20_;
							((Player) class246_sub3_sub4_sub2_sub2).anInt6521 = i_19_;
							((Player) class246_sub3_sub4_sub2_sub2).aBoolean6532 = true;
						} else
							class246_sub3_sub4_sub2_sub2.method3057(i_19_, i_20_, Class98_Sub10_Sub21.aByteArray5642[i], -1);
						((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level = (byte) i_16_;
		...
		do {
			try {
				...
				do {
					...
					aBoolean5636 = (class98_sub22.readUnsignedByte() ^ 0xffffffff) == -2;
				} while (false);
				if (i_21_ <= -92)
					break;
	...
	final int[][] method997(int i, int i_25_) {
		try {
			if (i > -76)
				return null;
			int[][] is = ((Class98_Sub10) this).aClass223_3859.method2828(i_25_, 0);
			if (((Class223) ((Class98_Sub10) this).aClass223_3859).aBoolean1683) {
				...
				for (int i_32_ = 0; i_32_ < Class25.anInt268; i_32_++) {
					...
					int i_39_ = (int) (Math.sqrt((double) ((float) (4096 + (i_38_ + i_37_)) / 4096.0F)) * 4096.0);
					int i_40_;
					int i_41_;
					int i_42_;
					if (i_39_ != 0) {
