...
final class Class233 {
	...
	static final void method2883(byte i) {
		try {
			if (i != 111)
				method2884(96);
	...
	static final void method2884(int i) {
		try {
			Class246_Sub3_Sub4_Sub5.method3084(true);
			Class217.method2799(2, 22050, (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub1_4043.method558((byte) 127) ^ 0xffffffff) == -2, (byte) 124);
