		...
		try {
			if (i >= 6) {
				...
				if (class24.anInt226 != 0)
					var_ha.method1760(10 + i_4_, (-i_9_ + i_5_ - -(i_6_ * class326.method3705()) + 1), i_9_, class24.anInt226, (byte) -66, i_8_);
				if (class24.anInt239 != 0)
					var_ha.method1781(true, (-i_9_ + i_6_ * class326.method3705() + i_5_ + 1), 10 + i_4_, class24.anInt239, i_8_, i_9_);
