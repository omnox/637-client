...
final class Class230 {
	...
	static final void method2869(int i) {
		try {
			int i_0_ = -17 / ((-9 - i) / 48);
		...
		try {
			...
			do {
				if ((i_1_ ^ 0xffffffff) != -3) {
					...
					Class98_Sub10_Sub39.method1121((byte) 17, Class265.aHa1974, Class98_Sub25.anInt4024, Class39_Sub1.anInt3593, 100, 100);
					break;
				}
				Class362.method3926(-120, 2, Class39_Sub1.anInt3593, Class341.anInt2856, Class265.aHa1974, Class356.anInt3018, 2, Class98_Sub25.anInt4024);
			} while (false);
			if (i >= -30)
				method2869(-126);
	...
	public static void method2872(byte i) {
		try {
			aClass171_1727 = null;
			anIntArray1728 = null;
