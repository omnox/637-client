...
final class Class136 {
	...
	private static final void method2265(int i, int i_0_) {
		if (i_0_ > i + 4) {
			int i_1_ = i;
			int i_2_ = anIntArray1073[i_1_];
			int i_3_ = anIntArray1073[i_1_ + 1];
			int i_4_ = anIntArray1073[i_1_ + 2];
			int i_5_ = anIntArray1073[i_1_ + 3];
			for (int i_6_ = i + 4; i_6_ < i_0_; i_6_ += 4) {
				int i_7_ = anIntArray1073[i_6_ + 1];
				if (i_7_ < i_3_) {
	...
	private static final boolean method2266(int i) {
		int i_8_ = anInt1077;
		int i_9_ = anInt1072;
		int i_10_ = anInt1076;
		int i_11_;
		for (/**/; i_9_ >= i_8_; i_9_ = i_11_) {
			...
			for (/**/; i_8_ < anInt1070; i_8_ += 4) {
				int i_12_ = anIntArray1073[i_8_ + 1];
				if (i_10_ < i_12_)
					break;
				int i_13_ = anIntArray1073[i_8_];
				int i_14_ = anIntArray1073[i_8_ + 2];
				int i_15_ = anIntArray1073[i_8_ + 3];
			...
			for (int i_18_ = i_11_; i_18_ < i_8_; i_18_ += 4) {
				int i_19_ = anIntArray1073[i_18_ + 3];
				if (i_10_ >= i_19_) {
	...
	private static final void method2267(int[] is, int i, int i_20_) {
		int i_21_ = anInt1070 + (i_20_ << 1);
	...
	private static final void method2268(ha var_ha, int[] is, int i, int i_28_, int i_29_, int[] is_30_, int[] is_31_) {
		int[] is_32_ = new int[4];
		var_ha.K(is_32_);
	...
	static final void method2270(ha var_ha, int[] is, int i) {
	...
	static final void method2272(ha var_ha, int[] is, int i, int[] is_37_, int[] is_38_) {
		method2268(var_ha, is, 0, is.length, i, is_37_, is_38_);
	}

	private static final void method2273(int i) {
		if (anInt1070 < 0) {
			...
			for (i_41_ = 0; i_41_ < anInt1070; i_41_ += 4) {
				int i_42_ = anIntArray1073[i_41_ + 1];
				if (i_39_ < i_42_)
					break;
				int i_43_ = anIntArray1073[i_41_];
				int i_44_ = anIntArray1073[i_41_ + 2];
				int i_45_ = anIntArray1073[i_41_ + 3];
