...
final class Class64_Sub20 extends Class64 {
	...
	static RuneScapeCache aClass207_3695;
	static int anInt3696;
	static RuneScapeCache aClass207_3697;
	static int anInt3698 = 1403;
	static ModelDefinitions[] aClass178Array3699 = new ModelDefinitions[4];
	...
	final int method556(int i, int i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "raa.F(" + i + ',' + i_0_ + ')');
		}
	}
	...
	Class64_Sub20(Class98_Sub27 class98_sub27) {
		super(class98_sub27);
	}

	static final Class206 method636(byte i) {
		try {
			try {
				if (i != 5)
					method637(20);
	...
	Class64_Sub20(int i, Class98_Sub27 class98_sub27) {
