...
final class Class209 {
	...
	final void method2772(RSByteBuffer class98_sub22) {
		anInt1582 = class98_sub22.readUnsignedByte();
		anIntArray1586 = new int[anInt1582];
		anIntArray1585 = new int[anInt1582];
		for (int i = 0; i < anInt1582; i++) {
			anIntArray1586[i] = class98_sub22.readShort();
			anIntArray1585[i] = class98_sub22.readShort();
		}
	}
