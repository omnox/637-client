...
final class Class45 {
	...
	static int anInt384;
	static RuneScapeCache aClass207_385;
	...
	static final void method430(boolean bool, int i, int i_0_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("dd.C(" + bool + ',' + i + ',' + i_0_ + ')'));
			}
			break;
		} while (false);
	}
	...
	static final void method431(long l, boolean bool, ha var_ha) {
		do {
			try {
				...
				System.out.println("Emitters: " + Class246_Sub3_Sub1_Sub2.anInt6252 + " Particles: " + Class113.anInt952 + ". Time taken: " + (-l_1_ + Class343.method3819(-47)) + "ms");
			} catch (RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("dd.B(" + l + ',' + bool + ',' + (var_ha != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}
