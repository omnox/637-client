...
final class Class47 implements Runnable {
	...
	final synchronized void method444(byte i, Interface10 interface10) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("dga.L(" + i + ',' + (interface10 != null ? "{...}" : "null") + ')'));
		}
	}
					...
					try {
						...
						if (!(anInterface10_398 instanceof Class292)) {
							...
							if (Class265.aHa1974 == null || anInterface10_402 == null || anInterface10_402.method25(-24591) == 0 || (-(long) anInterface10_402.method25(-24591) + l_2_ > aLong406)) {
								...
								anInterface10_398.method23(32210, (aBoolean397 || (Class265.aHa1974 != null && Class265.aHa1974.method1819())));
							} else {
							...
							try {
								if (Class265.aHa1974 != null && !(anInterface10_398 instanceof Class292))
									Class265.aHa1974.method1754(-128);
							} catch (Exception_Sub1 exception_sub1) {
								Map.method3585(exception_sub1, -121, (exception_sub1.getMessage() + " (Recovered) " + Class315.aClient3529.method94(0)));
	...
	final synchronized void method446(long l, byte i, int i_5_, Class75 class75, String string) {
		try {
			aLong405 = l;
			...
			throw Class64_Sub27.method667(runtimeexception, ("dga.G(" + l + ',' + i + ',' + i_5_ + ',' + (class75 != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
