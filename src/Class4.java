...
final class Class4 {
	...
	static final void method173(int i, int i_0_, int i_1_, GameInterfaceData class293, aa var_aa, int i_2_, byte i_3_, Class332 class332) {
		try {
			if (class332 != null) {
				int i_4_;
				do {
					if (Class98_Sub46_Sub20_Sub2.anInt6319 != 4) {
						i_4_ = ((int) GameWorld.cameraGetHrot + Class204.anInt1553) & 0x3fff;
			...
			throw Class64_Sub27.method667(runtimeexception, ("aea.C(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (class293 != null ? "{...}" : "null") + ',' + (var_aa != null ? "{...}" : "null") + ',' + i_2_ + ',' + i_3_ + ',' + (class332 != null ? "{...}" : "null") + ')'));
		}
	}
