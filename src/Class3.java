...
final class Class3 {
	...
	public static void method171(byte i) {
		try {
			IncomingOpcode.aClass58_75 = null;
			anImage74 = null;
			if (i > 73)
				aClass282_76 = null;
		...
		do {
			try {
				if (Class15.anInt185 != -1) {
					...
					Class62.method544(i_2_ + i_0_, i_3_, Class15.anInt185, i_2_ - -Class39_Sub1.anInt3593, 0, Class98_Sub25.anInt4024 + i_3_, i_2_, i_0_, i_1_, i_3_ + i_1_, i_3_, i_2_);
					if (Class11.aClass293_120 == null)
						break;
					Class246_Sub4.method3099(i_0_ - -i_2_, i_3_ + i_1_, (byte) 2);
				}
			} catch (RuntimeException runtimeexception) {
