...
final class Class282 {
	...
	private RuneScapeCache aClass207_2127;
	static int anInt2128;
	static GameInterfaceData aClass293_2129 = null;
	static int[] anIntArray2130 = { 1, 4, 1, 2 };
	private int[][] anIntArrayArray2131;
	static int anInt2132;

	static final void method3334(byte i, int i_0_, Mobile class246_sub3_sub4_sub2) {
		try {
			if (i != 37)
				aClass293_2129 = null;
			...
			throw Class64_Sub27.method667(runtimeexception, ("rj.E(" + i + ',' + i_0_ + ',' + (class246_sub3_sub4_sub2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final int[] method3335(int i, byte i_2_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "rj.A(" + i + ',' + i_2_ + ')');
		}
	}
	...
	final Class124 method3336(int i, int i_7_) {
		try {
			int i_8_ = -31 % ((-52 - i) / 54);
			byte[] is = aClass207_2127.readArchive(i_7_, 1);
			Class124 class124 = new Class124();
			class124.method2215(0, new RSByteBuffer(is));
			return class124;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "rj.D(" + i + ',' + i_7_ + ')');
		}
	}
	...
	Class282(Class279 class279, int i, RuneScapeCache class207) {
		try {
					...
					for (int i_15_ = 0; (i_15_ ^ 0xffffffff) > (i_13_ ^ 0xffffffff); i_15_++) {
						...
						if (anInt2124 == -1) {
							...
							for (int i_19_ = 0; i_17_ > i_19_; i_19_++)
								anIntArrayArray2131[i_16_][1 + i_19_] = class98_sub22.readShort();
						}
					}
			...
			throw Class64_Sub27.method667(runtimeexception, ("rj.<init>(" + (class279 != null ? "{...}" : "null") + ',' + i + ',' + (class207 != null ? "{...}" : "null") + ')'));
		}
	}
}
