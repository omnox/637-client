...
abstract class ha {
	...
	static final synchronized ha method1742(byte i, int i_2_, Canvas canvas, d var_d, int i_3_, RuneScapeCache class207, int i_4_, int i_5_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ha.VJ(" + i + ',' + i_2_ + ',' + (canvas != null ? "{...}" : "null") + ',' + (var_d != null ? "{...}" : "null") + ',' + i_3_ + ',' + (class207 != null ? "{...}" : "null") + ',' + i_4_ + ',' + i_5_ + ')'));
		}
	}
	...
	abstract s a(int i, int i_7_, int[][] is, int[][] is_8_, int i_9_, int i_10_, int i_11_);
	...
	final Class332 method1748(int i, int i_23_, int i_24_, int i_25_, int[] is, int i_26_) {
		try {
			if (i != -7962)
				return null;
			return method1770(is, i_23_, i_24_, i_26_, i_25_, true);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.WJ(" + i + ',' + i_23_ + ',' + i_24_ + ',' + i_25_ + ',' + (is != null ? "{...}" : "null") + ',' + i_26_ + ')'));
		}
	}
	...
	abstract void method1751(int i, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_);
	...
	final void method1753(int i, int i_43_, int i_44_, int i_45_, int i_46_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ha.EK(" + i + ',' + i_43_ + ',' + i_44_ + ',' + i_45_ + ',' + i_46_ + ')'));
		}
	}
	...
	final void method1755(int i, int i_48_, int i_49_, int i_50_, int i_51_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ha.TJ(" + i + ',' + i_48_ + ',' + i_49_ + ',' + i_50_ + ',' + i_51_ + ')'));
		}
	}

	abstract void method1756();

	abstract int r(int i, int i_52_, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_);

	final void method1757(int i, int i_58_, int i_59_, int i_60_, int i_61_) {
		try {
			if (i_60_ <= 19)
				ZA(-128, 0.4222986F, -0.8555362F, 0.64319474F, 0.16042754F, -0.00591929F);
			za(i_61_, i_58_, i, i_59_, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.RJ(" + i + ',' + i_58_ + ',' + i_59_ + ',' + i_60_ + ',' + i_61_ + ')'));
		}
	}
	...
	final void method1760(int i, int i_64_, int i_65_, int i_66_, byte i_67_, int i_68_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ha.HK(" + i + ',' + i_64_ + ',' + i_65_ + ',' + i_66_ + ',' + i_67_ + ',' + i_68_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method1763(int i, Class332 class332) {
		try {
			if (i > -56)
				K(null);
			method1740(method1815(class332, method1744(class332.method3734(), class332.method3731())));
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.UJ(" + i + ',' + (class332 != null ? "{...}" : "null") + ')'));
		}
	}

	abstract void method1764(int i, int i_69_) throws Exception_Sub1;

	abstract Class98_Sub5 method1765(int i, int i_70_, int i_71_, int i_72_, int i_73_, float f);

	protected void finalize() {
		try {
			method1743(-1);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "ha.finalize(" + ')');
		}
	}
	...
	abstract Class48 method1769(Class48 class48, Class48 class48_74_, float f, Class48 class48_75_);

	abstract Class332 method1770(int[] is, int i, int i_76_, int i_77_, int i_78_, boolean bool);

	abstract void ZA(int i, float f, float f_79_, float f_80_, float f_81_, float f_82_);
	...
	abstract void method1779(int i, int i_93_, int i_94_, int i_95_, int i_96_, int i_97_);

	abstract boolean method1780();

	final void method1781(boolean bool, int i, int i_98_, int i_99_, int i_100_, int i_101_) {
		try {
			method1779(i_100_, i_101_, i_98_, i, i_99_, 1);
			if (bool != true)
				return;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.SJ(" + bool + ',' + i + ',' + i_98_ + ',' + i_99_ + ',' + i_100_ + ',' + i_101_ + ')'));
		}
	}
	...
	abstract int JA(int i, int i_105_, int i_106_, int i_107_, int i_108_, int i_109_);

	abstract boolean method1788();

	final void method1789(int i, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_) {
		try {
			if (i_113_ != -10550)
				method1825();
			method1795(i_114_, i, i_112_, i_111_, i_110_, 1);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.GK(" + i + ',' + i_110_ + ',' + i_111_ + ',' + i_112_ + ',' + i_113_ + ',' + i_114_ + ')'));
		}
	}

	abstract void la();

	abstract AbstractModel method1790(ModelDefinitions class178, int i, int i_115_, int i_116_, int i_117_);

	abstract void method1791(float f, float f_118_, float f_119_);

	abstract void a(int i, int i_120_, int i_121_, int i_122_, int i_123_, int i_124_, aa var_aa, int i_125_, int i_126_, int i_127_, int i_128_, int i_129_);

	abstract Class111 method1793();

	final void method1794(Rectangle[] rectangles, int i, int i_130_) throws Exception_Sub1 {
		try {
			if (i_130_ != 27179)
				aClass110_941 = null;
			a(rectangles, i, 0, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("ha.AK(" + (rectangles != null ? "{...}" : "null") + ',' + i + ',' + i_130_ + ')'));
		}
	}

	abstract void method1795(int i, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_);

	static final Class337 method1796(int i, RSByteBuffer class98_sub22) {
		try {
			int i_136_ = class98_sub22.readShort();
			Class63 class63 = (Class98_Sub46_Sub13_Sub1.method1595(112)[class98_sub22.readUnsignedByte()]);
			if (i != 9342)
				anInt936 = -127;
			...
			throw Class64_Sub27.method667(runtimeexception, ("ha.BK(" + i + ',' + (class98_sub22 != null ? "{...}" : "null") + ')'));
		}
	}

	abstract Class332 method1797(int i, int i_139_, int i_140_, int i_141_, boolean bool);
	...
	abstract Class48 method1803(int i, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_);

	abstract Class43 method1804(Class197 class197, Class324[] class324s, boolean bool);
	...
	abstract void a(Rectangle[] rectangles, int i, int i_162_, int i_163_) throws Exception_Sub1;
	...
	abstract void a(int i, int i_164_, int i_165_, int i_166_, int i_167_, int i_168_, aa var_aa, int i_169_, int i_170_);
	...
	abstract void method1811(int i, int i_174_, int i_175_, int i_176_, int i_177_, int i_178_, int i_179_, int i_180_, int i_181_);
	...
	abstract Interface17 method1815(Interface5 interface5, Interface13 interface13);

	abstract void Q(int i, int i_185_, int i_186_, int i_187_, int i_188_, int i_189_, byte[] is, int i_190_, int i_191_);

	abstract void method1816(int i, int i_192_, int i_193_, int i_194_, int i_195_, int i_196_, int i_197_);
