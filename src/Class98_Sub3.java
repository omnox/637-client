...
final class Class98_Sub3 extends Node {
	...
	final AbstractModel method951(Class97 class97, int i, int i_0_, boolean bool, PlayerAppearance class313, int i_1_, int i_2_, int i_3_, byte i_4_, ha var_ha) {
		try {
			...
			int[] is = ((Class98_Sub3) this).anIntArray3824;
			if (class294 != null && ((RenderAnimDefinitions) class294).anIntArray2379 != null) {
				is = new int[((RenderAnimDefinitions) class294).anIntArray2379.length];
				for (int i_6_ = 0; ((i_6_ ^ 0xffffffff) > (((RenderAnimDefinitions) class294).anIntArray2379.length ^ 0xffffffff)); i_6_++) {
					int i_7_ = ((RenderAnimDefinitions) class294).anIntArray2379[i_6_];
					if (i_7_ < 0 || ((i_7_ ^ 0xffffffff) <= (((Class98_Sub3) this).anIntArray3824.length ^ 0xffffffff)))
						is[i_6_] = -1;
					else
						is[i_6_] = ((Class98_Sub3) this).anIntArray3824[i_7_];
				}
			}
			...
			if (class97 != null) {
				i_5_ |= 0x20;
				i_12_ = ((Class97) class97).anIntArray818[i_0_];
				...
				if (class98_sub46_sub16 != null) {
					...
					bool_10_ |= ((Class97) class97).aBoolean817;
				}
				if ((((Class97) class97).aBoolean825 || Class357.aBoolean3027) && (i_3_ ^ 0xffffffff) != 0 && ((Class97) class97).anIntArray818.length > i_3_) {
					i_14_ = ((Class97) class97).anIntArray811[i_0_];
					i_13_ = ((Class97) class97).anIntArray818[i_3_];
					int i_17_ = i_13_ >>> 951346256;
					i_13_ &= 0xffff;
					if ((i_16_ ^ 0xffffffff) != (i_17_ ^ 0xffffffff))
						class98_sub46_sub16_15_ = Class151_Sub7.aClass183_5001.method2624(2, i_13_ >>> -1068924144);
					else
			...
			long l = method952(i_1_, bool, is, (class313 != null ? ((PlayerAppearance) class313).anIntArray2683 : null), -29509);
			if (r_Sub1.aClass79_6321 != null)
				class146 = (AbstractModel) r_Sub1.aClass79_6321.get(l);
			if (class146 == null || (var_ha.c(class146.ua(), i_5_) ^ 0xffffffff) != -1) {
				if (class146 != null)
					i_5_ = var_ha.method1777(i_5_, class146.ua());
				int i_18_ = i_5_;
				boolean bool_19_ = false;
				for (int i_20_ = 0; (is.length ^ 0xffffffff) < (i_20_ ^ 0xffffffff); i_20_++) {
					if ((is[i_20_] ^ 0xffffffff) != 0 && !Class98_Sub46_Sub19.getItemDefs.getItemDefs(is[i_20_]).method3492(0, bool))
						bool_19_ = true;
				}
				if (bool_19_)
					return null;
				...
				if (class294 != null && ((RenderAnimDefinitions) class294).anIntArrayArray2366 != null) {
					for (int i_22_ = 0; ((i_22_ ^ 0xffffffff) > (((RenderAnimDefinitions) class294).anIntArrayArray2366.length ^ 0xffffffff)); i_22_++) {
						if ((((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_] != null) && class178s[i_22_] != null) {
							int i_23_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][0]);
							int i_24_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][1]);
							int i_25_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][2]);
							int i_26_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][3]);
							int i_27_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][4]);
							int i_28_ = (((RenderAnimDefinitions) class294).anIntArrayArray2366[i_22_][5]);
				...
				if (class313 != null) {
					for (int i_29_ = 0; i_29_ < 5; i_29_++) {
						for (int i_30_ = 0; Class61.aShortArrayArrayArray478.length > i_30_; i_30_++) {
							if ((Class61.aShortArrayArrayArray478[i_30_][i_29_]).length > ((PlayerAppearance) class313).anIntArray2683[i_29_])
								class146.ia((Class98_Sub10_Sub11.aShortArrayArray5597[i_30_][i_29_]), (Class61.aShortArrayArrayArray478[i_30_][i_29_][(((PlayerAppearance) class313).anIntArray2683[i_29_])]));
						}
					}
				}
				if (r_Sub1.aClass79_6321 != null) {
			...
			class146_31_.method2338(i - 1, class98_sub46_sub16, i_12_, class98_sub46_sub16_15_, ((Class97) class97).aBoolean817, 0, -104, i_14_, i_13_);
			return class146_31_;
	...
	private final long method952(int i, boolean bool, int[] is, int[] is_32_, int i_33_) {
		try {
			...
			long l = -1L;
			l = (ls[(int) (((long) (i >> 1392131400) ^ l) & 0xffL)] ^ l >>> -155609528);
			l = ls[(int) (0xffL & ((long) i ^ l))] ^ l >>> -1669638136;
			for (int i_34_ = 0; is.length > i_34_; i_34_++) {
				l = (ls[(int) (((long) (is[i_34_] >> -276629928) ^ l) & 0xffL)] ^ l >>> -947925880);
				l = l >>> -1018516728 ^ ls[(int) ((l ^ (long) (is[i_34_] >> 525663440)) & 0xffL)];
				l = (ls[(int) ((l ^ (long) (is[i_34_] >> 285473992)) & 0xffL)] ^ l >>> -600711224);
				l = (ls[(int) (0xffL & ((long) is[i_34_] ^ l))] ^ l >>> -24100984);
			}
			if (is_32_ != null) {
				for (int i_35_ = 0; (i_35_ ^ 0xffffffff) > -6; i_35_++)
					l = l >>> 1900652552 ^ ls[(int) (((long) is_32_[i_35_] ^ l) & 0xffL)];
			}
			if (i_33_ != -29509)
				return -33L;
			l = (ls[(int) (((long) (!bool ? 0 : 1) ^ l) & 0xffL)] ^ l >>> -778341368);
			return l;
		} catch (RuntimeException runtimeexception) {
