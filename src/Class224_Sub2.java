	...
	static final Class250 method2836(int[] is, boolean bool, ModelDefinitions class178, int i) {
		try {
			...
			if (((ModelDefinitions) class178).aByteArray1420 != null) {
				int i_3_ = ((ModelDefinitions) class178).anInt1396;
				...
				for (int i_11_ = 0; i_11_ < i; i_11_++) {
					int i_12_ = is[i_11_];
					if (((ModelDefinitions) class178).aByteArray1420[i_12_] != -1) {
						int i_13_ = (0xff & ((ModelDefinitions) class178).aByteArray1420[i_12_]);
						for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > -4; i_14_++) {
							short i_15_;
							if ((i_14_ ^ 0xffffffff) != -1) {
								if ((i_14_ ^ 0xffffffff) != -2)
									i_15_ = (((ModelDefinitions) class178).aShortArray1392[i_12_]);
								else
									i_15_ = (((ModelDefinitions) class178).aShortArray1410[i_12_]);
							} else
								i_15_ = (((ModelDefinitions) class178).aShortArray1393[i_12_]);
							int i_16_ = ((ModelDefinitions) class178).anIntArray1416[i_15_];
							int i_17_ = ((ModelDefinitions) class178).anIntArray1400[i_15_];
							int i_18_ = ((ModelDefinitions) class178).anIntArray1418[i_15_];
				...
				for (int i_19_ = 0; i_19_ < i_3_; i_19_++) {
					byte i_20_ = ((ModelDefinitions) class178).aByteArray1388[i_19_];
					if (i_20_ > 0) {
						...
						if ((i_20_ ^ 0xffffffff) == -2) {
							int i_23_ = ((ModelDefinitions) class178).anIntArray1389[i_19_];
							f = 64.0F / (float) (((ModelDefinitions) class178).anIntArray1404[i_19_]);
							if (i_23_ != 0) {
							...
							f = (float) (((ModelDefinitions) class178).anIntArray1404[i_19_]) / 1024.0F;
							f_21_ = (float) (((ModelDefinitions) class178).anIntArray1389[i_19_]) / 1024.0F;
							f_22_ = (float) (((ModelDefinitions) class178).anIntArray1390[i_19_]) / 1024.0F;
						} else {
							f = 64.0F / (float) (((ModelDefinitions) class178).anIntArray1404[i_19_]);
							f_21_ = 64.0F / (float) (((ModelDefinitions) class178).anIntArray1389[i_19_]);
							f_22_ = 64.0F / (float) (((ModelDefinitions) class178).anIntArray1390[i_19_]);
						}
						fs[i_19_] = (Class349.method3839((byte) 123, Class202.method2702((((ModelDefinitions) class178).aByteArray1423[i_19_]), 255), f_21_, f, ((ModelDefinitions) class178).aShortArray1385[i_19_], ((ModelDefinitions) class178).aShortArray1421[i_19_], f_22_, ((ModelDefinitions) class178).aShortArray1403[i_19_]));
					}
				}
			}
		...
		try {
			if (bool_24_ == true) {
				for (int i_27_ = 0; class293s.length > i_27_; i_27_++) {
					...
					if (class293 != null && ((((GameInterfaceData) class293).anInt2234 ^ 0xffffffff) == (i_26_ ^ 0xffffffff))) {
						Class253.method3180(i_25_, i, 1375731712, class293, bool);
						Class98_Sub8.method986(i, i_25_, class293, 119);
						if (((GameInterfaceData) class293).anInt2246 > (-((GameInterfaceData) class293).anInt2311 + ((GameInterfaceData) class293).anInt2290))
							((GameInterfaceData) class293).anInt2246 = (-((GameInterfaceData) class293).anInt2311 + ((GameInterfaceData) class293).anInt2290);
						if ((-((GameInterfaceData) class293).anInt2258 + ((GameInterfaceData) class293).anInt2228) < ((GameInterfaceData) class293).anInt2213)
