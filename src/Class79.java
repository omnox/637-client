...
final class Class79 {
	...
	static int[] anIntArray604 = { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535, 131071, 262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727, 268435455, 536870911, 1073741823, 2147483647, -1 };
		...
		try {
			...
			if (file != null) {
				try {
					...
					Method method = var_class_3_.getDeclaredMethod("setAccessible", (new Class[] { Boolean.TYPE }));
					Method method_4_ = (var_class_2_.getDeclaredMethod("load0", (new Class[] { Class.forName("java.lang.Class"), Class.forName("java.lang.String") })));
					method.invoke(method_4_, new Object[] { Boolean.TRUE });
					method_4_.invoke(Runtime.getRuntime(), new Object[] { var_class, file.getPath() });
					method.invoke(method_4_, new Object[] { Boolean.FALSE });
					Class10.aHashtable118.put(string, var_class);
					return true;
				} catch (NoSuchMethodException nosuchmethodexception) {
					System.load(file.getPath());
					Class10.aHashtable118.put(string, (aClass607 != null ? aClass607 : (aClass607 = method809("Class166"))));
					return true;
			...
			throw Class64_Sub27.method667(runtimeexception, ("fc.O(" + i + ',' + (var_class != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final void method796(Class98_Sub46_Sub2 class98_sub46_sub2, int i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("fc.G(" + (class98_sub46_sub2 != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method800(byte i, int i_6_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "fc.P(" + i + ',' + i_6_ + ')');
		}
	}
	...
	final Object get(long id) {
		try {
			Class98_Sub46_Sub2 class98_sub46_sub2 = (Class98_Sub46_Sub2) aClass377_599.method3990(id, -1);
			if (class98_sub46_sub2 == null)
				return null;
			...
			throw Class64_Sub27.method667(runtimeexception, "fc.F(" + id + ')');
		}
	}
	...
	final Object method803(boolean bool) {
		try {
			if (bool != false)
				anInt605 = -74;
			Class98_Sub46_Sub2 class98_sub46_sub2 = (Class98_Sub46_Sub2) aClass377_599.start_iteration(116);
	...
	final Object method804(boolean bool) {
		try {
			Class98_Sub46_Sub2 class98_sub46_sub2 = (Class98_Sub46_Sub2) aClass377_599.iterate_next(-1);
			if (bool != false)
				return null;
			while (class98_sub46_sub2 != null) {
				Object object = class98_sub46_sub2.method1533(true);
	...
	final void put(long l, Object object) {
		try {
			method807(13436, l, 1, object);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("fc.M(" + l + ',' + (object != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method807(int i, long l, int i_14_, Object object) {
		try {
			...
			anInt605 -= i_14_;
			while (anInt605 < 0) {
				Class98_Sub46_Sub2 class98_sub46_sub2 = ((Class98_Sub46_Sub2) aClass215_606.method2789(i ^ ~0xff3483));
				method796(class98_sub46_sub2, i ^ 0x347b);
			}
			Class98_Sub46_Sub2_Sub2 class98_sub46_sub2_sub2 = new Class98_Sub46_Sub2_Sub2(object, i_14_);
	...
	private final void method808(long l, int i) {
		try {
			if (i != 67108863)
				method794(-39);
			Class98_Sub46_Sub2 class98_sub46_sub2 = (Class98_Sub46_Sub2) aClass377_599.method3990(l, -1);
			method796(class98_sub46_sub2, 7);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "fc.N(" + l + ',' + i + ')');
		}
	}
	...
	Class79(int i, int i_15_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("fc.<init>(" + i + ',' + i_15_ + ')'));
		}
	}
