...
abstract class Class48_Sub2 extends Class48 {
	...
	static final void method470(byte[][] is, Map class305_sub1, int i) {
		try {
			...
			for (int i_0_ = 0; (class305_sub1.anInt2547 > i_0_); i_0_++) {
				Class128.method2224(i ^ ~0x4a1c);
				for (int i_1_ = 0; i_1_ < GameWorld.size_x >> 3; i_1_++) {
					for (int i_2_ = 0; i_2_ < GameWorld.size_y >> 3; i_2_++) {
						int i_3_ = (Class170.anIntArrayArrayArray1311[i_0_][i_1_][i_2_]);
						if (i_3_ != -1) {
							int i_4_ = 0x3 & i_3_ >> 24;
							if (!class305_sub1.aBoolean2544 || i_4_ == 0) {
								int i_5_ = 0x3 & i_3_ >> 1;
								int i_6_ = (i_3_ & 0xffc290) >> 14;
								int i_7_ = (i_3_ & 0x3ffc) >> 3;
								int i_8_ = (i_6_ / 8 << 8) - -(i_7_ / 8);
								for (int i_9_ = 0; i_9_ < Class121.anIntArray1006.length; i_9_++) {
									if ((Class121.anIntArray1006[i_9_] == i_8_) && is[i_9_] != null) {
