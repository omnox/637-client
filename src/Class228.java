...
final class Class228 {
	...
	final void method2860(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			...
			anInt1710 = i_9_;
			anInt1717 = i_5_;
			this.anInt1708 = i_8_ + anInt1710;
			this.anInt1714 = anInt1711 + i_1_;
			this.anInt1713 = i_3_ + anInt1710;
			if (i_0_ != -7409)
				anInt1717 = 79;
			this.anInt1715 = i_7_ + anInt1717;
			this.anInt1712 = anInt1711 - -i_4_;
			this.anInt1709 = anInt1717 - -i_6_;
	...
	static final void method2861(int i, int i_10_, int i_11_, int i_12_) {
		do {
			try {
				if (i_12_ == 18596) {
					i_10_ = i_10_ * Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub22_4069.method641((byte) 127) >> 8;
					if (i_10_ == 0 || i_11_ == -1)
						break;
					if (!Class151_Sub5.aBoolean4991 && Class144.anInt1169 != -1 && Class8.method188(false) && !Class168.method2534((byte) -128)) {
	...
	final boolean method2863(int i, int i_14_, int i_15_, int i_16_) {
		try {
			if (this.anInt1712 > i || this.anInt1714 < i)
				return false;
			if (this.anInt1713 > i_14_ || this.anInt1708 < i_14_)
				return false;
			if (this.anInt1715 > i_15_ || this.anInt1709 < i_15_)
				return false;
			if (i_16_ != 0)
				method2860(69, -4, -88, -91, -62, 109, -98, 2, -57, 18, -119);
			int i_17_ = i - anInt1711;
			int i_18_ = -anInt1717 + i_15_;
			if (anInt1716 <= i_17_ * i_17_ - -(i_18_ * i_18_))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	Class228(int i, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
		try {
			...
			anInt1710 = i_21_;
			this.anInt1713 = anInt1710 - -i_26_;
			this.anInt1715 = i_28_ + anInt1717;
			this.anInt1709 = anInt1717 - -i_29_;
			this.anInt1714 = anInt1711 - -i_25_;
			this.anInt1708 = i_27_ + anInt1710;
			this.anInt1712 = i_24_ + anInt1711;
		} catch (RuntimeException runtimeexception) {
