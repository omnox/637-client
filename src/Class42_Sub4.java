...
final class Class42_Sub4 extends Class42 {
	...
	final void method395(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			OpenGL.glCopyTexSubImage3D(((Class42) this).anInt3226, i_2_, i_0_, i_6_, i_1_, i, i_3_, i_4_, i_5_);
			OpenGL.glFlush();
	...
	public final void method3(byte i) {
		do {
			try {
				OpenGL.glFramebufferTexture3DEXT(anInt5370, anInt5367, ((Class42) this).anInt3226, 0, 0, 0);
				anInt5370 = -1;
				anInt5367 = -1;
				if (i <= -117)
					break;
	...
	Class42_Sub4(ha_Sub1 var_ha_Sub1, int i, int i_7_, int i_8_, int i_9_, byte[] is, int i_10_) {
		...
		try {
			((Class42_Sub4) this).anInt5368 = i_9_;
			((Class42_Sub4) this).anInt5369 = i_7_;
			((Class42_Sub4) this).anInt5372 = i_8_;
			((Class42) this).aHa_Sub1_3227.method1863(1, this);
			OpenGL.glPixelStorei(3317, 1);
			OpenGL.glTexImage3Dub(((Class42) this).anInt3226, 0, ((Class42) this).anInt3230, ((Class42_Sub4) this).anInt5369, ((Class42_Sub4) this).anInt5372, ((Class42_Sub4) this).anInt5368, 0, i_10_, 5121, is, 0);
	...
	Class42_Sub4(ha_Sub1 var_ha_Sub1, int i, int i_11_, int i_12_, int i_13_) {
		...
		try {
			((Class42_Sub4) this).anInt5369 = i_11_;
			((Class42_Sub4) this).anInt5368 = i_13_;
			((Class42_Sub4) this).anInt5372 = i_12_;
			((Class42) this).aHa_Sub1_3227.method1863(1, this);
			OpenGL.glTexImage3Dub(((Class42) this).anInt3226, 0, ((Class42) this).anInt3230, ((Class42_Sub4) this).anInt5369, ((Class42_Sub4) this).anInt5372, ((Class42_Sub4) this).anInt5368, 0, Class98_Sub31_Sub2.method1339((((Class42) this).anInt3230), 124), 5121, null, 0);
			this.method372(-28003, true);
		} catch (RuntimeException runtimeexception) {
