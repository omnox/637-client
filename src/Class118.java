...
final class Class118 {
	...
	static final void method2170(int i, String string) {
		try {
			if (string != null) {
				if (string.startsWith("*"))
					string = string.substring(1);
				String string_0_ = Class353.method3867(-1, string);
				if (string_0_ != null) {
					if (i < 25)
						anInt978 = -32;
			...
			throw Class64_Sub27.method667(runtimeexception, ("hk.D(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}

	Class118(ha_Sub1 var_ha_Sub1) {
		try {
			aHa_Sub1_977 = var_ha_Sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "hk.<init>(" + (var_ha_Sub1 != null ? "{...}" : "null") + ')');
		}
	}

	final boolean method2171(boolean bool) {
		try {
			if (bool != true)
				anInt980 = -111;
	...
	final boolean method2172(int i, Class42_Sub4 class42_sub4, float f, Class42_Sub4 class42_sub4_4_) {
		try {
			if (!method2171(true))
				return false;
			...
			throw Class64_Sub27.method667(runtimeexception, ("hk.A(" + i + ',' + (class42_sub4 != null ? "{...}" : "null") + ',' + f + ',' + (class42_sub4_4_ != null ? "{...}" : "null") + ')'));
		}
	}

	static final void method2173(boolean bool, int i) {
		try {
			do {
			...
			throw Class64_Sub27.method667(runtimeexception, "hk.B(" + bool + ',' + i + ')');
		}
	}
}
