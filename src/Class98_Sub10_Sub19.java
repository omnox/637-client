...
final class Class98_Sub10_Sub19 extends Class98_Sub10 {
	...
	static final void method1058(byte i, ha var_ha) {
		try {
			if (i < -35) {
				...
				for (int i_1_ = 0; (i_1_ < Class2.anIntArray70.length); i_1_++) {
		...
		try {
			...
			if (this.aClass16_3863.aBoolean198) {
				...
				for (int i_8_ = 0; i_8_ < anInt5632; i_8_++) {
					...
					int i_12_ = (anInt5629 * Class278_Sub1.anIntArray5168[i_9_] >> 12) + i_10_;
					int i_13_ = i_11_ + (aa_Sub2.anIntArray3565[i_9_] * anInt5629 >> 12);
					...
					if (i_15_ != 0 || i_14_ != 0) {
						...
						int i_25_ = (-(Class63.method546(-28737, 4096, random) >> 2) + 1024);
						if (i_22_ < 0)
							i_22_ = -i_22_;
	...
	static final void method1059(boolean bool, int i, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_) {
		try {
			...
			for (int i_46_ = i_40_; i_46_ <= i_41_; i_46_++) {
