			...
			for (int i_0_ = 0; i_0_ < Class366.anInt3112; i_0_++) {
				for (int i_1_ = 0; i_1_ < Class64_Sub9.anInt3662; i_1_++) {
					...
					if (class172 != null) {
						...
						Class246_Sub3_Sub3 class246_sub3_sub3_2_ = class172.aClass246_Sub3_Sub3_1333;
						...
						for (Class154 class154 = class172.aClass154_1325; class154 != null; class154 = class154.aClass154_1233) {
							...
							if (class246_sub3_sub4 != null && class246_sub3_sub4.method2982((byte) -128)) {
								Class64_Sub2.method562(class246_sub3_sub4, i, i_0_, i_1_, (class246_sub3_sub4.aShort6160 - class246_sub3_sub4.aShort6158 + 1), (class246_sub3_sub4.aShort6159 - class246_sub3_sub4.aShort6157 + 1));
								class246_sub3_sub4.method2992((byte) -73);
							}
						}
						Class246_Sub3_Sub1 class246_sub3_sub1 = class172.aClass246_Sub3_Sub1_1332;
		...
		try {
			if (i == 26256) {
				for (int i_5_ = 0; is_4_.length > i_5_; i_5_++) {
					...
					int i_7_ = is_3_[i_5_];
					int i_8_ = is[i_5_];
					for (int i_9_ = 0; i_7_ != 0 && ((class246_sub3_sub4_sub2_sub1.aClass226Array6387).length > i_9_); i_9_++) {
						if ((0x1 & i_7_) != 0) {
							if (i_6_ != -1) {
								Class97 class97 = Class151_Sub7.aClass183_5001.method2623(i_6_, 16383);
								int i_10_ = class97.anInt819;
								Class226 class226 = (class246_sub3_sub4_sub2_sub1.aClass226Array6387[i_9_]);
								if (class226 != null) {
									if (class226.anInt1700 != i_6_) {
										if (Class151_Sub7.aClass183_5001.method2623((class226.anInt1700), i ^ 0x596f).anInt829 <= class97.anInt829)
											class226 = class246_sub3_sub4_sub2_sub1.aClass226Array6387[i_9_] = null;
									} else if (i_10_ != 0) {
										if (i_10_ == 1) {
								...
								if (class226 == null) {
									class226 = class246_sub3_sub4_sub2_sub1.aClass226Array6387[i_9_] = new Class226();
									class226.anInt1703 = i_8_;
									class226.anInt1704 = 0;
								...
								class246_sub3_sub4_sub2_sub1.aClass226Array6387[i_9_] = null;
						}
						i_7_ >>>= 1;
					}
				}
