...
abstract class Class246_Sub3_Sub5 extends AnimableEntity {
	...
	final boolean method2977(ha var_ha, byte i) {
		try {
			if (i != 77)
				return false;
			return Class195.method2661(this.aByte5081, (this.localYPos >> Class151_Sub8.anInt5015), (this.localXPos >> Class151_Sub8.anInt5015), this.method2990(i + -77), (byte) -123);
		} catch (RuntimeException runtimeexception) {
	...
	Class246_Sub3_Sub5(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		try {
			this.localXPos = i;
			this.aByte5081 = (byte) i_8_;
			this.aShort6165 = (short) i_9_;
			this.aShort6163 = (short) i_10_;
			this.height_level = (byte) i_7_;
			this.localYPos = i_6_;
			this.anInt5089 = i_5_;
		} catch (RuntimeException runtimeexception) {
	...
	final boolean method2991(boolean bool) {
		try {
			if (bool != false)
				return true;
			return (Class74.aBooleanArrayArray551[(Class259.anInt1959 + -Class241.anInt1845 + (this.localXPos >> Class151_Sub8.anInt5015))][(Class259.anInt1959 + (this.localYPos >> Class151_Sub8.anInt5015) - Class64_Sub26.anInt3714)]);
		} catch (RuntimeException runtimeexception) {
