	...
	static final void method3391(int i, int i_0_, int i_1_) {
		try {
			...
			if (Class154.aHa1231 != null) {
				...
				} else if (Class98_Sub46.anInt4261 == 1 && (Class172.anInterface17Array1327 == null || ((Class191.anInt1477 ^ 0xffffffff) != (i_2_ ^ 0xffffffff)) || Class63.anInt493 != i_3_)) {
		...
		try {
			...
			for (int i_20_ = 0; (i_20_ ^ 0xffffffff) > (i_7_ ^ 0xffffffff); i_20_++) {
				for (int i_21_ = 0; (i_21_ ^ 0xffffffff) > (i_6_ ^ 0xffffffff); i_21_++) {
					if ((i_9_ ^ 0xffffffff) > -1 || (i_9_ ^ 0xffffffff) <= (is_8_.length ^ 0xffffffff))
						i_9_++;
					else {
