...
final class Class281 {
	...
	Class281(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, boolean bool, boolean bool_8_, int i_9_) {
		try {
			((Class281) this).aShort2119 = (short) i_4_;
			((Class281) this).anInt2115 = i_2_;
			((Class281) this).anInt2122 = i_0_;
			((Class281) this).aByte2113 = (byte) i_7_;
			((Class281) this).aShort2114 = (short) i_5_;
			((Class281) this).anInt2121 = i;
			((Class281) this).aBoolean2118 = bool_8_;
			((Class281) this).aShort2123 = (short) i_3_;
			((Class281) this).anInt2120 = i_1_;
			((Class281) this).anInt2116 = i_9_;
		} catch (RuntimeException runtimeexception) {
	...
	static final Class246_Sub3_Sub2 method3333(int i, int i_10_, int i_11_) {
		...
		if (class172 == null)
			return null;
		Class246_Sub3_Sub2 class246_sub3_sub2 = ((Class172) class172).aClass246_Sub3_Sub2_1331;
		((Class172) class172).aClass246_Sub3_Sub2_1331 = null;
