...
final class Class98_Sub46_Sub12 extends Class98_Sub46 {
	...
	final int method1585(int i, boolean bool, int i_0_) {
		try {
			if (aClass377_6033 == null)
				return i_0_;
			Class98_Sub34 class98_sub34 = (Class98_Sub34) aClass377_6033.method3990(i, -1);
			if (bool != true)
	...
	final String method1586(int i, byte i_1_, String string) {
		try {
			...
			if (i_1_ != -19)
				method1587((byte) 49);
			Class98_Sub15 class98_sub15 = ((Class98_Sub15) aClass377_6033.method3990(i, i_1_ ^ 0x12));
		...
		try {
			if (i == 249) {
				...
				for (int i_5_ = 0; i_5_ < i_3_; i_5_++) {
					boolean bool_6_ = (class98_sub22.readUnsignedByte() == 1);
