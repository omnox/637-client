...
final class Class261 {
	static final void method3210(byte i, byte[] is, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			if (i_3_ < i_1_) {
				i_2_ += i_3_;
			...
			throw Class64_Sub27.method667(runtimeexception, ("qga.B(" + i + ',' + (is != null ? "{...}" : "null") + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
		}
	}

	static final void method3211(byte[] is, int i, int i_4_, File file) throws IOException {
		try {
			if (i < 122)
				method3212(72);
			...
			throw Class64_Sub27.method667(runtimeexception, ("qga.C(" + (is != null ? "{...}" : "null") + ',' + i + ',' + i_4_ + ',' + (file != null ? "{...}" : "null") + ')'));
		}
	}

	static final void method3212(int i) {
		try {
			...
			if ((Class169.anInt1306 ^ 0xffffffff) != 0 && ((Class343.method3819(-47) ^ 0xffffffffffffffffL) < (Class198.aLong1525 ^ 0xffffffffffffffffL))) {
				for (int i_5_ = Class169.anInt1306; ((i_5_ ^ 0xffffffff) > (Class147.aStringArray1189.length ^ 0xffffffff)); i_5_++) {
					if (!Class147.aStringArray1189[i_5_].startsWith("pause")) {
						...
						int i_6_ = 5;
						try {
							i_6_ = Integer.parseInt(Class147.aStringArray1189[i_5_].substring(6));
						} catch (Exception exception) {
							/* empty */
						}
						Class98_Sub46.method1525(("Pausing for " + i_6_ + " seconds..."), -109);
						Class169.anInt1306 = 1 + i_5_;
						Class198.aLong1525 = Class343.method3819(i + -151) + (long) (i_6_ * 1000);
						return;
					}
				}
				Class169.anInt1306 = -1;
			}
			if (Class319.mouse_scroll_delta != 0) {
			...
			if (i == 104) {
				for (/**/; i_7_ < Class329.anInt2765; i_7_++) {
					Interface7 interface7 = Class21_Sub1.anInterface7Array5385[i_7_];
					...
					if ((i_8_ ^ 0xffffffff) == -81)
						...
						if (i_8_ != 67 || (i_9_ & 0x4 ^ 0xffffffff) == -1) {
							if (i_8_ == 85 && Class198.anInt1524 > 0) {
								...
								Class198.anInt1524--;
							} else if (i_8_ == 101 && (Class198.anInt1524 < Class45.aString382.length()))
							...
							if (transferable != null) {
								try {
									...
									if (string != null) {
										...
										Class98_Sub10_Sub13.method1044((byte) 120, strings);
									}
								} catch (Exception exception) {
									/* empty */
								}
