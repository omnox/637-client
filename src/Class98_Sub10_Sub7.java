...
final class Class98_Sub10_Sub7 extends Class98_Sub10 {
	...
	final int[][] method997(int i, int i_0_) {
		try {
						...
						while_64_: do {
							while_63_: do {
								...
								for (i_12_ = 0; ((i_12_ ^ 0xffffffff) > (Class25.anInt268 ^ 0xffffffff)); i_12_++) {
									...
									is_3_[i_12_] = i_30_ > i_27_ ? i_27_ : i_30_;
									is_4_[i_12_] = i_26_ <= i_25_ ? i_26_ : i_25_;
									is_5_[i_12_] = i_28_ < i_29_ ? i_28_ : i_29_;
								}
								break while_66_;
							} while (false);
			...
			throw Class64_Sub27.method667(runtimeexception, "dp.C(" + i + ',' + i_0_ + ')');
		}
	}
	...
	final int[] method990(int i, int i_49_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "dp.G(" + i + ',' + i_49_ + ')');
		}
	}
	...
	static final boolean method1023(int i, int i_65_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "dp.E(" + i + ',' + i_65_ + ')');
		}
	}
	...
	static final Class348 method1025(int i, byte i_66_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "dp.B(" + i + ',' + i_66_ + ')');
		}
	}

	final void method991(int i, RSByteBuffer class98_sub22, byte i_69_) {
		do {
			try {
				int i_70_ = i;
				do {
				...
				throw Class64_Sub27.method667(runtimeexception, ("dp.A(" + i + ',' + (class98_sub22 != null ? "{...}" : "null") + ',' + i_69_ + ')'));
			}
			break;
		} while (false);
	}
