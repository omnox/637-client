...
final class Class50 {
	...
	static final void method484(int i, int i_0_) {
		try {
			...
			if (i_2_ >= 100) {
				...
				if (Class43.anInt372 >> 8 > cameraVrotation)
					cameraVrotation = Class43.anInt372 >> 8;
				...
				Class104.method1712(false, cameraHrotation, ClientSettings.clientZoom * (cameraVrotation >> 3) + 600 << 2, Class224_Sub3_Sub1.anInt6147, i, Class201.anInt1545, cameraVrotation, (Perspective.getTileHeight(Class43.anInt377, Player.selfPlayer.localYPos, Player.selfPlayer.localXPos)) - 200);
	...
	static final OutgoingPacket method486(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, boolean bool, int i_21_) {
		try {
			...
			class98_sub11.packet.writeShort(Class272.anInt2038 + i_20_);
			class98_sub11.packet.writeShort(aa_Sub2.anInt3562 + i_19_);
