...
final class Class151_Sub2 extends Class151 {
	...
	Class151_Sub2(ha_Sub1 var_ha_Sub1, Class51 class51) {
		...
		do {
			try {
				...
				if (aClass51_4975.aClass42_Sub4_421 == null || !(this.aHa_Sub1_1215.aBoolean4399) || !(this.aHa_Sub1_1215.aBoolean4447))
					break;
	...
	final void method2440(boolean bool, boolean bool_3_) {
		do {
			try {
				if (bool == false) {
					Class42_Sub2 class42_sub2 = this.aHa_Sub1_1215.method1827(-122);
					if (!aBoolean4974 || class42_sub2 == null)
						break;
					float f = 2.0F * (1.0F - Math.abs(this.aHa_Sub1_1215.aFloatArray4438[1])) + 1.0F;
					this.aHa_Sub1_1215.method1845(1, 847872872);
					this.aHa_Sub1_1215.method1863(1, class42_sub2);
					this.aHa_Sub1_1215.method1845(0, 847872872);
					this.aHa_Sub1_1215.method1863(1, aClass51_4975.aClass42_Sub4_421);
					long l = aClass336_4971.aLong2821;
					...
					OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), f * (this.aHa_Sub1_1215.aFloat4433), f * (this.aHa_Sub1_1215.aFloat4420), f * (this.aHa_Sub1_1215.aFloat4458), 1.0F);
					OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"), (64.0F + 928.0F * Math.abs(this.aHa_Sub1_1215.aFloatArray4438[1])));
					aBoolean4972 = true;
				}
			} catch (RuntimeException runtimeexception) {
		...
		do {
			try {
				if (aBoolean4972) {
					...
					float f_8_ = (float) ((i_4_ & 0x37eb0) >> 16) / 8.0F;
					float f_9_ = (float) (0xf & i_4_ >> 19) / 16.0F;
					float f_10_ = (float) (0xf & i_4_ >> 23) / 16.0F;
					int i_11_ = (0x7f9b2e24 & i_4_) >> 27;
					long l = aClass336_4971.aLong2821;
					OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"), (float) (i_6_ * this.aHa_Sub1_1215.anInt4321 % 40000) / 40000.0F);
