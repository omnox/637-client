...
final class Class215 {
	...
	final void method2785(Class98_Sub46 class98_sub46, int i) {
		do {
			try {
				...
				((Class98_Sub46) class98_sub46).aClass98_Sub46_4262 = ((Class215) this).aClass98_Sub46_1615;
				((Class98_Sub46) class98_sub46).aClass98_Sub46_4265 = (((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4265);
	...
	final void method2786(int i) {
		try {
			...
			for (;;) {
				Class98_Sub46 class98_sub46 = (((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4262);
				if (((Class215) this).aClass98_Sub46_1615 == class98_sub46)
					break;
				class98_sub46.method1524((byte) -90);
			}
			aClass98_Sub46_1616 = null;
	...
	final Class98_Sub46 method2787(int i) {
		try {
			...
			aClass98_Sub46_1616 = ((Class98_Sub46) class98_sub46).aClass98_Sub46_4262;
	...
	final int method2788(int i) {
		try {
			...
			if (i > -108)
				return 8;
			for (Class98_Sub46 class98_sub46 = (((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4262); ((Class215) this).aClass98_Sub46_1615 != class98_sub46; class98_sub46 = ((Class98_Sub46) class98_sub46).aClass98_Sub46_4262)
				i_0_++;
			return i_0_;
		} catch (RuntimeException runtimeexception) {
	...
	static final int method2790(int i, int i_1_, int i_2_, int i_3_) {
		try {
			if (i < 124)
				return 75;
			i_3_ = (i_1_ * (0xff00ff & i_3_) & ~0xff00ff | i_1_ * (i_3_ & 0xff00) & 0xff0000) >>> 238779912;
			int i_4_ = -i_1_ + 255;
			return (((0xff0000 & i_4_ * (i_2_ & 0xff00) | i_4_ * (0xff00ff & i_2_) & ~0xff00ff) >>> -896446872) - -i_3_);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2791(byte i) {
		do {
			try {
				...
				if (za_Sub2.aBoolean6079 && ((Class146_Sub2.method2391((byte) 106) ^ 0xffffffff) != -2))
					Class92.method892(21337, 0, 0, ClientScript2Event.method1176(false), (Class177.anInt1376 == 3 || ((Class177.anInt1376 ^ 0xffffffff) == -8)), Class98_Sub10_Sub36.method1110((byte) 60));
				int i_5_ = 0;
				int i_6_ = 62 % ((i - 29) / 42);
				int i_7_ = 0;
				...
				if (Class65.aClass293Array500 == null)
					break;
				Class98_Sub10_Sub24.method1077(-1412584499, true, IncomingOpcode.anInt463, i_5_, i_7_, ((GameInterfaceData) Class189.aClass293_1457).anInt2238, Class65.aClass293Array500, Class39_Sub1.anInt3593 + i_5_, i_7_ + Class98_Sub25.anInt4024, true, Class64_Sub5.anInt3654);
				Class65.aClass293Array500 = null;
			} catch (RuntimeException runtimeexception) {
	...
	final Class98_Sub46 method2792(int i) {
		try {
			Class98_Sub46 class98_sub46 = (((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4262);
			if (class98_sub46 == ((Class215) this).aClass98_Sub46_1615) {
				aClass98_Sub46_1616 = null;
				return null;
			}
			if (i != -1)
	...
	public Class215() {
		try {
			((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4265 = ((Class215) this).aClass98_Sub46_1615;
			((Class98_Sub46) ((Class215) this).aClass98_Sub46_1615).aClass98_Sub46_4262 = ((Class215) this).aClass98_Sub46_1615;
		} catch (RuntimeException runtimeexception) {
