...
final class Class61 {
	...
	static final void method537(byte i) {
		try {
			...
			int i_0_ = ((Class272.anInt2038 >> 3) + (Class98_Sub46_Sub10.renderX >> 12));
			int i_1_ = ((Class134.renderZ >> 12) + (aa_Sub2.anInt3562 >> 3));
			Class43.anInt377 = Player.selfPlayer.height_level = (byte) 0;
			...
			if (i <= 64)
				method542(true);
			i_2_ = 0;
			for (int i_3_ = (i_0_ - (GameWorld.size_x >> 4)) / 8; i_3_ <= ((GameWorld.size_x >> 4) + i_0_) / 8; i_3_++) {
				for (int i_4_ = (-(GameWorld.size_y >> 4) + i_1_) / 8; i_4_ <= ((GameWorld.size_y >> 4) + i_1_) / 8; i_4_++) {
					...
					if (Class76_Sub7.anIntArray3765[i_2_] == -1) {
			...
			for (int i_6_ = i_2_; (Class76_Sub7.anIntArray3765.length > i_6_); i_6_++) {
	...
	static final void method538(int i, boolean bool) {
		try {
			if (Class177.anInt1376 != i) {
				...
				if (i == 7)
					Class96.method922((Class19.anInt3450 != Class15.anInt185), -1);
				if (i == 5) {
					if (Class98_Sub10_Sub10.aString5593 != null)
				...
				if (Class199.method2690(i, 8)) {
					...
					AnimableEntity.aClass207_5087.anInt1575 = 1;
					PlayerUpdateMask.aClass207_525.anInt1575 = 1;
				}
				if (i == 11 || i == 3)
					Class4.method174((byte) 99);
				boolean bool_8_ = (i == 2 || Class53_Sub1.method499(2048, i) || Class246_Sub3_Sub3.method3011(-6410, i));
				boolean bool_9_ = (Class177.anInt1376 == 2 || Class53_Sub1.method499(2048, Class177.anInt1376) || Class246_Sub3_Sub3.method3011(-6410, Class177.anInt1376));
				if (bool_8_ == !bool_9_) {
					if (bool_8_) {
						Class144.anInt1169 = Class94.anInt795;
						if (Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub22_4072.method641((byte) 125) == 0)
				...
				if (Class199.method2690(i, 8) || i == 13)
	...
	final Node method539(int i) {
		try {
			if (i != 2)
				aClass377_480 = null;
			if (anInt477 > 0 && (aClass377_480.aClass98Array3180[anInt477 - 1] != aClass98_482)) {
				Node class98 = aClass98_482;
				aClass98_482 = class98.aClass98_836;
				return class98;
			}
			while (aClass377_480.anInt3179 > anInt477) {
				Node class98 = (aClass377_480.aClass98Array3180[anInt477++].aClass98_836);
