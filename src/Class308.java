...
final class Class308 {
	...
	private RuneScapeCache aClass207_2577;
	private RuneScapeCache aClass207_2578;
	...
	static final void method3608(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sv.D(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ')'));
		}
	}
	...
	private final Class98_Sub24_Sub1 method3609(int i, int i_4_, int i_5_, int[] is) {
		try {
			...
			if (class98_sub24_sub1 == null)
				return null;
			class98_sub13.remove();
			if (i != 20855)
				method3610(-68);
			aClass377_2585.method3996(class98_sub24_sub1, l, i + -20856);
			return class98_sub24_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("sv.A(" + i + ',' + i_4_ + ',' + i_5_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void method3610(int i) {
		do {
			try {
				...
				IncomingOpcode.aClass58_2581 = null;
				if (i == -746085692)
					break;
				method3610(-1);
			} catch (RuntimeException runtimeexception) {
	...
	final Class98_Sub24_Sub1 method3611(int i, int i_7_, int[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sv.E(" + i + ',' + i_7_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final Class98_Sub24_Sub1 method3613(int i, boolean bool, int[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sv.F(" + i + ',' + bool + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}

	Class308(RuneScapeCache class207, RuneScapeCache class207_11_) {
		try {
			aClass207_2578 = class207;
			aClass207_2577 = class207_11_;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("sv.<init>(" + (class207 != null ? "{...}" : "null") + ',' + (class207_11_ != null ? "{...}" : "null") + ')'));
		}
	}
}
