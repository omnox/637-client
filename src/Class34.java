...
final class Class34 {
	...
	static final void method328(int i) {
		do {
			try {
	...
	static final void method330(byte i, boolean bool) {
		do {
			try {
				...
				if (!bool)
					break;
				VarpClass.aClass47_3241.method452(-7423);
			} catch (RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, "cha.A(" + i + ',' + bool + ')');
			}
			break;
		} while (false);
	}
