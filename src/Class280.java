...
final class Class280 {
			...
			if (!Player.aBoolean6540) {
				...
				if (!((Class98_Sub46_Sub8) class98_sub46_sub8).aBoolean5989) {
					...
					for (Class98_Sub46_Sub9 class98_sub46_sub9 = ((Class98_Sub46_Sub9) GameInterface.aClass215_3949.method2792(-1)); class98_sub46_sub9 != null; class98_sub46_sub9 = ((Class98_Sub46_Sub9) GameInterface.aClass215_3949.method2787(0))) {
						if (((Class98_Sub46_Sub9) class98_sub46_sub9).aString5998.equals(((Class98_Sub46_Sub8) class98_sub46_sub8).aString5992)) {
							boolean bool = false;
							for (Class98_Sub46_Sub8 class98_sub46_sub8_0_ = ((Class98_Sub46_Sub8) ((Class98_Sub46_Sub9) class98_sub46_sub9).aClass215_5999.method2792(-1)); class98_sub46_sub8_0_ != null; class98_sub46_sub8_0_ = ((Class98_Sub46_Sub8) ((Class98_Sub46_Sub9) class98_sub46_sub9).aClass215_5999.method2787(0))) {
	...
	final Class98_Sub46_Sub11 method3325(int quickChatFileID, int i_1_) {
		try {
			Class98_Sub46_Sub11 class98_sub46_sub11 = ((Class98_Sub46_Sub11) aClass79_2107.get((long) quickChatFileID));
			if (i_1_ <= 31)
			...
			byte[] is;
			do {
				if ((quickChatFileID ^ 0xffffffff) <= -32769) {
			...
			aClass79_2107.put((long) quickChatFileID, class98_sub46_sub11);
			return class98_sub46_sub11;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3327(int i, Class97 class97, byte i_3_) {
		try {
			if ((Class306.anInt2566 ^ 0xffffffff) > -51 && (class97 != null && ((Class97) class97).anIntArrayArray822 != null && (((Class97) class97).anIntArrayArray822.length ^ 0xffffffff) < (i ^ 0xffffffff) && ((Class97) class97).anIntArrayArray822[i] != null)) {
				int i_4_ = ((Class97) class97).anIntArrayArray822[i][0];
				int i_5_ = i_4_ >> -103665464;
				if (((Class97) class97).anIntArrayArray822[i].length > 1) {
					int i_6_ = (int) (Math.random() * (double) (((Class97) class97).anIntArrayArray822[i]).length);
					if (i_6_ > 0)
						i_5_ = ((Class97) class97).anIntArrayArray822[i][i_6_];
				}
				...
				if (((Class97) class97).anIntArray810 != null && ((Class97) class97).anIntArray815 != null)
					i_9_ = Class142.method2307((((Class97) class97).anIntArray810[i]), (((Class97) class97).anIntArray815[i]), 52);
	...
	static final void method3328(int i, int i_10_, int i_11_, int i_12_, int i_13_, Class98_Sub42 class98_sub42) {
		while_164_: do {
			do {
				try {
					if ((((Class98_Sub42) class98_sub42).anInt4210 ^ 0xffffffff) == 0 && (((Class98_Sub42) class98_sub42).anIntArray4208 == null))
						break;
					int i_14_ = 0;
					int i_15_ = (((Class98_Sub42) class98_sub42).anInt4236 * ((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub22_4051.method641((byte) 124)) >> -884604664;
					if ((i_12_ ^ 0xffffffff) >= (((Class98_Sub42) class98_sub42).anInt4224 ^ 0xffffffff)) {
						if ((i_12_ ^ 0xffffffff) > (((Class98_Sub42) class98_sub42).anInt4229 ^ 0xffffffff))
							i_14_ += -i_12_ + (((Class98_Sub42) class98_sub42).anInt4229);
					} else
					...
					if (((Class98_Sub42) class98_sub42).anInt4228 == 0 || (i_14_ + -256 > ((Class98_Sub42) class98_sub42).anInt4228) || (((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub22_4051.method641((byte) 120) ^ 0xffffffff) == -1 || (((Class98_Sub42) class98_sub42).anInt4220 ^ 0xffffffff) != (i_11_ ^ 0xffffffff)) {
					...
					int i_17_ = i_15_;
					int i_18_ = i_14_ - ((Class98_Sub42) class98_sub42).anInt4217;
					...
					if (i_20_ != 0 || (i_21_ ^ 0xffffffff) != -1) {
						int i_22_ = ((-4096 + (-GameWorld.cameraYaw + -(int) (2607.5945876176133 * Math.atan2((double) i_20_, (double) i_21_)))) & 0x3fff);
					...
					if ((((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4232) == null) {
						if (((Class98_Sub42) class98_sub42).anInt4210 >= 0) {
							int i_24_ = (((((Class98_Sub42) class98_sub42).anInt4237 != 256) || (((Class98_Sub42) class98_sub42).anInt4223) != 256) ? Class142.method2307((((Class98_Sub42) class98_sub42).anInt4223), (((Class98_Sub42) class98_sub42).anInt4237), i_10_ + -347) : 256);
							if (!((Class98_Sub42) class98_sub42).aBoolean4215) {
								Class37 class37 = Class37.method342((Class76_Sub2.aClass207_3733), (((Class98_Sub42) class98_sub42).anInt4210), 0);
								if (class37 != null) {
								...
								if ((((Class98_Sub42) class98_sub42).aClass98_Sub13_4213) == null)
									((Class98_Sub42) class98_sub42).aClass98_Sub13_4213 = (Class98_Sub13.method1137(Class196.aClass207_1512, (((Class98_Sub42) class98_sub42).anInt4210)));
								if ((((Class98_Sub42) class98_sub42).aClass98_Sub13_4213) != null) {
									if ((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4214) == null)
										((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4214 = (((Class98_Sub42) class98_sub42).aClass98_Sub13_4213.method1132(new int[] { 22050 }));
									if ((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4214) != null) {
										Class98_Sub31_Sub5 class98_sub31_sub5 = (Class98_Sub31_Sub5.method1402((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4214), i_24_, i_17_ << -669300698, i_19_));
										class98_sub31_sub5.method1422(-1);
										Class81.aClass98_Sub31_Sub3_619.method1371(class98_sub31_sub5);
										((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4232 = class98_sub31_sub5;
									}
						...
						((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4232.method1427(i_17_);
						((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4232.method1431(i_19_);
					}
					if ((((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230) == null) {
						if ((((Class98_Sub42) class98_sub42).anIntArray4208 != null) && ((((Class98_Sub42) class98_sub42).anInt4221 -= i_13_) ^ 0xffffffff) >= -1) {
							int i_25_ = (((((Class98_Sub42) class98_sub42).anInt4237 != 256) || (((Class98_Sub42) class98_sub42).anInt4223) != 256) ? (((Class98_Sub42) class98_sub42).anInt4223 + (int) (Math.random() * (double) (-(((Class98_Sub42) class98_sub42).anInt4223) + (((Class98_Sub42) class98_sub42).anInt4237)))) : 256);
							if (((Class98_Sub42) class98_sub42).aBoolean4226) {
								if ((((Class98_Sub42) class98_sub42).aClass98_Sub13_4231) == null) {
									...
									((Class98_Sub42) class98_sub42).aClass98_Sub13_4231 = (Class98_Sub13.method1137(Class196.aClass207_1512, (((Class98_Sub42) class98_sub42).anIntArray4208[i_26_])));
								}
								if ((((Class98_Sub42) class98_sub42).aClass98_Sub13_4231) != null) {
									if ((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4211) == null)
										((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4211 = (((Class98_Sub42) class98_sub42).aClass98_Sub13_4231.method1132(new int[] { 22050 }));
									if ((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4211) != null) {
										Class98_Sub31_Sub5 class98_sub31_sub5 = (Class98_Sub31_Sub5.method1402((((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4211), i_25_, i_17_ << -1521283386, i_19_));
										class98_sub31_sub5.method1422(0);
										Class81.aClass98_Sub31_Sub3_619.method1371(class98_sub31_sub5);
										((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230 = class98_sub31_sub5;
										((Class98_Sub42) class98_sub42).anInt4221 = ((int) (Math.random() * (double) (-(((Class98_Sub42) class98_sub42).anInt4219) + (((Class98_Sub42) class98_sub42).anInt4205))) + ((Class98_Sub42) class98_sub42).anInt4219);
									}
								}
							} else {
								int i_27_ = (int) (Math.random() * (double) (((Class98_Sub42) class98_sub42).anIntArray4208).length);
								Class37 class37 = Class37.method342((Class76_Sub2.aClass207_3733), (((Class98_Sub42) class98_sub42).anIntArray4208[i_27_]), 0);
								if (class37 == null)
									break;
								Class98_Sub24_Sub1 class98_sub24_sub1 = class37.method344().method1269(LinkedList.aClass314_1195);
						...
						((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230.method1427(i_17_);
						((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230.method1431(i_19_);
						if (((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230.method941((byte) 78))
							break while_164_;
						((Class98_Sub42) class98_sub42).aClass98_Sub31_Sub5_4230 = null;
						((Class98_Sub42) class98_sub42).aClass98_Sub13_4231 = null;
						((Class98_Sub42) class98_sub42).aClass98_Sub24_Sub1_4211 = null;
		...
		do {
			try {
				...
				if (aClass207_2109 != null)
					((Class280) this).anInt2102 = aClass207_2109.method2761(0, 1);
