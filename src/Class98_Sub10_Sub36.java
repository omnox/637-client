...
final class Class98_Sub10_Sub36 extends Class98_Sub10 {
	...
	final int[][] method997(int i, int i_4_) {
		try {
			if (i > -76)
				method997(-3, -64);
			int[][] is = ((Class98_Sub10) this).aClass223_3859.method2828(i_4_, 0);
			if (((Class223) ((Class98_Sub10) this).aClass223_3859).aBoolean1683) {
				...
				int[][][] is_8_ = ((Class98_Sub10) this).aClass223_3859.method2830(26279);
				...
				for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > (Class63.anInt492 ^ 0xffffffff); i_9_++) {
					...
					for (int i_15_ = 0; i_15_ < Class25.anInt268; i_15_++) {
						...
						is_13_[i_15_] = Class202.method2702(4080, i_16_ >> -819579196);
						is_12_[i_15_] = Class202.method2702(i_16_ >> 471431020, 4080);
					}
				}
			}
			return is;
			...
			try {
				if (bool == true) {
					...
					for (int i_18_ = 0; ((i_18_ ^ 0xffffffff) > (aClass119Array5743.length ^ 0xffffffff)); i_18_++) {
						...
						int i_19_ = ((Class119) class119).anInt988;
						int i_20_ = ((Class119) class119).anInt985;
						if (i_19_ < 0) {
	...
	final int[] method990(int i, int i_21_) {
		try {
			int[] is = ((Class98_Sub10) this).aClass16_3863.method237((byte) 98, i_21_);
			if (i != 255)
				aClass114Array5744 = null;
			if (((Class16) ((Class98_Sub10) this).aClass16_3863).aBoolean198)
				method1111(true, ((Class98_Sub10) this).aClass16_3863.method238(-124));
			return is;
		} catch (RuntimeException runtimeexception) {
