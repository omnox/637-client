...
final class Class263 {
	...
	static final void method3216(int i) {
		do {
			try {
				...
				if (i != 14059)
					break;
				if (i_0_ > 0 || i_2_ > 0 || (i_1_ ^ 0xffffffff) < -1 || i_3_ > 0) {
					try {
	...
	final void method3218(byte[] is, RSByteBuffer class98_sub22, int i) {
		try {
			if (i == 18762) {
				if (((((RSByteBuffer) class98_sub22).data[((RSByteBuffer) class98_sub22).position]) ^ 0xffffffff) != -32 || ((((RSByteBuffer) class98_sub22).data[((RSByteBuffer) class98_sub22).position - -1]) ^ 0xffffffff) != 116)
					throw new RuntimeException("Invalid GZIP header!");
				if (anInflater1963 == null)
					anInflater1963 = new Inflater(true);
				try {
					anInflater1963.setInput(((RSByteBuffer) class98_sub22).data, 10 + ((RSByteBuffer) class98_sub22).position, (-18 - ((RSByteBuffer) class98_sub22).position + (((RSByteBuffer) class98_sub22).data).length));
	...
	final byte[] method3220(byte i, byte[] is) {
		try {
			...
			((RSByteBuffer) class98_sub22).position = -4 + is.length;
