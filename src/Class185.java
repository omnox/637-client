...
final class Class185 {
	...
	static final Class98_Sub46_Sub17 setCS2StringOrVarc(int varcIndex, int i_0_, int i_1_) {
		try {
			Class98_Sub46_Sub17 class98_sub46_sub17 = ((Class98_Sub46_Sub17) Class76_Sub4.aClass377_3738.method3990((long) i_1_ << 1046340512 | (long) varcIndex, -1));
			if (i_0_ >= -17)
			...
			if (class98_sub46_sub17 == null) {
				...
				Class76_Sub4.aClass377_3738.method3996(class98_sub46_sub17, (((Node) class98_sub46_sub17).uid), -1);
			}
			...
			if (Class76_Sub9.aBoolean3788) {
				...
				if (Class177.anInt1376 == 10) {
					while (Class92.method893(118)) {
						...
						int i_3_ = (((RSByteBuffer) (((OutgoingPacket) class98_sub11).packet)).position);
						Class361.method3919((byte) -61, (((OutgoingPacket) class98_sub11).packet));
						((OutgoingPacket) class98_sub11).packet.method1211((byte) 91, -i_3_ + ((RSByteBuffer) (((OutgoingPacket) class98_sub11).packet)).position);
					...
					if (Class284.aClass98_Sub4_2167 != null) {
						if ((((Class98_Sub4) Class284.aClass98_Sub4_2167).anInt3827) != -1) {
							...
							((OutgoingPacket) class98_sub11).packet.writeShort((((Class98_Sub4) Class284.aClass98_Sub4_2167).anInt3827));
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						...
						Class284.aClass98_Sub4_2167 = (Class48_Sub2_Sub1.aClass265_5531.method3229(i ^ ~0xb, ((Class354) (Class98_Sub46_Sub10.aClass354_6011)).aString3016));
					...
					if (class98_sub17 != null) {
						...
						((OutgoingPacket) class98_sub11).packet.writeShort(i_13_ << 391207055 | i_14_);
						((OutgoingPacket) class98_sub11).packet.writeInt(i + 1571862941, i_12_ | i_11_ << -1879594384);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					}
					if ((Class98_Sub46_Sub1.anInt5949 ^ 0xffffffff) < -1) {
						...
						((OutgoingPacket) class98_sub11).packet.writeByte(3 * Class98_Sub46_Sub1.anInt5949);
						for (int i_15_ = 0; ((Class98_Sub46_Sub1.anInt5949 ^ 0xffffffff) < (i_15_ ^ 0xffffffff)); i_15_++) {
							...
							if ((l ^ 0xffffffffffffffffL) < -65536L)
								l = 65535L;
							((OutgoingPacket) class98_sub11).packet.writeByte(interface7.method17(true));
							((OutgoingPacket) class98_sub11).packet.writeShort((int) l);
						}
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					}
					if ((Class42_Sub1_Sub1.anInt6210 ^ 0xffffffff) < -1)
						Class42_Sub1_Sub1.anInt6210--;
					if (Class64_Sub6.aBoolean3656 && (Class42_Sub1_Sub1.anInt6210 ^ 0xffffffff) >= -1) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort((int) GameWorld.cameraGetVrot >> -52235901, 17624);
						((OutgoingPacket) class98_sub11).packet.writeShort((int) GameWorld.cameraGetHrot >> -449746077);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					}
					if (Class4.aBoolean84 == !Class101.aBoolean856) {
						...
						((OutgoingPacket) class98_sub11).packet.writeByte(!Class4.aBoolean84 ? 0 : 1);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					}
					if (!s_Sub1.aBoolean5207) {
						...
						((OutgoingPacket) class98_sub11).packet.writeByte(0);
						int i_16_ = (((RSByteBuffer) (((OutgoingPacket) class98_sub11).packet)).position);
						RSByteBuffer class98_sub22 = Class98_Sub9.aClass98_Sub27_3856.method1288(true);
						((OutgoingPacket) class98_sub11).packet.method1217(((RSByteBuffer) class98_sub22).data, ((RSByteBuffer) class98_sub22).position, -1, 0);
						((OutgoingPacket) class98_sub11).packet.method1211((byte) 107, (((RSByteBuffer) (((OutgoingPacket) class98_sub11).packet)).position) - i_16_);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					...
					if ((Class177.anInt1376 ^ 0xffffffff) == -11) {
						...
						if (Class224_Sub1.anInt5031 > 750)
								...
								if (i_18_ == 1) {
									...
									if ((i_18_ ^ 0xffffffff) != -4) {
										if (i_18_ == 4) {
											...
											if ((((GameInterfaceData) class293).anInt2233) != i_20_ || ((i_21_ ^ 0xffffffff) != ((((GameInterfaceData) class293).anInt2343) ^ 0xffffffff)) || (i_22_ != (((GameInterfaceData) class293).anInt2210))) {
												((GameInterfaceData) class293).anInt2233 = i_20_;
												((GameInterfaceData) class293).anInt2343 = i_21_;
												((GameInterfaceData) class293).anInt2210 = i_22_;
											...
											if ((i_18_ ^ 0xffffffff) != -7) {
												if ((i_18_ ^ 0xffffffff) != -8) {
													if (i_18_ == 8) {
														...
														if (((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054) != (((GameInterfaceData) class293).anInt2310)) || (((((GameInterfaceData) class293).anInt2218) ^ 0xffffffff) != ((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051) ^ 0xffffffff)) || ((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6053) != (((GameInterfaceData) class293).anInt2251))) {
															((GameInterfaceData) class293).anInt2310 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
															((GameInterfaceData) class293).anInt2251 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6053);
															((GameInterfaceData) class293).anInt2218 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051);
															if ((((GameInterfaceData) class293).anInt2302) != -1) {
																if ((((GameInterfaceData) class293).anInt2232) <= 0) {
																	if ((((GameInterfaceData) class293).anInt2235) > 0)
																		((GameInterfaceData) class293).anInt2251 = 32 * ((GameInterfaceData) class293).anInt2251 / ((GameInterfaceData) class293).anInt2235;
																} else
																	((GameInterfaceData) class293).anInt2251 = (32 * ((GameInterfaceData) class293).anInt2251 / ((GameInterfaceData) class293).anInt2232);
															}
															Class341.method3812(1, class293);
														}
														...
														if ((i_18_ ^ 0xffffffff) != -11) {
															if (i_18_ == 11) {
																GameInterfaceData class293 = (Class159.method2509(i_19_, -9820));
																((GameInterfaceData) class293).aByte2245 = (byte) 0;
																((GameInterfaceData) class293).aByte2240 = (byte) 0;
																((GameInterfaceData) class293).anInt2347 = ((GameInterfaceData) class293).anInt2283 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
																((GameInterfaceData) class293).anInt2299 = ((GameInterfaceData) class293).anInt2229 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051);
																Class341.method3812(1, class293);
															} else if (i_18_ != 12) {
																if ((i_18_ ^ 0xffffffff) == -15) {
																	GameInterfaceData class293 = (Class159.method2509(i_19_, i ^ 0x266f));
																	((GameInterfaceData) class293).anInt2237 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
																} else if ((i_18_ ^ 0xffffffff) != -16) {
																	if (i_18_ != 16) {
																		if (i_18_ == 17) {
																			GameInterfaceData class293 = Class159.method2509(i_19_, -9820);
																			((GameInterfaceData) class293).anInt2211 = ((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054;
																		}
																	} else {
																		GameInterfaceData class293 = Class159.method2509(i_19_, -9820);
																		((GameInterfaceData) class293).anInt2264 = ((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054;
																	}
																} else {
																...
																if ((class293 != null) && (((((GameInterfaceData) class293).type) ^ 0xffffffff) == -1)) {
																	if ((-(((GameInterfaceData) class293).anInt2258) + ((GameInterfaceData) class293).anInt2228) < i_23_)
																		i_23_ = ((GameInterfaceData) class293).anInt2228 + -((GameInterfaceData) class293).anInt2258;
																	if ((i_23_ ^ 0xffffffff) > -1)
																		i_23_ = 0;
																	if ((i_23_ ^ 0xffffffff) != (((GameInterfaceData) class293).anInt2213 ^ 0xffffffff)) {
																		((GameInterfaceData) class293).anInt2213 = i_23_;
																		Class341.method3812(1, class293);
																	}
																}
															}
															...
															GameInterfaceData class293 = (Class159.method2509(i_19_, -9820));
															if ((((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054) ^ 0xffffffff) != ((((GameInterfaceData) class293).anInt2268) ^ 0xffffffff)) || ((((GameInterfaceData) class293).anInt2273) != (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051)) || (((((GameInterfaceData) class293).anInt2346) ^ 0xffffffff) != ((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6053) ^ 0xffffffff))) {
																((GameInterfaceData) class293).anInt2346 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6053);
																((GameInterfaceData) class293).anInt2268 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
																((GameInterfaceData) class293).anInt2273 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051);
																Class341.method3812(1, class293);
															}
														}
													} else {
														GameInterfaceData class293 = (Class159.method2509(i_19_, -9820));
														if ((((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054) ^ 0xffffffff) != ((((GameInterfaceData) class293).anInt2302) ^ 0xffffffff)) || (((((GameInterfaceData) class293).anInt2349) ^ 0xffffffff) != ((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051) ^ 0xffffffff))) {
															((GameInterfaceData) class293).anInt2349 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6051);
															((GameInterfaceData) class293).anInt2302 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
															Class341.method3812(1, class293);
														}
													}
												} else {
													...
													if (!(((GameInterfaceData) class293).aBoolean2295) != !bool) {
														((GameInterfaceData) class293).aBoolean2295 = bool;
												...
												GameInterfaceData class293 = (Class159.method2509(i_19_, -9820));
												if ((i_28_ ^ 0xffffffff) != ((((GameInterfaceData) class293).anInt2236) ^ 0xffffffff)) {
													((GameInterfaceData) class293).anInt2236 = i_28_;
													Class341.method3812(1, class293);
												}
											}
										} else {
											GameInterfaceData class293 = Class159.method2509(i_19_, -9820);
											if (((((GameInterfaceData) class293).anInt2208) != (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054)) || ((((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054) ^ 0xffffffff) == 0) {
												((GameInterfaceData) class293).anInt2208 = (((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054);
												((GameInterfaceData) class293).anInt2303 = 0;
												((GameInterfaceData) class293).anInt2312 = 0;
												((GameInterfaceData) class293).anInt2287 = 1;
												Class97 class97 = (((((GameInterfaceData) class293).anInt2208) ^ 0xffffffff) != 0 ? (Class151_Sub7.aClass183_5001.method2623((((GameInterfaceData) class293).anInt2208), i + 16436)) : null);
												if (class97 != null)
													Class280.method3327((((GameInterfaceData) class293).anInt2303), class97, (byte) 118);
												Class341.method3812(i + 54, class293);
											}
										}
									} else {
										GameInterfaceData class293 = Class159.method2509(i_19_, i + -9767);
										if (!((Class98_Sub46_Sub17) class98_sub46_sub17).aString6052.equals(((GameInterfaceData) class293).aString2225)) {
											((GameInterfaceData) class293).aString2225 = (((Class98_Sub46_Sub17) class98_sub46_sub17).aString6052);
											Class341.method3812(i + 54, class293);
										}
									}
								} else {
							...
							if (Class102.aBoolean889) {
								...
								((OutgoingPacket) class98_sub11).packet.method1232((Class375.anInt3169 | (Class122.anInt1009 << 514171598 | Class333.anInt3385 << -509241764)), (byte) 106);
								Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							...
							for (;;) {
								...
								if ((((GameInterfaceData) class293).anInt2300 ^ 0xffffffff) <= -1) {
									GameInterfaceData class293_29_ = Class159.method2509((((GameInterfaceData) class293).anInt2234), i ^ 0x266f);
									if (class293_29_ == null || (((GameInterfaceData) class293_29_).interfaceComponents) == null || ((((GameInterfaceData) class293).anInt2300 ^ 0xffffffff) <= ((((GameInterfaceData) class293_29_).interfaceComponents).length ^ 0xffffffff)) || ((((GameInterfaceData) class293_29_).interfaceComponents[((GameInterfaceData) class293).anInt2300]) != class293))
										continue;
								}
							...
							for (;;) {
								...
								GameInterfaceData class293 = (((ClientScript2Event) class98_sub21).component);
								if ((((GameInterfaceData) class293).anInt2300 ^ 0xffffffff) <= -1) {
									GameInterfaceData class293_30_ = Class159.method2509((((GameInterfaceData) class293).anInt2234), -9820);
									if (class293_30_ == null || (((GameInterfaceData) class293_30_).interfaceComponents) == null || (((GameInterfaceData) class293).anInt2300 >= (((GameInterfaceData) class293_30_).interfaceComponents).length) || ((((GameInterfaceData) class293_30_).interfaceComponents[((GameInterfaceData) class293).anInt2300]) != class293))
										continue;
								}
								ClientScript2Runtime.method3144(class98_sub21);
							}
							for (;;) {
								...
								if (((GameInterfaceData) class293).anInt2300 >= 0) {
									GameInterfaceData class293_31_ = Class159.method2509((((GameInterfaceData) class293).anInt2234), -9820);
									if (class293_31_ == null || (((GameInterfaceData) class293_31_).interfaceComponents) == null || (((((GameInterfaceData) class293_31_).interfaceComponents).length ^ 0xffffffff) >= (((GameInterfaceData) class293).anInt2300 ^ 0xffffffff)) || (class293 != (((GameInterfaceData) class293_31_).interfaceComponents[(((GameInterfaceData) class293).anInt2300)])))
										continue;
								}
								ClientScript2Runtime.method3144(class98_sub21);
							}
							...
							if (Player.rights > 0 && RtKeyListener.key_listener.is_key_down(82, 5503) && RtKeyListener.key_listener.is_key_down(81, 5503) && (Class319.mouse_scroll_delta ^ 0xffffffff) != -1) {
								int scrollHeight = ((((AnimableEntity) (Player.selfPlayer)).height_level) - Class319.mouse_scroll_delta);
								if (scrollHeight >= 0) {
									if (scrollHeight > 3)
										scrollHeight = 3;
								} else
									scrollHeight = 0;
								Class351.shiftClickTele((((Mobile) (Player.selfPlayer)).walkQueueZ[0]) + aa_Sub2.anInt3562, (Class272.anInt2038 + (((Mobile) (Player.selfPlayer)).walkQueueX[0])), scrollHeight, 52);
							...
							for (Class246_Sub4_Sub1 class246_sub4_sub1 = ((Class246_Sub4_Sub1) Class119.aClass218_986.method2803((byte) 15)); class246_sub4_sub1 != null; class246_sub4_sub1 = ((Class246_Sub4_Sub1) Class119.aClass218_986.method2809(false))) {
								if (((-5L + Class343.method3819(i ^ 0x1a) / 1000L) ^ 0xffffffffffffffffL) < ((long) ((Class246_Sub4_Sub1) class246_sub4_sub1).anInt6172 ^ 0xffffffffffffffffL)) {
									if (((Class246_Sub4_Sub1) class246_sub4_sub1).aShort6167 > 0)
										Class98_Sub45.add_message((byte) 125, 5, (((Class246_Sub4_Sub1) class246_sub4_sub1).friendName + (TextResources.HAS_LOGGED_IN.get_text(Class374.anInt3159))), 0, "", "", "");
									if ((((Class246_Sub4_Sub1) class246_sub4_sub1).aShort6167 ^ 0xffffffff) == -1)
										Class98_Sub45.add_message((byte) -120, 5, (((Class246_Sub4_Sub1) class246_sub4_sub1).friendName + (TextResources.HAS_LOGGED_OUT.get_text(Class374.anInt3159))), 0, "", "", "");
