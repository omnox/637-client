...
final class Class362 {
	...
	private RuneScapeCache aClass207_3092;
	private RuneScapeCache aClass207_3093;

	static final Class93_Sub1_Sub1 method3924(int i, RSByteBuffer class98_sub22) {
		try {
			Class93_Sub1 class93_sub1 = Class338.method3781((byte) 94, class98_sub22);
	...
	Class362(RuneScapeCache class207, RuneScapeCache class207_1_) {
		try {
			aClass207_3092 = class207;
			aClass207_3093 = class207_1_;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("vu.<init>(" + (class207 != null ? "{...}" : "null") + ',' + (class207_1_ != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method3926(int i, int i_2_, int i_3_, int i_4_, ha var_ha, int i_5_, int i_6_, int i_7_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("vu.D(" + i + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final Interface18 method3927(byte i, Interface21 interface21) {
		try {
			...
			if (Class98_Sub10_Sub3.aClass113_5546 == class113)
				return new Class134_Sub1(aClass207_3092, (Class337_Sub1) interface21);
			if (class113 == Class47.aClass113_399)
				return new Class373_Sub2(aClass207_3092, aClass207_3093, (Class93_Sub3) interface21);
			if (Class137.aClass113_1078 == class113)
				return new Class373_Sub3(aClass207_3092, aClass207_3093, (Class93_Sub2) interface21);
			if (class113 == Class98_Sub44.aClass113_4245)
				return new PacketParser(aClass207_3092, aClass207_3093, (Class93_Sub1) interface21);
			if (Class308.aClass113_2582 == class113)
				return new Class19(aClass207_3092, aClass207_3093, (Class315) interface21);
			if (Class4.aClass113_80 == class113)
				return new Class5(aClass207_3092, (Class367) interface21);
			if (class113 == Class18.aClass113_210)
				return new Class373_Sub1_Sub1(aClass207_3092, aClass207_3093, (Class93_Sub1_Sub1) interface21);
			if (i != 62)
				aClass207_3093 = null;
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("vu.C(" + i + ',' + (interface21 != null ? "{...}" : "null") + ')'));
		}
	}
}
