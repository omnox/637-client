				...
				if (aClass175Array2903 != null) {
					...
					for (int i_3_ = 0; aClass175Array2903.length > i_3_; i_3_++) {
						...
						if (class175.method2575(anInt2898, anInt2892, anInt2905, anInt2896)) {
							is[anInt2904] = ((Class175) class175).anInt1361;
													...
													do {
														if (i_7_ != 32 && i_7_ != 160 && ((i_7_ ^ 0xffffffff) != -96) && ((i_7_ ^ 0xffffffff) != -46)) {
															...
															if (i_7_ == 237 || ((i_7_ ^ 0xffffffff) == -239) || ((i_7_ ^ 0xffffffff) == -240) || i_7_ == 205 || ((i_7_ ^ 0xffffffff) == -207) || i_7_ == 207)
																break while_234_;
															if (((i_7_ ^ 0xffffffff) == -243) || i_7_ == 243 || ((i_7_ ^ 0xffffffff) == -245) || i_7_ == 246 || ((i_7_ ^ 0xffffffff) == -246) || ((i_7_ ^ 0xffffffff) == -211) || ((i_7_ ^ 0xffffffff) == -212) || ((i_7_ ^ 0xffffffff) == -213) || i_7_ == 214 || i_7_ == 213)
																break while_235_;
		...
		try {
			...
			if ((anInt2902 ^ 0xffffffff) != 0 && anInt2897 != 0) {
				...
				if (aClass332_2894 == null && Class98_Sub10_Sub8.aD5578.method8(115, anInt2902)) {
					int[] is = ((((Class238) class238).anInt1818 ^ 0xffffffff) != -3 ? Class98_Sub10_Sub8.aD5578.method9(anInt2902, (byte) -112, anInt2897, 0.7F, false, anInt2897) : Class98_Sub10_Sub8.aD5578.method13(111, anInt2897, anInt2902, 0.7F, false, anInt2897));
					aClass332_2894 = var_ha.method1748(-7962, 0, anInt2897, anInt2897, is, anInt2897);
				}
				if ((((Class238) class238).anInt1818 ^ 0xffffffff) == -3)
					var_ha.aa(i_12_, i_10_, i_14_, i_13_, i_15_, 0);
				if (aClass332_2894 != null) {
					int i_16_ = ((((Class238) class238).anInt1818 ^ 0xffffffff) != -3 ? 0 : 1);
