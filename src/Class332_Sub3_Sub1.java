...
final class Class332_Sub3_Sub1 extends Class332_Sub3 {
		...
		if (i_5_ > 0 && i_6_ > 0) {
			...
			for (int i_17_ = i_15_; i_17_ < i_16_; i_17_++) {
				...
				for (int i_24_ = -i_19_; i_24_ < 0; i_24_++) {
					...
					is_14_[i_9_++] = ((((i_25_ & 0xff00ff) * i_26_ + (i_28_ & 0xff00ff) * i_27_) & ~0xff00ff) + (((i_25_ & 0xff00) * i_26_ + (i_28_ & 0xff00) * i_27_) & 0xff0000)) >> 8;
				}
				i_3_ += i_23_ + i_8_;
				i_9_ += i_23_ + i_7_;
			}
		...
		if (Class332_Sub3.anInt5444 == 0) {
							...
							if (i_39_ == 0) {
								...
								if (i_38_ == 1) {
									...
									if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
										int i_59_ = is_37_[i_36_];
										is_37_[i_36_] = ((((i_56_ & 0xff00ff) * i_57_ + (i_59_ & 0xff00ff) * i_58_) & ~0xff00ff) + (((i_56_ & 0xff00) * i_57_ + (i_59_ & 0xff00) * i_58_) & 0xff0000)) >> 8;
									} else if (i_57_ != 255) {
										int i_60_ = (((i_56_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_61_ = (((i_56_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_62_ = (((i_56_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
										i_56_ = (i_60_ | i_61_ | i_62_) >>> 8;
										int i_63_ = is_37_[i_36_];
										is_37_[i_36_] = ((((i_56_ & 0xff00ff) * i_57_ + (i_63_ & 0xff00ff) * i_58_) & ~0xff00ff) + (((i_56_ & 0xff00) * i_57_ + (i_63_ & 0xff00) * i_58_) & 0xff0000)) >> 8;
									} else {
										int i_64_ = (((i_56_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_65_ = (((i_56_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_66_ = (((i_56_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									...
									int i_72_ = (((i_67_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
									int i_73_ = 256 - i_72_;
									if (i_72_ != 255) {
										i_67_ = i_71_;
										i_71_ = is_37_[i_36_];
										i_71_ = ((((i_67_ & 0xff00ff) * i_72_ + (i_71_ & 0xff00ff) * i_73_) & ~0xff00ff) + (((i_67_ & 0xff00) * i_72_ + (i_71_ & 0xff00) * i_73_) & 0xff0000)) >> 8;
									}
									is_37_[i_36_] = i_71_;
								} else if (i_38_ == 2) {
									...
									int i_78_ = (((i_74_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
									i_74_ = (((i_77_ | i_78_) >>> 8) + Class332_Sub3.anInt5440);
									int i_79_ = is_37_[i_36_];
									is_37_[i_36_] = ((((i_74_ & 0xff00ff) * i_75_ + (i_79_ & 0xff00ff) * i_76_) & ~0xff00ff) + (((i_74_ & 0xff00) * i_75_ + (i_79_ & 0xff00) * i_76_) & 0xff0000)) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_39_ == 2) {
								if (i_38_ == 1) {
									...
									int i_89_ = i_84_ + i_88_;
									int i_90_ = ((i_84_ & 0xff00ff) + (i_88_ & 0xff00ff));
									...
									i_91_ = i_93_ - i_95_ | i_95_ - (i_95_ >>> 8);
									i_95_ = is_37_[i_36_];
									i_93_ = i_91_ + i_95_;
									i_94_ = (i_91_ & 0xff00ff) + (i_95_ & 0xff00ff);
									...
									int i_100_ = i_96_ + i_99_;
									int i_101_ = ((i_96_ & 0xff00ff) + (i_99_ & 0xff00ff));
									i_99_ = ((i_101_ & 0x1000100) + (i_100_ - i_101_ & 0x10000));
									is_37_[i_36_] = i_100_ - i_99_ | i_99_ - (i_99_ >>> 8);
								}
							} else
								throw new IllegalArgumentException();
						}
						...
						for (/**/; i_106_ < 0; i_106_++) {
							...
							if (i_112_ == 0) {
								...
								if (i_111_ == 1) {
									...
									if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
										int i_132_ = is_110_[i_109_];
										is_110_[i_109_] = ((((i_129_ & 0xff00ff) * i_130_ + ((i_132_ & 0xff00ff) * i_131_)) & ~0xff00ff) + (((i_129_ & 0xff00) * i_130_ + ((i_132_ & 0xff00) * i_131_)) & 0xff0000)) >> 8;
									} else if (i_130_ != 255) {
										int i_133_ = (((i_129_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_134_ = (((i_129_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_135_ = (((i_129_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
										i_129_ = (i_133_ | i_134_ | i_135_) >>> 8;
										int i_136_ = is_110_[i_109_];
										is_110_[i_109_] = ((((i_129_ & 0xff00ff) * i_130_ + ((i_136_ & 0xff00ff) * i_131_)) & ~0xff00ff) + (((i_129_ & 0xff00) * i_130_ + ((i_136_ & 0xff00) * i_131_)) & 0xff0000)) >> 8;
									} else {
										int i_137_ = (((i_129_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_138_ = (((i_129_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_139_ = (((i_129_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									...
									i_144_ = i_142_ - i_144_ | i_144_ - (i_144_ >>> 8);
									int i_145_ = (((i_140_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
									int i_146_ = 256 - i_145_;
									if (i_145_ != 255) {
										i_140_ = i_144_;
										i_144_ = is_110_[i_109_];
										i_144_ = ((((i_140_ & 0xff00ff) * i_145_ + ((i_144_ & 0xff00ff) * i_146_)) & ~0xff00ff) + (((i_140_ & 0xff00) * i_145_ + ((i_144_ & 0xff00) * i_146_)) & 0xff0000)) >> 8;
									}
									...
									int i_151_ = (((i_147_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
									i_147_ = (((i_150_ | i_151_) >>> 8) + Class332_Sub3.anInt5440);
									int i_152_ = is_110_[i_109_];
									is_110_[i_109_] = ((((i_147_ & 0xff00ff) * i_148_ + (i_152_ & 0xff00ff) * i_149_) & ~0xff00ff) + (((i_147_ & 0xff00) * i_148_ + (i_152_ & 0xff00) * i_149_) & 0xff0000)) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_112_ == 2) {
								if (i_111_ == 1) {
									...
									int i_163_ = ((i_157_ & 0xff00ff) + (i_161_ & 0xff00ff));
									...
									int i_168_ = ((i_167_ & 0x1000100) + (i_166_ - i_167_ & 0x10000));
									i_164_ = i_166_ - i_168_ | i_168_ - (i_168_ >>> 8);
									i_168_ = is_110_[i_109_];
									i_166_ = i_164_ + i_168_;
									i_167_ = (i_164_ & 0xff00ff) + (i_168_ & 0xff00ff);
									...
									int i_173_ = i_169_ + i_172_;
									int i_174_ = ((i_169_ & 0xff00ff) + (i_172_ & 0xff00ff));
									i_172_ = ((i_174_ & 0x1000100) + (i_173_ - i_174_ & 0x10000));
									is_110_[i_109_] = i_173_ - i_172_ | i_172_ - (i_172_ >>> 8);
								}
							} else
								throw new IllegalArgumentException();
						...
						for (/**/; i_179_ < 0; i_179_++) {
							...
							if (i_186_ == 0) {
								...
								if (i_185_ == 1) {
									...
									if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
										int i_206_ = is_184_[i_183_];
										is_184_[i_183_] = ((((i_203_ & 0xff00ff) * i_204_ + ((i_206_ & 0xff00ff) * i_205_)) & ~0xff00ff) + (((i_203_ & 0xff00) * i_204_ + ((i_206_ & 0xff00) * i_205_)) & 0xff0000)) >> 8;
									} else if (i_204_ != 255) {
										...
										int i_210_ = is_184_[i_183_];
										is_184_[i_183_] = ((((i_203_ & 0xff00ff) * i_204_ + ((i_210_ & 0xff00ff) * i_205_)) & ~0xff00ff) + (((i_203_ & 0xff00) * i_204_ + ((i_210_ & 0xff00) * i_205_)) & 0xff0000)) >> 8;
									} else {
									...
									int i_219_ = (((i_214_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
									int i_220_ = 256 - i_219_;
									if (i_219_ != 255) {
										i_214_ = i_218_;
										i_218_ = is_184_[i_183_];
										i_218_ = ((((i_214_ & 0xff00ff) * i_219_ + ((i_218_ & 0xff00ff) * i_220_)) & ~0xff00ff) + (((i_214_ & 0xff00) * i_219_ + ((i_218_ & 0xff00) * i_220_)) & 0xff0000)) >> 8;
									}
									...
									int i_225_ = (((i_221_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
									i_221_ = (((i_224_ | i_225_) >>> 8) + Class332_Sub3.anInt5440);
									int i_226_ = is_184_[i_183_];
									is_184_[i_183_] = ((((i_221_ & 0xff00ff) * i_222_ + (i_226_ & 0xff00ff) * i_223_) & ~0xff00ff) + (((i_221_ & 0xff00) * i_222_ + (i_226_ & 0xff00) * i_223_) & 0xff0000)) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_186_ == 2) {
								if (i_185_ == 1) {
									...
									int i_236_ = i_231_ + i_235_;
									int i_237_ = ((i_231_ & 0xff00ff) + (i_235_ & 0xff00ff));
									...
									i_238_ = i_240_ - i_242_ | i_242_ - (i_242_ >>> 8);
									i_242_ = is_184_[i_183_];
									i_240_ = i_238_ + i_242_;
									i_241_ = (i_238_ & 0xff00ff) + (i_242_ & 0xff00ff);
									...
									int i_247_ = i_243_ + i_246_;
									int i_248_ = ((i_243_ & 0xff00ff) + (i_246_ & 0xff00ff));
									i_246_ = ((i_248_ & 0x1000100) + (i_247_ - i_248_ & 0x10000));
									is_184_[i_183_] = i_247_ - i_246_ | i_246_ - (i_246_ >>> 8);
								}
							} else
								throw new IllegalArgumentException();
			...
			if (Class332_Sub3.anInt5436 == 0) {
						...
						for (/**/; i_253_ < 0; i_253_++) {
							...
							if (i_259_ == 0) {
								...
								if (i_258_ == 1) {
									...
									if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
										int i_279_ = is_257_[i_256_];
										is_257_[i_256_] = ((((i_276_ & 0xff00ff) * i_277_ + ((i_279_ & 0xff00ff) * i_278_)) & ~0xff00ff) + (((i_276_ & 0xff00) * i_277_ + ((i_279_ & 0xff00) * i_278_)) & 0xff0000)) >> 8;
									} else if (i_277_ != 255) {
										int i_280_ = (((i_276_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_281_ = (((i_276_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_282_ = (((i_276_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
										i_276_ = (i_280_ | i_281_ | i_282_) >>> 8;
										int i_283_ = is_257_[i_256_];
										is_257_[i_256_] = ((((i_276_ & 0xff00ff) * i_277_ + ((i_283_ & 0xff00ff) * i_278_)) & ~0xff00ff) + (((i_276_ & 0xff00) * i_277_ + ((i_283_ & 0xff00) * i_278_)) & 0xff0000)) >> 8;
									} else {
										int i_284_ = (((i_276_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
										int i_285_ = (((i_276_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
										int i_286_ = (((i_276_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									...
									int i_292_ = (((i_287_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
									int i_293_ = 256 - i_292_;
									if (i_292_ != 255) {
										i_287_ = i_291_;
										i_291_ = is_257_[i_256_];
										i_291_ = ((((i_287_ & 0xff00ff) * i_292_ + ((i_291_ & 0xff00ff) * i_293_)) & ~0xff00ff) + (((i_287_ & 0xff00) * i_292_ + ((i_291_ & 0xff00) * i_293_)) & 0xff0000)) >> 8;
									}
									...
									int i_298_ = (((i_294_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
									i_294_ = (((i_297_ | i_298_) >>> 8) + Class332_Sub3.anInt5440);
									int i_299_ = is_257_[i_256_];
									is_257_[i_256_] = ((((i_294_ & 0xff00ff) * i_295_ + (i_299_ & 0xff00ff) * i_296_) & ~0xff00ff) + (((i_294_ & 0xff00) * i_295_ + (i_299_ & 0xff00) * i_296_) & 0xff0000)) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_259_ == 2) {
								if (i_258_ == 1) {
									...
									i_311_ = i_313_ - i_315_ | i_315_ - (i_315_ >>> 8);
									i_315_ = is_257_[i_256_];
									i_313_ = i_311_ + i_315_;
									i_314_ = (i_311_ & 0xff00ff) + (i_315_ & 0xff00ff);
									...
									is_257_[i_256_] = i_320_ - i_319_ | i_319_ - (i_319_ >>> 8);
								}
							} else
								throw new IllegalArgumentException();
				...
				while (i_322_ < 0) {
					...
					int i_324_ = Class332_Sub3.anInt5450 + Class332_Sub3.anInt5425;
					...
					for (/**/; i_326_ < 0; i_326_++) {
						...
						if (i_332_ == 0) {
							...
							if (i_331_ == 1) {
								...
								if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
									int i_352_ = is_330_[i_329_];
									is_330_[i_329_] = ((((i_349_ & 0xff00ff) * i_350_ + (i_352_ & 0xff00ff) * i_351_) & ~0xff00ff) + (((i_349_ & 0xff00) * i_350_ + (i_352_ & 0xff00) * i_351_) & 0xff0000)) >> 8;
								} else if (i_350_ != 255) {
									int i_353_ = (((i_349_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_354_ = (((i_349_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_355_ = (((i_349_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									i_349_ = (i_353_ | i_354_ | i_355_) >>> 8;
									int i_356_ = is_330_[i_329_];
									is_330_[i_329_] = ((((i_349_ & 0xff00ff) * i_350_ + (i_356_ & 0xff00ff) * i_351_) & ~0xff00ff) + (((i_349_ & 0xff00) * i_350_ + (i_356_ & 0xff00) * i_351_) & 0xff0000)) >> 8;
								} else {
									int i_357_ = (((i_349_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_358_ = (((i_349_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_359_ = (((i_349_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
								...
								int i_365_ = (((i_360_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
								int i_366_ = 256 - i_365_;
								if (i_365_ != 255) {
									i_360_ = i_364_;
									i_364_ = is_330_[i_329_];
									i_364_ = ((((i_360_ & 0xff00ff) * i_365_ + (i_364_ & 0xff00ff) * i_366_) & ~0xff00ff) + (((i_360_ & 0xff00) * i_365_ + (i_364_ & 0xff00) * i_366_) & 0xff0000)) >> 8;
								}
								...
								int i_371_ = (((i_367_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
								i_367_ = (((i_370_ | i_371_) >>> 8) + Class332_Sub3.anInt5440);
								int i_372_ = is_330_[i_329_];
								is_330_[i_329_] = ((((i_367_ & 0xff00ff) * i_368_ + (i_372_ & 0xff00ff) * i_369_) & ~0xff00ff) + (((i_367_ & 0xff00) * i_368_ + (i_372_ & 0xff00) * i_369_) & 0xff0000)) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_332_ == 2) {
							if (i_331_ == 1) {
								...
								int i_382_ = i_377_ + i_381_;
								int i_383_ = ((i_377_ & 0xff00ff) + (i_381_ & 0xff00ff));
								...
								i_384_ = i_386_ - i_388_ | i_388_ - (i_388_ >>> 8);
								i_388_ = is_330_[i_329_];
								i_386_ = i_384_ + i_388_;
								i_387_ = (i_384_ & 0xff00ff) + (i_388_ & 0xff00ff);
								...
								is_330_[i_329_] = i_393_ - i_392_ | i_392_ - (i_392_ >>> 8);
							}
						} else
							throw new IllegalArgumentException();
				...
				while (i_395_ < 0) {
					...
					int i_397_ = Class332_Sub3.anInt5450 + Class332_Sub3.anInt5425;
					...
					for (/**/; i_399_ < 0; i_399_++) {
						...
						if (i_405_ == 0) {
							...
							if (i_404_ == 1) {
								...
								if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
									int i_425_ = is_403_[i_402_];
									is_403_[i_402_] = ((((i_422_ & 0xff00ff) * i_423_ + (i_425_ & 0xff00ff) * i_424_) & ~0xff00ff) + (((i_422_ & 0xff00) * i_423_ + (i_425_ & 0xff00) * i_424_) & 0xff0000)) >> 8;
								} else if (i_423_ != 255) {
									int i_426_ = (((i_422_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_427_ = (((i_422_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_428_ = (((i_422_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									i_422_ = (i_426_ | i_427_ | i_428_) >>> 8;
									int i_429_ = is_403_[i_402_];
									is_403_[i_402_] = ((((i_422_ & 0xff00ff) * i_423_ + (i_429_ & 0xff00ff) * i_424_) & ~0xff00ff) + (((i_422_ & 0xff00) * i_423_ + (i_429_ & 0xff00) * i_424_) & 0xff0000)) >> 8;
								} else {
									int i_430_ = (((i_422_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_431_ = (((i_422_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_432_ = (((i_422_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
								...
								int i_438_ = (((i_433_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
								int i_439_ = 256 - i_438_;
								if (i_438_ != 255) {
									i_433_ = i_437_;
									i_437_ = is_403_[i_402_];
									i_437_ = ((((i_433_ & 0xff00ff) * i_438_ + (i_437_ & 0xff00ff) * i_439_) & ~0xff00ff) + (((i_433_ & 0xff00) * i_438_ + (i_437_ & 0xff00) * i_439_) & 0xff0000)) >> 8;
								}
								...
								int i_444_ = (((i_440_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
								i_440_ = (((i_443_ | i_444_) >>> 8) + Class332_Sub3.anInt5440);
								int i_445_ = is_403_[i_402_];
								is_403_[i_402_] = ((((i_440_ & 0xff00ff) * i_441_ + (i_445_ & 0xff00ff) * i_442_) & ~0xff00ff) + (((i_440_ & 0xff00) * i_441_ + (i_445_ & 0xff00) * i_442_) & 0xff0000)) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_405_ == 2) {
							if (i_404_ == 1) {
								...
								i_457_ = i_459_ - i_461_ | i_461_ - (i_461_ >>> 8);
								i_461_ = is_403_[i_402_];
								i_459_ = i_457_ + i_461_;
								i_460_ = (i_457_ & 0xff00ff) + (i_461_ & 0xff00ff);
								...
								int i_466_ = i_462_ + i_465_;
								int i_467_ = ((i_462_ & 0xff00ff) + (i_465_ & 0xff00ff));
								i_465_ = (i_467_ & 0x1000100) + (i_466_ - i_467_ & 0x10000);
								is_403_[i_402_] = i_466_ - i_465_ | i_465_ - (i_465_ >>> 8);
							}
						} else
							throw new IllegalArgumentException();
					...
					for (/**/; i_472_ < 0; i_472_++) {
						...
						if (i_479_ == 0) {
							...
							if (i_478_ == 1) {
								...
								if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
									int i_499_ = is_477_[i_476_];
									is_477_[i_476_] = ((((i_496_ & 0xff00ff) * i_497_ + (i_499_ & 0xff00ff) * i_498_) & ~0xff00ff) + (((i_496_ & 0xff00) * i_497_ + (i_499_ & 0xff00) * i_498_) & 0xff0000)) >> 8;
								} else if (i_497_ != 255) {
									int i_500_ = (((i_496_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_501_ = (((i_496_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_502_ = (((i_496_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
									i_496_ = (i_500_ | i_501_ | i_502_) >>> 8;
									int i_503_ = is_477_[i_476_];
									is_477_[i_476_] = ((((i_496_ & 0xff00ff) * i_497_ + (i_503_ & 0xff00ff) * i_498_) & ~0xff00ff) + (((i_496_ & 0xff00) * i_497_ + (i_503_ & 0xff00) * i_498_) & 0xff0000)) >> 8;
								} else {
									int i_504_ = (((i_496_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
									int i_505_ = (((i_496_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
									int i_506_ = (((i_496_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
								...
								int i_511_ = ((i_510_ & 0x1000100) + (i_509_ - i_510_ & 0x10000));
								i_511_ = i_509_ - i_511_ | i_511_ - (i_511_ >>> 8);
								int i_512_ = (((i_507_ >>> 24) * Class332_Sub3.anInt5449) >> 8);
								int i_513_ = 256 - i_512_;
								if (i_512_ != 255) {
									i_507_ = i_511_;
									i_511_ = is_477_[i_476_];
									i_511_ = ((((i_507_ & 0xff00ff) * i_512_ + (i_511_ & 0xff00ff) * i_513_) & ~0xff00ff) + (((i_507_ & 0xff00) * i_512_ + (i_511_ & 0xff00) * i_513_) & 0xff0000)) >> 8;
								}
								...
								int i_518_ = (((i_514_ & 0xff00) * Class332_Sub3.anInt5449) & 0xff0000);
								i_514_ = (((i_517_ | i_518_) >>> 8) + Class332_Sub3.anInt5440);
								int i_519_ = is_477_[i_476_];
								is_477_[i_476_] = ((((i_514_ & 0xff00ff) * i_515_ + (i_519_ & 0xff00ff) * i_516_) & ~0xff00ff) + (((i_514_ & 0xff00) * i_515_ + (i_519_ & 0xff00) * i_516_) & 0xff0000)) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_479_ == 2) {
							if (i_478_ == 1) {
								...
								int i_529_ = i_524_ + i_528_;
								int i_530_ = ((i_524_ & 0xff00ff) + (i_528_ & 0xff00ff));
								...
								int i_535_ = ((i_534_ & 0x1000100) + (i_533_ - i_534_ & 0x10000));
								i_531_ = i_533_ - i_535_ | i_535_ - (i_535_ >>> 8);
								i_535_ = is_477_[i_476_];
								i_533_ = i_531_ + i_535_;
								i_534_ = (i_531_ & 0xff00ff) + (i_535_ & 0xff00ff);
								...
								int i_540_ = i_536_ + i_539_;
								int i_541_ = ((i_536_ & 0xff00ff) + (i_539_ & 0xff00ff));
								i_539_ = (i_541_ & 0x1000100) + (i_540_ - i_541_ & 0x10000);
								is_477_[i_476_] = i_540_ - i_539_ | i_539_ - (i_539_ >>> 8);
							}
						} else
							throw new IllegalArgumentException();
			...
			for (int i_542_ = Class332_Sub3.anInt5431; i_542_ < 0; i_542_++) {
				...
				if (i_544_ < 0) {
					int i_547_ = ((Class332_Sub3.anInt5444 - 1 - i_544_) / Class332_Sub3.anInt5444);
					i_546_ += i_547_;
				...
				for (/**/; i_546_ < 0; i_546_++) {
					...
					if (i_553_ == 0) {
						...
						if (i_552_ == 1) {
							...
							if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
								int i_573_ = is_551_[i_550_];
								is_551_[i_550_] = ((((i_570_ & 0xff00ff) * i_571_ + (i_573_ & 0xff00ff) * i_572_) & ~0xff00ff) + (((i_570_ & 0xff00) * i_571_ + (i_573_ & 0xff00) * i_572_) & 0xff0000)) >> 8;
							} else if (i_571_ != 255) {
								int i_574_ = (((i_570_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
								int i_575_ = (((i_570_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
								int i_576_ = (((i_570_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
								i_570_ = (i_574_ | i_575_ | i_576_) >>> 8;
								int i_577_ = is_551_[i_550_];
								is_551_[i_550_] = ((((i_570_ & 0xff00ff) * i_571_ + (i_577_ & 0xff00ff) * i_572_) & ~0xff00ff) + (((i_570_ & 0xff00) * i_571_ + (i_577_ & 0xff00) * i_572_) & 0xff0000)) >> 8;
							} else {
								int i_578_ = (((i_570_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
								int i_579_ = (((i_570_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
								int i_580_ = (((i_570_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
							...
							int i_585_ = ((i_584_ & 0x1000100) + (i_583_ - i_584_ & 0x10000));
							i_585_ = i_583_ - i_585_ | i_585_ - (i_585_ >>> 8);
							int i_586_ = ((i_581_ >>> 24) * Class332_Sub3.anInt5449 >> 8);
							int i_587_ = 256 - i_586_;
							if (i_586_ != 255) {
								i_581_ = i_585_;
								i_585_ = is_551_[i_550_];
								i_585_ = ((((i_581_ & 0xff00ff) * i_586_ + (i_585_ & 0xff00ff) * i_587_) & ~0xff00ff) + (((i_581_ & 0xff00) * i_586_ + (i_585_ & 0xff00) * i_587_) & 0xff0000)) >> 8;
							}
							...
							int i_592_ = ((i_588_ & 0xff00) * Class332_Sub3.anInt5449 & 0xff0000);
							i_588_ = (((i_591_ | i_592_) >>> 8) + Class332_Sub3.anInt5440);
							int i_593_ = is_551_[i_550_];
							is_551_[i_550_] = ((((i_588_ & 0xff00ff) * i_589_ + (i_593_ & 0xff00ff) * i_590_) & ~0xff00ff) + (((i_588_ & 0xff00) * i_589_ + (i_593_ & 0xff00) * i_590_) & 0xff0000)) >> 8;
						} else
							throw new IllegalArgumentException();
					} else if (i_553_ == 2) {
						if (i_552_ == 1) {
							...
							int i_603_ = i_598_ + i_602_;
							int i_604_ = (i_598_ & 0xff00ff) + (i_602_ & 0xff00ff);
							...
							int i_609_ = ((i_608_ & 0x1000100) + (i_607_ - i_608_ & 0x10000));
							...
							int i_615_ = (i_610_ & 0xff00ff) + (i_613_ & 0xff00ff);
							i_613_ = (i_615_ & 0x1000100) + (i_614_ - i_615_ & 0x10000);
							is_551_[i_550_] = i_614_ - i_613_ | i_613_ - (i_613_ >>> 8);
						}
					} else
						throw new IllegalArgumentException();
			...
			for (int i_616_ = Class332_Sub3.anInt5431; i_616_ < 0; i_616_++) {
				...
				if (i_618_ < 0) {
					int i_621_ = ((Class332_Sub3.anInt5444 - 1 - i_618_) / Class332_Sub3.anInt5444);
					i_620_ += i_621_;
				...
				for (/**/; i_620_ < 0; i_620_++) {
					...
					if (i_627_ == 0) {
						...
						if (i_626_ == 1) {
							...
							if ((Class332_Sub3.anInt5432 & 0xffffff) == 16777215) {
								int i_647_ = is_625_[i_624_];
								is_625_[i_624_] = ((((i_644_ & 0xff00ff) * i_645_ + (i_647_ & 0xff00ff) * i_646_) & ~0xff00ff) + (((i_644_ & 0xff00) * i_645_ + (i_647_ & 0xff00) * i_646_) & 0xff0000)) >> 8;
							} else if (i_645_ != 255) {
								int i_648_ = (((i_644_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
								int i_649_ = (((i_644_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
								int i_650_ = (((i_644_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
								i_644_ = (i_648_ | i_649_ | i_650_) >>> 8;
								int i_651_ = is_625_[i_624_];
								is_625_[i_624_] = ((((i_644_ & 0xff00ff) * i_645_ + (i_651_ & 0xff00ff) * i_646_) & ~0xff00ff) + (((i_644_ & 0xff00) * i_645_ + (i_651_ & 0xff00) * i_646_) & 0xff0000)) >> 8;
							} else {
								int i_652_ = (((i_644_ & 0xff0000) * Class332_Sub3.anInt5435) & ~0xffffff);
								int i_653_ = (((i_644_ & 0xff00) * Class332_Sub3.anInt5457) & 0xff0000);
								int i_654_ = (((i_644_ & 0xff) * Class332_Sub3.anInt5427) & 0xff00);
							...
							int i_660_ = ((i_655_ >>> 24) * Class332_Sub3.anInt5449 >> 8);
							int i_661_ = 256 - i_660_;
							if (i_660_ != 255) {
								i_655_ = i_659_;
								i_659_ = is_625_[i_624_];
								i_659_ = ((((i_655_ & 0xff00ff) * i_660_ + (i_659_ & 0xff00ff) * i_661_) & ~0xff00ff) + (((i_655_ & 0xff00) * i_660_ + (i_659_ & 0xff00) * i_661_) & 0xff0000)) >> 8;
							}
							...
							int i_666_ = ((i_662_ & 0xff00) * Class332_Sub3.anInt5449 & 0xff0000);
							i_662_ = (((i_665_ | i_666_) >>> 8) + Class332_Sub3.anInt5440);
							int i_667_ = is_625_[i_624_];
							is_625_[i_624_] = ((((i_662_ & 0xff00ff) * i_663_ + (i_667_ & 0xff00ff) * i_664_) & ~0xff00ff) + (((i_662_ & 0xff00) * i_663_ + (i_667_ & 0xff00) * i_664_) & 0xff0000)) >> 8;
						} else
							throw new IllegalArgumentException();
					} else if (i_627_ == 2) {
						if (i_626_ == 1) {
							...
							int i_677_ = i_672_ + i_676_;
							int i_678_ = (i_672_ & 0xff00ff) + (i_676_ & 0xff00ff);
							...
							int i_683_ = ((i_682_ & 0x1000100) + (i_681_ - i_682_ & 0x10000));
							...
							int i_688_ = i_684_ + i_687_;
							int i_689_ = (i_684_ & 0xff00ff) + (i_687_ & 0xff00ff);
							i_687_ = (i_689_ & 0x1000100) + (i_688_ - i_689_ & 0x10000);
							is_625_[i_624_] = i_688_ - i_687_ | i_687_ - (i_687_ >>> 8);
						}
					} else
						throw new IllegalArgumentException();
	...
	final void method3745(int i, int i_690_, int i_691_, int i_692_, int i_693_, int i_694_, int i_695_, int i_696_) {
		...
		if (i_691_ > 0 && i_692_ > 0) {
			...
			if (i_695_ == 0) {
				...
				if (i_693_ == 0) {
					int i_715_ = (i_694_ & 0xff0000) >> 16;
					int i_716_ = (i_694_ & 0xff00) >> 8;
				...
				if (i_693_ == 3) {
					...
					for (int i_727_ = -i_692_; i_727_ < 0; i_727_++) {
						...
						for (int i_729_ = -i_691_; i_729_ < 0; i_729_++) {
							...
							is[i_706_++] = i_731_ - i_733_ | i_733_ - (i_733_ >>> 8);
							i_697_ += i_702_;
						}
						i_698_ += i_703_;
						i_697_ = i_726_;
				...
				if (i_693_ == 2) {
					int i_734_ = i_694_ >>> 24;
					int i_735_ = 256 - i_734_;
				...
				if (i_693_ == 1) {
					...
					for (int i_744_ = -i_692_; i_744_ < 0; i_744_++) {
						...
						for (int i_746_ = -i_691_; i_746_ < 0; i_746_++) {
							...
							is[i_706_++] = (((((i_747_ & 0xff00ff) * i_748_ + (i_750_ & 0xff00ff) * i_749_) & ~0xff00ff) >> 8) + ((((i_747_ & ~0xff00ff) >>> 8) * i_748_ + ((i_750_ & ~0xff00ff) >>> 8) * i_749_) & ~0xff00ff));
							i_697_ += i_702_;
						}
						i_698_ += i_703_;
						i_697_ = i_743_;
					...
					if ((i_694_ & 0xffffff) == 16777215) {
						for (int i_752_ = -i_692_; i_752_ < 0; i_752_++) {
							...
							for (int i_754_ = -i_691_; i_754_ < 0; i_754_++) {
								...
								is[i_706_++] = ((((i_755_ & 0xff00ff) * i_756_ + (i_758_ & 0xff00ff) * i_757_) & ~0xff00ff) + (((i_755_ & 0xff00) * i_756_ + (i_758_ & 0xff00) * i_757_) & 0xff0000)) >> 8;
								i_697_ += i_702_;
							}
							i_698_ += i_703_;
							i_697_ = i_751_;
						...
						for (int i_762_ = -i_692_; i_762_ < 0; i_762_++) {
							...
							for (int i_764_ = -i_691_; i_764_ < 0; i_764_++) {
								...
								if (i_766_ != 255) {
									int i_768_ = ((i_765_ & 0xff0000) * i_759_ & ~0xffffff);
									int i_769_ = ((i_765_ & 0xff00) * i_760_ & 0xff0000);
									int i_770_ = (i_765_ & 0xff) * i_761_ & 0xff00;
									i_765_ = (i_768_ | i_769_ | i_770_) >>> 8;
									int i_771_ = is[i_706_];
									is[i_706_++] = ((((i_765_ & 0xff00ff) * i_766_ + (i_771_ & 0xff00ff) * i_767_) & ~0xff00ff) + (((i_765_ & 0xff00) * i_766_ + (i_771_ & 0xff00) * i_767_) & 0xff0000)) >> 8;
								} else {
									int i_772_ = ((i_765_ & 0xff0000) * i_759_ & ~0xffffff);
									int i_773_ = ((i_765_ & 0xff00) * i_760_ & 0xff0000);
									int i_774_ = (i_765_ & 0xff) * i_761_ & 0xff00;
				...
				if (i_693_ == 3) {
					...
					for (int i_776_ = -i_692_; i_776_ < 0; i_776_++) {
						...
						for (int i_778_ = -i_691_; i_778_ < 0; i_778_++) {
							...
							int i_783_ = (i_782_ >>> 24) * (i_694_ >>> 24) >> 8;
							int i_784_ = 256 - i_783_;
							if (i_783_ != 255) {
								i_779_ = i_782_;
								i_782_ = is[i_706_];
								i_782_ = ((((i_779_ & 0xff00ff) * i_783_ + (i_782_ & 0xff00ff) * i_784_) & ~0xff00ff) + (((i_779_ & 0xff00) * i_783_ + (i_782_ & 0xff00) * i_784_) & 0xff0000)) >> 8;
							}
							is[i_706_++] = i_782_;
							i_697_ += i_702_;
						}
				...
				if (i_693_ == 2) {
					...
					for (int i_790_ = -i_692_; i_790_ < 0; i_790_++) {
						...
						for (int i_792_ = -i_691_; i_792_ < 0; i_792_++) {
							...
							int i_796_ = is[i_706_];
							is[i_706_++] = ((((i_793_ & 0xff00ff) * i_794_ + (i_796_ & 0xff00ff) * i_795_) & ~0xff00ff) + (((i_793_ & 0xff00) * i_794_ + (i_796_ & 0xff00) * i_795_) & 0xff0000)) >> 8;
							i_697_ += i_702_;
						}
						i_698_ += i_703_;
						i_697_ = i_789_;
					...
					for (int i_798_ = -i_692_; i_798_ < 0; i_798_++) {
						...
						for (int i_800_ = -i_691_; i_800_ < 0; i_800_++) {
							...
							if (i_801_ != 0) {
								...
								is[i_706_++] = i_803_ - i_802_ | i_802_ - (i_802_ >>> 8);
							} else
								i_706_++;
							i_697_ += i_702_;
						}
					...
					for (int i_809_ = -i_692_; i_809_ < 0; i_809_++) {
						...
						for (int i_811_ = -i_691_; i_811_ < 0; i_811_++) {
							...
							if (i_812_ != 0) {
								...
								int i_815_ = (i_812_ & 0xff) * i_808_ & 0xff00;
								i_812_ = (i_813_ | i_814_ | i_815_) >>> 8;
								int i_816_ = is[i_706_];
								int i_817_ = i_812_ + i_816_;
								int i_818_ = ((i_812_ & 0xff00ff) + (i_816_ & 0xff00ff));
								i_816_ = (i_818_ & 0x1000100) + (i_817_ - i_818_ & 0x10000);
								is[i_706_++] = i_817_ - i_816_ | i_816_ - (i_816_ >>> 8);
							} else
								i_706_++;
							i_697_ += i_702_;
						}
				...
				if (i_693_ == 3) {
					...
					for (int i_820_ = -i_692_; i_820_ < 0; i_820_++) {
						...
						for (int i_822_ = -i_691_; i_822_ < 0; i_822_++) {
							...
							i_826_ = (i_825_ & 0x1000100) + (i_824_ - i_825_ & 0x10000);
							is[i_706_++] = i_824_ - i_826_ | i_826_ - (i_826_ >>> 8);
							i_697_ += i_702_;
						}
						i_698_ += i_703_;
						i_697_ = i_819_;
					...
					for (int i_832_ = -i_692_; i_832_ < 0; i_832_++) {
						...
						for (int i_834_ = -i_691_; i_834_ < 0; i_834_++) {
							...
							if (i_835_ != 0) {
								...
								int i_837_ = i_835_ + i_836_;
								int i_838_ = ((i_835_ & 0xff00ff) + (i_836_ & 0xff00ff));
								i_836_ = (i_838_ & 0x1000100) + (i_837_ - i_838_ & 0x10000);
								is[i_706_++] = i_837_ - i_836_ | i_836_ - (i_836_ >>> 8);
							} else
								i_706_++;
							i_697_ += i_702_;
						}
	...
	final void method3757(int i, int i_845_, int i_846_, int i_847_, int i_848_, int i_849_, int i_850_, int i_851_, int i_852_) {
		if (i_847_ > 0 && i_848_ > 0) {
			...
			if (i_851_ == 0) {
				...
				if (i_849_ == 0) {
					int i_870_ = (i_850_ & 0xff0000) >> 16;
					int i_871_ = (i_850_ & 0xff00) >> 8;
					...
					for (int i_882_ = -i_848_; i_882_ < 0; i_882_++) {
						...
						for (int i_884_ = -i_847_; i_884_ < 0; i_884_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								is[i_861_] = i_886_ - i_888_ | i_888_ - (i_888_ >>> 8);
								fs[i_861_] = (float) i_846_;
							}
							i_853_ += i_857_;
							i_861_++;
			...
			if (i_851_ == 1) {
					...
					for (int i_899_ = -i_848_; i_899_ < 0; i_899_++) {
						...
						for (int i_901_ = -i_847_; i_901_ < 0; i_901_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								is[i_861_] = (((((i_902_ & 0xff00ff) * i_903_ + (i_905_ & 0xff00ff) * i_904_) & ~0xff00ff) >> 8) + (((((i_902_ & ~0xff00ff) >>> 8) * i_903_) + (((i_905_ & ~0xff00ff) >>> 8) * i_904_)) & ~0xff00ff));
								fs[i_861_] = (float) i_846_;
							}
							i_853_ += i_857_;
							i_861_++;
						...
						for (int i_907_ = -i_848_; i_907_ < 0; i_907_++) {
							...
							for (int i_909_ = -i_847_; i_909_ < 0; i_909_++) {
								if ((float) i_846_ < fs[i_861_]) {
									...
									is[i_861_] = ((((i_910_ & 0xff00ff) * i_911_ + (i_913_ & 0xff00ff) * i_912_) & ~0xff00ff) + (((i_910_ & 0xff00) * i_911_ + (i_913_ & 0xff00) * i_912_) & 0xff0000)) >> 8;
									fs[i_861_] = (float) i_846_;
								}
								i_853_ += i_857_;
								i_861_++;
						...
						for (int i_917_ = -i_848_; i_917_ < 0; i_917_++) {
							...
							for (int i_919_ = -i_847_; i_919_ < 0; i_919_++) {
								if ((float) i_846_ < fs[i_861_]) {
									...
									if (i_921_ != 255) {
										int i_923_ = ((i_920_ & 0xff0000) * i_914_ & ~0xffffff);
										int i_924_ = ((i_920_ & 0xff00) * i_915_ & 0xff0000);
										int i_925_ = ((i_920_ & 0xff) * i_916_ & 0xff00);
										i_920_ = (i_923_ | i_924_ | i_925_) >>> 8;
										int i_926_ = is[i_861_];
										is[i_861_] = ((((i_920_ & 0xff00ff) * i_921_ + ((i_926_ & 0xff00ff) * i_922_)) & ~0xff00ff) + (((i_920_ & 0xff00) * i_921_ + ((i_926_ & 0xff00) * i_922_)) & 0xff0000)) >> 8;
										fs[i_861_] = (float) i_846_;
									} else {
										int i_927_ = ((i_920_ & 0xff0000) * i_914_ & ~0xffffff);
										int i_928_ = ((i_920_ & 0xff00) * i_915_ & 0xff0000);
										int i_929_ = ((i_920_ & 0xff) * i_916_ & 0xff00);
					...
					for (int i_931_ = -i_848_; i_931_ < 0; i_931_++) {
						...
						for (int i_933_ = -i_847_; i_933_ < 0; i_933_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								i_937_ = i_935_ - i_937_ | i_937_ - (i_937_ >>> 8);
								int i_938_ = (i_937_ >>> 24) * (i_850_ >>> 24) >> 8;
								int i_939_ = 256 - i_938_;
								if (i_938_ != 255) {
									i_934_ = i_937_;
									i_937_ = is[i_861_];
									i_937_ = ((((i_934_ & 0xff00ff) * i_938_ + (i_937_ & 0xff00ff) * i_939_) & ~0xff00ff) + (((i_934_ & 0xff00) * i_938_ + (i_937_ & 0xff00) * i_939_) & 0xff0000)) >> 8;
								}
								is[i_861_] = i_937_;
								fs[i_861_] = (float) i_846_;
							}
				...
				if (i_849_ == 2) {
					int i_940_ = i_850_ >>> 24;
					int i_941_ = 256 - i_940_;
					...
					for (int i_945_ = -i_848_; i_945_ < 0; i_945_++) {
						...
						for (int i_947_ = -i_847_; i_947_ < 0; i_947_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								int i_951_ = is[i_861_];
								is[i_861_] = ((((i_948_ & 0xff00ff) * i_949_ + (i_951_ & 0xff00ff) * i_950_) & ~0xff00ff) + (((i_948_ & 0xff00) * i_949_ + (i_951_ & 0xff00) * i_950_) & 0xff0000)) >> 8;
								fs[i_861_] = (float) i_846_;
							}
							i_853_ += i_857_;
							i_861_++;
			...
			if (i_851_ == 2) {
						...
						for (int i_955_ = -i_847_; i_955_ < 0; i_955_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								if (i_956_ != 0) {
									...
									is[i_861_] = i_958_ - i_957_ | i_957_ - (i_957_ >>> 8);
									fs[i_861_] = (float) i_846_;
								}
							}
							i_853_ += i_857_;
					...
					for (int i_975_ = -i_848_; i_975_ < 0; i_975_++) {
						...
						for (int i_977_ = -i_847_; i_977_ < 0; i_977_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								i_978_ = i_979_ - i_981_ | i_981_ - (i_981_ >>> 8);
								i_981_ = is[i_861_];
								i_979_ = i_978_ + i_981_;
								i_980_ = (i_978_ & 0xff00ff) + (i_981_ & 0xff00ff);
								i_981_ = (i_980_ & 0x1000100) + (i_979_ - i_980_ & 0x10000);
								is[i_861_] = i_979_ - i_981_ | i_981_ - (i_981_ >>> 8);
								fs[i_861_] = (float) i_846_;
							}
							i_853_ += i_857_;
							i_861_++;
				...
				if (i_849_ == 2) {
					int i_982_ = i_850_ >>> 24;
					int i_983_ = 256 - i_982_;
						...
						for (int i_989_ = -i_847_; i_989_ < 0; i_989_++) {
							if ((float) i_846_ < fs[i_861_]) {
								...
								if (i_990_ != 0) {
									...
									int i_992_ = i_990_ + i_991_;
									int i_993_ = ((i_990_ & 0xff00ff) + (i_991_ & 0xff00ff));
									i_991_ = ((i_993_ & 0x1000100) + (i_992_ - i_993_ & 0x10000));
									is[i_861_] = i_992_ - i_991_ | i_991_ - (i_991_ >>> 8);
									fs[i_861_] = (float) i_846_;
								}
							}
							i_853_ += i_857_;
	...
	final void method3748(int i, int i_1022_, int i_1023_, int i_1024_, int i_1025_) {
		...
		if (i_1030_ > 0 && i_1029_ > 0) {
			...
			if (i_1025_ == 0) {
				...
				if (i_1023_ == 0) {
					int i_1038_ = (i_1024_ & 0xff0000) >> 16;
					int i_1039_ = (i_1024_ & 0xff00) >> 8;
				...
				if (i_1023_ == 3) {
					for (int i_1047_ = -i_1029_; i_1047_ < 0; i_1047_++) {
						for (int i_1048_ = -i_1030_; i_1048_ < 0; i_1048_++) {
							...
							is[i_1027_++] = i_1050_ - i_1052_ | i_1052_ - (i_1052_ >>> 8);
						}
						i_1027_ += i_1031_;
						i_1028_ += i_1032_;
					}
				...
				if (i_1023_ == 1) {
					for (int i_1060_ = -i_1029_; i_1060_ < 0; i_1060_++) {
						for (int i_1061_ = -i_1030_; i_1061_ < 0; i_1061_++) {
							...
							is[i_1027_++] = (((((i_1062_ & 0xff00ff) * i_1063_ + (i_1065_ & 0xff00ff) * i_1064_) & ~0xff00ff) >> 8) + ((((i_1062_ & ~0xff00ff) >>> 8) * i_1063_ + (((i_1065_ & ~0xff00ff) >>> 8) * i_1064_)) & ~0xff00ff));
						}
						i_1027_ += i_1031_;
						i_1028_ += i_1032_;
					}
					...
					if ((i_1024_ & 0xffffff) == 16777215) {
						for (int i_1066_ = -i_1029_; i_1066_ < 0; i_1066_++) {
							for (int i_1067_ = -i_1030_; i_1067_ < 0; i_1067_++) {
								...
								is[i_1027_++] = ((((i_1068_ & 0xff00ff) * i_1069_ + (i_1071_ & 0xff00ff) * i_1070_) & ~0xff00ff) + (((i_1068_ & 0xff00) * i_1069_ + (i_1071_ & 0xff00) * i_1070_) & 0xff0000)) >> 8;
							}
							i_1027_ += i_1031_;
							i_1028_ += i_1032_;
						}
					} else {
						int i_1072_ = (i_1024_ & 0xff0000) >> 16;
						int i_1073_ = (i_1024_ & 0xff00) >> 8;
						...
						for (int i_1075_ = -i_1029_; i_1075_ < 0; i_1075_++) {
							for (int i_1076_ = -i_1030_; i_1076_ < 0; i_1076_++) {
								...
								if (i_1078_ != 255) {
									int i_1080_ = ((i_1077_ & 0xff0000) * i_1072_ & ~0xffffff);
									int i_1081_ = ((i_1077_ & 0xff00) * i_1073_ & 0xff0000);
									int i_1082_ = (i_1077_ & 0xff) * i_1074_ & 0xff00;
									i_1077_ = (i_1080_ | i_1081_ | i_1082_) >>> 8;
									int i_1083_ = is[i_1027_];
									is[i_1027_++] = ((((i_1077_ & 0xff00ff) * i_1078_ + (i_1083_ & 0xff00ff) * i_1079_) & ~0xff00ff) + (((i_1077_ & 0xff00) * i_1078_ + (i_1083_ & 0xff00) * i_1079_) & 0xff0000)) >> 8;
								} else {
									int i_1084_ = ((i_1077_ & 0xff0000) * i_1072_ & ~0xffffff);
									int i_1085_ = ((i_1077_ & 0xff00) * i_1073_ & 0xff0000);
									int i_1086_ = (i_1077_ & 0xff) * i_1074_ & 0xff00;
				...
				if (i_1023_ == 3) {
					for (int i_1087_ = -i_1029_; i_1087_ < 0; i_1087_++) {
						for (int i_1088_ = -i_1030_; i_1088_ < 0; i_1088_++) {
							...
							i_1092_ = i_1090_ - i_1092_ | i_1092_ - (i_1092_ >>> 8);
							int i_1093_ = (i_1092_ >>> 24) * (i_1024_ >>> 24) >> 8;
							int i_1094_ = 256 - i_1093_;
							if (i_1093_ != 255) {
								i_1089_ = i_1092_;
								i_1092_ = is[i_1027_];
								i_1092_ = ((((i_1089_ & 0xff00ff) * i_1093_ + (i_1092_ & 0xff00ff) * i_1094_) & ~0xff00ff) + (((i_1089_ & 0xff00) * i_1093_ + (i_1092_ & 0xff00) * i_1094_) & 0xff0000)) >> 8;
							}
							is[i_1027_++] = i_1092_;
						}
						i_1027_ += i_1031_;
				...
				if (i_1023_ == 2) {
					...
					for (int i_1099_ = -i_1029_; i_1099_ < 0; i_1099_++) {
						for (int i_1100_ = -i_1030_; i_1100_ < 0; i_1100_++) {
							...
							int i_1104_ = is[i_1027_];
							is[i_1027_++] = ((((i_1101_ & 0xff00ff) * i_1102_ + (i_1104_ & 0xff00ff) * i_1103_) & ~0xff00ff) + (((i_1101_ & 0xff00) * i_1102_ + (i_1104_ & 0xff00) * i_1103_) & 0xff0000)) >> 8;
						}
						i_1027_ += i_1031_;
						i_1028_ += i_1032_;
					}
			...
			if (i_1025_ == 2) {
					...
					for (int i_1105_ = -i_1029_; i_1105_ < 0; i_1105_++) {
						for (int i_1106_ = -i_1030_; i_1106_ < 0; i_1106_++) {
							...
							if (i_1107_ != 0) {
								...
								is[i_1027_++] = i_1109_ - i_1108_ | i_1108_ - (i_1108_ >>> 8);
							} else
								i_1027_++;
						}
						i_1027_ += i_1031_;
				...
				if (i_1023_ == 0) {
					int i_1111_ = (i_1024_ & 0xff0000) >> 16;
					int i_1112_ = (i_1024_ & 0xff00) >> 8;
					...
					for (int i_1114_ = -i_1029_; i_1114_ < 0; i_1114_++) {
						for (int i_1115_ = -i_1030_; i_1115_ < 0; i_1115_++) {
							...
							if (i_1116_ != 0) {
								...
								int i_1119_ = (i_1116_ & 0xff) * i_1113_ & 0xff00;
								i_1116_ = (i_1117_ | i_1118_ | i_1119_) >>> 8;
								int i_1120_ = is[i_1027_];
								int i_1121_ = i_1116_ + i_1120_;
								int i_1122_ = ((i_1116_ & 0xff00ff) + (i_1120_ & 0xff00ff));
								i_1120_ = ((i_1122_ & 0x1000100) + (i_1121_ - i_1122_ & 0x10000));
								is[i_1027_++] = i_1121_ - i_1120_ | i_1120_ - (i_1120_ >>> 8);
							} else
								i_1027_++;
						}
						i_1027_ += i_1031_;
				...
				if (i_1023_ == 3) {
					for (int i_1123_ = -i_1029_; i_1123_ < 0; i_1123_++) {
						for (int i_1124_ = -i_1030_; i_1124_ < 0; i_1124_++) {
							...
							i_1125_ = i_1126_ - i_1128_ | i_1128_ - (i_1128_ >>> 8);
							i_1128_ = is[i_1027_];
							i_1126_ = i_1125_ + i_1128_;
							i_1127_ = (i_1125_ & 0xff00ff) + (i_1128_ & 0xff00ff);
							i_1128_ = (i_1127_ & 0x1000100) + (i_1126_ - i_1127_ & 0x10000);
							is[i_1027_++] = i_1126_ - i_1128_ | i_1128_ - (i_1128_ >>> 8);
						}
						i_1027_ += i_1031_;
						i_1028_ += i_1032_;
					}
					...
					for (int i_1133_ = -i_1029_; i_1133_ < 0; i_1133_++) {
						for (int i_1134_ = -i_1030_; i_1134_ < 0; i_1134_++) {
							...
							if (i_1135_ != 0) {
								...
								is[i_1027_++] = i_1137_ - i_1136_ | i_1136_ - (i_1136_ >>> 8);
							} else
								i_1027_++;
						}
						i_1027_ += i_1031_;
	...
	final void method3758(int[] is, int[] is_1140_, int i, int i_1141_) {
		...
		if (Class332_Sub3.anInt5444 == 0) {
					...
					if (i_1144_ >= 0) {
						...
						if (i_1146_ >= 0 && i_1147_ >= 0 && i_1146_ - (((Class332_Sub3) this).anInt5433 << 12) < 0 && i_1147_ - (((Class332_Sub3) this).anInt5454 << 12) < 0) {
							...
							for (/**/; i_1148_ < 0; i_1148_++) {
								...
								is_1142_[i_1145_++] = ((((i_1152_ & 0xff00ff) * i_1153_ + (i_1155_ & 0xff00ff) * i_1154_) & ~0xff00ff) + (((i_1152_ & 0xff00) * i_1153_ + (i_1155_ & 0xff00) * i_1154_) & 0xff0000)) >> 8;
							}
						}
					}
					i_1143_++;
				...
				while (i_1156_ < 0) {
					...
					if (i_1157_ >= 0) {
						...
						if (i_1159_ >= 0 && i_1159_ - (((Class332_Sub3) this).anInt5433 << 12) < 0) {
							...
							int i_1165_ = (i_1163_ - (i_1158_ - Class332_Sub3.anInt5451));
							if (i_1165_ > 0) {
								i_1158_ += i_1165_;
								i_1161_ += i_1165_;
							...
							for (/**/; i_1161_ < 0; i_1161_++) {
								...
								is_1142_[i_1158_++] = ((((i_1166_ & 0xff00ff) * i_1167_ + (i_1169_ & 0xff00ff) * i_1168_) & ~0xff00ff) + (((i_1166_ & 0xff00) * i_1167_ + (i_1169_ & 0xff00) * i_1168_) & 0xff0000)) >> 8;
				...
				while (i_1170_ < 0) {
					...
					if (i_1171_ >= 0) {
						...
						if (i_1173_ >= 0 && i_1173_ - (((Class332_Sub3) this).anInt5433 << 12) < 0) {
							...
							int i_1180_ = (i_1178_ - (i_1172_ - Class332_Sub3.anInt5451));
							if (i_1180_ > 0) {
								i_1172_ += i_1180_;
								i_1175_ += i_1180_;
							...
							for (/**/; i_1175_ < 0; i_1175_++) {
								...
								is_1142_[i_1172_++] = ((((i_1181_ & 0xff00ff) * i_1182_ + (i_1184_ & 0xff00ff) * i_1183_) & ~0xff00ff) + (((i_1181_ & 0xff00) * i_1182_ + (i_1184_ & 0xff00) * i_1183_) & 0xff0000)) >> 8;
			...
			if (Class332_Sub3.anInt5436 == 0) {
					...
					if (i_1186_ >= 0) {
						...
						if (i_1189_ >= 0 && i_1189_ - (((Class332_Sub3) this).anInt5454 << 12) < 0) {
							...
							if ((i_1191_ = ((i_1188_ - Class332_Sub3.anInt5444) / Class332_Sub3.anInt5444)) > i_1190_)
								i_1190_ = i_1191_;
							int i_1192_ = is[i_1186_] - i;
							int i_1193_ = -is_1140_[i_1186_];
							int i_1194_ = (i_1192_ - (i_1187_ - Class332_Sub3.anInt5451));
							if (i_1194_ > 0) {
								i_1187_ += i_1194_;
								i_1190_ += i_1194_;
							...
							for (/**/; i_1190_ < 0; i_1190_++) {
								...
								is_1142_[i_1187_++] = ((((i_1195_ & 0xff00ff) * i_1196_ + (i_1198_ & 0xff00ff) * i_1197_) & ~0xff00ff) + (((i_1195_ & 0xff00) * i_1196_ + (i_1198_ & 0xff00) * i_1197_) & 0xff0000)) >> 8;
				...
				while (i_1199_ < 0) {
					...
					if (i_1200_ >= 0) {
						...
						if ((i_1205_ = ((i_1203_ - Class332_Sub3.anInt5436) / Class332_Sub3.anInt5436)) > i_1204_)
							i_1204_ = i_1205_;
						int i_1206_ = is[i_1200_] - i;
						int i_1207_ = -is_1140_[i_1200_];
						int i_1208_ = i_1206_ - (i_1201_ - Class332_Sub3.anInt5451);
						if (i_1208_ > 0) {
							i_1201_ += i_1208_;
							i_1204_ += i_1208_;
						...
						for (/**/; i_1204_ < 0; i_1204_++) {
							...
							is_1142_[i_1201_++] = ((((i_1209_ & 0xff00ff) * i_1210_ + (i_1212_ & 0xff00ff) * i_1211_) & ~0xff00ff) + (((i_1209_ & 0xff00) * i_1210_ + (i_1212_ & 0xff00) * i_1211_) & 0xff0000)) >> 8;
				...
				while (i_1213_ < 0) {
					...
					if (i_1214_ >= 0) {
						...
						int i_1222_ = i_1220_ - (i_1215_ - Class332_Sub3.anInt5451);
						if (i_1222_ > 0) {
							i_1215_ += i_1222_;
							i_1218_ += i_1222_;
						...
						for (/**/; i_1218_ < 0; i_1218_++) {
							...
							is_1142_[i_1215_++] = ((((i_1223_ & 0xff00ff) * i_1224_ + (i_1226_ & 0xff00ff) * i_1225_) & ~0xff00ff) + (((i_1223_ & 0xff00) * i_1224_ + (i_1226_ & 0xff00) * i_1225_) & 0xff0000)) >> 8;
			...
			while (i_1227_ < 0) {
				...
				if (i_1228_ >= 0) {
					...
					if (i_1231_ >= 0 && (i_1231_ - (((Class332_Sub3) this).anInt5454 << 12) < 0)) {
						...
						int i_1237_ = i_1235_ - (i_1229_ - Class332_Sub3.anInt5451);
						if (i_1237_ > 0) {
							i_1229_ += i_1237_;
							i_1232_ += i_1237_;
						...
						for (/**/; i_1232_ < 0; i_1232_++) {
							...
							is_1142_[i_1229_++] = ((((i_1238_ & 0xff00ff) * i_1239_ + (i_1241_ & 0xff00ff) * i_1240_) & ~0xff00ff) + (((i_1238_ & 0xff00) * i_1239_ + (i_1241_ & 0xff00) * i_1240_) & 0xff0000)) >> 8;
			...
			while (i_1242_ < 0) {
				int i_1243_ = i_1242_ + i_1141_;
				if (i_1243_ >= 0) {
					if (i_1243_ >= is.length)
						break;
					int i_1244_ = Class332_Sub3.anInt5451;
					int i_1245_ = Class332_Sub3.anInt5450 + Class332_Sub3.anInt5425;
					int i_1246_ = Class332_Sub3.anInt5443 + Class332_Sub3.anInt5456;
					int i_1247_ = Class332_Sub3.anInt5448;
					if (i_1245_ < 0) {
						int i_1248_ = ((Class332_Sub3.anInt5444 - 1 - i_1245_) / Class332_Sub3.anInt5444);
						i_1247_ += i_1248_;
					...
					if ((i_1249_ = ((i_1246_ - Class332_Sub3.anInt5436) / Class332_Sub3.anInt5436)) > i_1247_)
						i_1247_ = i_1249_;
					int i_1250_ = is[i_1243_] - i;
					int i_1251_ = -is_1140_[i_1243_];
					int i_1252_ = i_1250_ - (i_1244_ - Class332_Sub3.anInt5451);
					if (i_1252_ > 0) {
						i_1244_ += i_1252_;
						i_1247_ += i_1252_;
					...
					for (/**/; i_1247_ < 0; i_1247_++) {
						...
						is_1142_[i_1244_++] = ((((i_1253_ & 0xff00ff) * i_1254_ + (i_1256_ & 0xff00ff) * i_1255_) & ~0xff00ff) + (((i_1253_ & 0xff00) * i_1254_ + (i_1256_ & 0xff00) * i_1255_) & 0xff0000)) >> 8;
			...
			while (i_1257_ < 0) {
				int i_1258_ = i_1257_ + i_1141_;
				if (i_1258_ >= 0) {
					if (i_1258_ >= is.length)
						break;
					int i_1259_ = Class332_Sub3.anInt5451;
					int i_1260_ = Class332_Sub3.anInt5450 + Class332_Sub3.anInt5425;
					int i_1261_ = Class332_Sub3.anInt5443 + Class332_Sub3.anInt5456;
					int i_1262_ = Class332_Sub3.anInt5448;
					if (i_1260_ < 0) {
						int i_1263_ = ((Class332_Sub3.anInt5444 - 1 - i_1260_) / Class332_Sub3.anInt5444);
						i_1262_ += i_1263_;
					...
					int i_1267_ = i_1265_ - (i_1259_ - Class332_Sub3.anInt5451);
					if (i_1267_ > 0) {
						i_1259_ += i_1267_;
						i_1262_ += i_1267_;
					...
					for (/**/; i_1262_ < 0; i_1262_++) {
						...
						is_1142_[i_1259_++] = ((((i_1268_ & 0xff00ff) * i_1269_ + (i_1271_ & 0xff00ff) * i_1270_) & ~0xff00ff) + (((i_1268_ & 0xff00) * i_1269_ + (i_1271_ & 0xff00) * i_1270_) & 0xff0000)) >> 8;
