...
final class Class174 implements Runnable {
	private Class98_Sub5[] aClass98_Sub5Array1345 = new Class98_Sub5[8];
	private long aLong1346;
	private int[] anIntArray1347 = new int[3];
	...
	final boolean method2563() {
		if (aClass245_1350 != null && (aBoolean1352 || !aClass245_1350.method2959(124)))
			return false;
		return true;
	}

	final void method2564(Class245 class245) {
				...
				if (class246 instanceof AnimableEntity) {
					...
					if (i >= 1 && i <= 4) {
						...
						for (int i_0_ = 0; i_0_ < Class259.anInt1959 + Class259.anInt1959; i_0_++) {
							for (int i_1_ = 0; (i_1_ < Class259.anInt1959 + Class259.anInt1959); i_1_++) {
