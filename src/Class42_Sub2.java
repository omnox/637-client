...
final class Class42_Sub2 extends Class42 {
	...
	static final void method388(boolean bool) {
		do {
			try {
				...
				int i_3_ = Class201.anInt1545 >> 9;
				int i_4_ = Class224_Sub3_Sub1.anInt6147 >> 9;
				int i_5_ = Perspective.getTileHeight(Class43.anInt377, (Class224_Sub3_Sub1.anInt6147), Class201.anInt1545);
				if (bool == true) {
					int i_6_ = 0;
					if (i_3_ > 3 && i_4_ > 3 && (i_3_ < GameWorld.size_x + -4) && (i_4_ < GameWorld.size_y + -4)) {
						for (int i_7_ = -4 + i_3_; i_7_ <= 4 + i_3_; i_7_++) {
							for (int i_8_ = i_4_ - 4; 4 + i_4_ >= i_8_; i_8_++) {
								int i_9_ = Class43.anInt377;
								if (i_9_ < 3 && Class1.method162(i_8_, (byte) -104, i_7_))
									i_9_++;
								int i_10_ = 0;
								if ((Class146_Sub3.aClass305_Sub1_4952.cameraAdjusts) != null && ((Class146_Sub3.aClass305_Sub1_4952.cameraAdjusts[i_9_]) != null))
									i_10_ = ((0xff & (Class146_Sub3.aClass305_Sub1_4952.cameraAdjusts[i_9_][i_7_][i_8_])) * 8 << 2);
	...
	Class42_Sub2(ha_Sub1 var_ha_Sub1, int i, int i_16_, boolean bool, int[][] is) {
		...
		try {
			this.anInt5357 = i_16_;
			this.aHa_Sub1_3227.method1863(1, this);
			if (bool) {
				for (int i_17_ = 0; i_17_ < 6; i_17_++)
					Class336.method3773(this.anInt3230, 53, this.aHa_Sub1_3227.anInt4425, 34069 + i_17_, i_16_, 32993, i_16_, is[i_17_]);
			} else {
				for (int i_18_ = 0; i_18_ < 6; i_18_++)
					OpenGL.glTexImage2Di(34069 - -i_18_, 0, this.anInt3230, i_16_, i_16_, 0, 32993, (this.aHa_Sub1_3227.anInt4425), is[i_18_], 0);
			}
			this.method372(-28003, true);
		} catch (RuntimeException runtimeexception) {
	...
	static final int[] method389(int i, OutgoingPacket class98_sub11) {
		try {
			...
			class98_sub11.packet.method1217(class98_sub22.data, class98_sub22.position, i + -12207, 0);
			return is;
		} catch (RuntimeException runtimeexception) {
