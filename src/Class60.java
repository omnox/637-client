...
final class Class60 {
	...
	private final void method532(byte i, RSByteBuffer class98_sub22, int i_0_) {
		try {
			if (i < 1)
	...
	final void method533(RSByteBuffer class98_sub22, int i) {
		try {
			if (i != 0)
				method533(null, 76);
			for (;;) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("eba.C(" + (class98_sub22 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	public static void method534(byte i) {
		try {
			...
			if (i != -63)
				aLongArray475 = null;
			IncomingOpcode.bigVarpOpcode = null;
			aClass105_474 = null;
			aLongArray475 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method535(int i, int i_3_, int i_4_, int i_5_, byte[][][] is, int[] is_6_, int[] is_7_, int[] is_8_, int[] is_9_, int[] is_10_, int i_11_, byte i_12_, int i_13_, int i_14_, boolean bool, boolean bool_15_, int i_16_, int i_17_, boolean bool_18_) {
		Class135.aBoolean1052 = true;
		Class348.aBoolean2914 = Class98_Sub10_Sub30.aHa5709.method1822() > 0;
		Class302.aBoolean2526 = bool_15_;
		...
		if (Class302.aBoolean2526) {
			for (int i_20_ = 0; i_20_ < Class259.anInt1959 + Class259.anInt1959 + 2; i_20_++) {
				...
				for (int i_23_ = 0; i_23_ < Class259.anInt1959 + Class259.anInt1959 + 2; i_23_++) {
					...
					int i_25_ = Class64_Sub26.anInt3714 - Class259.anInt1959 + i_23_;
					if (i_24_ >= 0 && i_25_ >= 0 && i_24_ < Class366.anInt3112 && i_25_ < Class64_Sub9.anInt3662) {
						int i_26_ = i_24_ << Class151_Sub8.anInt5015;
						int i_27_ = i_25_ << Class151_Sub8.anInt5015;
						int i_28_ = (Class98_Sub46_Sub2_Sub2.aSArray6298[(Class98_Sub46_Sub2_Sub2.aSArray6298.length - 1)].method3420(i_25_, -12639, i_24_) - (1000 << Class151_Sub8.anInt5015 - 7));
						int i_29_ = (Class81.aSArray618 != null ? (Class81.aSArray618[0].method3420(i_25_, -12639, i_24_) + r_Sub2.anInt6333) : (Class98_Sub46_Sub2_Sub2.aSArray6298[0].method3420(i_25_, -12639, i_24_) + r_Sub2.anInt6333));
						i_22_ = (i_16_ >= 0 ? Class98_Sub10_Sub30.aHa5709.r(i_26_, i_28_, i_27_, i_26_, i_29_, i_27_, i_16_) : Class98_Sub10_Sub30.aHa5709.JA(i_26_, i_28_, i_27_, i_26_, i_29_, i_27_));
			...
			if (i_16_ >= 0)
				...
				Class340.method3802(Class98_Sub10_Sub30.aHa5709, i_11_, (byte) -59);
			}
		} else {
		...
		if (Class348.aBoolean2914) {
			for (int i_33_ = 0; i_33_ < Class226.anInt1705; i_33_++)
				Class98_Sub10_Sub31.aClass1Array5717[i_33_].method161(bool, i, 71);
		}
		if (Class375.aBoolean3170) {
			...
			for (int i_35_ = 0; i_35_ < Class18.anInt212 - 1; i_35_++)
				s.anIntArray2205[i_35_] = i_34_ * (i_35_ + 1) + Class15.anIntArray182[i_35_];
	...
	static final ha method536(int i, RuneScapeCache class207, d var_d, int i_40_, Canvas canvas) {
		try {
			...
			if (l == 0L)
				throw new RuntimeException("");
			ha_Sub3_Sub2 var_ha_Sub3_Sub2 = new ha_Sub3_Sub2(opengl, canvas, l, var_d, class207, i);
			var_ha_Sub3_Sub2.method1965(true);
			return var_ha_Sub3_Sub2;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("eba.E(" + i + ',' + (class207 != null ? "{...}" : "null") + ',' + (var_d != null ? "{...}" : "null") + ',' + i_40_ + ',' + (canvas != null ? "{...}" : "null") + ')'));
		}
	}
