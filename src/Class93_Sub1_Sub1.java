...
final class Class93_Sub1_Sub1 extends Class93_Sub1 {
	...
	Class93_Sub1_Sub1(Class63 class63, Class110 class110, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		super(class63, class110, i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_, i_8_, i_9_, i_10_, i_11_);
		try {
			((Class93_Sub1_Sub1) this).anInt6290 = i_12_;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("hi.<init>(" + (class63 != null ? "{...}" : "null") + ',' + (class110 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + i_9_ + ',' + i_10_ + ',' + i_11_ + ',' + i_12_ + ')'));
		}
	}

	static final void method908(int i, int i_13_, boolean bool, int i_14_, int i_15_) {
		try {
			if (Class98_Sub46.anInt4261 == 1) {
				...
				if (bool != false)
					anInt6291 = 95;
				if (i_16_ < Class191.anInt1477 && (i_17_ ^ 0xffffffff) <= -1 && (i_18_ ^ 0xffffffff) > (Class63.anInt493 ^ 0xffffffff) && (i_19_ ^ 0xffffffff) <= -1) {
					...
					for (int i_20_ = i_18_; i_20_ <= i_19_; i_20_++) {
						int i_21_ = (Class198.method2678((byte) 6, i_20_ + Class268.anInt2007, Class63.anInt493) * Class191.anInt1477);
						for (int i_22_ = i_16_; i_22_ <= i_17_; i_22_++) {
							int i_23_ = (i_21_ + Class198.method2678((byte) 6, i_22_ - -(Class76_Sub8.anInt3780), Class191.anInt1477));
			...
			throw Class64_Sub27.method667(runtimeexception, ("hi.C(" + i + ',' + i_13_ + ',' + bool + ',' + i_14_ + ',' + i_15_ + ')'));
		}
	}
	...
	static final void method909(int i, int i_24_, boolean bool, int i_25_, int i_26_, int i_27_) {
		try {
			if (GameInterface.aFrame3950 != null && (i != 3 || (Class110.anInt946 ^ 0xffffffff) != (i_26_ ^ 0xffffffff) || (i_27_ ^ 0xffffffff) != (Class112.anInt949 ^ 0xffffffff))) {
				Class281.method3331(false, GameInterface.aFrame3950, Class98_Sub43_Sub2.aClass88_5907);
				GameInterface.aFrame3950 = null;
			}
			if ((i ^ 0xffffffff) == -4 && GameInterface.aFrame3950 == null) {
				GameInterface.aFrame3950 = Class54.method503(0, (byte) 105, i_26_, i_27_, 0, Class98_Sub43_Sub2.aClass88_5907);
			...
			if ((i ^ 0xffffffff) == -4 && GameInterface.aFrame3950 == null)
				method909(((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub27_4052.method666((byte) 120), i_24_, true, i_25_, -1, -1);
			else {
				...
				if (!bool) {
					...
					if (Class284.aFrame2168 != container)
						...
						Insets insets = Class284.aFrame2168.getInsets();
						Class42_Sub3.aCanvas5361.setLocation(insets.left + Class98_Sub46_Sub10.anInt6022, insets.top + Class191.anInt1479);
					}
				} else
			...
			throw Class64_Sub27.method667(runtimeexception, ("hi.B(" + i + ',' + i_24_ + ',' + bool + ',' + i_25_ + ',' + i_26_ + ',' + i_27_ + ')'));
		}
	}
}
