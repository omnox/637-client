...
final class Class76_Sub8 extends Class76 {
	...
	final void method739(int i) {
		do {
			try {
				...
				((Class76) this).aHa_Sub3_585.method2051(0, -108, Class300.aClass65_2499);
				((Class76) this).aHa_Sub3_585.method2051(2, -54, Class64_Sub16.aClass65_3681);
				((Class76) this).aHa_Sub3_585.method1953(i ^ 0x5c, Class300.aClass65_2499, 0);
				((Class76) this).aHa_Sub3_585.method1951((byte) 120, 0);
				if (aBoolean3768) {
					((Class76) this).aHa_Sub3_585.method2051(0, -87, Class300.aClass65_2499);
					((Class76) this).aHa_Sub3_585.method1953(-93, Class300.aClass65_2499, 0);
					aBoolean3768 = false;
				}
				if (aBoolean3769) {
	...
	final void method747(int i) {
		try {
			if (i != -25684)
				anInt3778 = -102;
			int i_2_ = ((Class76) this).aHa_Sub3_585.method2017((byte) 67);
			Class111_Sub3 class111_sub3 = ((Class76) this).aHa_Sub3_585.method1956((byte) -90);
			do {
				if (!aBoolean3775) {
					OpenGL.glBindProgramARB(34336, ((i_2_ ^ 0xffffffff) != -2147483648 ? (((Class273) aClass273_3773).anInt2040) : (((Class273) aClass273_3781).anInt2040)));
					if (!client.aBoolean3553)
						break;
				}
				OpenGL.glBindProgramARB(34336, (i_2_ == 2147483647 ? (((Class273) aClass273_3774).anInt2040) : (((Class273) aClass273_3777).anInt2040)));
			} while (false);
		...
		try {
			do {
				if (interface4 == null) {
					if (aBoolean3768)
						break;
					((Class76) this).aHa_Sub3_585.method2005((((ha_Sub3) ((Class76) this).aHa_Sub3_585).anInterface4_4586), 41);
					((Class76) this).aHa_Sub3_585.method2015(1, (byte) -124);
					((Class76) this).aHa_Sub3_585.method2051(0, i + -132, IncomingOpcode.aClass65_459);
					((Class76) this).aHa_Sub3_585.method1953(-108, IncomingOpcode.aClass65_459, 0);
					aBoolean3768 = true;
					if (!client.aBoolean3553)
						break;
				}
				if (aBoolean3768) {
					((Class76) this).aHa_Sub3_585.method2051(0, -57, Class300.aClass65_2499);
					((Class76) this).aHa_Sub3_585.method1953(-67, Class300.aClass65_2499, 0);
					aBoolean3768 = false;
				}
	...
	Class76_Sub8(ha_Sub3_Sub2 var_ha_Sub3_Sub2, RuneScapeCache class207) {
		...
		aBoolean3768 = false;
		try {
			if (class207 == null || !((ha_Sub3_Sub2) var_ha_Sub3_Sub2).aBoolean6134)
				aBoolean3772 = false;
			else {
				...
				if (aClass273_3777 != null & (aClass273_3773 != null & (aClass273_3781 != null & aClass273_3774 != null))) {
					anInterface4_Impl2_3779 = ((Class76) this).aHa_Sub3_585.method2012(2, 1, (byte) 31, (new int[] { 0, -1 }), false);
	...
	final void method738(int i) {
		do {
			try {
				...
				if (!aBoolean3769)
					break;
				int i_4_ = ((Class76) this).aHa_Sub3_585.XA();
				int i_5_ = ((Class76) this).aHa_Sub3_585.i();
				float f = -((float) (i_4_ + -i_5_) * 0.125F) + (float) i_4_;
				float f_6_ = (float) i_4_ - (float) (-i_5_ + i_4_) * 0.25F;
				OpenGL.glProgramLocalParameter4fARB(34336, 0, f_6_, f, (1.0F / (float) ((Class76) this).aHa_Sub3_585.method1948(126)), (float) ((Class76) this).aHa_Sub3_585.method2018((byte) 98) / 255.0F);
				((Class76) this).aHa_Sub3_585.method1951((byte) 120, 1);
				((Class76) this).aHa_Sub3_585.method1984(2, ((Class76) this).aHa_Sub3_585.method1998((byte) 89));
				((Class76) this).aHa_Sub3_585.method1951((byte) 120, 0);
			} catch (RuntimeException runtimeexception) {
	...
	final void method748(int i, boolean bool) {
		try {
			if (i == 69) {
				aBoolean3775 = bool;
				((Class76) this).aHa_Sub3_585.method1951((byte) 120, 1);
				((Class76) this).aHa_Sub3_585.method2005(anInterface4_Impl2_3779, -114);
				((Class76) this).aHa_Sub3_585.method2019(Class288.aClass128_3381, Class323.aClass128_2715, 22831);
				((Class76) this).aHa_Sub3_585.method2051(0, -81, Class64_Sub16.aClass65_3681);
				((Class76) this).aHa_Sub3_585.method2026(2, true, (byte) 27, (Class300.aClass65_2499), false);
				((Class76) this).aHa_Sub3_585.method1953(-125, IncomingOpcode.aClass65_459, 0);
				((Class76) this).aHa_Sub3_585.method1951((byte) 120, 0);
				method747(-25684);
			}
		} catch (RuntimeException runtimeexception) {
