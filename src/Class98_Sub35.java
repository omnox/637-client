...
final class Class98_Sub35 extends Node {
	...
	static final void method1452(int i) {
		try {
			Class98_Sub37.aHa4185.xa(1.1523438F * (0.7F + 0.1F * (float) ((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub19_4057.method630((byte) 122)));
	...
	final void method1453(byte i, RSByteBuffer class98_sub22) {
		try {
			...
			class98_sub22.method1225(-24472, ((Class98_Sub35) this).anInt4129);
		...
		try {
			if (bool) {
				...
				if ((Class88.aString696.toLowerCase().indexOf("sun") ^ 0xffffffff) != 0)
					anInt4136 = 1;
				else if ((Class88.aString696.toLowerCase().indexOf("microsoft") ^ 0xffffffff) != 0)
					anInt4136 = 2;
				...
				if (!((Class88) class88).aBoolean682)
					aBoolean4138 = true;
				else
					aBoolean4138 = false;
				if (anInt4137 <= 3)
