...
final class Class98_Sub19 extends Node {
	...
	static final void method1164(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			...
			((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6054 = i_1_;
			((Class98_Sub46_Sub17) class98_sub46_sub17).anInt6053 = i_0_;
			...
			try {
				if (Class98_Sub10_Sub9.aBoolean5585 && (0x18 & Class98_Sub4.anInt3826 ^ 0xffffffff) != -1 && i == 36) {
					...
					for (int i_5_ = 0; (i_5_ ^ 0xffffffff) > (i_4_ ^ 0xffffffff); i_5_++) {
						...
						if (((Player) class246_sub3_sub4_sub2_sub2).displayName != null && ((Player) class246_sub3_sub4_sub2_sub2).displayName.equalsIgnoreCase(string) && (((Player.selfPlayer == class246_sub3_sub4_sub2_sub2) && (0x10 & Class98_Sub4.anInt3826) != 0) || (class246_sub3_sub4_sub2_sub2 != null && (Class98_Sub4.anInt3826 & 0x8) != 0))) {
							client.anInt3548++;
							OutgoingPacket class98_sub11 = (Class246_Sub3_Sub4.method3023(260, Class160.aClass171_1259, Class331.aClass117_2811));
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(is[i_5_], 128);
							...
							((OutgoingPacket) class98_sub11).packet.method1231(0, (byte) -95);
