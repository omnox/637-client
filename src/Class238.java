...
final class Class238 {
	...
	static final int method2917(int i, Class98_Sub22_Sub1 class98_sub22_sub1) {
		try {
			if (i != 0)
				return 89;
			...
			throw Class64_Sub27.method667(runtimeexception, ("pba.A(" + i + ',' + (class98_sub22_sub1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final boolean method2919(int i, int i_2_, int i_3_) {
		try {
			if (i > -49)
				method2917(-89, null);
			return ((IncomingOpcode.method523(i_3_, -1, i_2_) | Class105.method1715(true, i_2_, i_3_) | Class76_Sub9.method766(-99, i_3_, i_2_)) & Class93.method901(i_3_, i_2_, -122));
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("pba.D(" + i + ',' + i_2_ + ',' + i_3_ + ')'));
		}
	}
