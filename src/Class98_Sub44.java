...
final class Class98_Sub44 extends Node {
	...
	static final void method1512(boolean bool) {
		try {
			...
			int i;
			int i_0_;
			if ((((Class98_Sub27) Class98_Sub9.aClass98_Sub27_3856).aClass64_Sub3_4076.method564((byte) 120) ^ 0xffffffff) != -2)
	...
	static final boolean method1514(int i, int i_2_) {
		try {
			...
			for (Class98_Sub46_Sub8 class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2418(32)); class98_sub46_sub8 != null; class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2417(96))) {
				if (Class36.method340(((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5990, (byte) -38) && (((long) i_2_ ^ 0xffffffffffffffffL) == (((Class98_Sub46_Sub8) class98_sub46_sub8).aLong5987 ^ 0xffffffffffffffffL)))
					return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	Class98_Sub44(byte[] is) {
		try {
			...
			int i;
			for (i = 0; (((((RSByteBuffer) class98_sub22).data[i + ((RSByteBuffer) class98_sub22).position]) ^ 0xffffffff) != -1); i++) {
				/* empty */
			}
			...
			int i_5_ = ((RSByteBuffer) class98_sub22).position;
			((RSByteBuffer) class98_sub22).position += i;
			int i_6_;
			for (i_6_ = 0; ((((RSByteBuffer) class98_sub22).data[i_6_ + ((RSByteBuffer) class98_sub22).position]) != 0); i_6_++) {
				/* empty */
			}
			...
			i_6_++;
			((RSByteBuffer) class98_sub22).position++;
			int i_9_ = ((RSByteBuffer) class98_sub22).position;
			((RSByteBuffer) class98_sub22).position += i_6_;
			int i_10_;
			for (i_10_ = 0; ((((RSByteBuffer) class98_sub22).data[i_10_ + ((RSByteBuffer) class98_sub22).position]) != 0); i_10_++) {
				/* empty */
			}
			...
			int i_23_;
			for (i_23_ = 0; ((((RSByteBuffer) class98_sub22).data[((RSByteBuffer) class98_sub22).position - -i_23_]) != 0); i_23_++) {
				/* empty */
			}
			...
			for (int i_32_ = 0; i_32_ < 128; i_32_++) {
				...
				((Class98_Sub44) this).aShortArray4248[i_32_] += Class202.method2702(32768, -1 + i_31_ << -556142098);
			...
			for (int i_34_ = 0; (i_34_ ^ 0xffffffff) > -129; i_34_++) {
				if (anIntArray4246[i_34_] != 0) {
					if (i_29_ == 0) {
						i_33_ = -1 + (((RSByteBuffer) class98_sub22).data[i_5_++]);
			...
			for (int i_36_ = 0; i_36_ < 128; i_36_++) {
				if ((anIntArray4246[i_36_] ^ 0xffffffff) != -1) {
					if (i_29_ == 0) {
						i_35_ = (((RSByteBuffer) class98_sub22).data[i_9_++]) + 16 << -1732087870;
			...
			((Class98_Sub44) this).anInt4249 = 1 + class98_sub22.readUnsignedByte();
			for (int i_40_ = 0; i_14_ > i_40_; i_40_++) {
				...
				if (((Class89) class89_41_).aByteArray714 != null) {
					for (int i_42_ = 1; ((Class89) class89_41_).aByteArray714.length > i_42_; i_42_ += 2)
						((Class89) class89_41_).aByteArray714[i_42_] = class98_sub22.readSignedByte();
				}
				if (((Class89) class89_41_).aByteArray713 != null) {
					for (int i_43_ = 3; ((((Class89) class89_41_).aByteArray713.length - 2 ^ 0xffffffff) < (i_43_ ^ 0xffffffff)); i_43_ += 2)
						((Class89) class89_41_).aByteArray713[i_43_] = class98_sub22.readSignedByte();
				}
			}
			if (is_21_ != null) {
			...
			if (is_21_ != null) {
				...
				for (int i_55_ = 0; i_55_ < i_53_; i_55_++)
					((Class98_Sub44) this).aByteArray4252[i_55_] = (byte) ((((Class98_Sub44) this).aByteArray4252[i_55_] * i_54_) - -32 >> -1262360314);
				int i_56_ = 2;
				while (is_21_.length > i_56_) {
					...
					for (int i_60_ = i_53_; i_60_ < i_57_; i_60_++) {
						...
						((Class98_Sub44) this).aByteArray4252[i_60_] = (byte) (i_61_ * (((Class98_Sub44) this).aByteArray4252[i_60_]) - -32 >> -388909850);
						i_59_ += -i_54_ + i_58_;
					}
					i_56_ += 2;
					i_54_ = i_58_;
			...
			if (is_22_ != null) {
				...
				for (int i_75_ = i_64_; i_75_ < 128; i_75_++) {
					int i_76_ = i_65_ + (0xff & (((Class98_Sub44) this).aByteArray4247[i_75_]));
					if (i_76_ < 0)
						i_76_ = 0;
			...
			for (int i_77_ = 0; i_14_ > i_77_; i_77_++)
				((Class89) class89s[i_77_]).anInt707 = class98_sub22.readUnsignedByte();
			for (int i_78_ = 0; (i_14_ ^ 0xffffffff) < (i_78_ ^ 0xffffffff); i_78_++) {
				...
				if (((Class89) class89_79_).aByteArray714 != null)
					((Class89) class89_79_).anInt711 = class98_sub22.readUnsignedByte();
				if (((Class89) class89_79_).aByteArray713 != null)
					((Class89) class89_79_).anInt715 = class98_sub22.readUnsignedByte();
				if ((((Class89) class89_79_).anInt707 ^ 0xffffffff) < -1)
					((Class89) class89_79_).anInt712 = class98_sub22.readUnsignedByte();
			}
			for (int i_80_ = 0; i_14_ > i_80_; i_80_++)
				((Class89) class89s[i_80_]).anInt710 = class98_sub22.readUnsignedByte();
			for (int i_81_ = 0; (i_81_ ^ 0xffffffff) > (i_14_ ^ 0xffffffff); i_81_++) {
				...
				if (((Class89) class89_82_).anInt710 > 0)
					((Class89) class89_82_).anInt708 = class98_sub22.readUnsignedByte();
			}
			for (int i_83_ = 0; i_83_ < i_14_; i_83_++) {
				Class89 class89_84_ = class89s[i_83_];
				if (((Class89) class89_84_).anInt708 > 0)
					((Class89) class89_84_).anInt717 = class98_sub22.readUnsignedByte();
			}
		} catch (RuntimeException runtimeexception) {
					...
					if (i_88_ != 0) {
						if ((i_88_ ^ 0xffffffff) != (i_86_ ^ 0xffffffff)) {
							...
							if ((0x1 & i_88_ ^ 0xffffffff) != -1)
								class98_sub24_sub1 = class308.method3613(i_88_ >> -996567486, true, is_85_);
							else
								class98_sub24_sub1 = class308.method3611(-2, i_88_ >> -1729369054, is_85_);
