...
final class Class208 {
	...
	static RuneScapeCache aClass207_1581;
		...
		if (Class64_Sub21.anInt3702 != 0 && Class284_Sub1.aClass43_5177 != null) {
			...
			for (int i_2_ = 0; i_2_ < Class59.anInt464; i_2_++) {
				...
				if (Class237.anIntArray1809[2] != -1 && Class314.anIntArray2691[2] != -1 && Class98_Sub46_Sub6.anIntArray5980[2] != -1 && Class262.anIntArray1962[2] != -1) {
					...
					Class98_Sub10_Sub30.aHa5709.method1789(Class98_Sub46_Sub6.anIntArray5980[1], i_3_, Class262.anIntArray1962[1], Class262.anIntArray1962[0], -10550, Class98_Sub46_Sub6.anIntArray5980[0]);
					Class98_Sub10_Sub30.aHa5709.method1789(Class262.anIntArray1962[1], i_3_, Class237.anIntArray1809[1], Class237.anIntArray1809[0], -10550, Class262.anIntArray1962[0]);
					Class98_Sub10_Sub30.aHa5709.method1789(Class237.anIntArray1809[1], i_3_, Class98_Sub46_Sub6.anIntArray5980[1], Class98_Sub46_Sub6.anIntArray5980[0], -10550, Class237.anIntArray1809[0]);
				}
			}
			Class284_Sub1.aClass43_5177.method411((byte) -118, i_0_ + 45, ("Dynamic: " + Class347.anInt2907 + "/" + 5000), -256, -16777216, i);
			Class284_Sub1.aClass43_5177.method411((byte) 62, i_0_ + 60, ("Total Opaque Onscreen: " + Class302.anInt2523 + "/" + 10000), -256, -16777216, i);
			Class284_Sub1.aClass43_5177.method411((byte) 46, i_0_ + 75, ("Total Trans Onscreen: " + Class353.anInt3009 + "/" + 5000), -256, -16777216, i);
			Class284_Sub1.aClass43_5177.method411((byte) 78, i_0_ + 90, ("Occluders: " + (Class21_Sub3.anInt5389 + Class336.anInt2820) + " Active: " + Class59.anInt464), -256, -16777216, i);
			Class284_Sub1.aClass43_5177.method411((byte) 84, i_0_ + 105, ("Occluded: Ground:" + Class302.anInt2518 + " Walls: " + Class98_Sub16.anInt3927 + " CPs: " + Class151_Sub7.anInt5006 + " Pixels: " + Class4.anInt81), -256, -16777216, i);
			Class284_Sub1.aClass43_5177.method411((byte) 78, i_0_ + 120, ("Occlude Calc Took: " + Class249.aLong1898 / 1000L + "us"), -256, -16777216, i);
			if (Class64_Sub21.anInt3702 == 2 && Class111_Sub3.anIntArray4707 != null) {
				for (int i_4_ = 0; i_4_ < Class111_Sub3.anIntArray4707.length; i_4_++) {
					float f = (float) Class111_Sub3.anIntArray4707[i_4_];
					f /= 4194304.0F;
					if (f > 1.0F)
						f = 1.0F;
					f *= 255.0F;
					f = 255.0F - f;
					int i_5_ = (int) f;
					Class111_Sub3.anIntArray4707[i_4_] = i_5_ | i_5_ << 8 | i_5_ << 16 | ~0xffffff;
				}
				Class332 class332 = (Class98_Sub10_Sub30.aHa5709.method1748(-7962, 0, Class64_Sub3.anInt3646, IncomingOpcode.anInt461, Class111_Sub3.anIntArray4707, Class64_Sub3.anInt3646));
