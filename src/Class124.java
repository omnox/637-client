...
final class Class124 {
	...
	private final Interface21 method2213(Class113 class113, RSByteBuffer class98_sub22, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ie.D(" + (class113 != null ? "{...}" : "null") + ',' + (class98_sub22 != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
