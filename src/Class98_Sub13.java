...
final class Class98_Sub13 extends Node {
	...
	final Class98_Sub24_Sub1 method1132(int[] is) {
		if (is != null && is[0] <= 0)
			return null;
		...
		byte[] is_3_ = aByteArray3911;
		aByteArray3911 = null;
		return new Class98_Sub24_Sub1(anInt3880, is_3_, anInt3896, anInt3900, aBoolean3890);
	}

	private static final boolean method1133(RuneScapeCache class207) {
		if (!aBoolean3905) {
			byte[] is = class207.readArchive(0, 0);
			if (is == null)
				return false;
			method1143(is);
		}
	...
	static final int method1134() {
		int i = aByteArray3908[anInt3893] >> anInt3895 & 0x1;
		anInt3895++;
	...
	private final float[] method1135(int i) {
		method1141(aByteArrayArray3898[i], 0);
		method1134();
		int i_4_ = method1138(Class48_Sub2_Sub1.method474(anIntArray3906.length - 1, (byte) 31));
		boolean bool = aBooleanArray3903[i_4_];
		int i_5_ = bool ? anInt3904 : anInt3889;
		...
		if (bool_17_) {
			...
			float[] fs_28_ = bool ? aFloatArray3883 : aFloatArray3886;
			float[] fs_29_ = bool ? aFloatArray3888 : aFloatArray3899;
			float[] fs_30_ = bool ? aFloatArray3887 : aFloatArray3907;
			int[] is = bool ? anIntArray3891 : anIntArray3897;
			...
			for (int i_35_ = 0; i_35_ < i_25_; i_35_++) {
				...
				fs[4 * i_35_ + 3] = (f - f_37_) * f_39_ - (f_36_ - f_38_) * f_40_;
				fs[4 * i_35_ + 1] = (f_36_ - f_38_) * f_39_ + (f - f_37_) * f_40_;
			}
			int i_41_ = Class48_Sub2_Sub1.method474(i_5_ - 1, (byte) 31);
			for (int i_42_ = 0; i_42_ < i_41_ - 3; i_42_++) {
				...
				for (int i_45_ = 0; i_45_ < 2 << i_42_; i_45_++) {
					...
					for (int i_48_ = 0; i_48_ < i_5_ >> i_42_ + 4; i_48_++) {
						...
						fs[i_47_ - 1 - i_49_] = (f - f_51_) * f_53_ - (f_50_ - f_52_) * f_54_;
						fs[i_47_ - 3 - i_49_] = (f_50_ - f_52_) * f_53_ + (f - f_51_) * f_54_;
					}
				}
			}
			...
			for (int i_68_ = 0; i_68_ < i_24_; i_68_++) {
				fs[i_68_] = (fs[2 * i_68_ + i_23_] * fs_29_[2 * i_68_] + fs[2 * i_68_ + 1 + i_23_] * fs_29_[2 * i_68_ + 1]);
				fs[i_23_ - 1 - i_68_] = (fs[2 * i_68_ + i_23_] * fs_29_[2 * i_68_ + 1] - fs[2 * i_68_ + 1 + i_23_] * fs_29_[2 * i_68_]);
			}
			...
			for (int i_73_ = i_9_; i_73_ < i_10_; i_73_++) {
				...
				aFloatArray3882[i_73_] *= (float) Math.sin(1.5707963267948966 * (double) f * (double) f);
			}
			for (int i_74_ = i_12_; i_74_ < i_13_; i_74_++) {
				float f = (float) Math.sin((((double) (i_74_ - i_12_) + 0.5) / (double) i_14_ * 0.5 * 3.141592653589793) + 1.5707963267948966);
				aFloatArray3882[i_74_] *= (float) Math.sin(1.5707963267948966 * (double) f * (double) f);
			}
		}
		float[] fs = null;
		if (anInt3884 > 0) {
			int i_75_ = anInt3884 + i_5_ >> 2;
			fs = new float[i_75_];
			if (!aBoolean3892) {
				for (int i_76_ = 0; i_76_ < anInt3909; i_76_++) {
					int i_77_ = (anInt3884 >> 1) + i_76_;
	...
	static final Class98_Sub13 method1137(RuneScapeCache class207, int i) {
		if (!method1133(class207)) {
			class207.method2742(-88, i);
			return null;
		}
		byte[] is = class207.method2733(i, 55);
		if (is == null)
			return null;
	...
	static final float method1139(int i) {
		int i_85_ = i & 0x1fffff;
		int i_86_ = i & ~0x7fffffff;
	...
	static final Class98_Sub13 method1140(RuneScapeCache class207, int i, int i_88_) {
		...
		byte[] is = class207.readArchive(i_88_, i);
		if (is == null)
			return null;
		return new Class98_Sub13(is);
	}

	private static final void method1141(byte[] is, int i) {
		aByteArray3908 = is;
		anInt3893 = i;
		anInt3895 = 0;
	}

	private final void method1142(byte[] is) {
	...
	private static final void method1143(byte[] is) {
		...
		for (int i = 0; i < 2; i++) {
			...
			int i_103_ = Class48_Sub2_Sub1.method474(i_96_ - 1, (byte) 31);
			for (int i_104_ = 0; i_104_ < i_96_; i_104_++)
				is_102_[i_104_] = Applet_Sub1.method81(i_103_, (byte) -9, i_104_);
			if (i != 0) {
				aFloatArray3883 = fs;
