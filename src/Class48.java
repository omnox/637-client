	...
	static final String method454(int i, boolean bool) {
		try {
			...
			if (class98_sub36 != null) {
				Class98_Sub43_Sub4 class98_sub43_sub4 = ((Class98_Sub36) class98_sub36).aClass237_Sub1_4157.method2913(1);
				if (class98_sub43_sub4 != null) {
					double d = ((Class98_Sub36) class98_sub36).aClass237_Sub1_4157.method2901((byte) -100);
