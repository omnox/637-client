...
class Class246_Sub4_Sub2 extends Class246_Sub4 {
	static AnimableEntity[] aClass246_Sub3Array6173;
	...
	public static void method3106(byte i) {
		try {
			aClass171_6185 = null;
			IncomingOpcode.aClass58_6182 = null;
			if (i < 52)
				aClass171_6185 = null;
			aClass85_6186 = null;
	...
	static final boolean method3107(int i, byte i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "tha.C(" + i + ',' + i_0_ + ')');
		}
	}

	static final void method3108(byte i, int i_1_, int i_2_, int i_3_, int i_4_, byte[] is) {
		try {
			if (i != 1)
				method3106((byte) 100);
			if (i_2_ < i_3_) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tha.A(" + i + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
