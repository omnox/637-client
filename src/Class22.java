...
final class Class22 {
	...
	static final Class98_Sub46_Sub4 method280(byte[] is, int i) {
		try {
			...
			class98_sub22.position = -2 + class98_sub22.data.length;
			int i_0_ = class98_sub22.readShort();
			int i_1_ = (-12 + -i_0_ + (class98_sub22.data.length + -2));
			class98_sub22.position = i_1_;
			int i_2_ = class98_sub22.readInt(-2);
			class98_sub46_sub4.anInt5958 = class98_sub22.readShort();
			class98_sub46_sub4.anInt5964 = class98_sub22.readShort();
			class98_sub46_sub4.anInt5966 = class98_sub22.readShort();
			class98_sub46_sub4.anInt5965 = class98_sub22.readShort();
			...
			int i_8_ = i;
			while (class98_sub22.position < i_1_) {
				int i_9_ = class98_sub22.readShort();
				if (i_9_ == 3)
					class98_sub46_sub4.aStringArray5959[i_8_] = class98_sub22.readString().intern();
				else if (i_9_ < 100 && i_9_ != 21 && i_9_ != 38 && i_9_ != 39)
					class98_sub46_sub4.anIntArray5967[i_8_] = class98_sub22.readInt(i + -2);
				else
					class98_sub46_sub4.anIntArray5967[i_8_] = class98_sub22.readUnsignedByte();
