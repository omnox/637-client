...
final class Class56 {
	...
	final boolean method510() {
		...
		if (!bool)
			return false;
		int i = anIntArray446.length;
		for (int i_0_ = 0; i_0_ < i; i_0_++)
			anIntArray452[i_0_] = anIntArray446[i_0_];
		int i_1_ = anIntArray456[anInt454 - 1];
		int i_2_ = Class48_Sub2_Sub1.method474(i_1_ - 1, (byte) 31);
		...
		for (int i_4_ = 0; i_4_ < anIntArray449.length; i_4_++) {
			int i_5_ = anIntArray449[i_4_];
			int i_6_ = anIntArray455[i_5_];
			int i_7_ = anIntArray447[i_5_];
			int i_8_ = (1 << i_7_) - 1;
			int i_9_ = 0;
			if (i_7_ > 0)
				i_9_ = Class98_Sub13.aClass71Array3885[anIntArray448[i_5_]].method714();
			for (int i_10_ = 0; i_10_ < i_6_; i_10_++) {
				int i_11_ = anIntArrayArray453[i_5_][i_9_ & i_8_];
				i_9_ >>>= i_7_;
				anIntArray450[i_3_++] = (i_11_ >= 0 ? Class98_Sub13.aClass71Array3885[i_11_].method714() : 0);
			}
		}
		return true;
	}

	private final void method511(int i, int i_12_, int i_13_, int i_14_, float[] fs, int i_15_) {
	...
	private static final int method512(int[] is, int i) {
		int i_24_ = is[i];
		int i_25_ = -1;
	...
	final void method513(float[] fs, int i) {
		int i_29_ = anIntArray446.length;
		int i_30_ = anIntArray456[anInt454 - 1];
		aBooleanArray451[0] = aBooleanArray451[1] = true;
		for (int i_31_ = 2; i_31_ < i_29_; i_31_++) {
			int i_32_ = method512(anIntArray452, i_31_);
			int i_33_ = method516(anIntArray452, i_31_);
			int i_34_ = method517(anIntArray452[i_32_], anIntArray450[i_32_], anIntArray452[i_33_], anIntArray450[i_33_], anIntArray452[i_31_]);
			int i_35_ = anIntArray450[i_31_];
			int i_36_ = i_30_ - i_34_;
			int i_37_ = i_34_;
			int i_38_ = (i_36_ < i_37_ ? i_36_ : i_37_) << 1;
			if (i_35_ != 0) {
				aBooleanArray451[i_32_] = aBooleanArray451[i_33_] = true;
				aBooleanArray451[i_31_] = true;
				if (i_35_ >= i_38_)
					anIntArray450[i_31_] = (i_36_ > i_37_ ? i_35_ - i_37_ + i_34_ : i_34_ - i_35_ + i_36_ - 1);
				else
					anIntArray450[i_31_] = ((i_35_ & 0x1) != 0 ? i_34_ - (i_35_ + 1) / 2 : i_34_ + i_35_ / 2);
			} else {
		...
		for (int i_41_ = 1; i_41_ < i_29_; i_41_++) {
			if (aBooleanArray451[i_41_]) {
				int i_42_ = anIntArray452[i_41_];
				int i_43_ = anIntArray450[i_41_] * anInt454;
		...
		float f = aFloatArray445[i_40_];
		for (int i_44_ = i_39_; i_44_ < i; i_44_++)
			fs[i_44_] *= f;
	}

	private final void method514(int i, int i_45_) {
		if (i < i_45_) {
			int i_46_ = i;
			int i_47_ = anIntArray452[i_46_];
			int i_48_ = anIntArray450[i_46_];
			boolean bool = aBooleanArray451[i_46_];
			for (int i_49_ = i + 1; i_49_ <= i_45_; i_49_++) {
				int i_50_ = anIntArray452[i_49_];
				if (i_50_ < i_47_) {
	...
	private static final int method516(int[] is, int i) {
		int i_51_ = is[i];
		int i_52_ = -1;
	...
	private final int method517(int i, int i_56_, int i_57_, int i_58_, int i_59_) {
		int i_60_ = i_58_ - i_56_;
		int i_61_ = i_57_ - i;
		int i_62_ = i_60_ < 0 ? -i_60_ : i_60_;
		int i_63_ = i_62_ * (i_59_ - i);
		int i_64_ = i_63_ / i_61_;
		if (i_60_ < 0)
			return i_56_ - i_64_;
		return i_56_ + i_64_;
	}
	...
	Class56() {
		int i = Class98_Sub13.method1138(16);
		if (i != 1)
			throw new RuntimeException();
		int i_65_ = Class98_Sub13.method1138(5);
		int i_66_ = 0;
		anIntArray449 = new int[i_65_];
		for (int i_67_ = 0; i_67_ < i_65_; i_67_++) {
			int i_68_ = Class98_Sub13.method1138(4);
		...
		int i_72_ = Class98_Sub13.method1138(4);
		int i_73_ = 2;
