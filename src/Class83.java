			...
			if (Class255.draggedComponent == null) {
				if (Player.aBoolean6540 || Class266.aClass98_Sub46_Sub8_1994 == null) {
					...
					if (!Class248.aBoolean1896) {
						if (Class38.anInt355 < i_0_ && ((i_0_ ^ 0xffffffff) > ((Class246_Sub3_Sub4_Sub4.anInt6488 + Class38.anInt355) ^ 0xffffffff))) {
							int i_2_ = -1;
							...
							if (i_2_ != -1) {
								...
								for (Class98_Sub46_Sub8 class98_sub46_sub8 = ((Class98_Sub46_Sub8) class157.method2504((byte) -121)); class98_sub46_sub8 != null; class98_sub46_sub8 = ((Class98_Sub46_Sub8) class157.method2503(1000))) {
									if (i_6_++ == i_2_)
										return (((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5986);
								}
							}
						}
					} else if (Class38.anInt355 >= i_0_ || Class38.anInt355 + (Class246_Sub3_Sub4_Sub4.anInt6488) <= i_0_) {
						if (Class308.aClass98_Sub46_Sub9_2583 != null && (i_0_ ^ 0xffffffff) < (Class282.anInt2128 ^ 0xffffffff) && (Class5.anInt3439 + Class282.anInt2128 ^ 0xffffffff) < (i_0_ ^ 0xffffffff)) {
							int i_7_ = -1;
							for (int i_8_ = 0; ((i_8_ ^ 0xffffffff) > ((((Class98_Sub46_Sub9) Class308.aClass98_Sub46_Sub9_2583).anInt6001) ^ 0xffffffff)); i_8_++) {
								if (!Class98_Sub5_Sub3.aBoolean5539) {
						...
						if ((i_12_ ^ 0xffffffff) != 0) {
							...
							for (Class98_Sub46_Sub9 class98_sub46_sub9 = ((Class98_Sub46_Sub9) class252.method3173(true)); class98_sub46_sub9 != null; class98_sub46_sub9 = ((Class98_Sub46_Sub9) class252.method3174(0))) {
								if (i_16_++ == i_12_)
									return (((Class98_Sub46_Sub8) (Class98_Sub46_Sub8) (((Class98_Sub46) (((Class215) (((Class98_Sub46_Sub9) class98_sub46_sub9).aClass215_5999)).aClass98_Sub46_1615)).aClass98_Sub46_4262)).anInt5986);
							}
						}
					}
				} else
					return (((Class98_Sub46_Sub8) Class266.aClass98_Sub46_Sub8_1994).anInt5986);
			}
			return -1;
	...
	final Class152 method826(int i, int i_17_) {
		try {
			...
			synchronized (aClass79_634) {
				class152 = (Class152) aClass79_634.get((long) i);
			}
			if (class152 != null)
				return class152;
			byte[] is;
			...
			synchronized (aClass79_634) {
				aClass79_634.put((long) i, class152);
			}
			return class152;
		} catch (RuntimeException runtimeexception) {
