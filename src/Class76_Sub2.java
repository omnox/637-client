...
final class Class76_Sub2 extends Class76 {
	...
	final void method743(int i, boolean bool) {
		try {
			if (i < 93)
				method745((byte) -62);
			this.aHa_Sub3_585.method2019(Class1.aClass128_64, Class288.aClass128_3381, 22831);
		...
		try {
			do {
				if (aClass195_3732.aBoolean1501) {
					...
					this.aHa_Sub3_585.method2005(aClass195_3732.anInterface4_Impl1_1498, 36);
					OpenGL.glProgramLocalParameter4fARB(34336, 0, f, 0.0F, 0.0F, 1.0F);
					if (!client.aBoolean3553)
						break;
				}
				int i_2_ = 16 * (this.aHa_Sub3_585.anInt4556 % 4000) / 4000;
				this.aHa_Sub3_585.method2005((aClass195_3732.anInterface4_Impl2Array1503[i_2_]), -117);
	...
	final void method748(int i, boolean bool) {
		try {
			...
			if (i != 69)
				aClass207_3733 = null;
			this.aHa_Sub3_585.method2051(0, -128, IncomingOpcode.aClass65_459);
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean requestFlag(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, boolean bool, int i_21_) {
		try {
			int i_22_ = (Player.selfPlayer.walkQueueX[0]);
			int i_23_ = (Player.selfPlayer.walkQueueZ[0]);
			if (i_22_ < 0 || GameWorld.size_x <= i_22_ || i_23_ < 0 || i_23_ >= GameWorld.size_y)
				return false;
			if (i_18_ > i_20_ || i_20_ >= GameWorld.size_x || i_19_ < 0 || GameWorld.size_y <= i_19_)
				return false;
			int i_24_ = (Applet_Sub1.findPath((Class167.aClass243Array1281[Player.selfPlayer.height_level]), Player.selfPlayer.getSize(), Class76_Sub5.anIntArray3743, i_15_, i, i_19_, i_16_, i_23_, Class117.anIntArray974, bool, i_20_, i_17_, 48, i_22_, i_21_));
			if (i_24_ < 1)
				return false;
	...
	Class76_Sub2(ha_Sub3_Sub2 var_ha_Sub3_Sub2, RuneScapeCache class207, Class195 class195) {
		...
		try {
			...
			if (class207 == null || !aClass195_3732.method2659(-22382) || !aHa_Sub3_Sub2_3730.aBoolean6134)
				aClass273_3729 = null;
			else
