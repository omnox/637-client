...
final class Class14 {
	...
	static final boolean method225(String string, byte i) {
		try {
			if (string == null)
				return false;
			...
			throw Class64_Sub27.method667(runtimeexception, ("bb.A(" + (string != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}

	static final int method226(int i) {
		try {
			if (i <= 106)
