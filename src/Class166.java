	...
	static final void method2525(int i) {
		try {
			...
			for (int i_0_ = 0; (Class259.anInt1954 ^ 0xffffffff) < (i_0_ ^ 0xffffffff); i_0_++) {
				...
				if ((Class201.anInt1544 ^ 0xffffffff) != (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6406 ^ 0xffffffff)) {
					if (((Class246_Sub3_Sub4_Sub2_Sub1) class246_sub3_sub4_sub2_sub1).aClass141_6504.method2302((byte) 117))
			...
			if ((((RSByteBuffer) IncomingMessages.packetStream).position) != Class65.anInt496)
				throw new RuntimeException("gnp1 pos:" + (((RSByteBuffer) (IncomingMessages.packetStream)).position) + " psize:" + Class65.anInt496);
			for (int i_2_ = 0; (Class150.anInt1211 ^ 0xffffffff) < (i_2_ ^ 0xffffffff); i_2_++) {
				if (Class260.aClass377_3254.method3990((long) Class325.anIntArray2726[i_2_], -1) == null)
			...
			for (int i_3_ = 0; i_3_ < Class98_Sub10_Sub20.anInt5640; i_3_++) {
				if ((Class201.anInt1544 ^ 0xffffffff) != (((Mobile) (((Class98_Sub39) Class163.aClass98_Sub39Array3516[i_3_]).aClass246_Sub3_Sub4_Sub2_Sub1_4187)).anInt6406 ^ 0xffffffff))
					throw new RuntimeException("gnp4 uk:" + (((Mobile) (((Class98_Sub39) Class163.aClass98_Sub39Array3516[i_3_]).aClass246_Sub3_Sub4_Sub2_Sub1_4187)).anInt6369));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
