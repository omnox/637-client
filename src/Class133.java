...
final class Class133 implements Interface18 {
	...
	static final boolean method2238(boolean bool, Class196 class196) {
		try {
			...
			if (class196 != AbstractModel.aClass196_1182 && class196 != Player.aClass196_6543 && RuneScapeCache.aClass196_1578 != class196 && class196 != Class134.aClass196_3458)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("jb.D(" + bool + ',' + (class196 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class133(Class163 class163) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "jb.<init>(" + (class163 != null ? "{...}" : "null") + ')');
		}
	}
	...
	public final void method60(boolean bool, byte i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "jb.B(" + bool + ',' + i + ')');
			}
			break;
		} while (false);
	}
	...
	static final boolean method2239(int i, int i_0_, byte i_1_) {
		try {
			if (i_1_ != 100)
				anInt3452 = -91;
			boolean bool = ((i & 0x37) == 0 ? Class98_Sub27.method1292(i, (byte) 117, i_0_) : Class21_Sub3.method276(i_0_, 15123, i));
			return bool | (Class373_Sub3.method3978(i, i_0_, (byte) 103) | (0x10000 & i_0_) != 0);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("jb.F(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}
