		...
		try {
			...
			try {
				while (!this.aBoolean893) {
					for (int i = 0; i < 2; i++) {
						Class268 class268 = this.aClass268Array894[i];
						if (class268 != null)
		...
		try {
			...
			if (class332 != null) {
				...
				if (class24.aString263 != null) {
					i_4_ = (Class98_Sub46_Sub2_Sub2.aClass197_6296.method2675(class24.aString263, Class35.aStringArray335, null, null, -1));
				...
				if (Class278.anInt2086 - -i_0_ <= i_2_) {
					if (-i_0_ + Class278.anInt2093 < i_2_) {
				...
				if (i_3_ < Class278.anInt2077 - -i_0_) {
					i_10_ = i_0_ / 2 + i_1_ + Class278.anInt2077;
					i_3_ = Class278.anInt2077;
				} else if (i_3_ > Class278.anInt2094 - i_0_) {
				...
				if (class24.aString263 != null) {
					...
					if (class24.anInt226 != 0)
						var_ha.method1760(i_14_ + -i_12_, i_15_ + -i_13_, i_13_, class24.anInt226, (byte) -66, i_12_);
					if (class24.anInt239 != 0)
						var_ha.method1781(true, i_15_ + -i_13_, i_14_ - i_12_, class24.anInt239, i_12_, i_13_);
					for (int i_16_ = 0; i_4_ > i_16_; i_16_++) {
						String string = Class35.aStringArray335[i_16_];
						if (i_16_ < i_4_ - 1)
							string = string.substring(0, -4 + string.length());
						Class339_Sub1.aClass326_5308.method3706(var_ha, string, i_9_, i_10_, class24.anInt257, true);
