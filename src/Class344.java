...
final class Class344 {
	...
	final void method3820(RSByteBuffer class98_sub22) {
		...
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
			int i_1_ = class98_sub22.readSmart(1689622712);
			if (i_1_ == 0)
				break;
			anIntArray2881[i_0_] = i_1_;
			anIntArray2875[i_0_] = class98_sub22.method1239(-80);
			anIntArray2873[i_0_] = class98_sub22.readSmart(1689622712);
		}
	...
	private final int method3821(int i, int i_2_, int i_3_) {
		if (i_3_ == 1) {
			if ((i & 0x7fff) < 16384)
				return i_2_;
			return -i_2_;
	...
	final int[] method3822(int i, int i_4_) {
		...
		if (aClass209_2872 != null) {
			...
			for (int i_23_ = 0; i_23_ < i; i_23_++) {
				int i_24_ = aClass209_2872.method2770(i);
		...
		if (anInt2882 > 0 && anInt2868 > 0) {
			int i_27_ = (int) ((double) anInt2882 * d);
		...
		if (((Class182) aClass182_2871).anIntArray1437[0] > 0 || ((Class182) aClass182_2871).anIntArray1437[1] > 0) {
			...
			int i_31_ = aClass182_2871.method2613(1, (float) i_29_ / 65536.0F);
			if (i >= i_30_ + i_31_) {
				int i_32_ = 0;
				int i_33_ = i_31_;
				if (i_33_ > i - i_30_)
				...
				for (/**/; i_32_ < i_33_; i_32_++) {
					...
					for (int i_35_ = 0; i_35_ < i_30_; i_35_++)
						i_34_ += (int) (((long) (anIntArray2879[i_32_ + i_30_ - 1 - i_35_]) * (long) (Class182.anIntArrayArray1438[0][i_35_])) >> 16);
					for (int i_36_ = 0; i_36_ < i_32_; i_36_++)
						i_34_ -= (int) (((long) anIntArray2879[i_32_ - 1 - i_36_] * (long) (Class182.anIntArrayArray1438[1][i_36_])) >> 16);
				...
				for (;;) {
					...
					for (/**/; i_32_ < i_33_; i_32_++) {
						...
						for (int i_38_ = 0; i_38_ < i_30_; i_38_++)
							i_37_ += (int) (((long) (anIntArray2879[i_32_ + i_30_ - 1 - i_38_]) * (long) (Class182.anIntArrayArray1438[0][i_38_])) >> 16);
						for (int i_39_ = 0; i_39_ < i_31_; i_39_++)
							i_37_ -= (int) (((long) (anIntArray2879[i_32_ - 1 - i_39_]) * (long) (Class182.anIntArrayArray1438[1][i_39_])) >> 16);
						anIntArray2879[i_32_] = i_37_;
						i_29_ = aClass209_2865.method2770(i + 1);
					}
					if (i_32_ >= i - i_30_)
						break;
					i_30_ = aClass182_2871.method2613(0, (float) i_29_ / 65536.0F);
					i_31_ = aClass182_2871.method2613(1, (float) i_29_ / 65536.0F);
					i_33_ += 128;
				}
				for (/**/; i_32_ < i; i_32_++) {
					int i_40_ = 0;
					for (int i_41_ = i_32_ + i_30_ - i; i_41_ < i_30_; i_41_++)
						i_40_ += (int) (((long) (anIntArray2879[i_32_ + i_30_ - 1 - i_41_]) * (long) (Class182.anIntArrayArray1438[0][i_41_])) >> 16);
					for (int i_42_ = 0; i_42_ < i_31_; i_42_++)
						i_40_ -= (int) (((long) anIntArray2879[i_32_ - 1 - i_42_] * (long) (Class182.anIntArrayArray1438[1][i_42_])) >> 16);
	...
	static {
		...
		for (int i = 0; i < 32768; i++)
			anIntArray2866[i] = (int) (Math.sin((double) i / 5215.1903) * 16384.0);
