...
final class Class182 {
	...
	final void method2612(RSByteBuffer class98_sub22, Class209 class209) {
		...
		((Class182) this).anIntArray1437[0] = i >> 4;
		((Class182) this).anIntArray1437[1] = i & 0xf;
		if (i != 0) {
			...
			for (int i_1_ = 0; i_1_ < 2; i_1_++) {
				for (int i_2_ = 0; i_2_ < ((Class182) this).anIntArray1437[i_1_]; i_2_++) {
			...
			for (int i_3_ = 0; i_3_ < 2; i_3_++) {
				for (int i_4_ = 0; i_4_ < ((Class182) this).anIntArray1437[i_3_]; i_4_++) {
	...
	final int method2613(int i, float f) {
		if (i == 0) {
			...
			f_5_ *= 0.0030517578F;
			aFloat1436 = (float) Math.pow(0.1, (double) (f_5_ / 20.0F));
			anInt1439 = (int) (aFloat1436 * 65536.0F);
		}
		if (((Class182) this).anIntArray1437[i] == 0)
			return 0;
		float f_6_ = method2617(i, 0, f);
		aFloatArrayArray1435[i][0] = -2.0F * f_6_ * (float) Math.cos((double) method2615(i, 0, f));
		aFloatArrayArray1435[i][1] = f_6_ * f_6_;
		for (int i_7_ = 1; i_7_ < ((Class182) this).anIntArray1437[i]; i_7_++) {
			f_6_ = method2617(i, i_7_, f);
			float f_8_ = (-2.0F * f_6_ * (float) Math.cos((double) method2615(i, i_7_, f)));
		...
		if (i == 0) {
			for (int i_11_ = 0; i_11_ < ((Class182) this).anIntArray1437[0] * 2; i_11_++)
				aFloatArrayArray1435[0][i_11_] *= aFloat1436;
		}
		for (int i_12_ = 0; i_12_ < ((Class182) this).anIntArray1437[i] * 2; i_12_++)
			anIntArrayArray1438[i][i_12_] = (int) (aFloatArrayArray1435[i][i_12_] * 65536.0F);
		return ((Class182) this).anIntArray1437[i] * 2;
	}
