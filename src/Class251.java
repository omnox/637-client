...
final class Class251 {
	...
	static final void method3170(int i, int i_1_, boolean bool, int i_2_, int i_3_) {
		try {
			if (bool || i_2_ != Class160.anInt1258 || Class275.anInt2047 != i_1_ || (Class115.anInt963 != Class43.anInt377 && Class98_Sub9.aClass98_Sub27_3856.aClass64_Sub3_4076.method564((byte) 123) != 1)) {
				...
				Class272.anInt2038 = (Class160.anInt1258 - (GameWorld.size_x >> 4)) * 8;
				int i_5_ = aa_Sub2.anInt3562;
				aa_Sub2.anInt3562 = (-(GameWorld.size_y >> 4) + Class275.anInt2047) * 8;
				...
				if (i_3_ == 11) {
					for (int i_8_ = 0; (Class98_Sub10_Sub20.anInt5640 > i_8_); i_8_++) {
						...
						if (class98_sub39 != null) {
							...
							for (int i_9_ = 0; i_9_ < 10; i_9_++) {
								class246_sub3_sub4_sub2_sub1.walkQueueX[i_9_] -= i_6_;
								class246_sub3_sub4_sub2_sub1.walkQueueZ[i_9_] -= i_7_;
							}
							class246_sub3_sub4_sub2_sub1.localYPos -= i_7_ * 512;
							class246_sub3_sub4_sub2_sub1.localXPos -= i_6_ * 512;
						}
					}
				} else {
					...
					for (int i_13_ = 0; Class98_Sub10_Sub20.anInt5640 > i_13_; i_13_++) {
						...
						if (class98_sub39 != null) {
							Class246_Sub3_Sub4_Sub2_Sub1 class246_sub3_sub4_sub2_sub1 = (class98_sub39.aClass246_Sub3_Sub4_Sub2_Sub1_4187);
							class246_sub3_sub4_sub2_sub1.localXPos -= 512 * i_6_;
							class246_sub3_sub4_sub2_sub1.localYPos -= i_7_ * 512;
							if (class246_sub3_sub4_sub2_sub1.localXPos < 0 || i_11_ < class246_sub3_sub4_sub2_sub1.localXPos || class246_sub3_sub4_sub2_sub1.localYPos < 0 || (class246_sub3_sub4_sub2_sub1.localYPos > i_12_)) {
								...
								for (int i_15_ = 0; i_15_ < 10; i_15_++) {
									class246_sub3_sub4_sub2_sub1.walkQueueX[i_15_] -= i_6_;
									class246_sub3_sub4_sub2_sub1.walkQueueZ[i_15_] -= i_7_;
									if ((class246_sub3_sub4_sub2_sub1.walkQueueX[i_15_]) < 0 || (GameWorld.size_x <= (class246_sub3_sub4_sub2_sub1.walkQueueX[i_15_])) || (class246_sub3_sub4_sub2_sub1.walkQueueZ[i_15_]) < 0 || ((class246_sub3_sub4_sub2_sub1.walkQueueZ[i_15_]) >= GameWorld.size_y))
										bool_14_ = false;
								}
								if (!bool_14_) {
									class246_sub3_sub4_sub2_sub1.method3054(null, 1);
									...
									Class325.anIntArray2726[Class150.anInt1211++] = (class246_sub3_sub4_sub2_sub1.anInt6369);
							}
						}
					}
					if (bool_10_) {
				...
				for (int i_16_ = 0; i_16_ < 2048; i_16_++) {
					...
					if (class246_sub3_sub4_sub2_sub2 != null) {
						for (int i_17_ = 0; i_17_ < 10; i_17_++) {
							class246_sub3_sub4_sub2_sub2.walkQueueX[i_17_] -= i_6_;
							class246_sub3_sub4_sub2_sub2.walkQueueZ[i_17_] -= i_7_;
						}
						class246_sub3_sub4_sub2_sub2.localYPos -= 512 * i_7_;
						class246_sub3_sub4_sub2_sub2.localXPos -= 512 * i_6_;
					}
				}
				if (i == -6547) {
					Class36[] class36s = Class104.aClass36Array903;
					for (int i_18_ = 0; class36s.length > i_18_; i_18_++) {
					...
					for (Class98_Sub33 class98_sub33 = ((Class98_Sub33) Class191.aClass148_1478.method2418(32)); class98_sub33 != null; class98_sub33 = ((Class98_Sub33) Class191.aClass148_1478.method2417(88))) {
						...
						if (Class151_Sub9.anInt5028 != 4 && (class98_sub33.anInt4112 < 0 || (class98_sub33.anInt4113 < 0) || (GameWorld.size_x <= class98_sub33.anInt4112) || (GameWorld.size_y <= (class98_sub33.anInt4113))))
					...
					for (Class98_Sub33 class98_sub33 = ((Class98_Sub33) OutgoingPacket.aClass148_3866.method2418(32)); class98_sub33 != null; class98_sub33 = (Class98_Sub33) OutgoingPacket.aClass148_3866.method2417(116)) {
						class98_sub33.anInt4113 -= i_7_;
						class98_sub33.anInt4112 -= i_6_;
						if (Class151_Sub9.anInt5028 != 4 && (class98_sub33.anInt4112 < 0 || (class98_sub33.anInt4113 < 0) || ((class98_sub33.anInt4112) >= GameWorld.size_x) || (GameWorld.size_y <= (class98_sub33.anInt4113))))
							class98_sub33.remove();
					}
					if (Class151_Sub9.anInt5028 != 4) {
						for (Class98_Sub45 class98_sub45 = ((Class98_Sub45) AbstractModel.aClass377_1180.start_iteration(101)); class98_sub45 != null; class98_sub45 = (Class98_Sub45) AbstractModel.aClass377_1180.iterate_next(i + 6546)) {
							int i_19_ = (int) (class98_sub45.uid & 0x3fffL);
							int i_20_ = -Class272.anInt2038 + i_19_;
							int i_21_ = (int) ((class98_sub45.uid >> 14) & 0x3fffL);
							int i_22_ = i_21_ + -aa_Sub2.anInt3562;
							if (i_20_ < 0 || i_22_ < 0 || GameWorld.size_x <= i_20_ || GameWorld.size_y <= i_22_)
