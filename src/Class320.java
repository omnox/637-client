...
final class Class320 {
	static final void method3663(Class98_Sub46_Sub9 class98_sub46_sub9, int i, int i_0_, int i_1_, int i_2_, int i_3_, ha var_ha, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tn.B(" + (class98_sub46_sub9 != null ? "{...}" : "null") + ',' + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ')'));
		}
	}

	public static void method3664(int i) {
		do {
			try {
				IncomingOpcode.aClass58_2708 = null;
				if (i == 5989)
					break;
				IncomingOpcode.aClass58_2708 = null;
			} catch (RuntimeException runtimeexception) {
	...
	static final void method3665(byte i, String string, int i_9_, boolean bool) {
		try {
			...
			if (i_9_ == 0) {
				...
				if (string != null) {
					...
					Class43 class43 = (Class265.aHa1974.method1804(class197, Class324.method3680(Class332_Sub2.aClass207_5423, Class269.anInt2026, 0), true));
					Class263.method3216(14059);
					Class246_Sub2.method2972(-127, class197, class43, true, Class265.aHa1974, string);
				}
			} else {
				ha var_ha = null;
				if (string != null) {
					var_ha = Class76_Sub11.method771(0, Class42_Sub3.aCanvas5361, i + -21, Class284_Sub2_Sub2.aD6203, 0, Class212.aClass207_1603);
					var_ha.GA(0);
					Class197 class197 = Class109.method1733((byte) 115, 0, Class269.anInt2026, Class36.aClass207_348);
					Class43 class43 = (var_ha.method1804(class197, Class324.method3680(Class332_Sub2.aClass207_5423, Class269.anInt2026, 0), true));
					Class263.method3216(14059);
				...
				try {
					...
					if (string != null) {
						...
						Class43 class43 = var_ha.method1804(class197, (Class324.method3680(Class332_Sub2.aClass207_5423, Class269.anInt2026, 0)), true);
						Class263.method3216(14059);
						Class246_Sub2.method2972(-127, class197, class43, true, var_ha, string);
					}
			...
			throw Class64_Sub27.method667(runtimeexception, ("tn.C(" + i + ',' + (string != null ? "{...}" : "null") + ',' + i_9_ + ',' + bool + ')'));
		}
	}
}
