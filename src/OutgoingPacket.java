...
final class OutgoingPacket extends Node {
	OutgoingOpcode aClass171_3864;
	Class98_Sub22_Sub1 packet;
	static LinkedList aClass148_3866 = new LinkedList();
	int anInt3867;
	...
	static final void method1124(int i, byte i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "eda.E(" + i + ',' + i_0_ + ')');
		}
	}
	...
	static final void method1126(boolean bool, short[] is, String[] strings) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("eda.B(" + bool + ',' + (is != null ? "{...}" : "null") + ',' + (strings != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final void method1127(byte i, int i_2_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "eda.D(" + i + ',' + i_2_ + ')');
			}
			break;
		} while (false);
	}
