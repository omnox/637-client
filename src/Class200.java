...
final class Class200 {
	...
	static final Class332 method2693(int i, byte i_2_, ha var_ha) {
		try {
			if (i_2_ > -104)
				return null;
			Class98_Sub36 class98_sub36 = ((Class98_Sub36) Class156_Sub1.aClass377_3277.method3990((long) i, -1));
			if (class98_sub36 != null) {
				Class98_Sub43_Sub3 class98_sub43_sub3 = ((Class98_Sub36) class98_sub36).aClass237_Sub1_4157.method2908(-32675);
				((Class98_Sub36) class98_sub36).aBoolean4158 = true;
	...
	static final int method2694(String string, int i, int i_3_, int i_4_, byte[] is, int i_5_) {
		try {
			...
			for (int i_7_ = 0; (i_6_ ^ 0xffffffff) < (i_7_ ^ 0xffffffff); i_7_++) {
				...
				if (i_8_ > 0 && i_8_ < 128 || i_8_ >= 160 && (i_8_ ^ 0xffffffff) >= -256)
