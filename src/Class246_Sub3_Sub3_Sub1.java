...
final class Class246_Sub3_Sub3_Sub1 extends Class246_Sub3_Sub3 implements Interface19 {
	...
	static boolean[] loadedInterfaceFlags;
	...
	final boolean method2976(int i, ha var_ha, byte i_0_, int i_1_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tp.TA(" + i + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}
	...
	final void method2981(AnimableEntity class246_sub3, byte i, boolean bool, int i_2_, ha var_ha, int i_3_, int i_4_) {
		try {
			int i_5_ = 6 / ((15 - i) / 55);
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("tp.CA(" + (class246_sub3 != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + i_2_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_3_ + ',' + i_4_ + ')'));
		}
	}
	...
	final Class228 method2974(byte i, ha var_ha) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tp.KA(" + i + ',' + (var_ha != null ? "{...}" : "null") + ')'));
		}
	}
	...
	final void method3016(int i, Class185 class185) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("tp.P(" + i + ',' + (class185 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final void method62(ha var_ha, int i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("tp.G(" + (var_ha != null ? "{...}" : "null") + ',' + i + ')'));
			}
			break;
		} while (false);
	}
