...
final class Class43_Sub3 extends Class43 {
	...
	Class43_Sub3(ha_Sub2 var_ha_Sub2, Class197 class197, Class324[] class324s, int[] is, int[] is_0_) {
		...
		for (int i = 0; i < class324s.length; i++) {
			...
			if (class324.aByteArray2723 != null)
				...
				byte[] is_1_ = class324.aByteArray2717;
	...
	final void fa(char c, int i, int i_4_, int i_5_, boolean bool) {
		...
		int i_8_ = aHa_Sub2_3614.anInt4505;
		int i_9_ = i + i_4_ * i_8_;
		int i_10_ = i_8_ - i_6_;
		int i_11_ = 0;
		int i_12_ = 0;
		if (i_4_ < aHa_Sub2_3614.anInt4495) {
			int i_13_ = aHa_Sub2_3614.anInt4495 - i_4_;
			i_7_ -= i_13_;
		...
		if (i < aHa_Sub2_3614.anInt4509) {
			int i_14_ = aHa_Sub2_3614.anInt4509 - i;
			i_6_ -= i_14_;
		...
		if (i + i_6_ > aHa_Sub2_3614.anInt4507) {
			int i_15_ = i + i_6_ - aHa_Sub2_3614.anInt4507;
			i_6_ -= i_15_;
			i_11_ += i_15_;
			i_10_ += i_15_;
		}
		if (i_6_ > 0 && i_7_ > 0)
			method417(aByteArrayArray3612[c], aHa_Sub2_3614.anIntArray4504, i_5_, i_12_, i_9_, i_6_, i_7_, i_10_, i_11_);
	}
	...
	private final void method418(byte[] is, int[] is_28_, int i, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, aa var_aa, int i_38_, int i_39_) {
		...
		int[] is_40_ = var_aa_Sub1.anIntArray3555;
		int[] is_41_ = var_aa_Sub1.anIntArray3557;
		int i_42_ = i_35_ - aHa_Sub2_3614.anInt4509;
		int i_43_ = i_36_;
		if (i_39_ > i_43_) {
			i_43_ = i_39_;
	...
	final void method409(char c, int i, int i_56_, int i_57_, boolean bool, aa var_aa, int i_58_, int i_59_) {
		if (var_aa == null)
			...
			if (i < aHa_Sub2_3614.anInt4509) {
				int i_68_ = aHa_Sub2_3614.anInt4509 - i;
				i_60_ -= i_68_;
				i = aHa_Sub2_3614.anInt4509;
				i_66_ += i_68_;
				i_63_ += i_68_;
			...
			if (i + i_60_ > aHa_Sub2_3614.anInt4507) {
				int i_69_ = i + i_60_ - aHa_Sub2_3614.anInt4507;
				i_60_ -= i_69_;
				i_65_ += i_69_;
				i_64_ += i_69_;
			}
			if (i_60_ > 0 && i_61_ > 0)
				method418(aByteArrayArray3612[c], aHa_Sub2_3614.anIntArray4504, i_57_, i_66_, i_63_, i_60_, i_61_, i_64_, i_65_, i, i_56_, anIntArray3610[c], var_aa, i_58_, i_59_);
		}
	}
}
