						...
						for (int i_16_ = i_0_ - 1; (i_16_ ^ 0xffffffff) <= -1; i_16_--) {
							...
							if ((i_17_ ^ 0xffffffff) < -1) {
								for (int i_18_ = i_17_ - 1; (i_18_ ^ 0xffffffff) <= -1; i_18_--) {
									...
									int i_19_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6178);
									byte i_20_ = (byte) (i_19_ >> 1004982320);
									byte i_21_ = (byte) (i_19_ >> -1475022584);
									byte i_22_ = (byte) i_19_;
									byte i_23_ = (byte) (i_19_ >>> 499468248);
									float f_24_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6176) >> -1148612052);
									float f_25_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6177) >> -1842071796);
									float f_26_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6175) >> 1522356492);
									int i_27_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6179 >> -2078565748);
									...
									if ((((ha_Sub3) var_ha_Sub3).anInt4580 ^ 0xffffffff) == -1)
										stream.a(i_20_, i_21_, i_22_, i_23_);
									else
										stream.b(i_20_, i_21_, i_22_, i_23_);
									stream.b(1.0F);
								...
								if (anIntArray608[i_16_] > 64) {
									...
									for (int i_29_ = anIntArray614[i_28_] + -1; i_29_ >= 0; i_29_--) {
										...
										int i_30_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6178);
										byte i_31_ = (byte) (i_30_ >> -1731208688);
										byte i_32_ = (byte) (i_30_ >> 2114755272);
										byte i_33_ = (byte) i_30_;
										byte i_34_ = (byte) (i_30_ >>> 42394680);
										float f_35_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6176) >> -1812783700);
										float f_36_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6177) >> -1875090740);
										float f_37_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6175) >> -1949960628);
										int i_38_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6179 >> 1949500780);
						...
						for (int i_39_ = -1 + i_0_; (i_39_ ^ 0xffffffff) <= -1; i_39_--) {
							...
							if (i_40_ > 0) {
								for (int i_41_ = i_40_ + -1; i_41_ >= 0; i_41_--) {
									...
									int i_42_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6178);
									byte i_43_ = (byte) (i_42_ >> -1414407312);
									byte i_44_ = (byte) (i_42_ >> 1123272776);
									byte i_45_ = (byte) i_42_;
									byte i_46_ = (byte) (i_42_ >>> -997863304);
									float f_47_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6176) >> -83946644);
									float f_48_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6177) >> -867938740);
									float f_49_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6175) >> 13807948);
									int i_50_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6179 >> -1405584212);
								...
								if ((anIntArray608[i_39_] ^ 0xffffffff) < -65) {
									...
									for (int i_52_ = -1 + anIntArray614[i_51_]; i_52_ >= 0; i_52_--) {
										...
										int i_53_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6178);
										byte i_54_ = (byte) (i_53_ >> -924804944);
										byte i_55_ = (byte) (i_53_ >> 1479709480);
										byte i_56_ = (byte) i_53_;
										byte i_57_ = (byte) (i_53_ >>> 989558680);
										float f_58_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6176) >> -1539946420);
										float f_59_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6177) >> 1485597036);
										float f_60_ = (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6175) >> 750057452);
										int i_61_ = (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6179 >> 2108567500);
	...
	private final void method816(int i, ha_Sub3 var_ha_Sub3) {
		do {
			try {
				...
				if (Class98_Sub32_Sub1.aFloat5886 != ((ha_Sub3) var_ha_Sub3).aFloat4576)
	...
	final void method818(byte i, Class242 class242, int i_63_, ha_Sub3 var_ha_Sub3) {
		try {
			if (((ha_Sub3) var_ha_Sub3).aClass111_Sub3_4543 != null) {
				...
				float f = (((Class111_Sub3) ((ha_Sub3) var_ha_Sub3).aClass111_Sub3_4543).aFloat4708);
				float f_64_ = (((Class111_Sub3) ((ha_Sub3) var_ha_Sub3).aClass111_Sub3_4543).aFloat4713);
				float f_65_ = (((Class111_Sub3) ((ha_Sub3) var_ha_Sub3).aClass111_Sub3_4543).aFloat4704);
				float f_66_ = (((Class111_Sub3) ((ha_Sub3) var_ha_Sub3).aClass111_Sub3_4543).aFloat4703);
				try {
					int i_67_ = 0;
					int i_68_ = 2147483647;
					int i_69_ = 0;
					Class246_Sub4 class246_sub4 = (((Class358) ((Class242) class242).aClass358_1850).aClass246_Sub4_3028);
					for (Class246_Sub4 class246_sub4_70_ = (((Class246_Sub4) class246_sub4).aClass246_Sub4_5091); class246_sub4_70_ != class246_sub4; class246_sub4_70_ = (((Class246_Sub4) class246_sub4_70_).aClass246_Sub4_5091)) {
						Class246_Sub4_Sub2 class246_sub4_sub2 = (Class246_Sub4_Sub2) class246_sub4_70_;
						int i_71_ = (int) (f_66_ + ((float) (((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6175 >> 912414860) * f_65_ + ((float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6177) >> -493384788) * f_64_ + (float) ((((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6176) >> 1402072204) * f)));
					...
					i_67_ = 0;
					Class246_Sub4 class246_sub4_74_ = ((Class246_Sub4) class246_sub4).aClass246_Sub4_5091;
					int i_75_ = -2;
					if (i != -108)
					...
					while (class246_sub4 != class246_sub4_74_) {
						...
						for (/**/; class246_sub4_74_ != class246_sub4; class246_sub4_74_ = (((Class246_Sub4) class246_sub4_74_).aClass246_Sub4_5091)) {
							...
							if (bool_76_) {
								...
								i_75_ = ((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6180;
							}
							if (i_67_ > 0 && (i_75_ != ((Class246_Sub4_Sub2) class246_sub4_sub2).anInt6180 || (((Class246_Sub4_Sub2) class246_sub4_sub2).aBoolean6174 == !bool))) {
								bool_76_ = true;
								break;
							}
						...
						var_ha_Sub3.method2039(false, i ^ ~0x6b, ((i_75_ ^ 0xffffffff) > -1 ? -1 : i_75_), false);
						if (!bool || (Class98_Sub32_Sub1.aFloat5886 == ((ha_Sub3) var_ha_Sub3).aFloat4576)) {
