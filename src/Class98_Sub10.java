...
abstract class Class98_Sub10 extends Node {
	...
	final int[][] method994(int i, int i_3_, int i_4_) {
		try {
			...
			if (!((Class98_Sub10) ((Class98_Sub10) this).aClass98_Sub10Array3857[i_4_]).aBoolean3861)
				return ((Class98_Sub10) this).aClass98_Sub10Array3857[i_4_].method997(-119, i);
			int[] is = ((Class98_Sub10) this).aClass98_Sub10Array3857[i_4_].method990(i_3_ + -24176, i);
			int[][] is_5_ = new int[3][];
			is_5_[1] = is;
			is_5_[2] = is;
			is_5_[0] = is;
			...
			if (Class359.anInt3058 < 400) {
				...
				if (((Class141) class141).aBoolean1116) {
					...
					if (((Class141) class141).anInt1115 != 0) {
						...
						string += ((Class108.method1730((((Player) Player.selfPlayer).playerCbLevel), ((Class141) class141).anInt1115, i + 16328)) + " (" + (String) string_6_ + ((Class141) class141).anInt1115 + ")");
					}
					if (Class98_Sub10_Sub9.aBoolean5585 && !bool) {
						...
						if ((0x2 & Class98_Sub4.anInt3826 ^ 0xffffffff) != -1 && (class149 == null || ((class141.method2305((Class98_Sub46_Sub1.anInt5945), (((ParamType) class149).anInt1202), (byte) 125) ^ 0xffffffff) != (((ParamType) class149).anInt1202 ^ 0xffffffff))))
							GameInterfaceData.method3470(false, true, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), Class336.anInt2823, 0, (Class246_Sub3_Sub3.aString6156 + " -> <col=ffff00>" + string), false, 0, 48, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), -1, false, Class287_Sub2.aString3272);
					}
					if (!bool) {
						String[] strings = ((Class141) class141).aStringArray1148;
						if (Class34.aBoolean324)
							strings = Class98_Sub10_Sub6.method1022(i ^ ~0x37b, strings);
						if (strings != null) {
							for (int i_7_ = 4; (i_7_ ^ 0xffffffff) <= -1; i_7_--) {
								if (strings[i_7_] != null && (((Class141) class141).aByte1129 == 0 || !(strings[i_7_].equalsIgnoreCase(TextResources.ATTACK.get_text(Class374.anInt3159))))) {
									int i_8_ = 0;
									if (i_7_ == 0)
										i_8_ = 10;
									...
									if ((i_7_ ^ 0xffffffff) == -4)
										i_8_ = 12;
									if (((Class141) class141).anInt1143 == i_7_)
										i_9_ = ((Class141) class141).anInt1154;
									if (i_7_ == 4)
										i_8_ = 17;
									if (((Class141) class141).anInt1114 == i_7_)
										i_9_ = ((Class141) class141).anInt1110;
									GameInterfaceData.method3470(false, true, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), ((strings[i_7_].equalsIgnoreCase(TextResources.ATTACK.get_text(Class374.anInt3159))) ? ((Class141) class141).anInt1099 : i_9_), 0, "<col=ffff00>" + string, false, 0, i_8_, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), -1, false, strings[i_7_]);
								}
							}
						}
						if (((Class141) class141).aByte1129 == 1 && strings != null) {
							for (int i_10_ = 4; i_10_ >= 0; i_10_--) {
								if (strings[i_10_] != null && (strings[i_10_].equalsIgnoreCase(TextResources.ATTACK.get_text(Class374.anInt3159)))) {
									short i_11_ = 0;
									if (((((Player) (Player.selfPlayer)).playerCbLevel) ^ 0xffffffff) > (((Class141) class141).anInt1115 ^ 0xffffffff))
										i_11_ = (short) 2000;
									short i_12_ = 0;
									if (i_10_ == 0)
										i_12_ = (short) 10;
									...
									if ((i_12_ ^ 0xffffffff) != -1)
										i_12_ += i_11_;
									GameInterfaceData.method3470(false, true, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), ((Class141) class141).anInt1099, 0, "<col=ffff00>" + string, false, 0, i_12_, (long) (((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369), -1, false, strings[i_10_]);
								}
							}
						}
					}
					GameInterfaceData.method3470(false, true, (long) ((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369, Class16.anInt190, 0, "<col=ffff00>" + string, false, 0, 1002, (long) ((Mobile) class246_sub3_sub4_sub2_sub1).anInt6369, -1, bool, TextResources.EXAMINE.get_text(Class374.anInt3159));
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method998(int i, int i_14_, int i_15_) {
		try {
			int i_16_ = (i_15_ == (((Class98_Sub10) this).anInt3860 ^ 0xffffffff) ? i : ((Class98_Sub10) this).anInt3860);
			if (((Class98_Sub10) this).aBoolean3861)
				((Class98_Sub10) this).aClass16_3863 = new Class16(i_16_, i, i_14_);
			else
				((Class98_Sub10) this).aClass223_3859 = new Class223(i_16_, i, i_14_);
		} catch (RuntimeException runtimeexception) {
	...
	Class98_Sub10(int i, boolean bool) {
		try {
			...
			((Class98_Sub10) this).aClass98_Sub10Array3857 = new Class98_Sub10[i];
		} catch (RuntimeException runtimeexception) {
	...
	final int[] method1000(int i, int i_18_, int i_19_) {
		try {
			if (i_19_ != 0)
				method993(-48);
			if (((Class98_Sub10) ((Class98_Sub10) this).aClass98_Sub10Array3857[i_18_]).aBoolean3861)
				return ((Class98_Sub10) this).aClass98_Sub10Array3857[i_18_].method990(255, i);
			return (((Class98_Sub10) this).aClass98_Sub10Array3857[i_18_].method997(-94, i)[0]);
		} catch (RuntimeException runtimeexception) {
