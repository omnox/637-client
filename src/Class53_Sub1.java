...
final class Class53_Sub1 extends Class53 {
	...
	static final boolean method499(int i, int i_4_) {
		try {
			if (i != 2048)
			...
			throw Class64_Sub27.method667(runtimeexception, "jha.G(" + i + ',' + i_4_ + ')');
		}
	}
	...
	final Class114 method501(int i) {
		try {
			if (i != -1)
				method500(-79);
	...
	static final boolean method502(int i, int i_5_, byte i_6_) {
		try {
			if (i_6_ < 110)
				method500(-79);
			...
			throw Class64_Sub27.method667(runtimeexception, ("jha.H(" + i + ',' + i_5_ + ',' + i_6_ + ')'));
		}
	}
