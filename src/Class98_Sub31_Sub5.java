...
final class Class98_Sub31_Sub5 extends Class98_Sub31 {
	...
	private static final int method1393(int i, int i_0_, byte[] is, int[] is_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_9_, int i_10_) {
	...
	private final int method1394(int[] is, int i, int i_11_, int i_12_, int i_13_) {
		while (anInt5882 > 0) {
	...
	private static final int method1395(int i, int i_15_, byte[] is, int[] is_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_24_, int i_25_) {
		...
		if (i_24_ == 0 || (i_21_ = i_18_ + (i_23_ + 256 - i_17_ + i_24_) / i_24_) > i_22_)
			i_21_ = i_22_;
		while (i_18_ < i_21_) {
			i_15_ = i_17_ >> 8;
			i = is[i_15_ - 1];
			is_16_[i_18_++] += ((i << 8) + (is[i_15_] - i) * (i_17_ & 0xff)) * i_19_ >> 6;
			i_19_ += i_20_;
			i_17_ += i_24_;
		}
		if (i_24_ == 0 || (i_21_ = i_18_ + (i_23_ - i_17_ + i_24_) / i_24_) > i_22_)
			i_21_ = i_22_;
		i = i_25_;
		i_15_ = i_24_;
		while (i_18_ < i_21_) {
			is_16_[i_18_++] += (((i << 8) + (is[i_17_ >> 8] - i) * (i_17_ & 0xff)) * i_19_ >> 6);
			i_19_ += i_20_;
			i_17_ += i_15_;
		}
		class98_sub31_sub5.anInt5876 += class98_sub31_sub5.anInt5871 * i_18_;
	...
	private static final int method1396(byte[] is, int[] is_34_, int i, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i >>= 8;
		i_39_ >>= 8;
		i_36_ <<= 2;
	...
	private static final int method1403(int i, byte[] is, int[] is_46_, int i_47_, int i_48_, int i_49_, int i_50_, int i_51_, int i_52_, int i_53_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i_47_ >>= 8;
		i_53_ >>= 8;
		i_49_ <<= 2;
		i_50_ <<= 2;
	...
	private static final int method1404(int i, int i_60_, byte[] is, int[] is_61_, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_68_, int i_69_) {
		if (i_68_ == 0 || (i_65_ = i_63_ + (i_67_ + 256 - i_62_ + i_68_) / i_68_) > i_66_)
			i_65_ = i_66_;
		while (i_63_ < i_65_) {
			i_60_ = i_62_ >> 8;
			i = is[i_60_ - 1];
			is_61_[i_63_++] += ((i << 8) + (is[i_60_] - i) * (i_62_ & 0xff)) * i_64_ >> 6;
			i_62_ += i_68_;
		}
		if (i_68_ == 0 || (i_65_ = i_63_ + (i_67_ - i_62_ + i_68_) / i_68_) > i_66_)
			i_65_ = i_66_;
		i = i_69_;
		i_60_ = i_68_;
		while (i_63_ < i_65_) {
			is_61_[i_63_++] += (((i << 8) + (is[i_62_ >> 8] - i) * (i_62_ & 0xff)) * i_64_ >> 6);
			i_62_ += i_60_;
		}
	...
	private static final int method1405(int i, int i_70_) {
		if (i_70_ < 0)
			return i;
		return (int) (((double) i * Math.sqrt((double) (16384 - i_70_) * 1.220703125E-4)) + 0.5);
	}

	private static final int method1406(int i, int i_71_, byte[] is, int[] is_72_, int i_73_, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_80_, int i_81_) {
		if (i_80_ == 0 || (i_77_ = i_74_ + (i_79_ + 256 - i_73_ + i_80_) / i_80_) > i_78_)
			i_77_ = i_78_;
		i_74_ <<= 1;
		i_77_ <<= 1;
		while (i_74_ < i_77_) {
		...
		if (i_80_ == 0 || ((i_77_ = (i_74_ >> 1) + (i_79_ - i_73_ + i_80_) / i_80_) > i_78_))
			i_77_ = i_78_;
		i_77_ <<= 1;
		i_71_ = i_81_;
		while (i_74_ < i_77_) {
	...
	private static final int method1409(int i, int i_82_, byte[] is, int[] is_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_93_, int i_94_) {
	...
	private static final int method1414(byte[] is, int[] is_101_, int i, int i_102_, int i_103_, int i_104_, int i_105_, int i_106_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i >>= 8;
		i_106_ >>= 8;
		i_103_ <<= 2;
	...
	private static final int method1415(int i, int i_107_, byte[] is, int[] is_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, int i_115_, int i_116_, int i_117_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_118_, int i_119_) {
		class98_sub31_sub5.anInt5877 -= class98_sub31_sub5.anInt5878 * i_110_;
		if (i_118_ == 0 || ((i_115_ = i_110_ + (i_117_ - i_109_ + i_118_ - 257) / i_118_) > i_116_))
			i_115_ = i_116_;
		i_110_ <<= 1;
		i_115_ <<= 1;
		while (i_110_ < i_115_) {
		...
		if (i_118_ == 0 || (i_115_ = (i_110_ >> 1) + (i_117_ - i_109_ + i_118_ - 1) / i_118_) > i_116_)
			i_115_ = i_116_;
		i_115_ <<= 1;
		i_107_ = i_119_;
		while (i_110_ < i_115_) {
	...
	private static final int method1416(byte[] is, int[] is_120_, int i, int i_121_, int i_122_, int i_123_, int i_124_, int i_125_, int i_126_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i >>= 8;
		i_126_ >>= 8;
		i_122_ <<= 2;
		i_123_ <<= 2;
		if ((i_124_ = i_121_ + i_126_ - i) > i_125_)
			i_124_ = i_125_;
		class98_sub31_sub5.anInt5876 += class98_sub31_sub5.anInt5871 * (i_124_ - i_121_);
		class98_sub31_sub5.anInt5880 += class98_sub31_sub5.anInt5868 * (i_124_ - i_121_);
		i_124_ -= 3;
		while (i_121_ < i_124_) {
	...
	private static final int method1417(int i, byte[] is, int[] is_127_, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i_128_ >>= 8;
		i_136_ >>= 8;
		i_130_ <<= 2;
		i_131_ <<= 2;
		...
		if ((i_134_ = i_129_ + i_136_ - i_128_) > i_135_)
			i_134_ = i_135_;
		class98_sub31_sub5.anInt5877 += class98_sub31_sub5.anInt5878 * (i_134_ - i_129_);
		i_129_ <<= 1;
		i_134_ <<= 1;
		i_134_ -= 6;
		while (i_129_ < i_134_) {
	...
	private static final int method1418(byte[] is, int[] is_137_, int i, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i >>= 8;
		i_143_ >>= 8;
		i_139_ <<= 2;
		i_140_ <<= 2;
		if ((i_141_ = i_138_ + i - (i_143_ - 1)) > i_142_)
			i_141_ = i_142_;
		class98_sub31_sub5.anInt5876 += class98_sub31_sub5.anInt5871 * (i_141_ - i_138_);
		class98_sub31_sub5.anInt5880 += class98_sub31_sub5.anInt5868 * (i_141_ - i_138_);
		i_141_ -= 3;
		while (i_138_ < i_141_) {
	...
	private static final int method1420(int i, byte[] is, int[] is_144_, int i_145_, int i_146_, int i_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_, int i_153_, Class98_Sub31_Sub5 class98_sub31_sub5) {
		i_145_ >>= 8;
		i_153_ >>= 8;
		i_147_ <<= 2;
		i_148_ <<= 2;
		...
		if ((i_151_ = i_146_ + i_145_ - (i_153_ - 1)) > i_152_)
			i_151_ = i_152_;
		class98_sub31_sub5.anInt5877 += class98_sub31_sub5.anInt5878 * (i_151_ - i_146_);
		i_146_ <<= 1;
		i_151_ <<= 1;
		i_151_ -= 6;
		while (i_146_ < i_151_) {
	...
	private static final int method1421(int i, int i_154_) {
		if (i_154_ < 0)
			return -i;
		return (int) ((double) i * Math.sqrt((double) i_154_ * 1.220703125E-4) + 0.5);
	}
	...
	private static final int method1424(int i, int i_156_, byte[] is, int[] is_157_, int i_158_, int i_159_, int i_160_, int i_161_, int i_162_, int i_163_, int i_164_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_165_, int i_166_) {
		...
		if (i_165_ == 0 || ((i_162_ = i_159_ + (i_164_ - i_158_ + i_165_ - 257) / i_165_) > i_163_))
			i_162_ = i_163_;
		while (i_159_ < i_162_) {
			i_156_ = i_158_ >> 8;
			i = is[i_156_];
			is_157_[i_159_++] += (((i << 8) + (is[i_156_ + 1] - i) * (i_158_ & 0xff)) * i_160_) >> 6;
			i_160_ += i_161_;
			i_158_ += i_165_;
		}
		if (i_165_ == 0 || ((i_162_ = i_159_ + (i_164_ - i_158_ + i_165_ - 1) / i_165_) > i_163_))
			i_162_ = i_163_;
		i_156_ = i_166_;
		while (i_159_ < i_162_) {
			i = is[i_158_ >> 8];
			is_157_[i_159_++] += ((i << 8) + (i_156_ - i) * (i_158_ & 0xff)) * i_160_ >> 6;
			i_160_ += i_161_;
			i_158_ += i_165_;
		}
		class98_sub31_sub5.anInt5876 += class98_sub31_sub5.anInt5871 * i_159_;
	...
	private final int method1428(int[] is, int i, int i_167_, int i_168_, int i_169_) {
		while (anInt5882 > 0) {
	...
	private static final int method1432(int i, int i_179_, byte[] is, int[] is_180_, int i_181_, int i_182_, int i_183_, int i_184_, int i_185_, int i_186_, Class98_Sub31_Sub5 class98_sub31_sub5, int i_187_, int i_188_) {
		if (i_187_ == 0 || ((i_184_ = i_182_ + (i_186_ - i_181_ + i_187_ - 257) / i_187_) > i_185_))
			i_184_ = i_185_;
		while (i_182_ < i_184_) {
			i_179_ = i_181_ >> 8;
			i = is[i_179_];
			is_180_[i_182_++] += (((i << 8) + (is[i_179_ + 1] - i) * (i_181_ & 0xff)) * i_183_) >> 6;
			i_181_ += i_187_;
		}
		if (i_187_ == 0 || ((i_184_ = i_182_ + (i_186_ - i_181_ + i_187_ - 1) / i_187_) > i_185_))
			i_184_ = i_185_;
		i_179_ = i_188_;
		while (i_182_ < i_184_) {
			i = is[i_181_ >> 8];
			is_180_[i_182_++] += ((i << 8) + (i_179_ - i) * (i_181_ & 0xff)) * i_183_ >> 6;
			i_181_ += i_187_;
		}
