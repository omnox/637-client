	...
	static final boolean method3845(int i, int playerIndex, Class98_Sub22_Sub1 class98_sub22_sub1) {
		try {
			...
			if ((i_1_ ^ 0xffffffff) == -1) {
				...
				((Mobile) class246_sub3_sub4_sub2_sub2).anInt6369 = playerIndex;
				...
				class246_sub3_sub4_sub2_sub2.method3047(((Class376) class376).anInt3172, true, 61);
				((Mobile) class246_sub3_sub4_sub2_sub2).anInt6364 = ((Class376) class376).anInt3177;
				...
				((Mobile) class246_sub3_sub4_sub2_sub2).aByteArray6443[0] = Class98_Sub10_Sub21.aByteArray5642[playerIndex];
				((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level = ((AnimableEntity) class246_sub3_sub4_sub2_sub2).aByte5081 = (byte) i_5_;
			...
			if (i_1_ == 1) {
				...
				int i_11_ = ((Class376) Class306.aClass376Array2562[playerIndex]).anInt3176;
				((Class376) Class306.aClass376Array2562[playerIndex]).anInt3176 = (((0x3 & i_10_ + (i_11_ >> -1513072196)) << 1924544668) + (i_11_ & 0xfffffff));
				return false;
			}
			if (i_1_ == 2) {
				...
				int i_14_ = i_12_ & 0x7;
				int i_15_ = ((Class376) Class306.aClass376Array2562[playerIndex]).anInt3176;
				...
				((Class376) Class306.aClass376Array2562[playerIndex]).anInt3176 = (i_17_ << -893106514) + (i_16_ << 1563645276) - -i_18_;
				return false;
			}
			...
			int i_25_ = i_21_;
			int i_26_ = i_22_;
			((Class376) Class306.aClass376Array2562[playerIndex]).anInt3176 = (i_25_ << 40340942) + ((i_24_ << -1914335332) + i_26_);
			return false;
