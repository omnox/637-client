...
final class Class98_Sub28_Sub1 extends Class98_Sub28 {
	...
	static final byte[] method1310(boolean bool, Object object, boolean bool_2_) {
		try {
			if (object == null)
				return null;
			...
			throw Class64_Sub27.method667(runtimeexception, ("bw.I(" + bool + ',' + (object != null ? "{...}" : "null") + ',' + bool_2_ + ')'));
		}
	}
	...
	final void method1295(int i, int i_3_, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("bw.A(" + i + ',' + i_3_ + ',' + bool + ')'));
		}
	}

	final void method1302(Class42_Sub1 class42_sub1, int i, byte i_10_, Class42_Sub1 class42_sub1_11_) {
		try {
