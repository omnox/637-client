...
class Class284_Sub1 extends Class284 {
	...
	void method3363(byte i, int i_0_, byte i_1_) {
		do {
			try {
				aByteArray5174[anInt5173++] = (byte) (Class202.method2702(i >> 1, 127) + 127);
				if (i_1_ == 42)
					break;
	...
	final void method3356(int i, int i_2_, int i_3_) {
		try {
			anInt5175 += i_2_ * anIntArray5172[i] >> 12;
		} catch (RuntimeException runtimeexception) {
	...
	final void method3358(int i) {
		try {
			...
			if (anInt5175 >= 4096)
				anInt5175 = 4095;
			method3363((byte) (anInt5175 >> 4), anInt5173++, (byte) 42);
			anInt5175 = i;
		} catch (RuntimeException runtimeexception) {
	...
	Class284_Sub1(int i, int i_4_, int i_5_, int i_6_, int i_7_, float f) {
		...
		try {
			anIntArray5172 = new int[this.anInt2159];
			for (int i_8_ = 0; i_8_ < this.anInt2159; i_8_++)
				anIntArray5172[i_8_] = (short) (int) (4096.0 * Math.pow(f, i_8_));
		} catch (RuntimeException runtimeexception) {
