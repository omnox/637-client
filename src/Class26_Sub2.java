...
final class Class26_Sub2 extends Class26 implements Interface4_Impl1 {
	...
	public final void method5(int i) {
		do {
			try {
				((Class26_Sub2) this).aHa_Sub3_Sub1_270.method2077(false, this);
				if (i > 14)
					break;
	...
	Class26_Sub2(ha_Sub3_Sub1 var_ha_Sub3_Sub1, Class164 class164, int i, int i_0_, int i_1_, byte[] is) {
		...
		try {
			...
			anInt3581 = i_1_;
			anInt3579 = i;
			anIDirect3DVolumeTexture3578 = (((ha_Sub3_Sub1) ((Class26_Sub2) this).aHa_Sub3_Sub1_270).anIDirect3DDevice6098.a(i, i_0_, i_1_, 1, 0, ha_Sub3_Sub1.method2074(-1935, class164, (((Class26_Sub2) this).aClass162_271)), 1));
			PixelBuffer pixelbuffer = (((ha_Sub3_Sub1) ((Class26_Sub2) this).aHa_Sub3_Sub1_270).aPixelBuffer6095);
			int i_2_ = anIDirect3DVolumeTexture3578.LockBox(0, 0, 0, 0, i, i_0_, i_1_, 0, pixelbuffer);
			if (kg.a(-21593, i_2_)) {
				int i_3_ = (anInt3579 * (((Class164) ((Class26_Sub2) this).aClass164_273).anInt1275));
