...
final class Class98_Sub30 extends Node {
				...
				if (Class359.anInt3058 < 400) {
					if (Player.selfPlayer == class246_sub3_sub4_sub2_sub2) {
						if (Class98_Sub10_Sub9.aBoolean5585 && (0x10 & Class98_Sub4.anInt3826) != 0)
							GameInterfaceData.method3470(false, true, 0L, Class336.anInt2823, 0, (Class246_Sub3_Sub3.aString6156 + " -> <col=ffffff>" + (TextResources.aClass309_2623.get_text(Class374.anInt3159))), false, 0, 57, class246_sub3_sub4_sub2_sub2.anInt6369, -1, false, Class287_Sub2.aString3272);
					} else if (bool_0_ == true) {
						String string;
						if (class246_sub3_sub4_sub2_sub2.skillLevel == 0) {
							boolean bool_1_ = true;
							if ((Player.selfPlayer.combatRange) != -1 && class246_sub3_sub4_sub2_sub2.combatRange != -1) {
								int i = (((Player.selfPlayer.combatRange) >= (class246_sub3_sub4_sub2_sub2.combatRange)) ? (class246_sub3_sub4_sub2_sub2.combatRange) : (Player.selfPlayer.combatRange));
								int i_2_ = ((Player.selfPlayer.playerCbLevel) - (class246_sub3_sub4_sub2_sub2.playerCbLevel));
								if (i_2_ < 0)
									i_2_ = -i_2_;
								if (i_2_ > i)
									bool_1_ = false;
							...
							if (class246_sub3_sub4_sub2_sub2.combatLevelWithSummoning > class246_sub3_sub4_sub2_sub2.playerCbLevel)
								string = (class246_sub3_sub4_sub2_sub2.method3063(0, true) + (bool_1_ ? (Class108.method1730((Player.selfPlayer.playerCbLevel), (class246_sub3_sub4_sub2_sub2.playerCbLevel), 16383)) : "<col=ffffff>") + " (" + string_3_ + (class246_sub3_sub4_sub2_sub2.playerCbLevel) + "+" + ((class246_sub3_sub4_sub2_sub2.combatLevelWithSummoning) + -(class246_sub3_sub4_sub2_sub2.playerCbLevel)) + ")");
							else
								string = (class246_sub3_sub4_sub2_sub2.method3063(0, true) + (!bool_1_ ? "<col=ffffff>" : (Class108.method1730((Player.selfPlayer.playerCbLevel), (class246_sub3_sub4_sub2_sub2.playerCbLevel), 16383))) + " (" + string_3_ + (class246_sub3_sub4_sub2_sub2.playerCbLevel) + ")");
						} else if (class246_sub3_sub4_sub2_sub2.skillLevel != -1)
							string = (class246_sub3_sub4_sub2_sub2.method3063(0, true) + " (" + (TextResources.SKILL.get_text(Class374.anInt3159)) + class246_sub3_sub4_sub2_sub2.skillLevel + ")");
						else
						...
						if (Class98_Sub10_Sub9.aBoolean5585 && !bool && (Class98_Sub4.anInt3826 & 0x8) != 0)
							GameInterfaceData.method3470(false, true, class246_sub3_sub4_sub2_sub2.anInt6369, Class336.anInt2823, 0, (Class246_Sub3_Sub3.aString6156 + " -> <col=ffffff>" + string), false, 0, 5, class246_sub3_sub4_sub2_sub2.anInt6369, -1, false, Class287_Sub2.aString3272);
						if (!bool) {
							for (int i = 7; i >= 0; i--) {
								if (Class269.aStringArray2021[i] != null) {
									...
									if ((s_Sub1.aClass279_5197 == Class4.aClass279_86) && (Class269.aStringArray2021[i].equalsIgnoreCase(TextResources.ATTACK.get_text(Class374.anInt3159)))) {
										if ((class246_sub3_sub4_sub2_sub2.playerCbLevel) > (Player.selfPlayer.playerCbLevel))
											i_4_ = (short) 2000;
										if ((Player.selfPlayer.team) != 0 && (class246_sub3_sub4_sub2_sub2.team) != 0) {
											if ((class246_sub3_sub4_sub2_sub2.team) == (Player.selfPlayer.team))
												i_4_ = (short) 2000;
											else
												i_4_ = (short) 0;
										}
									...
									GameInterfaceData.method3470(false, true, class246_sub3_sub4_sub2_sub2.anInt6369, i_6_, 0, "<col=ffffff>" + string, false, 0, i_5_, class246_sub3_sub4_sub2_sub2.anInt6369, -1, false, Class269.aStringArray2021[i]);
								}
							}
						} else
							GameInterfaceData.method3470(false, false, 0L, -1, 0, "", false, 0, -1, class246_sub3_sub4_sub2_sub2.anInt6369, 0, true, "<col=cccccc>" + string);
						if (bool)
							break;
						for (Class98_Sub46_Sub8 class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2418(32)); class98_sub46_sub8 != null; class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2417(102))) {
							if ((class98_sub46_sub8.anInt5990) == 6) {
								class98_sub46_sub8.aString5985 = "<col=ffffff>" + string;
								break;
							}
						}
					}
	...
	final void method1314(int[] is, int i, int i_8_) {
		do {
			try {
				Interface2_Impl2 interface2_impl2 = aHa_Sub3_4087.method1963(62, (this.anInt4098) * 3);
				...
				if (buffer != null) {
					...
					if (!Stream.a()) {
						for (int i_12_ = 0; i > i_12_; i_12_++) {
							...
							if (i_14_ != 0 && is_15_ != null) {
								int i_16_ = 0;
								int i_17_ = 0;
								while (is_15_.length > i_17_) {
									if ((i_14_ & 1 << i_16_++) != 0) {
										i_9_++;
					...
					if (!interface2_impl2.method79((byte) 60) || i_9_ <= 0)
						break;
					aHa_Sub3_4087.method2039((0x8 & aS_Sub2_4097.anInt5233) != 0, i_8_ + -32736, this.anInt4084, (aS_Sub2_4097.anInt5233 & 0x7) != 0);
					if (aHa_Sub3_4087.aBoolean4563)
						aHa_Sub3_4087.EA(2147483647, this.anInt4091, this.anInt4090, this.anInt4086);
					Class111_Sub3 class111_sub3 = aHa_Sub3_4087.method1957((byte) -128);
					class111_sub3.method2137(1.0F / this.aFloat4092, (byte) -122, 1.0F / this.aFloat4092, 1.0F);
	...
	final void method1315(int i, int i_28_, int i_29_, int i_30_) {
		try {
			anIntArray4095[i_30_ * aS_Sub2_4097.anInt2203 + i_29_] = Class41.method366((anIntArray4095[(i_30_ * aS_Sub2_4097.anInt2203 + i_29_)]), 1 << i);
			if (i_28_ != -20787)
	...
	final void method1317(int i, int i_32_, int i_33_, int i_34_, float f) {
		try {
			if (this.anInt4084 != i_33_) {
				Class238 class238 = aHa_Sub3_4087.aD938.method11(this.anInt4084, -28755);
				int i_35_ = class238.aByte1830 & 0xff;
				if (i_35_ != 0 && class238.aByte1820 != 4) {
					int i_36_;
					if (i_32_ < 0)
						i_36_ = 0;
					else if (i_32_ > 127)
					...
					if (i_35_ == 256)
						...
						int i_37_ = i_35_;
						int i_38_ = 256 + -i_35_;
						i_34_ = (((~0xff00ff & (i_38_ * (0xff00ff & i_34_) + (i_36_ & 0xff00ff) * i_37_)) + (0xff0000 & ((i_36_ & 0xff00) * i_37_ + (0xff00 & i_34_) * i_38_))) >> 8);
					}
				}
				int i_39_ = 0xff & class238.aByte1829;
				if (i_39_ != 0) {
					i_39_ += 256;
					int i_40_ = ((0xff0000 & i_34_) >> 16) * i_39_;
					if (i_40_ > 65535)
						i_40_ = 65535;
					int i_41_ = (i_34_ >> 8 & 0xff) * i_39_;
					if (i_41_ > 65535)
						i_41_ = 65535;
					int i_42_ = (i_34_ & 0xff) * i_39_;
					if (i_42_ > 65535)
						i_42_ = 65535;
					i_34_ = (i_42_ >> 8) + ((0xff00 & i_41_) + ((i_40_ & 0x7000ff00) << 8));
				}
			}
			aStream4093.b(i * 4);
			if (f != 1.0F) {
				int i_43_ = (0xff9fc6 & i_34_) >> 16;
				int i_44_ = 0xff & i_34_ >> 8;
				i_43_ *= f;
				...
				if (i_45_ < 0)
					...
					i_45_ = 255;
				i_34_ = i_43_ << 16 | i_44_ << 8 | i_45_;
			}
			if (aHa_Sub3_4087.anInt4580 == 0) {
				aStream4093.e((byte) i_34_);
				aStream4093.e((byte) (i_34_ >> 8));
				aStream4093.e((byte) (i_34_ >> 16));
			} else {
				aStream4093.e((byte) (i_34_ >> 16));
				aStream4093.e((byte) (i_34_ >> 8));
				aStream4093.e((byte) i_34_);
	...
	Class98_Sub30(s_Sub2 var_s_Sub2, int i, int i_47_, int i_48_, int i_49_, int i_50_) {
		try {
			...
			this.anInt4091 = i_48_;
			this.anInt4084 = i;
			this.anInt4090 = i_49_;
			aHa_Sub3_4087 = aS_Sub2_4097.aHa_Sub3_5225;
			anIntArray4095 = new int[(aS_Sub2_4097.anInt2204 * aS_Sub2_4097.anInt2203)];
			this.anInt4086 = i_50_;
			this.aFloat4092 = (float) i_47_;
		} catch (RuntimeException runtimeexception) {
