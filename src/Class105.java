...
final class Class105 implements Interface15 {
	...
	public final String toString() {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "gm.toString(" + ')');
		}
	}
	...
	static final boolean method1715(boolean bool, int i, int i_0_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("gm.A(" + bool + ',' + i + ',' + i_0_ + ')'));
		}
	}

	static final Class93 method1716(int i, RSByteBuffer class98_sub22) {
		try {
			if (i != -1)
				aByteArrayArray3414 = null;
			...
			return new Class93(class63, class110, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("gm.B(" + i + ',' + (class98_sub22 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final Class326 method1718(int i, int i_15_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "gm.E(" + i + ',' + i_15_ + ')');
		}
	}
