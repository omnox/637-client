...
final class Class64_Sub10 extends Class64 {
	...
	final int method556(int i, int i_2_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "fe.F(" + i + ',' + i_2_ + ')');
		}
	}

	public static void method593(int i) {
		try {
			IncomingOpcode.aClass58_3665 = null;
			aClass85_3667 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final boolean method594(int i, int i_4_, int i_5_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("fe.D(" + i + ',' + i_4_ + ',' + i_5_ + ')'));
		}
	}
