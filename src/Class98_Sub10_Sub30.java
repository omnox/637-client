	...
	final int[] method990(int i, int i_0_) {
		try {
			...
			if (((Class16) ((Class98_Sub10) this).aClass16_3863).aBoolean198) {
				...
				int i_2_ = i_1_ + -2048 >> -1261703615;
				for (int i_3_ = 0; Class25.anInt268 > i_3_; i_3_++) {
					int i_4_ = Class64_Sub1.anIntArray3640[i_3_];
					int i_5_ = i_4_ - 2048 >> -1945705119;
					int i_6_;
					if (anInt5711 != 0) {
						int i_7_ = i_5_ * i_5_ + i_2_ * i_2_ >> 1054777292;
					...
					if (anInt5710 != 0) {
						...
						i_6_ = ((aa_Sub2.anIntArray3565[(0xff8 & i_6_) >> -627027964]) - -4096 >> 2128106177);
					is[i_3_] = i_6_;
				}
			}
			if (i != 255)
	...
	static final void method1093(int i, int i_10_, boolean bool, int i_11_) {
		do {
			try {
				if (i != -29680)
					aBoolean5712 = false;
				if (Class156_Sub1.aClass377_3277.method3990((long) i_11_, -1) != null)
					break;
				if (!Class372.aBoolean3152)
					...
					((Class98_Sub36) class98_sub36).aClass237_Sub1_4157.method2909(true, Class366.aStringArray3113[Class374.anInt3159]);
					Class156_Sub1.aClass377_3277.method3996(class98_sub36, (long) i_11_, i + 29679);
				}
			} catch (RuntimeException runtimeexception) {
