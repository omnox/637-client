...
final class Class224_Sub1 extends Class224 {
	...
	static RuneScapeCache aClass207_5035;
	static Color[] aColorArray5036;

	static final String method2834(int i, String string) {
		try {
			...
			if (string.startsWith("directlogin ")) {
				...
				if (i_2_ >= 0) {
					...
					for (int i_4_ = i_2_ - -1; i_4_ < i_3_; i_4_++)
						string += "*";
				}
			}
			if (string_0_ != null)
			...
			throw Class64_Sub27.method667(runtimeexception, ("cw.B(" + i + ',' + (string != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void method2835(int i) {
		try {
			...
			if (i != -15870)
				method2834(56, null);
			IncomingOpcode.aClass58_5032 = null;
		} catch (RuntimeException runtimeexception) {
	...
	static {
		...
		aColorArray5036 = new Color[] { new Color(9179409), new Color(16777215), new Color(16726277), new Color(16726277) };
	}
}
