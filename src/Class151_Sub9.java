...
final class Class151_Sub9 extends Class151 {
	...
	final void method2470(int i) {
		try {
			if (i != -16661)
				anInt5020 = 117;
			if (aBoolean5026) {
				int i_2_ = this.aHa_Sub1_1215.XA();
				int i_3_ = this.aHa_Sub1_1215.i();
				float f = (float) i_2_ - 0.125F * (float) (-i_3_ + i_2_);
				float f_4_ = -((float) (i_2_ + -i_3_) * 0.25F) + (float) i_2_;
				OpenGL.glProgramLocalParameter4fARB(34336, 0, f_4_, f, 1.0F / (float) this.aHa_Sub1_1215.anInt4454, (float) (this.aHa_Sub1_1215.anInt4453) / 255.0F);
	...
	final void method2471(byte i) {
		try {
			Class111_Sub1 class111_sub1 = (this.aHa_Sub1_1215.aClass111_Sub1_4353);
			do {
				if (!aBoolean5021) {
			...
			class111_sub1.method2109(-29834, 0.0F, (float) (this.aHa_Sub1_1215.anInt4362), 0.0F, -1.0F, Class222.aFloatArray1671);
			if (i == 34) {
	...
	final void method2440(boolean bool, boolean bool_5_) {
		try {
			...
			this.aHa_Sub1_1215.method1845(1, 847872872);
			this.aHa_Sub1_1215.method1863(1, aClass42_Sub1_5027);
			if (bool != false)
				aBoolean5018 = false;
			...
			if (Class177.anInt1376 != 3) {
				if (Class177.anInt1376 != 7) {
					if (Class177.anInt1376 != 10) {
						if (Class177.anInt1376 == 1 || Class177.anInt1376 == 2)
			...
			try {
				if (bool == false) {
					if (class42 != null) {
						...
						if (aBoolean5024)
							break;
						this.aHa_Sub1_1215.method1863(1, (this.aHa_Sub1_1215.aClass42_Sub1_4358));
