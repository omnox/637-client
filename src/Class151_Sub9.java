...
final class Class151_Sub9 extends Class151 {
	...
	Class151_Sub9(ha_Sub1 var_ha_Sub1) {
		...
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ws.<init>(" + (var_ha_Sub1 != null ? "{...}" : "null") + ')');
		}
	}
	...
	final void method2441(int i, int i_0_, int i_1_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("ws.G(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
			}
			break;
		} while (false);
	}
	...
	final void method2470(int i) {
		try {
			...
			if (aBoolean5026) {
				...
				OpenGL.glProgramLocalParameter4fARB(34336, 0, f_4_, f, 1.0F / (float) ((ha_Sub1) (((Class151) this).aHa_Sub1_1215)).anInt4454, (float) (((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4453) / 255.0F);
				((Class151) this).aHa_Sub1_1215.method1845(1, 847872872);
				((Class151) this).aHa_Sub1_1215.method1882(((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4423, -104);
	...
	final void method2471(byte i) {
		try {
			...
			do {
				if (!aBoolean5021) {
					OpenGL.glBindProgramARB(34336, ((((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4362) == 2147483647 ? ((Class202) aClass202_5022).anInt1549 : ((Class202) aClass202_5025).anInt1549));
					if (!client.aBoolean3553)
						break;
				}
				OpenGL.glBindProgramARB(34336, ((((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4362 != 2147483647) ? ((Class202) aClass202_5017).anInt1549 : ((Class202) aClass202_5029).anInt1549));
			} while (false);
			class111_sub1.method2109(-29834, 0.0F, (float) (((ha_Sub1) ((Class151) this).aHa_Sub1_1215).anInt4362), 0.0F, -1.0F, Class222.aFloatArray1671);
			if (i == 34) {
	...
	final void method2443(boolean bool, int i) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "ws.C(" + bool + ',' + i + ')');
			}
			break;
		} while (false);
	}
	...
	final void method2440(boolean bool, boolean bool_5_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ws.D(" + bool + ',' + bool_5_ + ')'));
		}
	}
	...
	static final void method2472(boolean bool, String string, int i, boolean bool_6_) {
		try {
			...
			IncomingMessages.method466(bool);
			...
			if ((Class177.anInt1376 ^ 0xffffffff) != -4) {
				if ((Class177.anInt1376 ^ 0xffffffff) != -8) {
					if (Class177.anInt1376 != 10) {
						if (Class177.anInt1376 == 1 || (Class177.anInt1376 ^ 0xffffffff) == -3)
			...
			throw Class64_Sub27.method667(runtimeexception, ("ws.H(" + bool + ',' + (string != null ? "{...}" : "null") + ',' + i + ',' + bool_6_ + ')'));
		}
	}
		...
		do {
			try {
				if (bool == false) {
					if (class42 != null) {
						if (aBoolean5024) {
							((Class151) this).aHa_Sub1_1215.method1840(0, 768, 74, 5890);
							((Class151) this).aHa_Sub1_1215.method1886(770, 0, 34200, 5890);
							aBoolean5024 = false;
						}
						...
						((Class151) this).aHa_Sub1_1215.method1840(0, 768, -50, 34168);
						((Class151) this).aHa_Sub1_1215.method1886(770, 0, 34200, 34168);
						aBoolean5024 = true;
					}
				}
			} catch (RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("ws.F(" + (class42 != null ? "{...}" : "null") + ',' + bool + ',' + i + ')'));
			}
			break;
		} while (false);
	}
