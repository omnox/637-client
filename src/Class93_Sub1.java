...
class Class93_Sub1 extends Class93 {
	...
	static int[][] anIntArrayArray5487 = { { 6, 6 }, { 6, 6 }, { 6, 5, 5 }, { 5, 6, 5 }, { 5, 5, 6 }, { 6, 5, 5 }, { 5, 0, 4, 1 }, { 7, 7, 1, 2 }, { 7, 1, 2, 7 }, { 8, 9, 4, 0, 8, 9 }, { 0, 8, 9, 8, 9, 4 }, { 11, 0, 10, 11, 4, 2 }, { 6, 6 }, { 7, 7, 1, 2 }, { 7, 7, 1, 2 } };
	...
	public static void method902(int i) {
		try {
			...
			if (i != 2)
				method902(45);
			IncomingOpcode.aClass58_5482 = null;
	...
	static final int method903(byte i) {
		try {
			...
			if (Class16.anInt196 == 1) {
				...
				Class102.aClass102_876.method1707((byte) 1, new PlayerUpdate(AnimableEntity.aClass207_5087));
	...
	static final boolean method905(int i, int i_40_, int i_41_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("ij.G(" + i + ',' + i_40_ + ',' + i_41_ + ')'));
		}
	}
	...
	static final Class348[] method906(byte i) {
		try {
			if (i <= 11)
				return null;
			return (new Class348[] { Class151_Sub9.aClass348_5023, Class77_Sub1.aClass348_3801, Class4.aClass348_82, Class306.aClass348_2565, Class42_Sub3.aClass348_5363, Class98_Sub36.aClass348_4156, Class186.aClass348_3433, aa_Sub3.aClass348_3573, Class359.aClass348_3046, Class151_Sub7.aClass348_5008, Class218.aClass348_1630, RuneScapeCache.aClass348_1569, Class98_Sub5_Sub1.aClass348_5534, Class238.aClass348_1834 });
		} catch (RuntimeException runtimeexception) {
