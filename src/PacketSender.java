...
final class PacketSender implements Runnable {
	...
	static final void method3604(int i, byte i_1_, int i_2_, Class98_Sub46_Sub8 class98_sub46_sub8) {
		do {
			try {
				if (class98_sub46_sub8 != null && (((LinkedList) Class33.aClass148_315).aClass98_1198 != class98_sub46_sub8)) {
					int i_3_ = ((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5995;
					int i_4_ = ((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5993;
					int i_5_ = ((Class98_Sub46_Sub8) class98_sub46_sub8).anInt5990;
					int i_6_ = (int) (((Class98_Sub46_Sub8) class98_sub46_sub8).aLong5987);
					if ((i_5_ ^ 0xffffffff) <= -2001)
						i_5_ -= 2000;
					long l = ((Class98_Sub46_Sub8) class98_sub46_sub8).aLong5987;
					if (i_5_ == 1002) {
						Class55.anInt440 = 2;
						IComponentSettings.anInt4286 = i;
						Class98_Sub10_Sub32.anInt5720 = 0;
						Class366.anInt3117 = i_2_;
						Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_6_, -1));
						if (class98_sub39 != null) {
							...
							if (class141 != null) {
								...
								((OutgoingPacket) class98_sub11).packet.writeShort(((Class141) class141).anInt1097);
					...
					if (i_5_ == 51) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
							((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) 107);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					}
					if (i_5_ == 45) {
						Player class246_sub3_sub4_sub2_sub2 = (Class151_Sub9.playerArray[i_6_]);
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeByteS((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), -102);
							((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, i_1_ + -78, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					}
					if ((i_5_ ^ 0xffffffff) == -59) {
						...
						((OutgoingPacket) class98_sub11).packet.method1200((byte) 127, Class187.anInt1450);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(aa_Sub2.anInt3562 + i_4_, 128);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort(Class272.anInt2038 + i_3_, 17624);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(Class310.anInt2652, 128);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					...
					if (i_5_ == 2) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort(Class272.anInt2038 + i_3_, 17624);
						((OutgoingPacket) class98_sub11).packet.writeLEShort(i_6_, 17624);
						((OutgoingPacket) class98_sub11).packet.writeShortA(i_4_ + aa_Sub2.anInt3562, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.method1244((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), (byte) 112);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class44.method427(-19181, i_4_, i_3_);
					}
					if ((i_5_ ^ 0xffffffff) == -51) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEInt(Class187.anInt1450, 1046032984);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(Class310.anInt2652, 128);
						((OutgoingPacket) class98_sub11).packet.writeShort(Class376.anInt3173);
						((OutgoingPacket) class98_sub11).packet.writeShort(Class272.anInt2038 + i_3_);
						((OutgoingPacket) class98_sub11).packet.writeByteS((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), i_1_ + -112);
						((OutgoingPacket) class98_sub11).packet.writeShortA((int) (l >>> 1575185440) & 0x7fffffff, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(aa_Sub2.anInt3562 + i_4_, i_1_ + 50);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					...
					if (i_5_ == 11) {
						...
						if (class98_sub39 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
							((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) 35);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub1.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub1.getSize());
						}
					}
					if ((i_5_ ^ 0xffffffff) == -21) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeLEShort(i_6_, 17624);
							((OutgoingPacket) class98_sub11).packet.writeByteS((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), -37);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, i_1_ + -78, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					}
					if (i_5_ == 5) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
							((OutgoingPacket) class98_sub11).packet.writeShortA(Class310.anInt2652, (byte) 126);
							((OutgoingPacket) class98_sub11).packet.writeLEInt(Class187.anInt1450, 1046032984);
							((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) -128);
							((OutgoingPacket) class98_sub11).packet.writeShortA(Class376.anInt3173, (byte) 126);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					}
					if (i_5_ == 19) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeShortA(i_6_, (byte) 126);
							((OutgoingPacket) class98_sub11).packet.method1244((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), (byte) 112);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					...
					if ((i_5_ ^ 0xffffffff) == -31) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort(i_4_ + aa_Sub2.anInt3562, 17624);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
						((OutgoingPacket) class98_sub11).packet.writeLEShort(Class272.anInt2038 + i_3_, i_1_ ^ 0x4496);
						((OutgoingPacket) class98_sub11).packet.method1231((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), (byte) 126);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					...
					if (i_5_ == 47) {
						...
						if (class246_sub3_sub4_sub2_sub2 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeByteS((RtKeyListener.key_listener.is_key_down(82, i_1_ + 5425) ? 1 : 0), -52);
							((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
						}
					...
					if ((i_5_ ^ 0xffffffff) == -17) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort(i_3_ - -Class272.anInt2038, 17624);
						((OutgoingPacket) class98_sub11).packet.writeLEShort(i_4_ + aa_Sub2.anInt3562, i_1_ + 17546);
						((OutgoingPacket) class98_sub11).packet.writeShortA((int) (l >>> -855876128) & 0x7fffffff, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) 74);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class67.method688(-23, l, i_3_, i_4_);
					}
					...
					if (i_5_ == 8) {
						...
						((OutgoingPacket) class98_sub11).packet.writeShortA(i_3_ + Class272.anInt2038, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(0x7fffffff & (int) (l >>> -769820512), 128);
						((OutgoingPacket) class98_sub11).packet.method1231((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), (byte) -124);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(aa_Sub2.anInt3562 + i_4_, 128);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class67.method688(-23, l, i_3_, i_4_);
					}
					if (i_5_ == 17) {
						...
						if (class98_sub39 != null) {
							...
							((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
							((OutgoingPacket) class98_sub11).packet.method1231(!RtKeyListener.key_listener.is_key_down(82, i_1_ ^ 0x1531) ? 0 : 1, (byte) 37);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub1.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub1.getSize());
						}
					}
					if ((i_5_ ^ 0xffffffff) == -10 && OutputStream_Sub1.aClass293_33 == null) {
					...
					if (i_5_ == 13) {
						...
						((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, i_1_ ^ 0x1531) ? 1 : 0), (byte) 32);
						((OutgoingPacket) class98_sub11).packet.writeShortA(i_3_ - -Class272.anInt2038, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.writeLEShort(i_6_, 17624);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_4_ - -aa_Sub2.anInt3562, 128);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class44.method427(-19181, i_4_, i_3_);
					}
					if ((i_5_ ^ 0xffffffff) == -50 || i_5_ == 1006)
						Class303.method3557(i_6_, i_3_, ((Class98_Sub46_Sub8) class98_sub46_sub8).aString5992, -124, i_4_);
					if (i_5_ == 48) {
						Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_6_, i_1_ + -79));
						if (class98_sub39 != null) {
							Class366.anInt3117 = i_2_;
							Class55.anInt440 = 2;
							Class246_Sub3_Sub4_Sub2_Sub1 class246_sub3_sub4_sub2_sub1 = (((Class98_Sub39) class98_sub39).aClass246_Sub3_Sub4_Sub2_Sub1_4187);
							...
							((OutgoingPacket) class98_sub11).packet.method1200((byte) 125, Class187.anInt1450);
							((OutgoingPacket) class98_sub11).packet.writeLEShort(Class310.anInt2652, i_1_ + 17546);
							((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
							((OutgoingPacket) class98_sub11).packet.writeByteS((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), -53);
							((OutgoingPacket) class98_sub11).packet.writeLEShort(Class376.anInt3173, i_1_ + 17546);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub1.getSize(), -2, i_1_ ^ 0x4e, (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub1.getSize());
						}
					}
					...
					if ((i_5_ ^ 0xffffffff) == -58) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShortA((((Mobile) Player.selfPlayer).anInt6369), i_1_ ^ 0xce);
						((OutgoingPacket) class98_sub11).packet.writeShortA(Class310.anInt2652, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.writeLEInt(Class187.anInt1450, 1046032984);
						((OutgoingPacket) class98_sub11).packet.method1231((!RtKeyListener.key_listener.is_key_down(82, i_1_ ^ 0x1531) ? 0 : 1), (byte) -72);
						((OutgoingPacket) class98_sub11).packet.writeShortA(Class376.anInt3173, (byte) 126);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
					}
					if (i_5_ == 15) {
						...
						((OutgoingPacket) class98_sub11).packet.writeLEShort(0x7fffffff & (int) (l >>> 933731040), 17624);
						((OutgoingPacket) class98_sub11).packet.writeByte((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1));
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_3_ + Class272.anInt2038, i_1_ ^ 0xce);
						((OutgoingPacket) class98_sub11).packet.writeShortA(i_4_ + aa_Sub2.anInt3562, (byte) 126);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class67.method688(i_1_ + -101, l, i_3_, i_4_);
					}
					if ((i_5_ ^ 0xffffffff) == -7) {
						if ((Player.rights ^ 0xffffffff) >= -1 || !RtKeyListener.key_listener.is_key_down(82, i_1_ ^ 0x1531) || !RtKeyListener.key_listener.is_key_down(81, i_1_ + 5425)) {
							...
							if ((i_6_ ^ 0xffffffff) != -2) {
								...
								((OutgoingPacket) outgoing).packet.writeByte(-1);
								((OutgoingPacket) outgoing).packet.writeByte(-1);
								((OutgoingPacket) outgoing).packet.writeShort((int) GameWorld.cameraGetHrot);
								((OutgoingPacket) outgoing).packet.writeByte(57);
								((OutgoingPacket) outgoing).packet.writeByte(Class204.anInt1553);
								((OutgoingPacket) outgoing).packet.writeByte(Class151.anInt1213);
								((OutgoingPacket) outgoing).packet.writeByte(89);
								((OutgoingPacket) outgoing).packet.writeShort((((AnimableEntity) (Player.selfPlayer)).localXPos));
								((OutgoingPacket) outgoing).packet.writeShort((((AnimableEntity) (Player.selfPlayer)).localYPos));
								((OutgoingPacket) outgoing).packet.writeByte(63);

							}
							Class76_Sub2.requestFlag(0, 0, 1, -4, i_1_ ^ 0x4e, i_4_, i_3_, true, 1);
							Class98_Sub10_Sub29.sendPacket(false, outgoing);
						} else
							Class351.shiftClickTele(aa_Sub2.anInt3562 - -i_4_, Class272.anInt2038 - -i_3_, (((AnimableEntity) Player.selfPlayer).height_level), 32);
					}
					if ((i_5_ ^ 0xffffffff) == -5) {
						...
						((OutgoingPacket) class98_sub11).packet.writeShort(aa_Sub2.anInt3562 + i_4_);
						((OutgoingPacket) class98_sub11).packet.writeLEShort((int) (l >>> 2020731040) & 0x7fffffff, 17624);
						((OutgoingPacket) class98_sub11).packet.writeShort(Class272.anInt2038 + i_3_);
						((OutgoingPacket) class98_sub11).packet.writeByteS((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), i_1_ ^ ~0x6e);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class67.method688(-23, l, i_3_, i_4_);
					}
					if ((i_5_ ^ 0xffffffff) == -61) {
						if (Player.rights > 0 && RtKeyListener.key_listener.is_key_down(82, 5503) && RtKeyListener.key_listener.is_key_down(81, i_1_ + 5425))
							Class351.shiftClickTele(i_4_ + aa_Sub2.anInt3562, i_3_ + Class272.anInt2038, (((AnimableEntity) Player.selfPlayer).height_level), -67);
						else {
							IComponentSettings.anInt4286 = i;
							Class98_Sub10_Sub32.anInt5720 = 0;
							Class55.anInt440 = 1;
							...
							((OutgoingPacket) class98_sub11).packet.writeShortA(i_4_ + aa_Sub2.anInt3562, (byte) 126);
							((OutgoingPacket) class98_sub11).packet.writeShortA(Class272.anInt2038 + i_3_, (byte) 126);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						}
					}
					if ((i_5_ ^ 0xffffffff) == -1008) {
						...
						((OutgoingPacket) class98_sub11).packet.writeShortA(i_3_ + Class272.anInt2038, (byte) 126);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(0x7fffffff & (int) (l >>> -1233322400), i_1_ ^ 0xce);
						((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) -120);
						((OutgoingPacket) class98_sub11).packet.writeLEShortA(aa_Sub2.anInt3562 + i_4_, 128);
						Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						Class67.method688(i_1_ + -101, l, i_3_, i_4_);
					}
					if ((i_5_ ^ 0xffffffff) == -22) {
						...
						if (class293 != null) {
							...
							Class246_Sub3_Sub3.aString6156 = (((GameInterfaceData) class293).aString2224 + "<col=ffffff>");
						}
					} else {
						if (i_5_ == 10) {
							Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_6_, -1));
							if (class98_sub39 != null) {
								...
								((OutgoingPacket) class98_sub11).packet.method1231((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0), (byte) -109);
								((OutgoingPacket) class98_sub11).packet.writeLEShort(i_6_, i_1_ + 17546);
								Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
								Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub1.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub1.getSize());
							}
						}
						if (i_5_ == 46) {
							...
							((OutgoingPacket) class98_sub11).packet.method1232(Class187.anInt1450, (byte) 94);
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(Class310.anInt2652, 128);
							((OutgoingPacket) class98_sub11).packet.writeShort(Class272.anInt2038 + i_3_);
							((OutgoingPacket) class98_sub11).packet.writeShort(Class376.anInt3173);
							((OutgoingPacket) class98_sub11).packet.writeShort(aa_Sub2.anInt3562 - -i_4_);
						...
						if ((i_5_ ^ 0xffffffff) == -19) {
							...
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(Class272.anInt2038 + i_3_, 128);
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(aa_Sub2.anInt3562 + i_4_, 128);
							((OutgoingPacket) class98_sub11).packet.writeByte((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1));
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
						...
						if (i_5_ == 22) {
							...
							if (class246_sub3_sub4_sub2_sub2 != null) {
								...
								((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_6_, 128);
								((OutgoingPacket) class98_sub11).packet.method1231(RtKeyListener.key_listener.is_key_down(82, i_1_ ^ 0x1531) ? 1 : 0, (byte) 122);
								Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
								Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
							}
						}
						if (i_5_ == 44) {
							...
							if (class246_sub3_sub4_sub2_sub2 != null) {
								...
								((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
								((OutgoingPacket) class98_sub11).packet.writeByte((RtKeyListener.key_listener.is_key_down(82, 5503) ? 1 : 0));
								Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
								Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub2.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub2.getSize());
							}
						}
						if ((i_5_ ^ 0xffffffff) == -24) {
							...
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_4_ - -aa_Sub2.anInt3562, i_1_ ^ 0xce);
							((OutgoingPacket) class98_sub11).packet.method1231((!RtKeyListener.key_listener.is_key_down(82, 5503) ? 0 : 1), (byte) 101);
							((OutgoingPacket) class98_sub11).packet.writeShortA(i_6_, (byte) 126);
							((OutgoingPacket) class98_sub11).packet.writeLEShortA(i_3_ - -Class272.anInt2038, 128);
							Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
							Class44.method427(-19181, i_4_, i_3_);
						}
						if (i_5_ == 12) {
							...
							if (class98_sub39 != null) {
								...
								((OutgoingPacket) class98_sub11).packet.writeShort(i_6_);
								((OutgoingPacket) class98_sub11).packet.method1231(!RtKeyListener.key_listener.is_key_down(82, i_1_ + 5425) ? 0 : 1, (byte) -99);
								Class98_Sub10_Sub29.sendPacket(false, class98_sub11);
								Class76_Sub2.requestFlag(0, 0, class246_sub3_sub4_sub2_sub1.getSize(), -2, 0, (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueZ[0]), (((Mobile) class246_sub3_sub4_sub2_sub1).walkQueueX[0]), true, class246_sub3_sub4_sub2_sub1.getSize());
							}
						}
						if ((i_5_ ^ 0xffffffff) == -26) {
							Class98_Sub39 class98_sub39 = ((Class98_Sub39) Class260.aClass377_3254.method3990((long) i_6_, i_1_ ^ ~0x4e));
							if (class98_sub39 != null) {
								Class366.anInt3117 = i_2_;
								Class55.anInt440 = 2;
								IComponentSettings.anInt4286 = i;
