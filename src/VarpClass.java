...
final class VarpClass implements Interface6 {
	...
	final void setVarp(int i, int varbitValue, int varpIndex) {
		try {
			...
			Class98_Sub50 class98_sub50 = (Class98_Sub50) aClass377_3242.method3990(varpIndex, -1);
			if (class98_sub50 != null) {
				if (class98_sub50.aLong4288 != 4611686018427387905L)
				...
				aClass377_3242.method3996(class98_sub50, varpIndex, -1);
			}
		} catch (RuntimeException runtimeexception) {
	...
	public final int method7(int i, int i_4_) {
		try {
			...
			int i_5_ = class366.anInt3115;
			int i_6_ = class366.anInt3116;
			int i_7_ = class366.anInt3118;
			if (i_4_ != 7373)
				return -48;
			int i_8_ = Class98_Sub46_Sub20.anIntArray6070[i_7_ + -i_6_];
			return this.anIntArray3244[i_5_] >> i_6_ & i_8_;
		} catch (RuntimeException runtimeexception) {
	...
	final void method2289(int i, int i_13_, int i_14_) {
		try {
			...
			int i_15_ = class366.anInt3115;
			int i_16_ = class366.anInt3116;
			int i_17_ = class366.anInt3118;
			int i_18_ = Class98_Sub46_Sub20.anIntArray6070[i_17_ - i_16_];
			if (i < i_14_ || i_18_ < i)
				i = 0;
			i_18_ <<= i_16_;
			method2291(i_15_, 86, (i_18_ & i << i_16_ | ((~i_18_) & this.anIntArray3244[i_15_])));
		} catch (RuntimeException runtimeexception) {
	...
	final int method2290(int i, boolean bool) {
		try {
			...
			for (/**/; class98_sub50 != null; class98_sub50 = (Class98_Sub50) aClass377_3242.iterate_next(-1)) {
				if (l > (0x3fffffffffffffffL & class98_sub50.aLong4288)) {
					if ((0x4000000000000000L & class98_sub50.aLong4288) == 0L)
						class98_sub50.remove();
					else {
						int i_20_ = (int) class98_sub50.uid;
						this.anIntArray3244[i_20_] = varps[i_20_];
						class98_sub50.remove();
						return i_20_;
					}
				}
	...
	public VarpClass() {
		try {
			...
			varps = new int[Class134.aClass139_3465.anInt1086];
		} catch (RuntimeException runtimeexception) {
	...
	final void method2291(int i, int i_21_, int i_22_) {
		do {
			try {
				this.anIntArray3244[i] = i_22_;
				Class98_Sub50 class98_sub50 = (Class98_Sub50) aClass377_3242.method3990(i, -1);
				do {
					if (class98_sub50 == null) {
	...
	final void method2292(int i, int i_23_, int i_24_) {
		try {
			...
			int i_25_ = class366.anInt3115;
			if (i_24_ == -32727) {
				int i_26_ = class366.anInt3116;
				int i_27_ = class366.anInt3118;
				int i_28_ = Class98_Sub46_Sub20.anIntArray6070[i_27_ + -i_26_];
				if (i_23_ < 0 || i_28_ < i_23_)
					i_23_ = 0;
				i_28_ <<= i_26_;
				setVarp(i_24_ + 25258, (i_23_ << i_26_ & i_28_ | varps[i_25_] & (~i_28_)), i_25_);
			}
		} catch (RuntimeException runtimeexception) {
