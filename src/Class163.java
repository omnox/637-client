...
final class Class163 implements Interface21 {
	...
	static final void method2519(int i, ha var_ha) {
		try {
			...
			Class17.method241(i_6_, var_ha, Class246_Sub3_Sub4_Sub4.anInt6488, Class15.anInt172, (byte) 58, Class38.anInt355 - -i_0_, Class104.anInt897 + i_1_, TextResources.CHOOSE_OPTION.get_text(Class374.anInt3159));
			...
			Class249.method3164(Class246_Sub3_Sub4_Sub4.anInt6488, i_6_, var_ha, Class104.anInt897 - -i_1_, Class38.anInt355 - -i_0_, -22275, Class15.anInt172);
			if (!Class248.aBoolean1896) {
				int i_15_ = 0;
				for (Class98_Sub46_Sub8 class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2418(32)); class98_sub46_sub8 != null; class98_sub46_sub8 = ((Class98_Sub46_Sub8) Class33.aClass148_315.method2417(122))) {
					int i_16_ = (16 * (-1 + Class359.anInt3058 + -i_15_) + (i_6_ + i_3_ - -13));
					Class246_Sub3_Sub2_Sub1.method3009(i_5_, class98_sub46_sub8, Class246.anInt1871 | ~0xffffff, i_4_, i_16_, i_3_, i_8_, var_ha, i_9_, 0, Class147.anInt1194 | ~0xffffff, i_2_);
					i_15_++;
				}
			} else {
				int i_17_ = 0;
				...
				if (Class308.aClass98_Sub46_Sub9_2583 != null) {
					...
					Class351.method3849(Class98_Sub43_Sub4.anInt5938, -8, Class282.anInt2128, Class5.anInt3439, anInt3518);
				}
			}
			Class351.method3849(Class15.anInt172, -8, Class38.anInt355 + i_0_, Class246_Sub3_Sub4_Sub4.anInt6488, Class104.anInt897 - -i_1_);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("kr.D(" + i + ',' + (var_ha != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final int method2520(int i, byte i_20_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "kr.C(" + i + ',' + i_20_ + ')');
		}
	}
