...
final class Class373_Sub1_Sub1 extends PacketParser {
	...
	static final void method3972(int i, int i_0_, int i_1_) {
		...
		if (class172 != null) {
			Class129.method2227(((Class172) class172).aClass246_Sub3_Sub3_1324);
			Class129.method2227(((Class172) class172).aClass246_Sub3_Sub3_1333);
			if (((Class172) class172).aClass246_Sub3_Sub3_1324 != null)
				((Class172) class172).aClass246_Sub3_Sub3_1324 = null;
			if (((Class172) class172).aClass246_Sub3_Sub3_1333 != null)
				((Class172) class172).aClass246_Sub3_Sub3_1333 = null;
		}
	}
	...
	static final boolean method3973(int i, int i_2_, int i_3_) {
		try {
			...
			if (!((i & 0x60000 ^ 0xffffffff) != -1 | Class161.method2514(i, 16, i_2_)) && !Class228.method2864(55, i, i_2_) && !Class216.method2793(i_2_, (byte) -112, i))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	final void method3966(int i, int i_5_, int i_6_, int i_7_, byte i_8_) {
		try {
			if (i_8_ >= 21) {
				int i_9_ = ((PacketParser) this).aClass332_5462.method3737();
				int i_10_ = (((Class93_Sub1_Sub1) (Class93_Sub1_Sub1) ((Class373) this).aClass93_3478).anInt6290 * RuntimeException_Sub1.method4012(true) / 10 % i_9_);
				((PacketParser) this).aClass332_5462.method3738(i_10_ + i_7_ + -i_9_, i_6_, i_9_ + i_5_ + -i_10_, i);
			}
		} catch (RuntimeException runtimeexception) {
	...
	Class373_Sub1_Sub1(RuneScapeCache class207, RuneScapeCache class207_11_, Class93_Sub1_Sub1 class93_sub1_sub1) {
		super(class207, class207_11_, (Class93_Sub1) class93_sub1_sub1);
	}
}
