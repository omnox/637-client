...
public final class Class68 {
	...
	public final void method690() {
		try {
			if (null != aDisplayMode522) {
				...
				if (!aGraphicsDevice523.getDisplayMode().equals(aDisplayMode522))
	...
	private final void method691(byte i, Frame frame) {
		try {
			...
			try {
				...
				boolean bool_0_ = ((Boolean) field.get(aGraphicsDevice523)).booleanValue();
				if (bool_0_) {
	...
	public final void method692(Frame frame, int i, int i_1_, int i_2_, int i_3_) {
		try {
			...
			aGraphicsDevice523.setDisplayMode(new DisplayMode(i, i_1_, i_2_, i_3_));
		} catch (RuntimeException runtimeexception) {
			throw runtimeexception;
		}
	}
