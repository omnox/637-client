...
final class Class98_Sub31_Sub1 extends Class98_Sub31 {
	...
	final void method1325(int[] is, int i, int i_0_) {
		try {
			this.aClass98_Sub31_Sub3_5818.method1325(is, i, i_0_);
			Class98_Sub16 class98_sub16 = ((Class98_Sub16) this.aClass148_5817.method2418(32));
			while_19_: for (/**/; class98_sub16 != null; class98_sub16 = (Class98_Sub16) this.aClass148_5817.method2417(111)) {
				if (!aClass98_Sub31_Sub2_5815.method1345(1816, class98_sub16)) {
					int i_1_ = i;
					int i_2_ = i_0_;
					while (class98_sub16.anInt3923 < i_2_) {
						method1328(i_2_ + i_1_, class98_sub16.anInt3923, i_1_, 1048575, is, class98_sub16);
	...
	private final void method1328(int i, int i_3_, int i_4_, int i_5_, int[] is, Class98_Sub16 class98_sub16) {
		do {
			try {
				if (((aClass98_Sub31_Sub2_5815.anIntArray5840[class98_sub16.anInt3940]) & 0x4) != 0 && class98_sub16.anInt3930 < 0) {
					int i_6_ = ((aClass98_Sub31_Sub2_5815.anIntArray5843[class98_sub16.anInt3940]) / Class64_Sub15.anInt3678);
					for (;;) {
						int i_7_ = ((1048575 - -i_6_ + -class98_sub16.anInt3919) / i_6_);
						if (i_3_ < i_7_)
							break;
						class98_sub16.aClass98_Sub31_Sub5_3939.method1325(is, i_4_, i_7_);
						i_4_ += i_7_;
						...
						if (i_9_ < i_8_)
							i_8_ = i_9_;
						Class98_Sub31_Sub5 class98_sub31_sub5 = (class98_sub16.aClass98_Sub31_Sub5_3939);
						if ((aClass98_Sub31_Sub2_5815.anIntArray5842[class98_sub16.anInt3940]) != 0) {
							class98_sub16.aClass98_Sub31_Sub5_3939 = (Class98_Sub31_Sub5.method1402((class98_sub16.aClass98_Sub24_Sub1_3934), class98_sub31_sub5.method1430(), 0, class98_sub31_sub5.method1426()));
							aClass98_Sub31_Sub2_5815.method1361(1, (class98_sub16.aClass98_Sub44_3918.aShortArray4248[class98_sub16.anInt3936]) < 0, class98_sub16);
							class98_sub16.aClass98_Sub31_Sub5_3939.method1397(i_8_, class98_sub31_sub5.method1400());
						} else
							class98_sub16.aClass98_Sub31_Sub5_3939 = (Class98_Sub31_Sub5.method1402((class98_sub16.aClass98_Sub24_Sub1_3934), class98_sub31_sub5.method1430(), class98_sub31_sub5.method1400(), class98_sub31_sub5.method1426()));
						if ((class98_sub16.aClass98_Sub44_3918.aShortArray4248[class98_sub16.anInt3936]) < 0)
						...
						if (class98_sub31_sub5.method1425())
							this.aClass98_Sub31_Sub3_5818.method1371(class98_sub31_sub5);
					}
					class98_sub16.anInt3919 += i_6_ * i_3_;
				}
				class98_sub16.aClass98_Sub31_Sub5_3939.method1325(is, i_4_, i_3_);
				if (i_5_ == 1048575)
					break;
				method1321(-128);
			} catch (RuntimeException runtimeexception) {
	...
	final void method1321(int i) {
		try {
			this.aClass98_Sub31_Sub3_5818.method1321(i);
			Class98_Sub16 class98_sub16 = ((Class98_Sub16) this.aClass148_5817.method2418(32));
			while_21_: for (/**/; class98_sub16 != null; class98_sub16 = (Class98_Sub16) this.aClass148_5817.method2417(94)) {
				if (!aClass98_Sub31_Sub2_5815.method1345(1816, class98_sub16)) {
					int i_10_ = i;
					while (class98_sub16.anInt3923 < i_10_) {
	...
	private final void method1330(int i, Class98_Sub16 class98_sub16, int i_11_) {
		try {
			if ((0x4 & (aClass98_Sub31_Sub2_5815.anIntArray5840[class98_sub16.anInt3940])) != 0 && (class98_sub16.anInt3930 < 0)) {
				int i_12_ = ((aClass98_Sub31_Sub2_5815.anIntArray5843[class98_sub16.anInt3940]) / Class64_Sub15.anInt3678);
				int i_13_ = ((1048575 - (-i_12_ - -class98_sub16.anInt3919)) / i_12_);
				...
				if (i >= i_13_) {
					do {
						if ((aClass98_Sub31_Sub2_5815.anIntArray5842[class98_sub16.anInt3940]) != 0) {
							...
							aClass98_Sub31_Sub2_5815.method1361(i_11_ + 2, (class98_sub16.aClass98_Sub44_3918.aShortArray4248[class98_sub16.anInt3936]) < 0, class98_sub16);
