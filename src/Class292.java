...
final class Class292 implements Interface10 {
	...
	private final int method3445(String string, int i, Object object, Class var_class) throws IllegalAccessException, NoSuchFieldException {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sa.P(" + (string != null ? "{...}" : "null") + ',' + i + ',' + (object != null ? "{...}" : "null") + ',' + (var_class != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public final boolean method28(int i, long l) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "sa.N(" + i + ',' + l + ')');
		}
	}
	...
	private final void method3447(int i) {
		try {
			...
			Class283.method3347(VarpClass.aClass47_3241.method440(-119), Class224_Sub1.aColorArray5036[Class98_Sub9.anInt3855], Class301.aColorArray2508[Class98_Sub9.anInt3855], Class98_Sub5_Sub1.aColorArray5533[Class98_Sub9.anInt3855], VarpClass.aClass47_3241.method443((byte) -46), 90);
		} catch (RuntimeException runtimeexception) {
	...
	private final void method3449(int i) throws IllegalAccessException, NoSuchFieldException {
		try {
			Class var_class = Class76_Sub11.anApplet3799.getClass();
			anImage3352 = (Image) method3454(var_class, "bar", (byte) 60);
			anImage3334 = (Image) method3454(var_class, "background", (byte) 121);
			...
			anImage3341 = (Image) method3454(var_class, "bodyRight", (byte) -113);
			anImage3342 = (Image) method3454(var_class, "bodyFill", (byte) -116);
			aFont3348 = (Font) method3454(var_class, "bf", (byte) -125);
			aFontMetrics3360 = (FontMetrics) method3454(var_class, "bfm", (byte) 49);
			if (i == 2) {
				aColor3337 = (Color) method3454(var_class, "colourtext", (byte) -125);
				Object object = method3454(var_class, "lb", (byte) -116);
				Class var_class_1_ = object.getClass();
				aBoolean3357 = method3452(var_class_1_, (byte) 103, "xMiddle", object);
				aBoolean3347 = method3452(var_class_1_, (byte) 97, "yMiddle", object);
				...
				anInt3332 = method3445("boxXOffset", i + 2233, object, var_class_1_);
				anInt3354 = method3445("boxYOffset", 2235, object, var_class_1_);
				anInt3343 = method3445("boxWidth", 2235, object, var_class_1_);
				anInt3349 = method3445("textYOffset", i ^ 0x8b9, object, var_class_1_);
				anInt3338 = method3445("offsetPerTenCycles", i ^ 0x8b9, object, var_class_1_);
			}
		} catch (RuntimeException runtimeexception) {
	...
	private final int method3450(int i, int i_2_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "sa.O(" + i + ',' + i_2_ + ')');
		}
	}
	...
	static final int method3451(int i, int i_3_, boolean bool, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sa.L(" + i + ',' + i_3_ + ',' + bool + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ',' + i_7_ + ')'));
		}
	}

	private final boolean method3452(Class var_class, byte i, String string, Object object) throws IllegalAccessException, NoSuchFieldException {
		try {
			int i_9_ = -18 % ((51 - i) / 37);
			Field field = var_class.getDeclaredField(string);
			return field.getBoolean(object);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("sa.E(" + (var_class != null ? "{...}" : "null") + ',' + i + ',' + (string != null ? "{...}" : "null") + ',' + (object != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final int method3453(int i, int i_10_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "sa.B(" + i + ',' + i_10_ + ')');
		}
	}

	private final Object method3454(Class var_class, String string, byte i) throws IllegalAccessException, NoSuchFieldException {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("sa.G(" + (var_class != null ? "{...}" : "null") + ',' + (string != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
	...
	public final void method23(int i, boolean bool) {
		try {
			...
			if (aBoolean3358)
				...
				if (graphics != null) {
					try {
						int i_12_ = VarpClass.aClass47_3241.method440(-127);
						...
						graphics_13_.clearRect(0, 0, Class39_Sub1.anInt3593, Class98_Sub25.anInt4024);
						...
						int i_33_ = method3453(anInt3333, i ^ 0x7dd5) + anInt3350;
						int i_34_ = method3450(anInt3335, 0) + anInt3340;
						graphics_13_.drawImage(anImage3345, i_33_, i_34_ - -((anInt3335 - i_24_) / 2), null);
						graphics_13_.drawImage(anImage3351, -i_25_ + i_33_ + anInt3333, ((-i_26_ + anInt3335) / 2 + i_34_), null);
						if (anImage3346 == null)
							anImage3346 = (Class42_Sub3.aCanvas5361.createImage(-i_25_ + (anInt3333 - i_23_), anInt3335));
						...
						if ((i_38_ ^ 0xffffffff) < -1) {
							...
							for (int i_46_ = 0; i_46_ < i_44_; i_46_ += i_32_)
								graphics_45_.drawImage(anImage3334, i_46_, 0, null);
							graphics_35_.drawImage(image, i_43_, i_29_, null);
						}
						graphics_13_.drawImage(anImage3346, i_23_ + i_33_, i_34_, null);
						graphics_13_.setFont(aFont3348);
						graphics_13_.setColor(aColor3337);
						graphics_13_.drawString(string, ((anInt3333 - aFontMetrics3360.stringWidth(string)) / 2) + i_33_, (anInt3349 + i_34_ + anInt3335 / 2 - -4));
			...
			throw Class64_Sub27.method667(runtimeexception, "sa.I(" + i + ',' + bool + ')');
		}
	}
