...
final class Class76_Sub5 extends Class76 {
	...
	final void method746(int i, int i_0_, int i_1_) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, ("jh.E(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
			}
			break;
		} while (false);
	}
	...
	static final boolean method758(byte i, int i_3_, int i_4_, int i_5_) {
		try {
			...
			if (Class78.activeTileHeightMap == Class81.aSArray618)
				return false;
			int i_7_ = -108 % ((i - 2) / 56);
			int i_8_ = i_5_ << Class151_Sub8.anInt5015;
			int i_9_ = i_4_ << Class151_Sub8.anInt5015;
			if ((Class254.method3187(Class78.activeTileHeightMap[i_3_].method3420(i_4_ - -1, -12639, i_5_ + 1), 1 + i_8_, i_9_ - -1, (byte) 82, Class78.activeTileHeightMap[i_3_].method3420(i_4_, -12639, i_5_), i_9_ - -r_Sub2.anInt6333 + -1, Class78.activeTileHeightMap[i_3_].method3420(1 + i_4_, -12639, i_5_), i_9_ - (-r_Sub2.anInt6333 - -1), r_Sub2.anInt6333 + i_8_ + -1, 1 + i_8_)) && (Class254.method3187(Class78.activeTileHeightMap[i_3_].method3420(i_4_, -12639, i_5_ + 1), r_Sub2.anInt6333 + i_8_ - 1, i_9_ + 1, (byte) 82, Class78.activeTileHeightMap[i_3_].method3420(i_4_, -12639, i_5_), -1 + r_Sub2.anInt6333 + i_9_, Class78.activeTileHeightMap[i_3_].method3420(1 + i_4_, -12639, i_5_ - -1), i_9_ - -1, -1 + (i_8_ - -r_Sub2.anInt6333), 1 + i_8_))) {
				Class302.anInt2518++;
			...
			throw Class64_Sub27.method667(runtimeexception, ("jh.G(" + i + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ')'));
		}
	}
	...
	static final void method759(byte i, int[][] is) {
		do {
			try {
				Class97.anIntArrayArray814 = is;
				if (i < -62)
					break;
				anIntArray3744 = null;
			} catch (RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("jh.F(" + i + ',' + (is != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}

	Class76_Sub5(ha_Sub3 var_ha_Sub3) {
		super(var_ha_Sub3);
	}
	...
	final void method748(int i, boolean bool) {
		do {
			try {
				...
				throw Class64_Sub27.method667(runtimeexception, "jh.B(" + i + ',' + bool + ')');
			}
			break;
		} while (false);
	}
