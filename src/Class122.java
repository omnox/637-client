...
final class Class122 {
	...
	static final void method2199(boolean bool) {
		try {
			if (Class221.anIntArray1665 == null) {
				...
				for (int i_0_ = 0; (i_0_ ^ 0xffffffff) > -513; i_0_++) {
					...
					for (int i_2_ = 0; i_2_ < 128; i_2_++) {
						...
						int i_8_ = (int) f_7_;
						int i_9_ = i_8_ % 6;
						float f_10_ = (float) -i_8_ + f_7_;
						float f_11_ = (-f_1_ + 1.0F) * f_3_;
	...
	final int method2200(byte i, int i_18_) {
		try {
			if (i != -26)
			...
			throw Class64_Sub27.method667(runtimeexception, "ica.A(" + i + ',' + i_18_ + ')');
		}
	}
	...
	Class122(int[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "ica.<init>(" + (is != null ? "{...}" : "null") + ')');
		}
	}

	static final void method2201(int i, Class352 class352, int i_25_, ha var_ha, int i_26_, byte i_27_) {
		try {
			if (i_27_ != 70)
			...
			throw Class64_Sub27.method667(runtimeexception, ("ica.B(" + i + ',' + (class352 != null ? "{...}" : "null") + ',' + i_25_ + ',' + (var_ha != null ? "{...}" : "null") + ',' + i_26_ + ',' + i_27_ + ')'));
		}
	}
}
