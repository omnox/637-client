...
class Class268 {
		...
		do {
			try {
				...
				do {
					...
					((Class98_Sub31) class98_sub31_3_).aClass98_Sub31_4101 = class98_sub31;
				} while (false);
				aClass98_Sub31Array2020[i_2_] = class98_sub31;
				((Class98_Sub31) class98_sub31).anInt4103 = i_1_;
				if (i == -16680)
					break;
				anInt2014 = 29;
			} catch (RuntimeException runtimeexception) {
	...
	final synchronized void method3252(int i, Class98_Sub31 class98_sub31) {
		do {
			try {
				...
				if (i == 0)
					break;
				((Class268) this).anIntArray2005 = null;
			} catch (RuntimeException runtimeexception) {
		...
		if (aClass98_Sub31_2003 != null && anInt2015 <= 0) {
				...
				for (int i_14_ = i_10_ >>> i_12_ & 0x11111111; i_14_ != 0; i_14_ >>>= 4) {
					if ((i_14_ & 0x1) != 0) {
						...
						while (class98_sub31_15_ != null) {
							Class98_Sub24 class98_sub24 = (((Class98_Sub31) class98_sub31_15_).aClass98_Sub24_4104);
							if (class98_sub24 != null && (((Class98_Sub24) class98_sub24).anInt4008 > i_13_)) {
								i_10_ |= 1 << i_12_;
								class98_sub31 = class98_sub31_15_;
								class98_sub31_15_ = (((Class98_Sub31) class98_sub31_15_).aClass98_Sub31_4101);
							} else {
								((Class98_Sub31) class98_sub31_15_).aBoolean4102 = true;
								int i_16_ = class98_sub31_15_.method1326();
								i_9_ += i_16_;
								if (class98_sub24 != null)
									((Class98_Sub24) class98_sub24).anInt4008 += i_16_;
								if (i_9_ >= anInt2004)
									break while_161_;
								Class98_Sub31 class98_sub31_17_ = class98_sub31_15_.method1322();
								if (class98_sub31_17_ != null) {
									int i_18_ = (((Class98_Sub31) class98_sub31_15_).anInt4103);
								...
								Class98_Sub31 class98_sub31_19_ = (((Class98_Sub31) class98_sub31_15_).aClass98_Sub31_4101);
								((Class98_Sub31) class98_sub31_15_).aClass98_Sub31_4101 = null;
								if (class98_sub31 == null)
									aClass98_Sub31Array2019[i_12_] = class98_sub31_19_;
								else
									((Class98_Sub31) class98_sub31).aClass98_Sub31_4101 = class98_sub31_19_;
			...
			for (int i_20_ = 0; i_20_ < 8; i_20_++) {
				...
				for (/**/; class98_sub31 != null; class98_sub31 = class98_sub31_21_) {
					class98_sub31_21_ = ((Class98_Sub31) class98_sub31).aClass98_Sub31_4101;
					((Class98_Sub31) class98_sub31).aClass98_Sub31_4101 = null;
				}
			}
		}
		if (anInt2015 < 0)
			...
			try {
				if (Class177.aClass103_1375 != null) {
					...
					for (int i_22_ = 0; (i_22_ ^ 0xffffffff) > -3; i_22_++) {
						if ((((Class103) Class177.aClass103_1375).aClass268Array894[i_22_]) == this)
							((Class103) Class177.aClass103_1375).aClass268Array894[i_22_] = null;
						if ((((Class103) Class177.aClass103_1375).aClass268Array894[i_22_]) != null)
							bool = false;
					}
					if (bool) {
						((Class103) Class177.aClass103_1375).aBoolean893 = true;
						while (((Class103) Class177.aClass103_1375).aBoolean895)
	...
	int method3258() throws Exception {
		try {
			return ((Class268) this).anInt2010;
		} catch (RuntimeException runtimeexception) {
			...
			if (!aBoolean2008) {
				...
				try {
					...
					for (/**/; 5000L + aLong2006 < l; l = Class343.method3819(-47)) {
						method3260(256, -113);
						aLong2006 += (long) (256000 / Class64_Sub15.anInt3678);
					}
				} catch (Exception exception) {
					aLong2006 = l;
				}
				if (((Class268) this).anIntArray2005 != null) {
					try {
						if (aLong2017 != 0L) {
							if ((l ^ 0xffffffffffffffffL) > (aLong2017 ^ 0xffffffffffffffffL))
								return;
							method3250(((Class268) this).anInt2010);
							aLong2017 = 0L;
							aBoolean2011 = true;
						}
						if (i >= -66)
						...
						int i_26_ = anInt2018 + ((Class268) this).anInt2016;
						if (i_26_ + 256 > 16384)
							i_26_ = 16128;
						if (((Class268) this).anInt2010 < i_26_ - -256) {
							((Class268) this).anInt2010 += 1024;
							if ((((Class268) this).anInt2010 ^ 0xffffffff) < -16385)
								((Class268) this).anInt2010 = 16384;
							method3262();
							method3250(((Class268) this).anInt2010);
							i_25_ = 0;
							aBoolean2011 = true;
							if ((((Class268) this).anInt2010 ^ 0xffffffff) > (i_26_ + 256 ^ 0xffffffff)) {
								i_26_ = ((Class268) this).anInt2010 - 256;
								anInt2018 = i_26_ + -((Class268) this).anInt2016;
							}
						}
						for (/**/; i_26_ > i_25_; i_25_ += 256) {
							method3255(((Class268) this).anIntArray2005, 256);
							method3257();
						}
						if ((aLong2009 ^ 0xffffffffffffffffL) > (l ^ 0xffffffffffffffffL)) {
							if (!aBoolean2011) {
								if (anInt2012 == 0 && (anInt2014 ^ 0xffffffff) == -1) {
									method3262();
									aLong2017 = 2000L + l;
									return;
								}
