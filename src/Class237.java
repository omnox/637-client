...
abstract class Class237 {
	...
	static final void method2898(int i, byte i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("pb.F(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
		}
	}

	abstract int method2899(int i, byte[] is) throws IOException;

	final Class98_Sub43_Sub1 method2900(byte i) {
		try {
			if (i != -79)
				return null;
	...
	final double method2901(byte i) {
		try {
	...
	final boolean method2902(boolean bool) {
		try {
			if (bool != true)
				aBoolean1803 = true;
			if (!aBoolean1815 && !aBoolean1805)
				return false;
			if (aClass98_Sub43_Sub1_1807 != null && aClass98_Sub43_Sub1_1807.method1492((byte) -110) > 0)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	final void method2904(boolean bool) throws IOException {
		try {
				...
				while (!aBoolean1815) {
					...
					if (aClass98_Sub43_Sub1_1807 == class98_sub43) {
						...
						while ((((Class98_Sub43) aClass98_Sub43_Sub1_1807).anOggStreamState4241.packetOut(anOggPacket1802) ^ 0xffffffff) == -2) {
							...
							method2910((byte) 119);
							if (aClass98_Sub43_Sub3_1813 != null) {
								double d = aClass98_Sub43_Sub3_1813.method1502(0);
	...
	private final void method2907(int i) {
		while_151_: do {
			try {
	...
	final Class98_Sub43_Sub3 method2908(int i) {
		try {
			if (i != -32675)
				anOggPage1808 = null;
	...
	final void method2909(boolean bool, String string) {
		do {
			try {
				if (bool != true)
					aString1806 = null;
				...
				if (aString1806 == null)
					...
					if (aClass98_Sub43_Sub4_1801 != null && !aString1806.equals(aClass98_Sub43_Sub4_1801.method1507(bool)))
						aClass98_Sub43_Sub4_1801 = null;
					if (aClass98_Sub43_Sub4_1801 != null)
						break;
					for (Class98_Sub43 class98_sub43 = (Class98_Sub43) aClass377_1811.start_iteration(111); class98_sub43 != null; class98_sub43 = (Class98_Sub43) aClass377_1811.iterate_next(-1)) {
						if (class98_sub43 instanceof Class98_Sub43_Sub4) {
							Class98_Sub43_Sub4 class98_sub43_sub4 = (Class98_Sub43_Sub4) class98_sub43;
							if (aString1806.equals(class98_sub43_sub4.method1507(true))) {
				...
				throw Class64_Sub27.method667(runtimeexception, ("pb.A(" + bool + ',' + (string != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	}

	private final void method2910(byte i) {
		try {
	...
	final void method2911(boolean bool, byte i) {
		try {
			if (aClass98_Sub43_Sub1_1807 != null) {
				Class98_Sub31_Sub4 class98_sub31_sub4 = aClass98_Sub43_Sub1_1807.method1488((byte) 88);
			...
			throw Class64_Sub27.method667(runtimeexception, "pb.D(" + bool + ',' + i + ')');
		}
	}

	private final boolean method2912(byte i) {
		try {
			if (i != -59)
			...
			if (aClass98_Sub43_Sub3_1813.method1498(1024) && !(method2901((byte) -117) > aClass98_Sub43_Sub3_1813.method1502(0)))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	final Class98_Sub43_Sub4 method2913(int i) {
		try {
			if (i != 1)
				method2902(false);
	...
	private final Class98_Sub43 method2914(int i) throws IOException {
		try {
			if (i != 1)
				method2908(110);
			if (aBoolean1815)
			...
			if (aClass98_Sub43_Sub3_1813 != null || !anOggPacket1802.isTheora()) {
				if (aClass98_Sub43_Sub1_1807 != null || !anOggPacket1802.isVorbis()) {
					...
					aClass98_Sub43_Sub1_1807 = new Class98_Sub43_Sub1(oggstreamstate);
