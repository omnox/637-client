...
abstract class Class98_Sub28 extends Node {
	...
	abstract void method1302(Class42_Sub1 class42_sub1, int i, byte i_3_, Class42_Sub1 class42_sub1_4_);
	...
	static final String method1305(int i, long l) {
		try {
			...
			while (l != 0L) {
				long l_7_ = l;
				l /= 37L;
				stringbuffer.append(Exception_Sub1.aCharArray45[(int) (-(37L * l) + l_7_)]);
			}
			return stringbuffer.reverse().toString();
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "lb.P(" + i + ',' + l + ')');
		}
	}
	...
	static final int method1307(int i, int i_14_, int i_15_, int i_16_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("lb.L(" + i + ',' + i_14_ + ',' + i_15_ + ',' + i_16_ + ')'));
		}
	}
