...
final class Class195 {
	...
	final boolean method2659(int i) {
		try {
			if (i != -22382)
				return false;
	...
	static final boolean method2661(int i, int i_0_, int i_1_, int i_2_, byte i_3_) {
		try {
			if (i_3_ > -94)
				method2662(-60);
			...
			if (!Class76_Sub5.method758((byte) 72, i, i_0_, i_1_))
				return false;
			int i_4_ = i_1_ << Class151_Sub8.anInt5015;
			int i_5_ = i_0_ << Class151_Sub8.anInt5015;
			if (s_Sub1.method3427(Class78.activeTileHeightMap[i].method3420(i_0_, -12639, i_1_), r_Sub2.anInt6333, i_2_, r_Sub2.anInt6333, (byte) 16, i_5_, i_4_)) {
				Class151_Sub7.anInt5006++;
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("mt.C(" + i + ',' + i_0_ + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')'));
		}
	}

	static final boolean method2662(int i) {
		try {
			if (i > -84)
				aClass225_1502 = null;
	...
	static final boolean method2663(int i, int i_6_, boolean bool) {
		try {
			if (bool != false)
				method2660(-61);
			...
			throw Class64_Sub27.method667(runtimeexception, ("mt.A(" + i + ',' + i_6_ + ',' + bool + ')'));
		}
	}
		...
		try {
			...
			if (((Class195) this).aBoolean1501 || aHa_Sub3_1504.method1942(0, Class74.aClass164_547, Class162.aClass162_1266)) {
				...
				if (!((Class195) this).aBoolean1501) {
					...
					for (int i = 0; i < 16; i++) {
						byte[] is = Class98_Sub10_Sub20.method1061(2, 32768, 16384 * i * 2, (Class64_Sub24.anObject3709));
			...
			throw Class64_Sub27.method667(runtimeexception, "mt.<init>(" + (var_ha_Sub3 != null ? "{...}" : "null") + ')');
		}
	}
}
