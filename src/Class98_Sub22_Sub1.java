...
final class Class98_Sub22_Sub1 extends RSByteBuffer {
	...
	final void method1251(int i, int i_0_, byte[] is, boolean bool) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("bi.H(" + i + ',' + i_0_ + ',' + (is != null ? "{...}" : "null") + ',' + bool + ')'));
		}
	}
	...
	final void method1252(byte i, Class117 class117) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("bi.I(" + i + ',' + (class117 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	static final int method1253(boolean bool, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "bi.C(" + bool + ',' + i + ')');
		}
	}
	...
	final int method1258(int i, int i_8_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "bi.J(" + i + ',' + i_8_ + ')');
		}
	}
	...
	final void method1259(int[] is, int i) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("bi.F(" + (is != null ? "{...}" : "null") + ',' + i + ')'));
		}
	}
