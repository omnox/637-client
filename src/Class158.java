...
public final class Class158 implements Interface11 {
	...
	private DSCursors[] aDSCursorsArray3362 = new DSCursors[2];
	private int anInt3363;
	private int[] anIntArray3364;
	private WaveFormatEx aWaveFormatEx3365;
	private int[] anIntArray3366 = new int[2];
	...
	private DirectSoundBuffer[] aDirectSoundBufferArray3371 = new DirectSoundBuffer[2];
	private boolean[] aBooleanArray3372 = new boolean[2];
	private byte[][] aByteArrayArray3373 = new byte[2][];
	...
	public final void method32(int i, boolean bool, int i_0_) throws Exception {
		try {
			...
			aDirectSoundBufferArray3371[i_0_] = aDirectSound3368.createSoundBuffer((aDSBufferDescArray3370[i_0_]), aWaveFormatEx3365);
	...
	public final void method31(int i, int i_2_) {
		do {
			try {
				if (i < 84)
					method34((byte) -82, -40);
	...
	public final int method34(byte i, int i_3_) {
		try {
			if (!aBooleanArray3372[i_3_])
				return 0;
			aDirectSoundBufferArray3371[i_3_].getCurrentPosition(aDSCursorsArray3362[i_3_]);
			int i_4_ = aDSCursorsArray3362[i_3_].write / anInt3369;
			int i_5_ = -117 % ((i - 60) / 57);
	...
	public final void method33(int i, int[] is) {
		int i_8_ = is.length;
		if (i_8_ != 256 * anInt3361)
			throw new IllegalArgumentException();
		int i_9_ = anIntArray3364[i] * anInt3369;
		...
		aDirectSoundBufferArray3371[i].writeBuffer(i_9_, i_8_ * 2, aByteArrayArray3373[i], 0);
	...
	public final void method29(boolean bool, int i, Component component, int i_12_) throws Exception {
		try {
			if (anInt3363 == 0) {
	...
	public final void method30(int i, byte i_15_) {
		do {
			try {
				try {
