		...
		do {
			try {
				if ((0x400 & mask) != 0) {
					...
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6394 = class98_sub22_sub1.readByteA();
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6401 = class98_sub22_sub1.readByteS();
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6420 = i_2_ & 0x7fff;
					((Mobile) class246_sub3_sub4_sub2_sub2).aBoolean6348 = (i_2_ & 0x8000) != 0;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6412 = (((Mobile) class246_sub3_sub4_sub2_sub2).anInt6420 + (Class215.anInt1614 - -((Mobile) class246_sub3_sub4_sub2_sub2).anInt6394));
				}
				byte i_3_ = -1;
				if ((mask & 0x4000) != 0) {
				...
				if ((0x40000 & mask) != 0) {
					...
					for (int i_11_ = 0; i_9_ > i_11_; i_11_++) {
						...
						if ((0xc000 & i_12_ ^ 0xffffffff) != -49153)
							...
							is[i_11_] = Class41.method366(i_13_, i_12_ << -663124336);
						}
				...
				if ((mask & 0x200 ^ 0xffffffff) != -1) {
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6378 = class98_sub22_sub1.method1187((byte) -112);
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6347 = class98_sub22_sub1.method1184(-1498293360);
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6362 = class98_sub22_sub1.method1187((byte) -112);
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6392 = class98_sub22_sub1.method1187((byte) -112);
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6390 = class98_sub22_sub1.readShort1((byte) 92) + Class215.anInt1614;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6424 = class98_sub22_sub1.readLEShortA((byte) -53) + Class215.anInt1614;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6407 = class98_sub22_sub1.readByteA();
					if (!((Player) class246_sub3_sub4_sub2_sub2).aBoolean6532) {
				...
				if ((mask & 0x4) != 0) {
					((Player) class246_sub3_sub4_sub2_sub2).anInt6512 = class98_sub22_sub1.readLEShortA((byte) 91);
					if (((Mobile) class246_sub3_sub4_sub2_sub2).anInt6434 == 0) {
				...
				if ((0x2 & mask ^ 0xffffffff) != -1) {
					...
					if (i_19_ == 65535)
						i_19_ = -1;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6364 = i_19_;
				}
				if ((mask & 0x10000 ^ 0xffffffff) != -1) {
					((Mobile) class246_sub3_sub4_sub2_sub2).aByte6404 = class98_sub22_sub1.method1187((byte) -112);
					((Mobile) class246_sub3_sub4_sub2_sub2).aByte6381 = class98_sub22_sub1.method1234(128);
					((Mobile) class246_sub3_sub4_sub2_sub2).aByte6368 = class98_sub22_sub1.method1234(128);
					((Mobile) class246_sub3_sub4_sub2_sub2).aByte6422 = (byte) class98_sub22_sub1.readUnsignedByte();
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6403 = (Class215.anInt1614 + class98_sub22_sub1.readLEShortA((byte) 97));
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6349 = (Class215.anInt1614 - -class98_sub22_sub1.readShortA(98));
				}
				if ((0x8 & mask) != 0) {//hit
				...
				if ((0x1000 & mask ^ 0xffffffff) != -1)
					((Player) class246_sub3_sub4_sub2_sub2).aBoolean6534 = class98_sub22_sub1.readByteA() == 1;
				if (i_0_ <= 7)
					DebugConsole.handleCommand(null, false, true, (byte) -128);
				if ((mask & 0x8000) != 0) {
					((Mobile) class246_sub3_sub4_sub2_sub2).aString6374 = class98_sub22_sub1.readString();
					if ((((Mobile) class246_sub3_sub4_sub2_sub2).aString6374.charAt(0) ^ 0xffffffff) == -127) {
						((Mobile) class246_sub3_sub4_sub2_sub2).aString6374 = ((Mobile) class246_sub3_sub4_sub2_sub2).aString6374.substring(1);
						Class98_Sub45.add_message((byte) -96, 2, ((Mobile) class246_sub3_sub4_sub2_sub2).aString6374, 0, class246_sub3_sub4_sub2_sub2.method3059(-1, false), class246_sub3_sub4_sub2_sub2.method3063(0, true), ((Player) class246_sub3_sub4_sub2_sub2).name);
					} else if (class246_sub3_sub4_sub2_sub2 == Player.selfPlayer)
						Class98_Sub45.add_message((byte) 90, 2, ((Mobile) class246_sub3_sub4_sub2_sub2).aString6374, 0, class246_sub3_sub4_sub2_sub2.method3059(-1, false), class246_sub3_sub4_sub2_sub2.method3063(0, true), ((Player) class246_sub3_sub4_sub2_sub2).name);
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6384 = 150;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6398 = 0;
					((Mobile) class246_sub3_sub4_sub2_sub2).anInt6402 = 0;
				}
				...
				if (i_3_ != 127) {
					...
					class246_sub3_sub4_sub2_sub2.method3057(((Player) class246_sub3_sub4_sub2_sub2).anInt6521, ((Player) class246_sub3_sub4_sub2_sub2).anInt6541, i_36_, -1);
				} else
					class246_sub3_sub4_sub2_sub2.method3060(((Player) class246_sub3_sub4_sub2_sub2).anInt6541, ((Player) class246_sub3_sub4_sub2_sub2).anInt6521, 1470);
