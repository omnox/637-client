...
final class Class88 implements Runnable {
	...
	final boolean method860(byte i) {
		try {
			int i_1_ = 6 % ((-56 - i) / 40);
			if (!((Class88) this).aBoolean682)
				return false;
			if (!((Class88) this).aBoolean675) {
				if (anObject693 == null)
					return false;
				return true;
			}
	...
	public final void run() {
		try {
			for (;;) {
				...
				synchronized (this) {
					for (;;) {
						...
						if (aClass143_697 != null) {
							...
							aClass143_697 = ((Class143) aClass143_697).aClass143_1167;
							if (aClass143_697 == null)
								aClass143_689 = null;
							break;
						}
				...
				try {
					int i = ((Class143) class143).anInt1164;
					if ((i ^ 0xffffffff) != -2) {
						if (i == 22) {
							if ((aLong701 ^ 0xffffffffffffffffL) < (Class343.method3819(-47) ^ 0xffffffffffffffffL))
								throw new IOException();
							try {
								class143.anObject1162 = Class246_Sub3_Sub2_Sub1.method3006((String) (((Class143) class143).anObject1161), 0, class143.anInt1166).method305(-2);
							} catch (IOException_Sub1 ioexception_sub1) {
								class143.anObject1162 = ioexception_sub1.getMessage();
								throw ioexception_sub1;
							}
						} else if (i == 2) {
							Thread thread = new Thread((Runnable) (((Class143) class143).anObject1161));
							...
							if ((i ^ 0xffffffff) != -9) {
								if ((i ^ 0xffffffff) == -10) {
									Object[] objects = ((Object[]) ((Class143) class143).anObject1161);
									if (((Class88) this).aBoolean682 && ((Class) objects[0]).getClassLoader() == null)
									...
									if (((Class88) this).aBoolean682) {
										if (i == 3) {
											if (aLong701 > Class343.method3819(-47))
												throw new IOException();
											String string = ((String.valueOf(0xff & (class143.anInt1166 >> 443133112))) + "." + (0xff & (class143.anInt1166 >> -1933975568)) + "." + ((class143.anInt1166 & 0xfffc) >> -963801848) + "." + (0xff & class143.anInt1166));
											...
											if (i != 5) {
												if ((i ^ 0xffffffff) == -7) {
													...
													if (!((Class88) this).aBoolean675)
														Class.forName("Class68").getMethod("method692", (new Class[] { ((aClass703 != null) ? aClass703 : (aClass703 = (method878("java.awt.Frame")))), Integer.TYPE, Integer.TYPE, Integer.TYPE, (Integer.TYPE) })).invoke(anObject693, (new Object[] { frame, (new Integer((class143.anInt1166) >>> -367960272)), (new Integer((class143.anInt1166) & 0xffff)), (new Integer((((Class143) class143).anInt1165) >> 753354768)), (new Integer((((Class143) class143).anInt1165) & 0xffff)) }));
													else
														aClass20_684.method255(((((Class143) class143).anInt1165) >> 178448656), -2147483648, ((class143.anInt1166) >>> 1019450064), ((((Class143) class143).anInt1165) & 0xffff), (0xffff & (class143.anInt1166)), frame);
												} else if ((i ^ 0xffffffff) == -8) {
													if (!((Class88) this).aBoolean675)
														Class.forName("Class68").getMethod("method690", new Class[0]).invoke(anObject693, new Object[0]);
													else
														aClass20_684.method253(83, ((Frame) (((Class143) class143).anObject1161)));
												} else if (i == 12) {
													Class356 class356 = (method871(aString694, ((String) (((Class143) class143).anObject1161)), anInt691, (byte) -121));
													class143.anObject1162 = class356;
												} else if ((i ^ 0xffffffff) != -14) {
													if ((((Class88) this).aBoolean682) && ((i ^ 0xffffffff) == -15)) {
														int i_3_ = (class143.anInt1166);
														int i_4_ = (((Class143) class143).anInt1165);
														if (((Class88) this).aBoolean675)
													...
													} else if ((((Class88) this).aBoolean682) && ((i ^ 0xffffffff) == -16)) {
														boolean bool = ((class143.anInt1166) != 0);
														Component component = ((Component) (((Class143) class143).anObject1161));
														if (((Class88) this).aBoolean675)
													...
													} else if ((((Class88) this).aBoolean675) || i != 17) {
														if (i != 16)
															throw new Exception("");
														try {
															if (!aString699.startsWith("win"))
																throw new Exception();
															String string = ((String) (((Class143) class143).anObject1161));
														...
														Object[] objects = ((Object[]) (((Class143) class143).anObject1161));
														Class.forName("Class321").getDeclaredMethod("method3666", (new Class[] { ((aClass704 != null) ? aClass704 : (aClass704 = (method878("java.awt.Component")))), ((aClass705 != null) ? aClass705 : (aClass705 = (method878("[I")))), Integer.TYPE, Integer.TYPE, ((aClass706 != null) ? aClass706 : (aClass706 = (method878("java.awt.Point")))) })).invoke(anObject687, (new Object[] { ((Component) objects[0]), ((int[]) objects[1]), (new Integer(class143.anInt1166)), (new Integer(((Class143) class143).anInt1165)), ((Point) (objects[2])) }));
													}
												} else {
													Class356 class356 = (method871("", ((String) (((Class143) class143).anObject1161)), anInt691, (byte) -110));
													class143.anObject1162 = class356;
												}
											} else if (((Class88) this).aBoolean675)
											...
											if ((aLong701 ^ 0xffffffffffffffffL) < (Class343.method3819(-47) ^ 0xffffffffffffffffL))
												throw new IOException();
											class143.anObject1162 = InetAddress.getByName((String) (((Class143) class143).anObject1161)).getAddress();
										}
									} else
										throw new Exception("");
								} else {
									Transferable transferable = ((Transferable) ((Class143) class143).anObject1161);
									Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
							...
							if (aLong701 > Class343.method3819(-47))
								throw new IOException();
							class143.anObject1162 = new DataInputStream(((URL) (((Class143) class143).anObject1161)).openStream());
						}
					} else {
						if ((aLong701 ^ 0xffffffffffffffffL) < (Class343.method3819(-47) ^ 0xffffffffffffffffL))
							throw new IOException();
						class143.anObject1162 = new Socket((InetAddress.getByName((String) (((Class143) class143).anObject1161))), class143.anInt1166);
					}
	...
	final Class143 method869(int i, int i_9_, int i_10_, int i_11_, int i_12_) {
		try {
			if (i != -21605)
				return null;
			return method877((i_9_ << 1082083888) - -i_11_, i + 21511, i_12_ + (i_10_ << 2029886704), 6, null);
		} catch (RuntimeException runtimeexception) {
			throw runtimeexception;
		}
	}
	...
	final void method874(int i) {
		try {
			...
			if (((Class88) this).aClass356_702 != null) {
				try {
					((Class88) this).aClass356_702.method3880(true);
				} catch (IOException ioexception) {
					/* empty */
				}
			}
			if (i >= 54) {
				if (((Class88) this).aClass356_680 != null) {
					try {
						((Class88) this).aClass356_680.method3880(true);
					} catch (IOException ioexception) {
						/* empty */
					}
				}
				if (((Class88) this).aClass356Array695 != null) {
					for (int i_21_ = 0; ((i_21_ ^ 0xffffffff) > (((Class88) this).aClass356Array695.length ^ 0xffffffff)); i_21_++) {
						if (((Class88) this).aClass356Array695[i_21_] != null) {
							try {
								((Class88) this).aClass356Array695[i_21_].method3880(true);
							} catch (IOException ioexception) {
								/* empty */
							}
						}
				...
				if (((Class88) this).aClass356_685 != null) {
					try {
						((Class88) this).aClass356_685.method3880(true);
					} catch (IOException ioexception) {
						/* empty */
					}
				}
	...
	private final Class143 method877(int i, int i_22_, int i_23_, int i_24_, Object object) {
		try {
			...
			((Class143) class143).anObject1161 = object;
			((Class143) class143).anInt1164 = i_24_;
			class143.anInt1166 = i_23_;
			((Class143) class143).anInt1165 = i;
			synchronized (this) {
				if (aClass143_689 != null) {
					((Class143) aClass143_689).aClass143_1167 = class143;
	...
	Class88(int i, String string, int i_25_, boolean bool) throws Exception {
		((Class88) this).aClass356_680 = null;
		((Class88) this).aClass356_685 = null;
		aBoolean681 = false;
		aClass143_697 = null;
		((Class88) this).aBoolean682 = false;
		((Class88) this).aBoolean675 = false;
		((Class88) this).aClass356_702 = null;
		try {
			aString692 = "1.1";
			aString694 = string;
			((Class88) this).aBoolean682 = bool;
			aString696 = "Unknown";
			anInt691 = i;
			try {
			...
			if (aString679 == null)
				aString679 = "~/";
			try {
				((Class88) this).anEventQueue698 = Toolkit.getDefaultToolkit().getSystemEventQueue();
			} catch (Throwable throwable) {
				/* empty */
			}
			if (!((Class88) this).aBoolean675) {
			...
			if (((Class88) this).aBoolean682) {
				((Class88) this).aClass356_685 = new Class356(Class316.method3648(anInt691, 0, "random.dat", null), "rw", 25L);
				((Class88) this).aClass356_702 = new Class356(Class316.method3649("main_file_cache.dat2", 13), "rw", 209715200L);
				((Class88) this).aClass356_680 = (new Class356(Class316.method3649("main_file_cache.idx255", 61), "rw", 1048576L));
				((Class88) this).aClass356Array695 = new Class356[i_25_];
				for (int i_26_ = 0; (i_25_ ^ 0xffffffff) < (i_26_ ^ 0xffffffff); i_26_++)
					((Class88) this).aClass356Array695[i_26_] = new Class356((Class316.method3649("main_file_cache.idx" + i_26_, -128)), "rw", 1048576L);
				if (((Class88) this).aBoolean675) {
					try {
			...
			if (((Class88) this).aBoolean682 && !((Class88) this).aBoolean675) {
