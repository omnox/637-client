...
final class Class374 {
	...
	final void method3981(byte[] is, int i, long l) {
		try {
			int i_0_ = 0;
			int i_1_ = 0x7 & -((int) l & 0x7) + 8;
			if (i != 64)
				method3980((byte) 113);
			int i_2_ = anInt3165 & 0x7;
			long l_3_ = l;
			int i_4_ = 31;
			int i_5_ = 0;
			for (/**/; i_4_ >= 0; i_4_--) {
			...
			while (l > 8L) {
				...
				aByteArray3154[anInt3160] = (byte) Class202.method2702(i_6_ << 8 + -i_2_, 255);
				anInt3165 += i_2_;
				l -= 8L;
				i_0_++;
			}
			...
			if (l > 0L) {
				...
				aByteArray3154[anInt3160] = (byte) Class41.method366(aByteArray3154[anInt3160], i_7_ >>> i_2_);
			} else
				i_7_ = 0;
			if (l + (long) i_2_ >= 8L) {
				anInt3160++;
				...
				aByteArray3154[anInt3160] = (byte) Class202.method2702(255, i_7_ << 8 + -i_2_);
				anInt3165 += (int) l;
			} else
				anInt3165 += l;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("wn.F(" + (is != null ? "{...}" : "null") + ',' + i + ',' + l + ')'));
		}
	}

	final void method3982(byte i, int i_8_, byte[] is) {
		try {
			int i_9_ = -79 / ((i - 17) / 60);
			...
			throw Class64_Sub27.method667(runtimeexception, ("wn.A(" + i + ',' + i_8_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	private final void method3984(byte i) {
		do {
			try {
				int i_14_ = 0;
				int i_15_ = 0;
				...
				for (int i_17_ = 1; (i_17_ ^ 0xffffffff) >= -11; i_17_++) {
					for (int i_18_ = 0; (i_18_ ^ 0xffffffff) > -9; i_18_++) {
						...
						int i_20_ = 56;
						while (i_19_ < 8) {
							aLongArray3162[i_18_] = (Class284_Sub1_Sub1.method3367(aLongArray3162[i_18_], (Class27.aLongArrayArray279[i_19_][(Class202.method2702(255, (int) ((aLongArray3155[(Class202.method2702(7, -i_19_ + i_18_))]) >>> i_20_)))])));
							i_19_++;
							i_20_ -= 8;
						}
					}
				...
				for (int i_26_ = 0; i_26_ < 8; i_26_++)
					aLongArray3158[i_26_] = (Class284_Sub1_Sub1.method3367(aLongArray3158[i_26_], Class284_Sub1_Sub1.method3367((aLongArray3161[i_26_]), (aLongArray3163[i_26_]))));
				if (i >= 98)
					break;
	...
	public static void method3985(int i) {
		do {
			try {
