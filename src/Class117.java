...
final class Class117 {
	...
	static final void method2164(ha var_ha, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, boolean bool, boolean bool_5_) {
		Class98_Sub10_Sub30.aHa5709 = var_ha;
		RenderAnimDefinitions.anInt2407 = i;
		Class375.aBoolean3170 = (RenderAnimDefinitions.anInt2407 > 1 && Class98_Sub10_Sub30.aHa5709.method1810());
		...
		Class379.aClass246_Sub3Array3198 = new AnimableEntity[2];
		Class359.aClass246_Sub3Array3056 = new AnimableEntity[2];
		Class130.aClass246_Sub3Array1029 = new AnimableEntity[2];
		Class32.aClass246_Sub3Array307 = new AnimableEntity[10000];
		Class302.anInt2523 = 0;
		Class246_Sub4_Sub2.aClass246_Sub3Array6173 = new AnimableEntity[5000];
		...
		if (Class375.aBoolean3170) {
			...
			if (Class98_Sub46_Sub5.aClass174Array5970 != null)
				Class249.method3162();
			Class98_Sub46_Sub5.aClass174Array5970 = new Class174[RenderAnimDefinitions.anInt2407];
			...
			for (int i_6_ = 0; i_6_ < Class98_Sub46_Sub5.aClass174Array5970.length; i_6_++) {
				Class98_Sub46_Sub5.aClass174Array5970[i_6_] = new Class174(i_6_ + 1, Class98_Sub10_Sub30.aHa5709);
			...
			for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
				Class98_Sub43_Sub3.aClass245Array5922[i_8_] = new Class245(Class55.aStringArrayArray441[RenderAnimDefinitions.anInt2407 - 2][i_8_]);
		} else
			Class18.anInt212 = 1;
	...
	private final void method2165(byte i) {
		try {
			int i_10_;
			int i_11_;
			int i_12_;
	...
	static final void method2169(int[] is, long[] ls, int i, int i_23_, boolean bool) {
		do {
			try {
				if (i < i_23_) {
					int i_24_ = (i_23_ + i) / 2;
				...
				throw Class64_Sub27.method667(runtimeexception, ("hj.F(" + (is != null ? "{...}" : "null") + ',' + (ls != null ? "{...}" : "null") + ',' + i + ',' + i_23_ + ',' + bool + ')'));
			}
			break;
		} while (false);
	}
	...
	Class117(int[] is) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "hj.<init>(" + (is != null ? "{...}" : "null") + ')');
		}
	}
}
