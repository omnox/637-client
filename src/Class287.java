...
abstract class Class287 {
	...
	static final boolean method3386(int i, int i_0_, byte i_1_) {
		try {
			int i_2_ = -41 / ((71 - i_1_) / 40);
			if (!((0x70000 & i) != 0 | Node.method944(i, i_0_, (byte) 85)) && !Class76_Sub7.method763(i, i_0_, false))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("rq.N(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}

	static final void method3387(String string, String string_3_, byte i, boolean bool, int i_4_) {
		do {
			try {
				Class277.method3288(bool, i_4_, string, 2, string_3_, true, -1);
				if (i > 0)
					break;
				IncomingOpcode.carriedWeightOpcode = null;
			} catch (RuntimeException runtimeexception) {
				throw Class64_Sub27.method667(runtimeexception, ("rq.J(" + (string != null ? "{...}" : "null") + ',' + (string_3_ != null ? "{...}" : "null") + ',' + i + ',' + bool + ',' + i_4_ + ')'));
			}
			break;
		} while (false);
	}
	...
	public static void method3388(int i) {
		do {
			try {
				anIntArray2195 = null;
				objectDataArchive = null;
				IncomingOpcode.carriedWeightOpcode = null;
				IncomingOpcode.aClass58_2187 = null;
				if (i == 32414)
					break;
				method3385((byte) -61);
			} catch (RuntimeException runtimeexception) {
	...
	final void method3389(int i, int i_5_, byte[] is) {
		try {
			method3384(i + i);
			if (i_5_ > anInt2193) {
			...
			throw Class64_Sub27.method667(runtimeexception, ("rq.L(" + i + ',' + i_5_ + ',' + (is != null ? "{...}" : "null") + ')'));
		}
	}
	...
	Class287(ha_Sub1 var_ha_Sub1, int i, byte[] is, int i_6_, boolean bool) {
		try {
			anInt2189 = i;
			anInt2193 = i_6_;
