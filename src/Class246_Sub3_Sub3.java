...
abstract class Class246_Sub3_Sub3 extends AnimableEntity {
	...
	final int method2980(int i, Class98_Sub5[] class98_sub5s) {
		try {
			int i_0_ = this.localXPos >> Class151_Sub8.anInt5015;
			int i_1_ = this.localYPos >> Class151_Sub8.anInt5015;
			int i_2_ = 0;
			if (i_0_ != Class241.anInt1845) {
				...
				i_2_++;
			if (i_1_ != Class64_Sub26.anInt3714) {
				if (Class64_Sub26.anInt3714 > i_1_)
					i_2_ += 6;
			} else
				i_2_ += 3;
			int i_3_ = Class241.anIntArray1846[i_2_];
			if ((this.aShort6153 & i_3_) != 0)
				return this.method2989(i_0_, false, class98_sub5s, i_1_);
			if (this.aShort6153 == 1 && i_0_ > 0)
				return this.method2989(-1 + i_0_, false, class98_sub5s, i_1_);
			if (this.aShort6153 == 4 && i_0_ <= Class366.anInt3112)
				return this.method2989(1 + i_0_, false, class98_sub5s, i_1_);
			if (this.aShort6153 == 8 && i_1_ > 0)
				return this.method2989(i_0_, false, class98_sub5s, -1 + i_1_);
			if (this.aShort6153 == 2 && i_1_ <= Class64_Sub9.anInt3662)
				return this.method2989(i_0_, false, class98_sub5s, 1 + i_1_);
			if (this.aShort6153 == 16 && i_0_ > 0 && Class64_Sub9.anInt3662 >= i_1_)
				return this.method2989(-1 + i_0_, false, class98_sub5s, 1 + i_1_);
			if (this.aShort6153 == 32 && i_0_ <= Class366.anInt3112 && Class64_Sub9.anInt3662 >= i_1_)
				return this.method2989(i_0_ + 1, false, class98_sub5s, 1 + i_1_);
			if (this.aShort6153 == 128 && i_0_ > 0 && i_1_ > 0)
				return this.method2989(i_0_ + -1, false, class98_sub5s, i_1_ - 1);
			int i_4_ = 124 % ((i - 29) / 62);
			if (this.aShort6153 == 64 && i_0_ <= Class366.anInt3112 && i_1_ > 0)
				return this.method2989(i_0_ + 1, false, class98_sub5s, i_1_ - 1);
	...
	final boolean method2991(boolean bool) {
		try {
			if (bool != false)
				aString6156 = null;
			return (Class74.aBooleanArrayArray551[((this.localXPos >> Class151_Sub8.anInt5015) + (-Class241.anInt1845 - -Class259.anInt1959))][(-Class64_Sub26.anInt3714 + ((this.localYPos >> Class151_Sub8.anInt5015) + Class259.anInt1959))]);
		} catch (RuntimeException runtimeexception) {
			...
			try {
				...
				if (!(class246_sub3_sub4_sub2 instanceof Class246_Sub3_Sub4_Sub2_Sub1)) {
					if (class246_sub3_sub4_sub2 instanceof Player) {
						...
						Class98_Sub30.method1311(((Player.selfPlayer.height_level) != (class246_sub3_sub4_sub2_sub2.height_level)), true, class246_sub3_sub4_sub2_sub2);
					}
				} else {
					...
					if (class246_sub3_sub4_sub2_sub1.aClass141_6504 == null)
						break;
					Class98_Sub10.method995(class246_sub3_sub4_sub2_sub1, (byte) 55, ((class246_sub3_sub4_sub2_sub1.height_level) != (Player.selfPlayer.height_level)));
				}
			} catch (RuntimeException runtimeexception) {
	...
	final boolean method2977(ha var_ha, byte i) {
		try {
			if (i != 77)
				return false;
			return Class100.method1688(this.aByte5081, (this.localXPos >> Class151_Sub8.anInt5015), (this.localYPos >> Class151_Sub8.anInt5015), this, (byte) 112);
		} catch (RuntimeException runtimeexception) {
	...
	Class246_Sub3_Sub3(int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
		try {
			this.aShort6153 = (short) i_13_;
			this.localXPos = i;
			this.height_level = (byte) i_11_;
			this.aByte5081 = (byte) i_12_;
			this.anInt5089 = i_9_;
			this.localYPos = i_10_;
		} catch (RuntimeException runtimeexception) {
