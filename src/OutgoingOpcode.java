...
final class OutgoingOpcode {
	...
	static final void method2540(int i, int i_0_, Class197 class197, int i_1_, GameInterfaceData class293, int i_2_, byte i_3_, String string, aa var_aa, int i_4_, int i_5_, Class43 class43) {
		try {
			int i_6_;
			do {
	...
	public final String toString() {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, "lga.toString(" + ')');
		}
	}
