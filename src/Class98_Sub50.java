...
final class Class98_Sub50 extends Node {
	...
	static Class97[] aClass97Array4293 = new Class97[14];
	...
	static final void method1671(int i, byte i_1_, int i_2_, int i_3_, int i_4_) {
		do {
			try {
				if (i_1_ != 0)
					aClass171_4290 = null;
				...
				throw Class64_Sub27.method667(runtimeexception, ("wca.C(" + i + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ')'));
			}
			break;
		} while (false);
	}
	...
	public static void method1673(int i) {
		try {
			IncomingOpcode.aClass58_4291 = null;
			aClass332_4287 = null;
			if (i != 1)
				anInt4294 = 41;
			aClass171_4290 = null;
