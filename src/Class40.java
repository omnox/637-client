...
final class Class40 {
	...
	static final void method364(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			...
			if (Class98_Sub10_Sub38.anInt5753 <= i_6_ && (Class218.anInt1635 ^ 0xffffffff) <= (i_6_ ^ 0xffffffff)) {
			...
			while (i_10_ > 0) {
				...
				if ((i_28_ ^ 0xffffffff) <= (Class98_Sub10_Sub38.anInt5753 ^ 0xffffffff) && (i_27_ ^ 0xffffffff) >= (Class218.anInt1635 ^ 0xffffffff)) {
	...
	Class40(long l, int[] is, short[] is_31_, short[] is_32_) {
		try {
			((Class40) this).aShortArray368 = is_32_;
			((Class40) this).aLong365 = l;
			((Class40) this).aShortArray370 = is_31_;
			((Class40) this).anIntArray366 = is;
		} catch (RuntimeException runtimeexception) {
