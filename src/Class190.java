...
final class Class190 {
	...
	final void method2643(int i) {
		try {
			if (i != 30925)
				method2648(-107L, -52);
			method2645(-18732, anInterface2_Impl2_1471, this.anInt1460);
	...
	private final void method2647(int i) {
		try {
			...
			if (this.aBoolean1470) {
				...
				if (anInterface4_Impl2_1461 != null && anInt1469 == i_3_)
					this.aBoolean1470 = false;
				else {
					anInt1469 = i_3_;
					...
					if (!aHa_Sub3_1465.method1942(i + -128, Class53_Sub1.aClass164_3633, Class162.aClass162_1266)) {
						...
						for (int i_14_ = -128; i_14_ < 0; i_14_++) {
	...
	Class190(ha_Sub3 var_ha_Sub3, Class15 class15, s_Sub2 var_s_Sub2, int i, int i_17_, int i_18_, int i_19_, int i_20_) {
		try {
			...
			for (int i_25_ = 0; i_21_ > i_25_; i_25_++) {
				int i_26_ = var_s_Sub2.anInt2203 * (i_24_ - -i_25_) + i_23_;
					...
					if (buffer != null) {
						...
						if (Stream.a()) {
							for (int i_29_ = 0; i_21_ > i_29_; i_29_++) {
								int i_30_ = (((i_24_ - -i_29_) * var_s_Sub2.anInt2203) + i_23_);
							...
							for (int i_34_ = 0; i_34_ < i_21_; i_34_++) {
								int i_35_ = i_23_ + ((i_24_ - -i_34_) * var_s_Sub2.anInt2203);
	...
	static final void method2648(long l, int i) {
		try {
			...
			for (int i_40_ = 0; i_40_ < Class69_Sub2.anInt5335; i_40_++) {
			...
			int i_42_ = (Player.selfPlayer.getSize() << 8);
			Class169.method2535(Class279.anInt2099, (Player.selfPlayer.height_level), (Player.selfPlayer.localYPos) - -i_42_, (Player.selfPlayer.localXPos) + i_42_, (byte) 112);
