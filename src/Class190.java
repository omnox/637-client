...
final class Class190 {
	...
	final void method2643(int i) {
		try {
			if (i != 30925)
				method2648(-107L, -52);
			method2645(-18732, anInterface2_Impl2_1471, ((Class190) this).anInt1460);
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "mj.C(" + i + ')');
		}
	}

	static final byte method2644(int i, int i_0_, int i_1_) {
		try {
			if (i_0_ <= 54)
				method2644(8, 49, -34);
			if ((i ^ 0xffffffff) != -10)
			...
			throw Class64_Sub27.method667(runtimeexception, ("mj.E(" + i + ',' + i_0_ + ',' + i_1_ + ')'));
		}
	}

	final void method2645(int i, Interface2_Impl2 interface2_impl2, int i_2_) {
		try {
			...
			throw Class64_Sub27.method667(runtimeexception, ("mj.B(" + i + ',' + (interface2_impl2 != null ? "{...}" : "null") + ',' + i_2_ + ')'));
		}
	}
	...
	private final void method2647(int i) {
		try {
			...
			if (((Class190) this).aBoolean1470) {
				((Class190) this).aBoolean1470 = false;
				byte[] is = ((Class15) aClass15_1464).aByteArray176;
				int i_3_ = 0;
				int i_4_ = ((Class15) aClass15_1464).anInt180;
				int i_5_ = (((Class15) aClass15_1464).anInt180 * anInt1466 + anInt1467);
				...
				if (anInterface4_Impl2_1461 != null && (i_3_ ^ 0xffffffff) == (anInt1469 ^ 0xffffffff))
					...
					if (!aHa_Sub3_1465.method1942(i + -128, Class53_Sub1.aClass164_3633, Class162.aClass162_1266)) {
						...
						int[] is_9_ = Class64_Sub1.anIntArray3639;
						for (int i_10_ = -128; (i_10_ ^ 0xffffffff) > -1; i_10_++) {
							...
							i_5_ += ((Class15) aClass15_1464).anInt180 + -128;
						}
						if (anInterface4_Impl2_1461 != null)
							anInterface4_Impl2_1461.method49(17779, 0, 128, (Class64_Sub1.anIntArray3639), 0, 0, 128, 128);
						else {
							anInterface4_Impl2_1461 = aHa_Sub3_1465.method2012(128, 128, (byte) 31, (Class64_Sub1.anIntArray3639), false);
							anInterface4_Impl2_1461.method46(false, false, i + -61);
						}
					} else {
						if (Class298.aByteArray2492 == null)
							Class298.aByteArray2492 = new byte[16384];
						byte[] is_13_ = Class298.aByteArray2492;
						...
						if (anInterface4_Impl2_1461 == null) {
							anInterface4_Impl2_1461 = aHa_Sub3_1465.method2053(128, (Class53_Sub1.aClass164_3633), (byte) 87, (Class298.aByteArray2492), false, 128);
							anInterface4_Impl2_1461.method46(false, false, 124);
						} else
							anInterface4_Impl2_1461.method41(128, 0, 128, 0, 128, -26946, Class298.aByteArray2492, Class53_Sub1.aClass164_3633, 0);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	Class190(ha_Sub3 var_ha_Sub3, Class15 class15, s_Sub2 var_s_Sub2, int i, int i_17_, int i_18_, int i_19_, int i_20_) {
		try {
			...
			for (int i_25_ = 0; i_21_ > i_25_; i_25_++) {
				int i_26_ = ((s) var_s_Sub2).anInt2203 * (i_24_ - -i_25_) + i_23_;
				for (int i_27_ = 0; (i_21_ ^ 0xffffffff) < (i_27_ ^ 0xffffffff); i_27_++) {
					short[] is = ((s_Sub2) var_s_Sub2).aShortArrayArray5230[i_26_++];
					if (is != null)
						i_22_ += is.length;
				}
			}
			if (i_22_ > 0) {
						...
						if (Stream.a()) {
							for (int i_29_ = 0; (i_29_ ^ 0xffffffff) > (i_21_ ^ 0xffffffff); i_29_++) {
								...
								for (int i_31_ = 0; ((i_21_ ^ 0xffffffff) < (i_31_ ^ 0xffffffff)); i_31_++) {
									short[] is = (((s_Sub2) var_s_Sub2).aShortArrayArray5230[i_30_++]);
									if (is != null) {
							...
							for (int i_34_ = 0; i_34_ < i_21_; i_34_++) {
								int i_35_ = i_23_ + ((i_24_ - -i_34_) * ((s) var_s_Sub2).anInt2203);
								for (int i_36_ = 0; i_36_ < i_21_; i_36_++) {
									short[] is = (((s_Sub2) var_s_Sub2).aShortArrayArray5230[i_35_++]);
									if (is != null) {
				...
				((Class190) this).anInt1460 = i_22_ / 3;
			} else {
				((Class190) this).anInt1460 = 0;
				anInterface4_Impl2_1461 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, ("mj.<init>(" + (var_ha_Sub3 != null ? "{...}" : "null") + ',' + (class15 != null ? "{...}" : "null") + ',' + (var_s_Sub2 != null ? "{...}" : "null") + ',' + i + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ',' + i_20_ + ')'));
		}
	}

	static final void method2648(long l, int i) {
		try {
			...
			int i_42_ = (Player.selfPlayer.getSize() << 2087692776);
			Class169.method2535(Class279.anInt2099, (((AnimableEntity) Player.selfPlayer).height_level), (((AnimableEntity) Player.selfPlayer).localYPos) - -i_42_, (((AnimableEntity) Player.selfPlayer).localXPos) + i_42_, (byte) 112);
			Class279.anInt2099 = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class64_Sub27.method667(runtimeexception, "mj.A(" + l + ',' + i + ')');
		}
	}
}
