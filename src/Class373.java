...
abstract class Class373 implements Interface18 {
	...
	public boolean method59(int i) {
		try {
			if (i != 14017)
				return false;
			boolean bool = true;
			if (!((Class373) this).aClass207_3473.method2742(i + -14068, ((Class93) ((Class373) this).aClass93_3478).anInt3506))
				bool = false;
			if (!aClass207_3476.method2742(-112, (((Class93) (((Class373) this).aClass93_3478)).anInt3506)))
				bool = false;
			return bool;
	...
	public final void method60(boolean bool, byte i) {
		try {
			int i_2_ = ((((Class93) ((Class373) this).aClass93_3478).aClass63_3509.method545(Class98_Sub17_Sub1.anInt5782, ((Class93) ((Class373) this).aClass93_3478).anInt3514, (byte) 124)) - -((Class93) ((Class373) this).aClass93_3478).anInt3505);
			int i_3_ = ((((Class93) ((Class373) this).aClass93_3478).aClass110_3511.method2088(((Class93) ((Class373) this).aClass93_3478).anInt3504, Class246_Sub2.anInt5072, (byte) -56)) - -((Class93) ((Class373) this).aClass93_3478).anInt3507);
			...
			aClass43_3474.method415(((Class93) ((Class373) this).aClass93_3478).anInt3513, string, (i_2_ + ((Class93) ((Class373) this).aClass93_3478).anInt3514 / 2), -1, (byte) -98, 4 + (i_3_ - -(((Class93) ((Class373) this).aClass93_3478).anInt3504 / 2) + (((Class93) ((Class373) this).aClass93_3478).anInt3508)));
		} catch (RuntimeException runtimeexception) {
	...
	final int method3963(int i) {
		try {
			...
			int i_5_ = i_4_ * i;
			if ((i_4_ ^ 0xffffffff) != (anInt3472 ^ 0xffffffff) || (i_4_ ^ 0xffffffff) == -1) {
				anInt3472 = i_4_;
	...
	public void method58(byte i) {
		try {
			...
			Class197 class197 = Class119_Sub1.method2182(aClass207_3476, true, (((Class93) ((Class373) this).aClass93_3478).anInt3506));
			aClass43_3474 = (Class265.aHa1974.method1804(class197, Class324.method3684(((Class373) this).aClass207_3473, (((Class93) ((Class373) this).aClass93_3478).anInt3506)), true));
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3964(Class98_Sub22_Sub1 class98_sub22_sub1, int i) {
		try {
			...
			((Mobile) class246_sub3_sub4_sub2_sub2).anInt6369 = i_9_;
			int i_10_ = class98_sub22_sub1.readBits((byte) -108, 30);
			byte i_11_ = (byte) (i_10_ >> -638775876);
			int i_12_ = (0xffff6b1 & i_10_) >> -190559890;
			((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0] = i_12_ - Class272.anInt2038;
			int i_13_ = 0x3fff & i_10_;
			((AnimableEntity) class246_sub3_sub4_sub2_sub2).localXPos = (((((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0]) << 152480009) - -(class246_sub3_sub4_sub2_sub2.getSize() << 15811816));
			((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0] = -aa_Sub2.anInt3562 + i_13_;
			((AnimableEntity) class246_sub3_sub4_sub2_sub2).localYPos = (((((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]) << 652406601) + (class246_sub3_sub4_sub2_sub2.getSize() << 2125038824));
			Class43.anInt377 = ((AnimableEntity) class246_sub3_sub4_sub2_sub2).height_level = ((AnimableEntity) class246_sub3_sub4_sub2_sub2).aByte5081 = i_11_;
			if (Class1.method162((((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueZ[0]), (byte) -117, (((Mobile) class246_sub3_sub4_sub2_sub2).walkQueueX[0])))
				((AnimableEntity) class246_sub3_sub4_sub2_sub2).aByte5081++;
			...
			for (int i_14_ = 1; (i_14_ ^ 0xffffffff) > -2049; i_14_++) {
				if ((i_14_ ^ 0xffffffff) != (i_9_ ^ 0xffffffff)) {
					...
					((Class376) class376).anInt3176 = (i_16_ << -148957092) - (-(i_17_ << -430930482) - i_18_);
					((Class376) class376).aBoolean3175 = false;
					((Class376) class376).anInt3177 = -1;
					((Class376) class376).anInt3172 = 0;
	...
	Class373(RuneScapeCache class207, RuneScapeCache class207_21_, Class93 class93) {
		try {
			((Class373) this).aClass207_3473 = class207;
			aClass207_3476 = class207_21_;
			((Class373) this).aClass93_3478 = class93;
		} catch (RuntimeException runtimeexception) {
